...
count(*) as record_count
from <[Enroll360].[Student Phone].{fulfillment_ug_inquiries}> stud_phone
...
count(*) as record_count
from <[Enroll360].[Student Email].{fulfillment_ug_inquiries}> stud_email
...
count(*) as record_count
from <[Enroll360].[Student Test Scores].{fulfillment_ug_inquiries}> stud_test_scores
...
count(*) as record_count
from <[Enroll360].[Student Relationship].{fulfillment_ug_inquiries}> stud_rship
...
count(*) as record_count
from <[Enroll360].[Student Year Financial Aid].{fulfillment_ug_inquiries}> stud_yr_fin_aid
...
count(*) as record_count
from <[Enroll360].[Student Term].{fulfillment_ug_inquiries}> stud_term
...
current_entry_term as partner_value,
count(*) as record_count
from <[Enroll360].[Student Term Application].{fulfillment_ug_inquiries}> stud_term
group by current_entry_term
) et
...
current_entry_year_as_academic_year as partner_value,
count(*) as record_count
from <[Enroll360].[Student Year Financial Aid].{fulfillment_ug_inquiries}> stud_term
group by current_entry_year_as_academic_year  
)  ey
...
count(*) as record_count
from <[Enroll360].[Student Address].{fulfillment_ug_inquiries}> stud_addr
...
count(*) as record_count
from <[Enroll360].[Student Race].{fulfillment_ug_inquiries}> stud
group by <eab_race>,
race
...
count(*) as record_count
from <[Enroll360].[Student Term Application].{fulfillment_ug_inquiries}> stud_term_app
