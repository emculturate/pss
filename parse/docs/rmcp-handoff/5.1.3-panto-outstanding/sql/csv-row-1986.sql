/*2025-11-18: moved to v2 - ccreekman*/
/*2025-05-12: Enrollment Indicator is from supplemental table - fulfillment_enrolls - ehatfield*/
...
removed/commented out sections (usually non-discrete numeric data, no need for 1:1 conversions, variable will be in final queries)
  ...
  --EAB Std Value sections are commented out as STAtt is still in flux
  Student Term SIS
...
--expense_group_key
select 
eab_expense_group_key as partner_value,
count(*) as record_count
