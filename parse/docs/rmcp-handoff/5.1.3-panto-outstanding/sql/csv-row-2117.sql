/**Source of Truth = this Query: Enroll360.Project Atlas Migration Checks.st_sta_data_undeduped_apps*/

/*2026-04-30: aligned with <cte07_st_sta_data_undeduped_apps>*/
/*use this table to see students with multiple app records*/
...
stud_term_app.rn as app_record_rank
...
order by stud_term.partnercontact_id, stud_term.partner_system_name,
stud_term.partnercontact_id_sis, stud_term.partner_system_name_sis,
stud_term.partnercontact_id_crm, stud_term.partner_system_name_crm,
stud_term.eab_student_type,
stud_term.eab_entry_term,
