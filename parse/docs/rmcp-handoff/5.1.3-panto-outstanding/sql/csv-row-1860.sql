/*Primary difference are Stud Term Att fields at end*/
...
current_entry_term as partner_value,
count(*) as record_count
from <[Enroll360].[Student Term Attributes].{fulfillment}> stud_term
group by current_entry_term
) et
...
count(*) as record_count
from <[Enroll360].[Student Term Attributes].{fulfillment}> stud_term_att
