...
when countries.eab_common_country_name is not null then countries.eab_common_country_name
...
left outer join <[ALR].[Partner Code Mapping].{Countries}> countries--select * from <[ALR].[Partner Code Mapping].{Countries}> c
on stud_addr.country = countries.alpha_2_code
----------------------------------------
