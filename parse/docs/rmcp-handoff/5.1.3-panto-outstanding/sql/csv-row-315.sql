...
,CASE
WHEN regexp_replace(GENERIC_STAGING_FIELD_02,'"','') = 'PGS' AND regexp_replace(GENERIC_STAGING_FIELD_01,'"','') = 'Yes' AND (regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') IN ('Graduate', 'Graduate International', 'Graduate Re-Admit') OR regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') = '') AND (regexp_replace(SCHOOL_PROGRAM,'"','') IN ('Art – Art Therapy', 'Addiction Counseling','Advanced Alternative Preparation for Literacy Specialist','Master of Arts in Art Therapy and Counseling','Master of Arts in Leadership','Master of Arts in Liberal Studies','Master of Business Administration','Master of Fine Arts in Writing','Master of Public Administration','Master of Science in Accounting','Master of Science in Clinical Counseling','Master of Science in Criminal Justice','Master of Science in Education','Master of Science in Human Services','Master of Science in Management and Organizational Leadership','Personal Financial Management Certificate','Undecided') OR regexp_replace(SCHOOL_PROGRAM,'"','') = '') THEN 'INQ' 
...
,CASE
WHEN regexp_replace(GENERIC_STAGING_FIELD_02,'"','') = 'PGS' AND regexp_replace(GENERIC_STAGING_FIELD_01,'"','') = 'Yes' AND (regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') IN ('Graduate', 'Graduate International', 'Graduate Re-Admit') OR regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') = '') AND (regexp_replace(SCHOOL_PROGRAM,'"','') IN ('Art – Art Therapy', 'Addiction Counseling','Advanced Alternative Preparation for Literacy Specialist','Master of Arts in Art Therapy and Counseling','Master of Arts in Leadership','Master of Arts in Liberal Studies','Master of Business Administration','Master of Fine Arts in Writing','Master of Public Administration','Master of Science in Accounting','Master of Science in Clinical Counseling','Master of Science in Criminal Justice','Master of Science in Education','Master of Science in Human Services','Master of Science in Management and Organizational Leadership','Personal Financial Management Certificate','Undecided') OR regexp_replace(SCHOOL_PROGRAM,'"','') = '') THEN 1 
...
from
<[ALR].[Inquiry]> as a
WHERE regexp_replace(GENERIC_STAGING_FIELD_02,'"','') = 'PGS' AND regexp_replace(GENERIC_STAGING_FIELD_01,'"','') = 'Yes' AND (regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') IN ('Graduate', 'Graduate International', 'Graduate Re-Admit') OR regexp_replace(STUDENT_TYPE_SOURCE_VALUE,'"','') = '') AND (regexp_replace(SCHOOL_PROGRAM,'"','') IN ('Art – Art Therapy', 'Addiction Counseling','Advanced Alternative Preparation for Literacy Specialist','Master of Arts in Art Therapy and Counseling','Master of Arts in Leadership','Master of Arts in Liberal Studies','Master of Business Administration','Master of Fine Arts in Writing','Master of Public Administration','Master of Science in Accounting','Master of Science in Clinical Counseling','Master of Science in Criminal Justice','Master of Science in Education','Master of Science in Human Services','Master of Science in Management and Organizational Leadership','Personal Financial Management Certificate','Undecided') OR regexp_replace(SCHOOL_PROGRAM,'"','') = '')