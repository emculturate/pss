...
count(*) as record_count
from <[Enroll360].[Student Year Financial Aid].{fulfillment_ug_applicants}> stud_yr_fin_aid
...
current_entry_term as partner_value,
count(*) as record_count
from <[Enroll360].[Student Term Application].{fulfillment_ug_applicants}> stud_term
group by current_entry_term
) et
...
current_entry_year_as_academic_year as partner_value,
count(*) as record_count
from <[Enroll360].[Student Year Financial Aid].{fulfillment_ug_applicants}> stud_term
group by current_entry_year_as_academic_year
) ey
...
count(*) as record_count
from <[Enroll360].[Student Term Application].{fulfillment_ug_applicants}> stud_term_app
