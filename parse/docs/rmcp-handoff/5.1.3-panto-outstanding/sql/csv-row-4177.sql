...
as output_header
from <[Partner_Portal].[cultivate_inquiry_generation]> as cig
where 1=1
and first_cultivate_ig_email_engagement_date is not null
and first_cultivate_ig_email_engagement_date >= current_date - 7