-- Custom Tenant Query required in order to convert First Gen from the Application Object on Student and App Type from the Contact Object on Student Term Application. blang 2024-10-08
...
from <[Enroll360].[Student].{fulfillment_app}> stud_app
...
count(*) as record_count
from <[Enroll360].[Student Term Application].{fulfillment_contact}> sta_contact
