...
| 11 | **2.11** | Panto timeout corpus residuals: walk-gate follow-up + fast-FATAL rows (11) | High — correctness / diagnostics on live RMCP SQL | **In progress** — §2.8 **W1–W3** done; **W4–W5** + Cluster B open |
