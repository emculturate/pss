...
| `unpivotTableJoinOnWithUnqualifiedSalesAmountGateTest` | C | subset=C (heuristic) |
| `unpivotTableJoinOnWithUnqualifiedSalesAmountGateWithTabAliasTest` | C | subset=C (heuristic) |
| `unpivotTableWithQualifySalesAmountGateTest` | B | subset=B (heuristic) |
| `unpivotTableWithQualifySalesAmountGateWithTabAliasTest` | B | subset=B (heuristic) |
| `unpivotTableWithOrderByExpressionSalesAmountGateTest` | B | subset=B (heuristic) |
| `unpivotTableWithOrderByExpressionSalesAmountGateWithTabAliasTest` | B | subset=B (heuristic) |
