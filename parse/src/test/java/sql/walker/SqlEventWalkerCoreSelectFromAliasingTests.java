...
public class SqlEventWalkerCoreSelectFromAliasingTests extends AbstractSqlParseEventWalkerTest {
	...
	public void correlatedScalarPredicandNestedJoinSubqueryTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{query3={query_dictionary={pd1=[[@3,10:12='pd1',<381>,1:10]], pd2=[[@7,18:20='pd2',<381>,1:18]]}, table_dictionary={tab_a={pd1=[[@1,7:8='oa',<381>,1:7], [@41,146:147='oa',<381>,4:23]], pd3=[[@13,45:46='oa',<381>,2:6]], pd2=[[@5,15:16='oa',<381>,1:15]]}}, def_query1={query_dictionary={pd9=[[@21,65:67='pd9',<381>,2:26]]}, table_dictionary={tab_b={pd6=[[@52,180:181='ib',<381>,5:20]], pd9=[[@19,62:63='ib',<381>,2:23]]}}, def_query0={query_dictionary={pd7=[[@31,102:104='pd7',<381>,3:16], [@48,171:172='ix',<381>,5:11]]}, table_dictionary={tab_c={pd7=[[@29,99:100='ic',<381>,3:13], [@37,137:138='ic',<381>,4:14]]}}, filters=[{name=pd7, table_ref=ic}, {name=pd1, table_ref=oa}], interface={pd7=[{name=pd7, table_ref=ic}]}, table_alias={ic=tab_c}}, filters=[{name=pd7, table_ref=ix}, {name=pd6, table_ref=ib}], interface={pd9=[{name=pd9, table_ref=ib}]}, table_alias={ib=tab_b, ix=query0}}, dependent_queries={predicand2={query=query1, type=filters}}, filters=[{name=pd3, table_ref=oa}], interface={pd1=[{name=pd1, table_ref=oa}], pd2=[{name=pd2, table_ref=oa}]}, table_alias={oa=tab_a}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void correlatedScalarPredicandCteGroupByOuterFatalTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{query1={context_list={w2=query0}, query_dictionary={b1=[[@21,83:84='b1',<381>,5:10]]}, table_dictionary={}, def_query0={query_dictionary={b1=[[@7,25:26='b1',<381>,2:12], [@19,80:81='w2',<381>,5:7]]}, table_dictionary={tab_b={b_group_bad=[[@14,56:57='bb',<381>,3:11]], b1=[[@5,22:23='bb',<381>,2:9], [@19,80:81='w2',<381>,5:7]]}}, grouped_by=[{name=b_group_bad, table_ref=bb}], interface={b1=[{name=b1, table_ref=bb}]}, table_alias={bb=tab_b}}, interface={b1=[{name=b1, table_ref=w2}]}, table_alias={w2=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void correlatedScalarPredicandPlainUnionBranchOuterFatalTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{query5={query_dictionary={pu1=[[@3,10:12='pu1',<381>,1:10]]}, table_dictionary={tab_a={pu2=[[@9,37:38='ua',<381>,2:6]], pu1=[[@1,7:8='ua',<381>,1:7], [@36,128:129='ua',<381>,4:23], [@44,158:159='ua',<381>,4:53], [@61,225:226='ua',<381>,6:23]], pu_branch_bad=[[@40,139:140='ua',<381>,4:34]]}}, dependent_queries={predicand4={query=query3, type=filters}}, filters=[{name=pu2, table_ref=ua}], interface={pu1=[{name=pu1, table_ref=ua}]}, def_query3={def_union2={query0={query_dictionary={pu4=[[@26,84:86='pu4',<381>,3:10]]}, table_dictionary={tab_b={pu5=[[@32,119:120='ub',<381>,4:14]], pu4=[[@24,81:82='ub',<381>,3:7]]}}, filters=[{name=pu5, table_ref=ub}, {name=pu1, table_ref=ua}, {name=pu_branch_bad, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=ub}]}, table_alias={ub=tab_b}}, interface={pu4=[{name=pu4, table_ref=ub}, {name=pu4, table_ref=uc}]}, query1={query_dictionary={pu4=[[@51,181:183='pu4',<381>,5:16]]}, table_dictionary={tab_c={pu6=[[@57,216:217='uc',<381>,6:14]], pu4=[[@49,178:179='uc',<381>,5:13]]}}, filters=[{name=pu6, table_ref=uc}, {name=pu1, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=uc}]}, table_alias={uc=tab_c}}}, query_dictionary={unnamed_0=[[@20,65:65=')',<288>,2:34]]}, table_dictionary={}, interface={unnamed_0=[{name=pu4, table_ref=sub}]}, table_alias={sub=union2}}, table_alias={ua=tab_a}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void correlatedScalarPredicandUnionContextSubqueryTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{query5={query_dictionary={pu1=[[@3,10:12='pu1',<381>,1:10]]}, table_dictionary={tab_a={pu2=[[@9,37:38='ua',<381>,2:6]], pu1=[[@1,7:8='ua',<381>,1:7], [@36,128:129='ua',<381>,4:23], [@53,195:196='ua',<381>,6:23]]}}, dependent_queries={predicand4={query=query3, type=filters}}, filters=[{name=pu2, table_ref=ua}], interface={pu1=[{name=pu1, table_ref=ua}]}, def_query3={def_union2={query0={query_dictionary={pu4=[[@26,84:86='pu4',<381>,3:10]]}, table_dictionary={tab_b={pu5=[[@32,119:120='ub',<381>,4:14]], pu4=[[@24,81:82='ub',<381>,3:7]]}}, filters=[{name=pu5, table_ref=ub}, {name=pu1, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=ub}]}, table_alias={ub=tab_b}}, interface={pu4=[{name=pu4, table_ref=ub}, {name=pu4, table_ref=uc}]}, query1={query_dictionary={pu4=[[@43,151:153='pu4',<381>,5:16]]}, table_dictionary={tab_c={pu6=[[@49,186:187='uc',<381>,6:14]], pu4=[[@41,148:149='uc',<381>,5:13]]}}, filters=[{name=pu6, table_ref=uc}, {name=pu1, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=uc}]}, table_alias={uc=tab_c}}}, query_dictionary={unnamed_0=[[@20,65:65=')',<288>,2:34]]}, table_dictionary={}, interface={unnamed_0=[{name=pu4, table_ref=sub}]}, table_alias={sub=union2}}, table_alias={ua=tab_a}}}",
				extractor.getSymbolTable().toString());
	}
	@Test
	...
	public void correlatedInSubqueryMiddleCteReferencesFirstCteTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{query4={context_list={w1=query0, w2=query3}, query_dictionary={b1=[[@56,193:194='b1',<381>,5:10]]}, table_dictionary={}, def_query0={query_dictionary={a1=[[@7,22:23='a1',<381>,1:22], [@36,118:119='ww',<381>,3:30]], a2=[[@11,29:30='a2',<381>,1:29], [@44,167:168='ww',<381>,4:29]]}, table_dictionary={tab_a={a1=[[@5,19:20='aa',<381>,1:19], [@36,118:119='ww',<381>,3:30]], a2=[[@9,26:27='aa',<381>,1:26], [@44,167:168='ww',<381>,4:29]]}}, interface={a1=[{name=a1, table_ref=aa}], a2=[{name=a2, table_ref=aa}]}, table_alias={aa=tab_a}}, interface={b1=[{name=b1, table_ref=w2}]}, table_alias={w1=query0, w2=query3}, def_query3={context_list={w1=query0}, query_dictionary={b1=[[@24,68:69='b1',<381>,2:17], [@54,190:191='w2',<381>,5:7]]}, table_dictionary={tab_b={b2=[[@48,175:176='bb',<381>,4:37]], b1=[[@22,65:66='bb',<381>,2:14], [@30,101:102='bb',<381>,3:13], [@54,190:191='w2',<381>,5:7]]}}, def_query1={context_list={w1=query0, ww=query0}, query_dictionary={a1=[[@38,121:122='a1',<381>,3:33]]}, table_dictionary={}, filters=[{name=a2, table_ref=ww}, {name=b2, table_ref=bb}], interface={a1=[{name=a1, table_ref=ww}]}, table_alias={ww=query0, w1=query0}}, dependent_queries={in_list2={query=query1, type=filters}}, filters=[{name=b1, table_ref=bb}], interface={b1=[{name=b1, table_ref=bb}]}, table_alias={bb=tab_b, w1=query0}}}}",
				extractor.getSymbolTable().toString());
	}
	@Test
