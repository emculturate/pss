...
public class SqlEventWalkerCoreSelectFromAliasingTests extends AbstractSqlParseEventWalkerTest {
	...
	public void nestedQueryDemoWithCteTest() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query12={def_query12={def_query9={context_list={gg=query0}, query_dictionary={}, table_dictionary={jj={w=[[@97,284:284='w',<381>,7:14]], y=[[@101,300:301='jj',<381>,7:30]], m=[[@109,324:325='jj',<381>,7:54]]}}, filters=[{name=y, table_ref=jj}, {substitution={name=<z_col>, type=column}, table_ref=tab1}, {name=m, table_ref=jj}, {name=e3, table_ref=tab2}], interface={w=[{name=w, table_ref=null}]}, table_alias={gg=query0}}, context_list={gg=query0}, def_query7={context_list={gg=query0}, query_dictionary={mnd=[[@69,206:208='mnd',<381>,6:16]]}, table_dictionary={ee={D=[[@67,203:203='D',<381>,6:13]], x=[[@73,224:225='ee',<381>,6:34]], x2=[[@85,250:251='ee',<381>,6:60]]}}, filters=[{name=x, table_ref=ee}, {name=x, table_ref=tab1}, {name=f, table_ref=tt}, {name=x2, table_ref=ee}], interface={mnd=[{name=D, table_ref=null}]}, table_alias={gg=query0}}, def_query10={context_list={gg=query0}, query_dictionary={gg_y=[[@130,381:384='gg_y',<381>,8:28]]}, table_dictionary={ff={c=[[@125,373:373='c',<381>,8:20]], z=[[@134,400:401='ff',<381>,8:47]]}}, filters=[{name=z, table_ref=ff}, {substitution={name=<w_col>, type=column}, table_ref=tab1}], interface={c=[{name=c, table_ref=null}], gg_y=[{name=y, table_ref=gg}]}, table_alias={gg=query0}}, table_dictionary={tab1={a=[[@58,179:182='tab1',<381>,5:1]], <z_col>=[[@105,307:310='tab1',<381>,7:37]], c=[[@121,360:360='c',<381>,8:7]], t=[[@28,95:98='tab1',<381>,3:52]], x=[[@77,231:234='tab1',<381>,6:41]], <y_col>=[[@51,156:159='tab1',<381>,4:30]], <w_col>=[[@138,407:410='tab1',<381>,8:54]]}}, filters=[{name=c, table_ref=null}], def_query5={context_list={gg=query0}, query_dictionary={mxd=[[@41,121:123='mxd',<381>,3:78]]}, table_dictionary={ee={x=[[@45,141:142='ee',<381>,4:15], [@73,224:225='ee',<381>,6:34]], x2=[[@36,113:114='ee',<381>,3:70], [@85,250:251='ee',<381>,6:60]]}}, def_query1={context_list={gg=query0}, query_dictionary={at=[[@20,71:72='at',<381>,3:28]]}, table_dictionary={tt={b=[[@24,88:89='tt',<381>,3:45]], t=[[@18,68:68='t',<381>,3:25]], e=[[@32,106:107='tt',<381>,3:63]]}}, filters=[{name=b, table_ref=tt}, {name=t, table_ref=tab1}, {name=e, table_ref=tt}, {name=x2, table_ref=ee}], interface={at=[{name=t, table_ref=null}]}, table_alias={gg=query0}}, dependent_queries={predicand2={query=query1, type=interface}, predicand4={query=query3, type=filters}}, filters=[{name=x, table_ref=ee}], interface={mxd=[{name=t, table_ref=null}, {name=b, table_ref=tt}, {name=t, table_ref=tab1}, {name=e, table_ref=tt}, {name=x2, table_ref=ee}]}, def_query3={context_list={gg=query0}, query_dictionary={}, interface={<y_col>=[{substitution={name=<y_col>, type=column}, table_ref=tab1}]}, table_alias={gg=query0}}, table_alias={gg=query0}}, interface={aa=[{name=a, table_ref=tab1}], max_D=[{name=x, table_ref=ee}, {substitution={name=<y_col>, type=column}, table_ref=tab1}, {name=t, table_ref=null}, {name=b, table_ref=tt}, {name=t, table_ref=tab1}, {name=e, table_ref=tt}, {name=x2, table_ref=ee}], min_D=[{name=x, table_ref=ee}, {name=x, table_ref=tab1}, {name=f, table_ref=tt}, {name=x2, table_ref=ee}, {name=D, table_ref=null}], w=[{name=w, table_ref=kk}]}, query_dictionary={aa=[[@61,186:187='aa',<381>,5:8]], max_D=[[@56,171:175='max_D',<381>,4:45]], min_D=[[@89,257:261='min_D',<381>,6:67]]}, dependent_queries={predicand6={query=query5, type=interface}, predicand8={query=query7, type=interface}, in_list11={query=query10, type=filters}}, table_alias={gg=query0, kk=query9}}, context_list={gg=query0}, def_query0={query_dictionary={y=[[@5,19:19='y',<381>,1:19], [@127,376:377='gg',<381>,8:23]]}, table_dictionary={gg_src={y=[[@5,19:19='y',<381>,1:19], [@127,376:377='gg',<381>,8:23]]}}, interface={y=[{name=y, table_ref=gg_src}]}}, table_alias={gg=query0}}}",
				extractor.getSymbolTable().toString());
	}
