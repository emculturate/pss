...
public class SqlEventWalkerCoreSelectFromAliasingTests extends AbstractSqlParseEventWalkerTest {
	...
	public void concatenationFormulaTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={strm=[[@3,14:17='strm',<359>,1:14], [@13,37:40='strm',<359>,1:37], [@25,64:67='strm',<359>,1:64]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@30,73:73=')',<287>,1:73]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@30,73:73=')',<287>,1:73]]}, table_dictionary={tab1={strm=[[@3,14:17='strm',<359>,1:14], [@13,37:40='strm',<359>,1:37], [@25,64:67='strm',<359>,1:64]]}}, interface={unnamed_0=[{name=strm, table_ref=tab1}]}}}",
	...
	public void basicSelectList2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@3,10:10='b',<359>,1:10]], c=[[@5,12:12='c',<359>,1:12]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@1,8:8='a',<359>,1:8]], b=[[@3,10:10='b',<359>,1:10]], c=[[@5,12:12='c',<359>,1:12]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@1,8:8='a',<359>,1:8]], b=[[@3,10:10='b',<359>,1:10]], c=[[@5,12:12='c',<359>,1:12]]}, table_dictionary={tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@3,10:10='b',<359>,1:10]], c=[[@5,12:12='c',<359>,1:12]]}}, interface={a=[{name=a, table_ref=tab1}], b=[{name=b, table_ref=tab1}], c=[{name=c, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectList3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={d=[[@15,29:29='d',<359>,1:29]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@5,17:17='a',<359>,1:17]], b=[[@12,25:25='b',<359>,1:25]], c=[[@18,35:35='c',<359>,1:35]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@5,17:17='a',<359>,1:17]], b=[[@12,25:25='b',<359>,1:25]], c=[[@18,35:35='c',<359>,1:35]]}, table_dictionary={tab1={d=[[@15,29:29='d',<359>,1:29]]}}, interface={a=[], b=[], c=[{name=d, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectDistinctQualifierListTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}, table_dictionary={tab1={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}}, interface={a=[{name=a, table_ref=tab1}], b=[{name=b, table_ref=tab1}], c=[{name=c, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectDistinctListWithEmbeddedAllListQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab2={b=[[@11,40:40='b',<359>,1:40]], c=[[@13,42:42='c',<359>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={b=[[@11,40:40='b',<359>,1:40]], c=[[@13,42:42='c',<359>,1:42]]}, query1={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={a=[[@2,17:17='a',<359>,1:17]], b=[[@4,19:19='b',<359>,1:19]], c=[[@6,21:21='c',<359>,1:21]]}, table_dictionary={}, def_query0={query_dictionary={b=[[@11,40:40='b',<359>,1:40]], c=[[@13,42:42='c',<359>,1:42]]}, table_dictionary={tab2={b=[[@11,40:40='b',<359>,1:40]], c=[[@13,42:42='c',<359>,1:42]]}}, interface={b=[{name=b, table_ref=tab2}], c=[{name=c, table_ref=tab2}]}}, interface={a=[{name=a, table_ref=null}], b=[{name=b, table_ref=query0}], c=[{name=c, table_ref=query0}]}, table_alias={tab1=query0}}}",
				extractor.getSymbolTable().toString());
	...
	public void basicSelectListAliasing1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@5,15:15='b',<359>,1:15]], c=[[@9,22:22='c',<359>,1:22]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={x=[[@3,13:13='x',<359>,1:13]], y=[[@7,20:20='y',<359>,1:20]], z=[[@11,27:27='z',<359>,1:27]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={x=[[@3,13:13='x',<359>,1:13]], y=[[@7,20:20='y',<359>,1:20]], z=[[@11,27:27='z',<359>,1:27]]}, table_dictionary={tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@5,15:15='b',<359>,1:15]], c=[[@9,22:22='c',<359>,1:22]]}}, interface={x=[{name=a, table_ref=tab1}], y=[{name=b, table_ref=tab1}], z=[{name=c, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@5,18:18='b',<359>,1:18]], c=[[@9,28:28='c',<359>,1:28]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={02_y=[[@7,23:26='02_y',<362>,1:23]], 999_z=[[@11,33:37='999_z',<362>,1:33]], 01_x=[[@3,13:16='01_x',<362>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={02_y=[[@7,23:26='02_y',<362>,1:23]], 999_z=[[@11,33:37='999_z',<362>,1:33]], 01_x=[[@3,13:16='01_x',<362>,1:13]]}, table_dictionary={tab1={a=[[@1,8:8='a',<359>,1:8]], b=[[@5,18:18='b',<359>,1:18]], c=[[@9,28:28='c',<359>,1:28]]}}, interface={02_y=[{name=b, table_ref=tab1}], 999_z=[{name=c, table_ref=tab1}], 01_x=[{name=a, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListQuotedNumericPrefixColumnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{\"99tab1\"={\"22_b\"=[[@5,24:29='\"22_b\"',<363>,1:24]], \"09_a\"=[[@1,8:13='\"09_a\"',<363>,1:8]], \"36_c\"=[[@9,39:44='\"36_c\"',<363>,1:39]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={\"999_z\"=[[@11,49:55='\"999_z\"',<363>,1:49]], 02_y=[[@7,34:37='02_y',<362>,1:34]], 01_x=[[@3,18:21='01_x',<362>,1:18]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={\"999_z\"=[[@11,49:55='\"999_z\"',<363>,1:49]], 02_y=[[@7,34:37='02_y',<362>,1:34]], 01_x=[[@3,18:21='01_x',<362>,1:18]]}, table_dictionary={\"99tab1\"={\"22_b\"=[[@5,24:29='\"22_b\"',<363>,1:24]], \"09_a\"=[[@1,8:13='\"09_a\"',<363>,1:8]], \"36_c\"=[[@9,39:44='\"36_c\"',<363>,1:39]]}}, interface={\"999_z\"=[{name=\"36_c\", table_ref=\"99tab1\"}], 02_y=[{name=\"22_b\", table_ref=\"99tab1\"}], 01_x=[{name=\"09_a\", table_ref=\"99tab1\"}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real1SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{pantoresultprod.hive_result_pit_5223_164728_46090704={*=[[@23,101:101='t',<359>,1:101]], f1=[[@19,95:95='t',<359>,1:95]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={Degree_Code=[[@1,7:9='sub',<359>,1:7]], Degree_Name=[[@7,40:42='sub',<359>,1:40]], *=[[@25,103:103='*',<290>,1:103]], f1=[[@21,97:98='f1',<359>,1:97], [@13,75:77='sub',<359>,1:75]]}, query1={02_DEGREE_NAME=[[@11,59:72='02_DEGREE_NAME',<362>,1:59]], f1=[[@15,79:80='f1',<359>,1:79]], 01_DEGREE_CD=[[@5,26:37='01_DEGREE_CD',<362>,1:26]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={02_DEGREE_NAME=[[@11,59:72='02_DEGREE_NAME',<362>,1:59]], f1=[[@15,79:80='f1',<359>,1:79]], 01_DEGREE_CD=[[@5,26:37='01_DEGREE_CD',<362>,1:26]]}, table_dictionary={}, def_query0={query_dictionary={Degree_Code=[[@1,7:9='sub',<359>,1:7]], Degree_Name=[[@7,40:42='sub',<359>,1:40]], *=[[@25,103:103='*',<290>,1:103]], f1=[[@21,97:98='f1',<359>,1:97], [@13,75:77='sub',<359>,1:75]]}, table_dictionary={pantoresultprod.hive_result_pit_5223_164728_46090704={*=[[@23,101:101='t',<359>,1:101]], f1=[[@19,95:95='t',<359>,1:95]]}}, interface={*=[{name=*, table_ref=t}], f1=[{name=f1, table_ref=t}]}, table_alias={t=pantoresultprod.hive_result_pit_5223_164728_46090704}}, interface={02_DEGREE_NAME=[{name=Degree_Name, table_ref=sub}], f1=[{name=f1, table_ref=sub}], 01_DEGREE_CD=[{name=Degree_Code, table_ref=sub}]}, table_alias={sub=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedQueryDemoTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@10,30:30='D',<359>,1:30], [@21,61:61='D',<359>,1:61]]}, jj={w=[[@36,110:110='w',<359>,1:110]]}, ff={c=[[@46,143:143='c',<359>,1:143]]}, tab1={a=[[@1,7:10='tab1',<359>,1:7], [@42,130:130='a',<359>,1:130]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={w=[[@36,110:110='w',<359>,1:110], [@28,81:82='kk',<359>,1:81]]}, query5={c=[[@46,143:143='c',<359>,1:143]]}, query7={aa=[[@4,14:15='aa',<359>,1:14]], max_D=[[@15,42:46='max_D',<359>,1:42]], min_D=[[@26,73:77='min_D',<359>,1:73]], w=[[@30,84:84='w',<359>,1:84]]}, query0={unnamed_0=[[@11,31:31=')',<287>,1:31]]}, query2={unnamed_1=[[@22,62:62=')',<287>,1:62]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query7={query_dictionary={aa=[[@4,14:15='aa',<359>,1:14]], max_D=[[@15,42:46='max_D',<359>,1:42]], min_D=[[@26,73:77='min_D',<359>,1:73]], w=[[@30,84:84='w',<359>,1:84]]}, table_dictionary={tab1={a=[[@1,7:10='tab1',<359>,1:7], [@42,130:130='a',<359>,1:130]]}}, def_query0={query_dictionary={unnamed_0=[[@11,31:31=')',<287>,1:31]]}, table_dictionary={ee={D=[[@10,30:30='D',<359>,1:30], [@21,61:61='D',<359>,1:61]]}}, interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query5}], def_query5={query_dictionary={c=[[@46,143:143='c',<359>,1:143]]}, table_dictionary={ff={c=[[@46,143:143='c',<359>,1:143]]}}, interface={c=[{name=c, table_ref=ff}]}}, interface={aa=[{name=a, table_ref=tab1}], max_D=[{query=query0}], min_D=[{query=query2}], w=[{name=w, table_ref=kk}]}, def_query4={query_dictionary={w=[[@36,110:110='w',<359>,1:110], [@28,81:82='kk',<359>,1:81]]}, table_dictionary={jj={w=[[@36,110:110='w',<359>,1:110]]}}, interface={w=[{name=w, table_ref=jj}]}}, table_alias={kk=query4}, def_query2={query_dictionary={unnamed_1=[[@22,62:62=')',<287>,1:62]]}, table_dictionary={ee={D=[[@21,61:61='D',<359>,1:61]]}}, interface={unnamed_1=[{name=D, table_ref=ee}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real2SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{pantoresultprod.hive_result_pit_6875_220752_46090864={*=[[@15,92:92='t',<359>,1:92]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={College_Name=[[@7,42:44='sub',<359>,1:42]], *=[[@17,94:94='*',<290>,1:94]], College_Code=[[@1,7:9='sub',<359>,1:7]]}, query1={02_College_Name=[[@11,62:76='02_College_Name',<362>,1:62]], 01_College_Cd=[[@5,27:39='01_College_Cd',<362>,1:27]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={02_College_Name=[[@11,62:76='02_College_Name',<362>,1:62]], 01_College_Cd=[[@5,27:39='01_College_Cd',<362>,1:27]]}, table_dictionary={}, def_query0={query_dictionary={College_Name=[[@7,42:44='sub',<359>,1:42]], *=[[@17,94:94='*',<290>,1:94]], College_Code=[[@1,7:9='sub',<359>,1:7]]}, table_dictionary={pantoresultprod.hive_result_pit_6875_220752_46090864={*=[[@15,92:92='t',<359>,1:92]]}}, interface={*=[{name=*, table_ref=t}]}, table_alias={t=pantoresultprod.hive_result_pit_6875_220752_46090864}}, interface={02_College_Name=[{name=College_Name, table_ref=sub}], 01_College_Cd=[{name=College_Code, table_ref=sub}]}, table_alias={sub=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real3SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{pantoresultprod.hive_result_pit_5223_164727_46090703={*=[[@15,148:148='t',<359>,1:148]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={Course_Registration_Description=[[@7,67:69='sub',<359>,1:67]], *=[[@17,150:150='*',<290>,1:150]], Course_Registration_Code=[[@1,7:9='sub',<359>,1:7]]}, query1={02_COURSE_REGISTRATION_DESC=[[@11,106:132='02_COURSE_REGISTRATION_DESC',<362>,1:106]], 01_COURSE_REGISTRATION_CD=[[@5,39:63='01_COURSE_REGISTRATION_CD',<362>,1:39]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={02_COURSE_REGISTRATION_DESC=[[@11,106:132='02_COURSE_REGISTRATION_DESC',<362>,1:106]], 01_COURSE_REGISTRATION_CD=[[@5,39:63='01_COURSE_REGISTRATION_CD',<362>,1:39]]}, table_dictionary={}, def_query0={query_dictionary={Course_Registration_Description=[[@7,67:69='sub',<359>,1:67]], *=[[@17,150:150='*',<290>,1:150]], Course_Registration_Code=[[@1,7:9='sub',<359>,1:7]]}, table_dictionary={pantoresultprod.hive_result_pit_5223_164727_46090703={*=[[@15,148:148='t',<359>,1:148]]}}, interface={*=[{name=*, table_ref=t}]}, table_alias={t=pantoresultprod.hive_result_pit_5223_164727_46090703}}, interface={02_COURSE_REGISTRATION_DESC=[{name=Course_Registration_Description, table_ref=sub}], 01_COURSE_REGISTRATION_CD=[{name=Course_Registration_Code, table_ref=sub}]}, table_alias={sub=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real4SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{pantoresultprod.hive_result_pit_5223_164727_46090703={*=[[@11,140:140='t',<359>,1:140]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@13,142:142='*',<290>,1:142]]}, query1={02_COURSE_REGISTRATION_DESC=[[@7,98:124='02_COURSE_REGISTRATION_DESC',<362>,1:98]], 01_COURSE_REGISTRATION_CD=[[@3,35:59='01_COURSE_REGISTRATION_CD',<362>,1:35]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={02_COURSE_REGISTRATION_DESC=[[@7,98:124='02_COURSE_REGISTRATION_DESC',<362>,1:98]], 01_COURSE_REGISTRATION_CD=[[@3,35:59='01_COURSE_REGISTRATION_CD',<362>,1:35]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@13,142:142='*',<290>,1:142]]}, table_dictionary={pantoresultprod.hive_result_pit_5223_164727_46090703={*=[[@11,140:140='t',<359>,1:140]]}}, interface={*=[{name=*, table_ref=t}]}, table_alias={t=pantoresultprod.hive_result_pit_5223_164727_46090703}}, interface={02_COURSE_REGISTRATION_DESC=[{name=Course_Registration_Description, table_ref=query0}], 01_COURSE_REGISTRATION_CD=[{name=Course_Registration_Code, table_ref=query0}]}, table_alias={sub=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleVariableName1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<with blanks in name>=column, <simple>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<with blanks in name>=[[@5,20:20='a',<359>,1:20]], <simple>=[[@1,8:8='a',<359>,1:8]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void simpleVariableNameWithDotTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<simple>=column, <with.dots.in.name>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<simple>=[[@1,8:8='a',<359>,1:8]], <with.dots.in.name>=[[@5,20:20='a',<359>,1:20]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void simpleVariableNameWithDashTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<simple>=column, <with-dash-in - name>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<simple>=[[@1,8:8='a',<359>,1:8]], <with-dash-in - name>=[[@5,20:20='a',<359>,1:20]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={<simple>=[[@3,10:17='<simple>',<326>,1:10]], <with-dash-in - name>=[[@7,22:42='<with-dash-in - name>',<326>,1:22]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={<simple>=[[@3,10:17='<simple>',<326>,1:10]], <with-dash-in - name>=[[@7,22:42='<with-dash-in - name>',<326>,1:22]]}, table_dictionary={tab1={<simple>=[[@1,8:8='a',<359>,1:8]], <with-dash-in - name>=[[@5,20:20='a',<359>,1:20]]}}, interface={<simple>=[{substitution={name=<simple>, type=column}, table_ref=a}], <with-dash-in - name>=[{substitution={name=<with-dash-in - name>, type=column}, table_ref=a}]}, table_alias={a=tab1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void extendedVariableName1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[another].[item]>=column, <[DOMAIN].[ENTITY].[ATTRIBUTE]>=column, <[DOMAIN].[ENTITY]>=tuple, <[simple]>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[DOMAIN].[ENTITY]>={<[another].[item]>=[[@9,57:57='a',<359>,1:57]], <[DOMAIN].[ENTITY].[ATTRIBUTE]>=[[@5,22:22='a',<359>,1:22]], <[simple]>=[[@1,8:8='a',<359>,1:8]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void extendedVariableNameWithDots2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[DOMAIN].[ENTITY]>=tuple, <[PREFIX.DOMAIN.SUFFIX].[ENTITY.SUFFIX].[Prefix.ATTRIBUTE]>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[DOMAIN].[ENTITY]>={<[PREFIX.DOMAIN.SUFFIX].[ENTITY.SUFFIX].[Prefix.ATTRIBUTE]>=[[@1,9:9='a',<359>,1:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void extendedVariableNamePopulationSubnamerTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}>={col=[[@1,9:9='a',<359>,1:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col=[[@3,11:13='col',<359>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={col=[[@3,11:13='col',<359>,1:11]]}, table_dictionary={<[schema].[entity].{pop1}>={col=[[@1,9:9='a',<359>,1:9]]}}, interface={col=[{name=col, table_ref=a}]}, table_alias={a=<[schema].[entity].{pop1}>}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void extendedVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>={col=[[@1,9:9='a',<359>,1:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col=[[@3,11:13='col',<359>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={col=[[@3,11:13='col',<359>,1:11]]}, table_dictionary={<[schema].[entity].{pop1}.[Current Batch]>={col=[[@1,9:9='a',<359>,1:9]]}}, interface={col=[{name=col, table_ref=a}]}, table_alias={a=<[schema].[entity].{pop1}.[Current Batch]>}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationSubnameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}>={col=[[@1,9:9='a',<359>,1:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col=[[@3,11:13='col',<359>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={col=[[@3,11:13='col',<359>,1:11]]}, table_dictionary={<[entity].{pop1}>={col=[[@1,9:9='a',<359>,1:9]]}}, interface={col=[{name=col, table_ref=a}]}, table_alias={a=<[entity].{pop1}>}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}.[Current Batch]>={col=[[@1,9:9='a',<359>,1:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col=[[@3,11:13='col',<359>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={col=[[@3,11:13='col',<359>,1:11]]}, table_dictionary={<[entity].{pop1}.[Current Batch]>={col=[[@1,9:9='a',<359>,1:9]]}}, interface={col=[{name=col, table_ref=a}]}, table_alias={a=<[entity].{pop1}.[Current Batch]>}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void variation2ColumnVariableTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[[@1,7:11='apple',<359>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={apple=[[@1,7:11='apple',<359>,1:7]], <other>=[[@5,19:25='<other>',<326>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={apple=[[@1,7:11='apple',<359>,1:7]], <other>=[[@5,19:25='<other>',<326>,1:19]]}, table_dictionary={tab1={apple=[[@1,7:11='apple',<359>,1:7]]}}, interface={apple=[{name=apple, table_ref=tab1}], <other>=[{substitution={name=<other>, type=column}, table_ref=tab2}]}}}",
				extractor.getSymbolTable().toString());
	...
	public void variation3ColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<other>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[[@5,27:31='apple',<359>,1:27]]}, tab2={apple=[[@23,93:96='tab2',<359>,1:93]], <other>=[[@9,49:52='tab2',<359>,1:49]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={apple=[[@5,27:31='apple',<359>,1:27], [@19,83:83='a',<359>,1:83]]}, query1={apple=[[@1,7:11='apple',<359>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={apple=[[@1,7:11='apple',<359>,1:7]]}, table_dictionary={tab2={apple=[[@23,93:96='tab2',<359>,1:93]]}}, def_query0={query_dictionary={apple=[[@5,27:31='apple',<359>,1:27], [@19,83:83='a',<359>,1:83]]}, table_dictionary={tab1={apple=[[@5,27:31='apple',<359>,1:27]]}}, filters=[{substitution={name=<other>, type=column}, table_ref=tab2}], interface={apple=[{name=apple, table_ref=tab1}]}}, filters=[{name=apple, table_ref=a}, {name=apple, table_ref=tab2}], interface={apple=[{name=apple, table_ref=null}]}, table_alias={a=query0}}}",
				extractor.getSymbolTable().toString());
	...
	+	"\n    QUALIFY ROW_NUMBER() OVER ( PARTITION BY contact_key ORDER BY cbsc.contact_priority ASC) = 1";
		...
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_ALR_V2','rsc__cappex_contacts') }}=tuple, {{ source('PDP_ALR_V2_CONTACTS','prc__contacts_by_sourcecontacts_current') }}=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_alr_v2','rsc__cappex_contacts') }}={cappex_id=[[@5,26:28='rsc',<359>,1:26]], sourcecontact_id=[[@32,206:208='rsc',<359>,3:3]]}, {{ source('pdp_alr_v2_contacts','prc__contacts_by_sourcecontacts_current') }}={contact_key=[[@1,8:11='cbsc',<359>,1:8]], sourcecontact_id=[[@36,229:232='cbsc',<359>,3:26]], contact_priority=[[@50,318:321='cbsc',<359>,4:66]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={cappex_id=[[@7,30:38='cappex_id',<359>,1:30]], contact_key=[[@3,13:23='contact_key',<359>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={cappex_id=[[@7,30:38='cappex_id',<359>,1:30]], contact_key=[[@3,13:23='contact_key',<359>,1:13]]}, table_dictionary={{{ source('pdp_alr_v2','rsc__cappex_contacts') }}={cappex_id=[[@5,26:28='rsc',<359>,1:26]], sourcecontact_id=[[@32,206:208='rsc',<359>,3:3]]}, {{ source('pdp_alr_v2_contacts','prc__contacts_by_sourcecontacts_current') }}={contact_key=[[@1,8:11='cbsc',<359>,1:8]], sourcecontact_id=[[@36,229:232='cbsc',<359>,3:26]], contact_priority=[[@50,318:321='cbsc',<359>,4:66]]}}, filters=[{name=sourcecontact_id, table_ref=rsc}, {name=sourcecontact_id, table_ref=cbsc}, {name=contact_key, table_ref=null}, {name=contact_priority, table_ref=cbsc}], interface={cappex_id=[{name=cappex_id, table_ref=rsc}], contact_key=[{name=contact_key, table_ref=cbsc}]}, table_alias={cbsc={{ source('PDP_ALR_V2_CONTACTS','prc__contacts_by_sourcecontacts_current') }}, rsc={{ source('PDP_ALR_V2','rsc__cappex_contacts') }}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	+    "\n QUALIFY ROW_NUMBER() OVER ( PARTITION BY contact_key ORDER BY cbsc.contact_priority ASC) = 1";
		...
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_ALR_V2_CONTACTS','prc__contacts_by_sourcecontacts_current') }}=tuple}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_alr_v2_contacts','prc__contacts_by_sourcecontacts_current') }}={contact_key=[[@1,8:11='cbsc',<359>,1:8], [@23,159:169='contact_key',<359>,2:42]], contact_priority=[[@26,180:183='cbsc',<359>,2:63]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={contact_key=[[@3,13:23='contact_key',<359>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={contact_key=[[@3,13:23='contact_key',<359>,1:13]]}, table_dictionary={{{ source('pdp_alr_v2_contacts','prc__contacts_by_sourcecontacts_current') }}={contact_key=[[@1,8:11='cbsc',<359>,1:8], [@23,159:169='contact_key',<359>,2:42]], contact_priority=[[@26,180:183='cbsc',<359>,2:63]]}}, filters=[{name=contact_key, table_ref={{ source('pdp_alr_v2_contacts','prc__contacts_by_sourcecontacts_current') }}}, {name=contact_priority, table_ref=cbsc}], interface={contact_key=[{name=contact_key, table_ref=cbsc}]}, table_alias={cbsc={{ source('PDP_ALR_V2_CONTACTS','prc__contacts_by_sourcecontacts_current') }}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void informaticaINFunctionStatementTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{dual={property=[[@3,10:17='property',<359>,1:10], [@5,19:26='property',<359>,1:19]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={colum=[[@10,34:38='colum',<359>,1:34]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={colum=[[@10,34:38='colum',<359>,1:34]]}, table_dictionary={dual={property=[[@3,10:17='property',<359>,1:10], [@5,19:26='property',<359>,1:19]]}}, interface={colum=[{name=property, table_ref=dual}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void informaticaINFunctionConditionStatement1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<in_list>=in_list}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{dual={property=[[@7,28:35='property',<359>,1:28], [@9,37:44='property',<359>,1:37]], *=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={*=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={dual={property=[[@7,28:35='property',<359>,1:28], [@9,37:44='property',<359>,1:37]], *=[[@1,7:7='*',<290>,1:7]]}}, filters=[{name=property, table_ref=dual}], interface={*=[{name=*, table_ref=*}]}}}",
				extractor.getSymbolTable().toString());
	}
