...
public class SqlEventWalkerCoreSelectFromAliasingTests extends AbstractSqlParseEventWalkerTest {
	...
	public void correlatedScalarPredicandUnionContextSubqueryTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={pu4=[[@17,58:60='sub',<381>,2:27]]}, query5={pu1=[[@3,10:12='pu1',<381>,1:10]]}, query0={pu4=[[@26,84:86='pu4',<381>,3:10]]}, query1={pu4=[[@43,151:153='pu4',<381>,5:16]]}, query3={unnamed_0=[[@20,65:65=')',<288>,2:34]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query5={query_dictionary={pu1=[[@3,10:12='pu1',<381>,1:10]]}, table_dictionary={tab_a={pu2=[[@9,37:38='ua',<381>,2:6]], pu1=[[@1,7:8='ua',<381>,1:7], [@36,128:129='ua',<381>,4:23]]}}, dependent_queries={predicand4={query=query3, type=filters}}, filters=[{name=pu2, table_ref=ua}], interface={pu1=[{name=pu1, table_ref=ua}]}, def_query3={def_union2={query_dictionary={pu4=[[@17,58:60='sub',<381>,2:27]]}, def_query1={query_dictionary={pu4=[[@43,151:153='pu4',<381>,5:16]]}, table_dictionary={tab_a={pu1=[[@53,195:196='ua',<381>,6:23]]}, tab_c={pu6=[[@49,186:187='uc',<381>,6:14]], pu4=[[@41,148:149='uc',<381>,5:13]]}}, filters=[{name=pu6, table_ref=uc}, {name=pu1, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=uc}]}, table_alias={uc=tab_c}}, def_query0={query_dictionary={pu4=[[@26,84:86='pu4',<381>,3:10]]}, table_dictionary={tab_a={pu1=[[@36,128:129='ua',<381>,4:23], [@53,195:196='ua',<381>,6:23], [@1,7:8='ua',<381>,1:7]]}, tab_b={pu5=[[@32,119:120='ub',<381>,4:14]], pu4=[[@24,81:82='ub',<381>,3:7]]}}, filters=[{name=pu5, table_ref=ub}, {name=pu1, table_ref=ua}], interface={pu4=[{name=pu4, table_ref=ub}]}, table_alias={ub=tab_b}}, interface={pu4=query_column}}, query_dictionary={unnamed_0=[[@20,65:65=')',<288>,2:34]]}, interface={unnamed_0=[{name=pu4, table_ref=sub}]}, table_alias={sub=union2}}, table_alias={ua=tab_a}}}",
				extractor.getSymbolTable().toString());
	}
