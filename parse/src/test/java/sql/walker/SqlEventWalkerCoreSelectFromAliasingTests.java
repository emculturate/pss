	...
	public void getSubstitutionColumnVariableV2GroupByQualifiedColumnReferencesTest() {
		...
		public void getSubstitutionColumnVariableV10CteWrappedGroupByVariantWithJoinOnSelectColumnTest() {
			...
			Assert.assertEquals("Table Dictionary is wrong", "{<[Enrollment Services].[Client Entering Class]>={agg_col=[[@12,62:64='cec',<381>,1:62]], <select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@21,143:145='cec',<381>,3:9]], <where column>=[[@25,165:167='cec',<381>,3:31]]}, dummy_table={dummy_col=[[@48,289:289='d',<381>,4:102]], dummy_col2=[[@34,215:215='d',<381>,4:28]]}}",
							extractor.getTableColumnDictionaryMap().toString());
			Assert.assertEquals("Query Column Dictionary is wrong", "{query0={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@30,194:196='cec',<381>,4:7], [@44,267:269='cec',<381>,4:80]], unnamed_0=[[@15,73:73=')',<288>,1:73]]}, query1={<select column>=[[@32,198:212='<select column>',<327>,4:11], [@30,194:196='cec',<381>,4:7], [@44,267:269='cec',<381>,4:80]], dummy_col2=[[@36,217:226='dummy_col2',<381>,4:30]]}}",
							extractor.getQueryColumnDictionaryMap().toString());
			Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={context_list={wrapped=query0, cec=query0}, query_dictionary={<select column>=[[@32,198:212='<select column>',<327>,4:11], [@30,194:196='cec',<381>,4:7], [@44,267:269='cec',<381>,4:80]], dummy_col2=[[@36,217:226='dummy_col2',<381>,4:30]]}, table_dictionary={dummy_table={dummy_col=[[@48,289:289='d',<381>,4:102]], dummy_col2=[[@34,215:215='d',<381>,4:28]]}}, def_query0={query_dictionary={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@30,194:196='cec',<381>,4:7], [@44,267:269='cec',<381>,4:80]], unnamed_0=[[@15,73:73=')',<288>,1:73]]}, table_dictionary={<[Enrollment Services].[Client Entering Class]>={agg_col=[[@12,62:64='cec',<381>,1:62]], <select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@21,143:145='cec',<381>,3:9]], <where column>=[[@25,165:167='cec',<381>,3:31]]}}, grouped_by=[{name=non_variable_col, table_ref=cec}, {substitution={name=<where column>, type=column}, table_ref=cec}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}], unnamed_0=[{name=agg_col, table_ref=cec}]}, table_alias={cec=<[Enrollment Services].[Client Entering Class]>}}, filters=[{substitution={name=<select column>, type=column}, table_ref=cec}, {name=dummy_col, table_ref=d}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}], dummy_col2=[{name=dummy_col2, table_ref=d}]}, table_alias={cec=query0, d=dummy_table, wrapped=query0}}}",
				extractor.getSymbolTable().toString());
		}
		...
		public void getSubstitutionColumnVariableV11CteWrappedOrderByVariantWithJoinOnSelectColumnTest() {
			...
			Assert.assertEquals("Table Dictionary is wrong", "{<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@13,114:116='cec',<381>,3:9]], <where column>=[[@17,136:138='cec',<381>,3:31]]}, dummy_table={dummy_col=[[@40,260:260='d',<381>,4:102]], dummy_col2=[[@26,186:186='d',<381>,4:28]]}}",
							extractor.getTableColumnDictionaryMap().toString());
			Assert.assertEquals("Query Column Dictionary is wrong", "{query0={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@22,165:167='cec',<381>,4:7], [@36,238:240='cec',<381>,4:80]]}, query1={<select column>=[[@24,169:183='<select column>',<327>,4:11], [@22,165:167='cec',<381>,4:7], [@36,238:240='cec',<381>,4:80]], dummy_col2=[[@28,188:197='dummy_col2',<381>,4:30]]}}",
							extractor.getQueryColumnDictionaryMap().toString());
			Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={context_list={wrapped=query0, cec=query0}, query_dictionary={<select column>=[[@24,169:183='<select column>',<327>,4:11], [@22,165:167='cec',<381>,4:7], [@36,238:240='cec',<381>,4:80]], dummy_col2=[[@28,188:197='dummy_col2',<381>,4:30]]}, table_dictionary={dummy_table={dummy_col=[[@40,260:260='d',<381>,4:102]], dummy_col2=[[@26,186:186='d',<381>,4:28]]}}, def_query0={query_dictionary={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@22,165:167='cec',<381>,4:7], [@36,238:240='cec',<381>,4:80]]}, table_dictionary={<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@13,114:116='cec',<381>,3:9]], <where column>=[[@17,136:138='cec',<381>,3:31]]}}, ordered_by=[{name=non_variable_col, table_ref=cec}, {substitution={name=<where column>, type=column}, table_ref=cec}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}]}, table_alias={cec=<[Enrollment Services].[Client Entering Class]>}}, filters=[{substitution={name=<select column>, type=column}, table_ref=cec}, {name=dummy_col, table_ref=d}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}], dummy_col2=[{name=dummy_col2, table_ref=d}]}, table_alias={cec=query0, d=dummy_table, wrapped=query0}}}",
				extractor.getSymbolTable().toString());
		}
		...
		public void getSubstitutionColumnVariableV13CteWrappedQualifyVariantWithJoinOnSelectColumnTest() {
			...
			Assert.assertEquals("Table Dictionary is wrong", "{<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@19,145:147='cec',<381>,3:40], [@28,195:197='cec',<381>,3:90]], <where column>=[[@23,167:169='cec',<381>,3:62]]}, dummy_table={dummy_col=[[@54,326:326='d',<381>,4:102]], dummy_col2=[[@40,252:252='d',<381>,4:28]]}}",
							extractor.getTableColumnDictionaryMap().toString());
			Assert.assertEquals("Query Column Dictionary is wrong", "{query0={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@36,231:233='cec',<381>,4:7], [@50,304:306='cec',<381>,4:80]]}, query1={<select column>=[[@38,235:249='<select column>',<327>,4:11], [@36,231:233='cec',<381>,4:7], [@50,304:306='cec',<381>,4:80]], dummy_col2=[[@42,254:263='dummy_col2',<381>,4:30]]}}",
							extractor.getQueryColumnDictionaryMap().toString());
			Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={context_list={wrapped=query0, cec=query0}, query_dictionary={<select column>=[[@38,235:249='<select column>',<327>,4:11], [@36,231:233='cec',<381>,4:7], [@50,304:306='cec',<381>,4:80]], dummy_col2=[[@42,254:263='dummy_col2',<381>,4:30]]}, table_dictionary={dummy_table={dummy_col=[[@54,326:326='d',<381>,4:102]], dummy_col2=[[@40,252:252='d',<381>,4:28]]}}, def_query0={query_dictionary={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@36,231:233='cec',<381>,4:7], [@50,304:306='cec',<381>,4:80]]}, table_dictionary={<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@19,145:147='cec',<381>,3:40], [@28,195:197='cec',<381>,3:90]], <where column>=[[@23,167:169='cec',<381>,3:62]]}}, filters=[{name=non_variable_col, table_ref=cec}, {substitution={name=<where column>, type=column}, table_ref=cec}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}]}, table_alias={cec=<[Enrollment Services].[Client Entering Class]>}}, filters=[{substitution={name=<select column>, type=column}, table_ref=cec}, {name=dummy_col, table_ref=d}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}], dummy_col2=[{name=dummy_col2, table_ref=d}]}, table_alias={cec=query0, d=dummy_table, wrapped=query0}}}",
				extractor.getSymbolTable().toString());
		}
		...
		public void getSubstitutionColumnVariableV14CteWrappedSecondJoinOnVariantWithJoinOnSelectColumnTest() {
			...
			Assert.assertEquals("Table Dictionary is wrong", "{<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@15,166:168='cec',<381>,3:61], [@19,189:192='cec2',<381>,3:84]], <where column>=[[@30,294:297='cec3',<381>,4:82], [@26,273:275='cec',<381>,4:61]]}, dummy_table={dummy_col=[[@53,419:419='d',<381>,5:102]], dummy_col2=[[@39,345:345='d',<381>,5:28]]}}",
							extractor.getTableColumnDictionaryMap().toString());
			Assert.assertEquals("Query Column Dictionary is wrong", "{query0={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@35,324:326='cec',<381>,5:7], [@49,397:399='cec',<381>,5:80]]}, query1={<select column>=[[@37,328:342='<select column>',<327>,5:11], [@35,324:326='cec',<381>,5:7], [@49,397:399='cec',<381>,5:80]], dummy_col2=[[@41,347:356='dummy_col2',<381>,5:30]]}}",
							extractor.getQueryColumnDictionaryMap().toString());
			Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={context_list={wrapped=query0, cec=query0}, query_dictionary={<select column>=[[@37,328:342='<select column>',<327>,5:11], [@35,324:326='cec',<381>,5:7], [@49,397:399='cec',<381>,5:80]], dummy_col2=[[@41,347:356='dummy_col2',<381>,5:30]]}, table_dictionary={dummy_table={dummy_col=[[@53,419:419='d',<381>,5:102]], dummy_col2=[[@39,345:345='d',<381>,5:28]]}}, def_query0={query_dictionary={<select column>=[[@7,30:44='<select column>',<327>,1:30], [@35,324:326='cec',<381>,5:7], [@49,397:399='cec',<381>,5:80]]}, table_dictionary={<[Enrollment Services].[Client Entering Class]>={<select column>=[[@5,26:28='cec',<381>,1:26]], non_variable_col=[[@15,166:168='cec',<381>,3:61], [@19,189:192='cec2',<381>,3:84]], <where column>=[[@30,294:297='cec3',<381>,4:82], [@26,273:275='cec',<381>,4:61]]}}, filters=[{name=non_variable_col, table_ref=cec}, {name=non_variable_col, table_ref=cec2}, {substitution={name=<where column>, type=column}, table_ref=cec}, {substitution={name=<where column>, type=column}, table_ref=cec3}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}]}, table_alias={cec=<[Enrollment Services].[Client Entering Class]>, cec3=<[Enrollment Services].[Client Entering Class]>, cec2=<[Enrollment Services].[Client Entering Class]>}}, filters=[{substitution={name=<select column>, type=column}, table_ref=cec}, {name=dummy_col, table_ref=d}], interface={<select column>=[{substitution={name=<select column>, type=column}, table_ref=cec}], dummy_col2=[{name=dummy_col2, table_ref=d}]}, table_alias={cec=query0, d=dummy_table, wrapped=query0}}}",
				extractor.getSymbolTable().toString());
		}
