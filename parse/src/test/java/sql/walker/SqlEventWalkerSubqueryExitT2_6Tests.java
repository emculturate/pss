...
public class SqlEventWalkerSubqueryExitT2_6Tests extends AbstractSqlParseEventWalkerTest {
	...
	public void subqueryScalarInSelectListT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[m]", "{}",
				"{t1={}, t2={x=[[@5,19:19='x',<392>,1:19]]}}",
				"{query0={unnamed_0=[[@6,20:20=')',<288>,1:20]]}, query2={m=[[@11,34:34='m',<392>,1:34]]}}",
				"{def_query2={query_dictionary={m=[[@11,34:34='m',<392>,1:34]]}, table_dictionary={t1={}}, dependent_queries={predicand1={query=query0, type=interface}}, def_query0={query_dictionary={unnamed_0=[[@6,20:20=')',<288>,1:20]]}, table_dictionary={t2={x=[[@5,19:19='x',<392>,1:19]]}}, interface={unnamed_0=[{name=x, table_ref=t2}]}}, interface={m=[{name=x, table_ref=null}]}}}");
	}
	...
	public void subqueryScalarInWhereT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[a]", "{}",
				"{t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}, t2={b=[[@11,39:39='b',<392>,1:39]]}}",
				"{query0={unnamed_0=[[@12,40:40=')',<288>,1:40]]}, query2={a=[[@1,7:7='a',<392>,1:7]]}}",
				"{def_query2={query_dictionary={a=[[@1,7:7='a',<392>,1:7]]}, table_dictionary={t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}}, dependent_queries={predicand1={query=query0, type=filters}}, def_query0={query_dictionary={unnamed_0=[[@12,40:40=')',<288>,1:40]]}, table_dictionary={t2={b=[[@11,39:39='b',<392>,1:39]]}}, interface={unnamed_0=[{name=b, table_ref=t2}]}}, filters=[{name=a, table_ref=t1}], interface={a=[{name=a, table_ref=t1}]}}}");
	}
	...
	public void subqueryExistsPredicateT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[a]", "{}",
				"{t1={a=[[@1,7:7='a',<392>,1:7]], id=[[@16,62:63='t1',<392>,1:62]]}, t2={id=[[@12,54:55='t2',<392>,1:54]]}}",
				"{query0={unnamed_0=[[@8,38:38='1',<300>,1:38]]}, query2={a=[[@1,7:7='a',<392>,1:7]]}}",
				"{def_query2={query_dictionary={a=[[@1,7:7='a',<392>,1:7]]}, table_dictionary={t1={a=[[@1,7:7='a',<392>,1:7]], id=[[@16,62:63='t1',<392>,1:62]]}}, dependent_queries={exists1={query=query0, type=filters}}, def_query0={query_dictionary={unnamed_0=[[@8,38:38='1',<300>,1:38]]}, table_dictionary={t2={id=[[@12,54:55='t2',<392>,1:54]]}}, filters=[{name=id, table_ref=t2}, {name=id, table_ref=t1}], interface={unnamed_0=[]}}, filters=[], interface={a=[{name=a, table_ref=t1}]}}}");
	}
	...
	public void subqueryInPredicateT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[a]", "{}",
				"{t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}, t2={b=[[@9,36:36='b',<392>,1:36]]}}",
				"{query0={b=[[@9,36:36='b',<392>,1:36]]}, query2={a=[[@1,7:7='a',<392>,1:7]]}}",
				"{def_query2={query_dictionary={a=[[@1,7:7='a',<392>,1:7]]}, table_dictionary={t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}}, dependent_queries={in_list1={query=query0, type=filters}}, def_query0={query_dictionary={b=[[@9,36:36='b',<392>,1:36]]}, table_dictionary={t2={b=[[@9,36:36='b',<392>,1:36]]}}, interface={b=[{name=b, table_ref=t2}]}}, filters=[{name=a, table_ref=t1}], interface={a=[{name=a, table_ref=t1}]}}}");
	}
	...
	public void subqueryFromDerivedTableT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[x]", "{}",
				"{t2={a=[[@7,24:24='a',<392>,1:24]]}}",
				"{query0={x=[[@9,29:29='x',<392>,1:29], [@1,7:7='s',<392>,1:7]]}, query1={x=[[@3,9:9='x',<392>,1:9]]}}",
				"{def_query1={query_dictionary={x=[[@3,9:9='x',<392>,1:9]]}, def_query0={query_dictionary={x=[[@9,29:29='x',<392>,1:29], [@1,7:7='s',<392>,1:7]]}, table_dictionary={t2={a=[[@7,24:24='a',<392>,1:24]]}}, interface={x=[{name=a, table_ref=t2}]}}, interface={x=[{name=x, table_ref=s}]}, table_alias={s=query0}}}");
	}
	...
	public void subqueryInsertSelectSourceT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[*]", "{}",
				"{dst={*=[[@4,23:23='*',<291>,1:23]]}, src={a=[[@8,38:38='a',<392>,1:38]], b=[[@10,41:41='b',<392>,1:41]]}}",
				"{query0={a=[[@8,38:38='a',<392>,1:38]], b=[[@10,41:41='b',<392>,1:41]], *=[[@4,23:23='*',<291>,1:23]]}, query1={*=[[@4,23:23='*',<291>,1:23]]}, insert2={*=[[@4,23:23='*',<291>,1:23]]}}",
				"{def_insert2={query_dictionary={*=[[@4,23:23='*',<291>,1:23]]}, table_dictionary={dst={*=[[@4,23:23='*',<291>,1:23]]}}, def_query1={query_dictionary={*=[[@4,23:23='*',<291>,1:23]]}, def_query0={query_dictionary={a=[[@8,38:38='a',<392>,1:38]], b=[[@10,41:41='b',<392>,1:41]], *=[[@4,23:23='*',<291>,1:23]]}, table_dictionary={src={a=[[@8,38:38='a',<392>,1:38]], b=[[@10,41:41='b',<392>,1:41]]}}, interface={a=[{name=a, table_ref=src}], b=[{name=b, table_ref=src}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={q=query0}}, interface={*=[{name=*, table_ref=query1}]}}}");
	}
	...
	public void subquerySetOpMemberT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[a]", "{}",
				"{t1={a=[[@2,8:8='a',<392>,1:8]]}, t2={a=[[@9,33:33='a',<392>,1:33]]}}",
				"{query0={a=[[@2,8:8='a',<392>,1:8]]}, query1={a=[[@9,33:33='a',<392>,1:33]]}}",
				"{def_union2={def_query1={query_dictionary={a=[[@9,33:33='a',<392>,1:33]]}, table_dictionary={t2={a=[[@9,33:33='a',<392>,1:33]]}}, setop=UNION, interface={a=[{name=a, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@2,8:8='a',<392>,1:8]]}, table_dictionary={t1={a=[[@2,8:8='a',<392>,1:8]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}}");
	}
	...
	public void subqueryQuantifiedCompareT2_6Test() {
		...
		assertSubqueryExitOutputs(extractor,
				...
				"[a]", "{}",
				"{t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}, t2={b=[[@10,39:39='b',<392>,1:39]]}}",
				"{query0={b=[[@10,39:39='b',<392>,1:39]]}, query2={a=[[@1,7:7='a',<392>,1:7]]}}",
				"{def_query2={query_dictionary={a=[[@1,7:7='a',<392>,1:7]]}, table_dictionary={t1={a=[[@1,7:7='a',<392>,1:7], [@5,23:23='a',<392>,1:23]]}}, dependent_queries={quantified1={query=query0, type=filters}}, def_query0={query_dictionary={b=[[@10,39:39='b',<392>,1:39]]}, table_dictionary={t2={b=[[@10,39:39='b',<392>,1:39]]}}, interface={b=[{name=b, table_ref=t2}]}}, filters=[{name=a, table_ref=t1}], interface={a=[{name=a, table_ref=t1}]}}}");
	}
}
