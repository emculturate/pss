...
*/
	...
	public void insertWithColumnsFromUnionQueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{insert3={query_dictionary={d=[[@6,21:21='d',<381>,1:21]], c=[[@4,18:18='c',<381>,1:18]]}, def_union2={query0={query_dictionary={a=[[@9,31:31='a',<381>,1:31]], b=[[@11,33:33='b',<381>,1:33]]}, table_dictionary={tab2={a=[[@9,31:31='a',<381>,1:31]], b=[[@11,33:33='b',<381>,1:33]]}}, _tmp_insert_source_select_sequence=[a, b], interface={a=[{name=a, table_ref=tab2}], b=[{name=b, table_ref=tab2}]}}, interface={a=query_column, b=query_column}, query1={query_dictionary={c=[[@16,58:58='c',<381>,1:58]], d=[[@18,60:60='d',<381>,1:60]]}, table_dictionary={tab3={c=[[@16,58:58='c',<381>,1:58]], d=[[@18,60:60='d',<381>,1:60]]}}, _tmp_insert_source_select_sequence=[c, d], interface={c=[{name=c, table_ref=tab3}], d=[{name=d, table_ref=tab3}]}}}, table_dictionary={tab1={c=[[@4,18:18='c',<381>,1:18]], d=[[@6,21:21='d',<381>,1:21]]}}, interface={c=[{name=a, table_ref=union2}], d=[{name=b, table_ref=union2}]}}}",
        	snippet.getSymbolTable().toString());
