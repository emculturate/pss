 ...
 *  */		
	...
	public void basicSQLTest() {
		...
		Assert.assertEquals("Symbol Table is wrong", "{def_query0={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,10:10='b',<393>,1:10]]}, table_dictionary={tab1={a=[[@1,7:7='a',<393>,1:7], [@7,28:28='a',<393>,1:28]], b=[[@3,10:10='b',<393>,1:10], [@9,32:32='b',<393>,1:32]]}}, filters=[{name=a, table_ref=tab1}, {name=b, table_ref=tab1}], interface={a=[{name=a, table_ref=tab1}], b=[{name=b, table_ref=tab1}]}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@1,7:7='a',<393>,1:7], [@7,28:28='a',<393>,1:28]], b=[[@3,10:10='b',<393>,1:10], [@9,32:32='b',<393>,1:32]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,10:10='b',<393>,1:10]]}}",
	...
	public void basicPredicandSnippetTest() {
		...
		Assert.assertEquals("Interface is wrong", "[]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table_dictionary={unresolved_column={item.emp_sales=[[@0,0:3='item',<393>,1:0]]}}, unresolved_column={item.emp_sales={column={name=emp_sales, table_ref=item}, locations=[[@0,0:3='item',<393>,1:0]]}}}",
			snippet.getSymbolTable().toString()); 
	...
	public void basicConditionSnippetTest() {
		...
		Assert.assertEquals("Interface is wrong", "[]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table_dictionary={unresolved_column={table1.emp_sales_count=[[@0,0:5='table1',<393>,1:0]]}}, unresolved_column={table1.emp_sales_count={column={name=emp_sales_count, table_ref=table1}, locations=[[@0,0:5='table1',<393>,1:0]]}}}",
			snippet.getSymbolTable().toString()); 
		Assert.assertEquals("Table Dictionary is wrong", "{}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
	...
	public void basicColumnSnippetTest() {
		...
		Assert.assertEquals("Interface is wrong", "[]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table_dictionary={unresolved_column={schema1.emp_sales=[[@0,0:6='schema1',<393>,1:0]]}}, unresolved_column={schema1.emp_sales={column={name=emp_sales, table_ref=schema1}, locations=[[@0,0:6='schema1',<393>,1:0]]}}}",
			snippet.getSymbolTable().toString()); 
		Assert.assertEquals("Table Dictionary is wrong", "{}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
	...
	public void joinExtensionSnippetLeftJoinWithOnTest2() {
		...
		Assert.assertEquals("Interface is wrong", "[]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table_dictionary={<[Hedgss].[college]>={id=[[@10,45:46='aa',<393>,1:45]]}}, unresolved_column={a.id={column={name=id, table_ref=a}, locations=[[@6,40:40='a',<393>,1:40]]}}, filters=[{name=id, table_ref=a}, {name=id, table_ref=aa}], table_alias={aa=<[Hedgss].[college]>}}",
			snippet.getSymbolTable().toString()); 
		Assert.assertEquals("Table Dictionary is wrong", "{<[Hedgss].[college]>={id=[[@10,45:46='aa',<393>,1:45]]}}",
			snippet.getTableDictionary().toString());
	...
	public void ambiguousColumnAllocationInNestedSubqueriesDiagnosticsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={x=[[@14,40:40='x',<393>,2:9]]}, tab2={z=[[@32,105:105='z',<393>,3:9]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@16,45:45='a',<393>,2:14], [@1,8:9='dd',<393>,1:8], [@42,133:134='dd',<393>,3:37]]}, query1={y=[[@34,110:110='y',<393>,3:14], [@24,74:74='y',<393>,2:43]]}, query2={missing=[[@28,82:88='missing',<393>,2:51]], b=[[@26,79:79='b',<393>,2:48], [@6,17:18='cc',<393>,1:17], [@46,140:141='cc',<393>,3:44]]}, query3={aa=[[@4,13:14='aa',<393>,1:13]], b=[[@8,20:20='b',<393>,1:20]], c=[[@10,23:23='c',<393>,1:23]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={query_dictionary={aa=[[@4,13:14='aa',<393>,1:13]], b=[[@8,20:20='b',<393>,1:20]], c=[[@10,23:23='c',<393>,1:23]]}, def_query0={query_dictionary={a=[[@16,45:45='a',<393>,2:14], [@1,8:9='dd',<393>,1:8], [@42,133:134='dd',<393>,3:37]]}, table_dictionary={tab1={x=[[@14,40:40='x',<393>,2:9]]}}, interface={a=[{name=x, table_ref=tab1}]}}, filters=[{name=a, table_ref=dd}, {name=b, table_ref=cc}], interface={aa=[{name=a, table_ref=dd}], b=[{name=b, table_ref=cc}], c=[{name=c, table_ref=null}]}, table_alias={dd=query0, cc=query2}, def_query2={query_dictionary={b=[[@26,79:79='b',<393>,2:48], [@6,17:18='cc',<393>,1:17], [@46,140:141='cc',<393>,3:44]], missing=[[@28,82:88='missing',<393>,2:51]]}, def_query1={query_dictionary={y=[[@34,110:110='y',<393>,3:14], [@24,74:74='y',<393>,2:43]]}, table_dictionary={tab2={z=[[@32,105:105='z',<393>,3:9]]}}, interface={y=[{name=z, table_ref=tab2}]}}, interface={b=[{name=y, table_ref=query1}], missing=[{name=missing, table_ref=null}]}, table_alias={ee=query1}}}}",
				snippet.getSymbolTable().toString());
 ...
 */
	...
	public void explicitValuesAliasValidColumnDoesNotFallBackToUnknownTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{values0={a=[[@13,33:33='a',<393>,1:33], [@1,7:8='dd',<393>,1:7]]}, query1={a=[[@3,10:10='a',<393>,1:10]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query1={query_dictionary={a=[[@3,10:10='a',<393>,1:10]]}, def_values0={query_dictionary={a=[[@13,33:33='a',<393>,1:33], [@1,7:8='dd',<393>,1:7]]}, interface={a=[]}}, interface={a=[{name=a, table_ref=dd}]}, table_alias={dd=values0}}}",
				snippet.getSymbolTable().toString());
	}
...
*/
	...
	public void basicInsertFromQueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert1={query_dictionary={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}, table_dictionary={tab1={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}}, def_query0={query_dictionary={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}, table_dictionary={tab2={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}}, interface={a=[{name=a, table_ref=tab2}], b=[{name=b, table_ref=tab2}]}}, interface={a=[{name=a, table_ref=query0}], b=[{name=b, table_ref=query0}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}, tab2={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}, insert1={a=[[@4,24:24='a',<393>,1:24]], b=[[@6,26:26='b',<393>,1:26]]}}",
       	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void basicInsertWithColumnsFromQueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert1={query_dictionary={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}, table_dictionary={tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}}, def_query0={query_dictionary={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, table_dictionary={tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}, interface={a=[{name=a, table_ref=tab2}], b=[{name=b, table_ref=tab2}]}}, interface={c=[{name=a, table_ref=query0}], d=[{name=b, table_ref=query0}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}, tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, insert1={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void insertWithColumnsFromUnionQueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert3={query_dictionary={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}, def_union2={def_query1={query_dictionary={c=[[@16,58:58='c',<393>,1:58]], d=[[@18,60:60='d',<393>,1:60]]}, table_dictionary={tab3={c=[[@16,58:58='c',<393>,1:58]], d=[[@18,60:60='d',<393>,1:60]]}}, setop=UNION, interface={c=[{name=c, table_ref=tab3}], d=[{name=d, table_ref=tab3}]}}, def_query0={query_dictionary={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, table_dictionary={tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}, interface={a=[{name=a, table_ref=tab2}], b=[{name=b, table_ref=tab2}]}}, interface={a=query_column, b=query_column}}, table_dictionary={tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}}, interface={c=[{name=a, table_ref=union2}], d=[{name=b, table_ref=union2}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab3={c=[[@16,58:58='c',<393>,1:58]], d=[[@18,60:60='d',<393>,1:60]]}, tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}, tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, query1={d=[[@18,60:60='d',<393>,1:60]], c=[[@16,58:58='c',<393>,1:58]]}, insert3={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void insertWithColumnsFromExceptQueryTest(){
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert3={query_dictionary={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}, def_union2={def_query1={query_dictionary={c=[[@16,59:59='c',<393>,1:59]], d=[[@18,61:61='d',<393>,1:61]]}, table_dictionary={tab3={c=[[@16,59:59='c',<393>,1:59]], d=[[@18,61:61='d',<393>,1:61]]}}, setop=EXCEPT, interface={c=[{name=c, table_ref=tab3}], d=[{name=d, table_ref=tab3}]}}, def_query0={query_dictionary={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, table_dictionary={tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}, interface={a=[{name=a, table_ref=tab2}], b=[{name=b, table_ref=tab2}]}}, interface={a=query_column, b=query_column}}, table_dictionary={tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}}, interface={c=[{name=a, table_ref=union2}], d=[{name=b, table_ref=union2}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab3={c=[[@16,59:59='c',<393>,1:59]], d=[[@18,61:61='d',<393>,1:61]]}, tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}, tab2={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@9,31:31='a',<393>,1:31]], b=[[@11,33:33='b',<393>,1:33]]}, query1={d=[[@18,61:61='d',<393>,1:61]], c=[[@16,59:59='c',<393>,1:59]]}, insert3={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void insertWithColumnsFromJoinQueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert1={query_dictionary={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}, table_dictionary={tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}}, def_query0={query_dictionary={a=[[@11,34:34='a',<393>,1:34]], b=[[@15,40:40='b',<393>,1:40]]}, table_dictionary={tab3={b=[[@13,37:38='gg',<393>,1:37]], id=[[@27,79:80='gg',<393>,1:79]]}, tab2={a=[[@9,31:32='ff',<393>,1:31]], id=[[@23,71:72='ff',<393>,1:71]]}}, filters=[{name=id, table_ref=ff}, {name=id, table_ref=gg}], interface={a=[{name=a, table_ref=ff}], b=[{name=b, table_ref=gg}]}, table_alias={ff=tab2, gg=tab3}}, interface={c=[{name=a, table_ref=query0}], d=[{name=b, table_ref=query0}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab3={b=[[@13,37:38='gg',<393>,1:37]], id=[[@27,79:80='gg',<393>,1:79]]}, tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]]}, tab2={a=[[@9,31:32='ff',<393>,1:31]], id=[[@23,71:72='ff',<393>,1:71]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@11,34:34='a',<393>,1:34]], b=[[@15,40:40='b',<393>,1:40]]}, insert1={d=[[@6,21:21='d',<393>,1:21]], c=[[@4,18:18='c',<393>,1:18]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void basicInsertWithColumnsFromVariableTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d, e]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert0={query_dictionary={d=[[@6,21:21='d',<393>,1:21]], e=[[@8,24:24='e',<393>,1:24]], c=[[@4,18:18='c',<393>,1:18]]}, table_dictionary={tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]], e=[[@8,24:24='e',<393>,1:24]]}}, interface={c=[], d=[], e=[]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={c=[[@4,18:18='c',<393>,1:18]], d=[[@6,21:21='d',<393>,1:21]], e=[[@8,24:24='e',<393>,1:24]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{<query variable>=query}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{insert0={d=[[@6,21:21='d',<393>,1:21]], e=[[@8,24:24='e',<393>,1:24]], c=[[@4,18:18='c',<393>,1:18]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void basicInsertWithColumnsFromValuesTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]", 
        	snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert1={query_dictionary={d=[[@6,22:22='d',<393>,1:22]], c=[[@4,19:19='c',<393>,1:19]]}, table_dictionary={tab1={c=[[@4,19:19='c',<393>,1:19]], d=[[@6,22:22='d',<393>,1:22]]}}, def_values0={query_dictionary={$1=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]], $2=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]], $3=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]]}, interface={$1=[], $2=[], $3=[]}}, interface={c=[{name=$1, table_ref=values0}], d=[{name=$2, table_ref=values0}]}}}",
        	snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={c=[[@4,19:19='c',<393>,1:19]], d=[[@6,22:22='d',<393>,1:22]]}}",
        	snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}", 
        	snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{values0={$1=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]], $2=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]], $3=[[@9,33:33='(',<287>,1:33], [@17,42:42='(',<287>,1:42]]}, insert1={d=[[@6,22:22='d',<393>,1:22]], c=[[@4,19:19='c',<393>,1:19]]}}",
        	snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void insertWithTargetColumnsAndSubqueryValuesTest() {
		...
		Assert.assertEquals("Interface is wrong", "[newcol2, newcol1]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert2={query_dictionary={newcol2=[[@10,36:42='newcol2',<393>,1:36]], newcol1=[[@8,27:33='newcol1',<393>,1:27]]}, table_dictionary={sch.subj.tbl={newcol2=[[@10,36:42='newcol2',<393>,1:36]], newcol1=[[@8,27:33='newcol1',<393>,1:27]]}}, def_query1={query_dictionary={att2=[[@21,70:73='att2',<393>,1:70]], att1=[[@17,62:65='att1',<393>,1:62]]}, def_query0={query_dictionary={att2=[[@35,115:118='att2',<393>,1:115], [@19,68:68='b',<393>,1:68]], att1=[[@29,99:102='att1',<393>,1:99], [@15,60:60='b',<393>,1:60]]}, table_dictionary={sch.subj.tab1={col2=[[@31,105:105='a',<393>,1:105]], col3=[[@49,161:161='a',<393>,1:161]], col1=[[@25,89:89='a',<393>,1:89], [@45,151:151='a',<393>,1:151]]}}, filters=[{name=col1, table_ref=a}, {name=col3, table_ref=a}], interface={att2=[{name=col2, table_ref=a}], att1=[{name=col1, table_ref=a}]}, table_alias={a=sch.subj.tab1}}, interface={att2=[{name=att2, table_ref=b}], att1=[{name=att1, table_ref=b}]}, table_alias={b=query0}}, interface={newcol1=[{name=att1, table_ref=query1}], newcol2=[{name=att2, table_ref=query1}]}, table_alias={values=sch.subj.tbl}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sch.subj.tbl={newcol2=[[@10,36:42='newcol2',<393>,1:36]], newcol1=[[@8,27:33='newcol1',<393>,1:27]]}, sch.subj.tab1={col2=[[@31,105:105='a',<393>,1:105]], col3=[[@49,161:161='a',<393>,1:161]], col1=[[@25,89:89='a',<393>,1:89], [@45,151:151='a',<393>,1:151]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={att2=[[@35,115:118='att2',<393>,1:115], [@19,68:68='b',<393>,1:68]], att1=[[@29,99:102='att1',<393>,1:99], [@15,60:60='b',<393>,1:60]]}, query1={att2=[[@21,70:73='att2',<393>,1:70]], att1=[[@17,62:65='att1',<393>,1:62]]}, insert2={newcol2=[[@10,36:42='newcol2',<393>,1:36]], newcol1=[[@8,27:33='newcol1',<393>,1:27]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void subqueryUnionJinjaSourceUnionInterfaceValidationV1Test() {
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={def_union2={def_query1={query_dictionary={audience=[[@46,328:335='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,359:368='stream_key',<393>,11:22]], eab_contact_id=[[@42,291:304='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,422:434='valid_from_dt',<393>,12:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,311:326='offset_marketing',<393>,10:5]], sent_dt=[[@54,380:395='offset_marketing',<393>,12:10]], stream_key=[[@48,342:357='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,274:289='offset_marketing',<393>,9:12]]}}, setop=UNION, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, interface={*=[{name=*, table_ref=*}]}, table_alias={paper_data=union2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,311:326='offset_marketing',<393>,10:5]], sent_dt=[[@54,380:395='offset_marketing',<393>,12:10]], stream_key=[[@48,342:357='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,274:289='offset_marketing',<393>,9:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, query1={audience=[[@46,328:335='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,359:368='stream_key',<393>,11:22]], eab_contact_id=[[@42,291:304='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,422:434='valid_from_dt',<393>,12:52]]}, query3={*=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryExceptJinjaSourceExceptInterfaceValidationV1Test(){
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={def_union2={def_query1={query_dictionary={audience=[[@46,329:336='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,360:369='stream_key',<393>,11:22]], eab_contact_id=[[@42,292:305='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,423:435='valid_from_dt',<393>,12:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,312:327='offset_marketing',<393>,10:5]], sent_dt=[[@54,381:396='offset_marketing',<393>,12:10]], stream_key=[[@48,343:358='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,275:290='offset_marketing',<393>,9:12]]}}, setop=EXCEPT, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, interface={*=[{name=*, table_ref=*}]}, table_alias={paper_data=union2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,312:327='offset_marketing',<393>,10:5]], sent_dt=[[@54,381:396='offset_marketing',<393>,12:10]], stream_key=[[@48,343:358='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,275:290='offset_marketing',<393>,9:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, query1={audience=[[@46,329:336='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,360:369='stream_key',<393>,11:22]], eab_contact_id=[[@42,292:305='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,423:435='valid_from_dt',<393>,12:52]]}, query3={*=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryUnionJinjaSourceUnionInterfaceValidationV2Test() {
		...
		Assert.assertEquals("Interface is wrong", "[audience, rno, stream_key, eab_contact_id, valid_from_dt]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={window_ordered_by=[{name=valid_from_dt, table_ref=paper_data}], def_union2={query_dictionary={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, def_query1={query_dictionary={audience=[[@84,578:585='audience',<393>,13:22]], stream_key=[[@88,609:618='stream_key',<393>,14:22]], eab_contact_id=[[@80,541:554='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,672:684='valid_from_dt',<393>,15:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,561:576='offset_marketing',<393>,13:5]], sent_dt=[[@92,630:645='offset_marketing',<393>,15:10]], stream_key=[[@86,592:607='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,524:539='offset_marketing',<393>,12:12]]}}, setop=UNION, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, query_dictionary={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}, window_partition_by=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}], interface={audience=[{name=audience, table_ref=paper_data}], rno=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}, {name=valid_from_dt, table_ref=paper_data}], stream_key=[{name=stream_key, table_ref=paper_data}], eab_contact_id=[{name=eab_contact_id, table_ref=paper_data}], valid_from_dt=[{name=valid_from_dt, table_ref=paper_data}]}, table_alias={paper_data=union2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,561:576='offset_marketing',<393>,13:5]], sent_dt=[[@92,630:645='offset_marketing',<393>,15:10]], stream_key=[[@86,592:607='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,524:539='offset_marketing',<393>,12:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, query0={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, query1={audience=[[@84,578:585='audience',<393>,13:22]], stream_key=[[@88,609:618='stream_key',<393>,14:22]], eab_contact_id=[[@80,541:554='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,672:684='valid_from_dt',<393>,15:52]]}, query3={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryExceptJinjaSourceExceptInterfaceValidationV2Test(){
		...
		Assert.assertEquals("Interface is wrong", "[audience, rno, stream_key, eab_contact_id, valid_from_dt]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={window_ordered_by=[{name=valid_from_dt, table_ref=paper_data}], def_union2={query_dictionary={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, def_query1={query_dictionary={audience=[[@84,579:586='audience',<393>,13:22]], stream_key=[[@88,610:619='stream_key',<393>,14:22]], eab_contact_id=[[@80,542:555='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,673:685='valid_from_dt',<393>,15:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,562:577='offset_marketing',<393>,13:5]], sent_dt=[[@92,631:646='offset_marketing',<393>,15:10]], stream_key=[[@86,593:608='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,525:540='offset_marketing',<393>,12:12]]}}, setop=EXCEPT, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, query_dictionary={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}, window_partition_by=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}], interface={audience=[{name=audience, table_ref=paper_data}], rno=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}, {name=valid_from_dt, table_ref=paper_data}], stream_key=[{name=stream_key, table_ref=paper_data}], eab_contact_id=[{name=eab_contact_id, table_ref=paper_data}], valid_from_dt=[{name=valid_from_dt, table_ref=paper_data}]}, table_alias={paper_data=union2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,562:577='offset_marketing',<393>,13:5]], sent_dt=[[@92,631:646='offset_marketing',<393>,15:10]], stream_key=[[@86,593:608='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,525:540='offset_marketing',<393>,12:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, query0={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, query1={audience=[[@84,579:586='audience',<393>,13:22]], stream_key=[[@88,610:619='stream_key',<393>,14:22]], eab_contact_id=[[@80,542:555='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,673:685='valid_from_dt',<393>,15:52]]}, query3={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryIntersectJinjaSourceUnionInterfaceValidationV1Test() {
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, def_intersect2={def_query1={query_dictionary={audience=[[@46,332:339='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,363:372='stream_key',<393>,11:22]], eab_contact_id=[[@42,295:308='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,426:438='valid_from_dt',<393>,12:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,315:330='offset_marketing',<393>,10:5]], sent_dt=[[@54,384:399='offset_marketing',<393>,12:10]], stream_key=[[@48,346:361='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,278:293='offset_marketing',<393>,9:12]]}}, setop=INTERSECTION, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, interface={*=[{name=*, table_ref=*}]}, table_alias={paper_data=intersect2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@44,315:330='offset_marketing',<393>,10:5]], sent_dt=[[@54,384:399='offset_marketing',<393>,12:10]], stream_key=[[@48,346:361='offset_marketing',<393>,11:5]], eab_contact_id=[[@40,278:293='offset_marketing',<393>,9:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@9,59:71='mail_contacts',<393>,4:5]], intake_dt=[[@19,122:134='mail_contacts',<393>,6:10]], stream_key=[[@13,87:99='mail_contacts',<393>,5:5]], eab_contact_id=[[@5,25:37='mail_contacts',<393>,3:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={audience=[[@11,73:80='audience',<393>,4:19]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@15,101:110='stream_key',<393>,5:19]], eab_contact_id=[[@7,39:52='eab_contact_id',<393>,3:25]], valid_from_dt=[[@26,163:175='valid_from_dt',<393>,6:51]]}, query1={audience=[[@46,332:339='audience',<393>,10:22]], *=[[@1,7:7='*',<291>,1:7]], stream_key=[[@50,363:372='stream_key',<393>,11:22]], eab_contact_id=[[@42,295:308='eab_contact_id',<393>,9:29]], valid_from_dt=[[@61,426:438='valid_from_dt',<393>,12:52]]}, query3={*=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryIntersectJinjaSourceUnionInterfaceValidationV2Test() {
		...
		Assert.assertEquals("Interface is wrong", "[audience, rno, stream_key, eab_contact_id, valid_from_dt]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query3={window_ordered_by=[{name=valid_from_dt, table_ref=paper_data}], query_dictionary={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}, def_intersect2={query_dictionary={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, def_query1={query_dictionary={audience=[[@84,582:589='audience',<393>,13:22]], stream_key=[[@88,613:622='stream_key',<393>,14:22]], eab_contact_id=[[@80,545:558='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,676:688='valid_from_dt',<393>,15:52]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,565:580='offset_marketing',<393>,13:5]], sent_dt=[[@92,634:649='offset_marketing',<393>,15:10]], stream_key=[[@86,596:611='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,528:543='offset_marketing',<393>,12:12]]}}, setop=INTERSECTION, interface={audience=[{name=audience, table_ref=offset_marketing}], stream_key=[{name=stream_key, table_ref=offset_marketing}], eab_contact_id=[{name=eab_contact_id, table_ref=offset_marketing}], valid_from_dt=[{name=sent_dt, table_ref=offset_marketing}]}, table_alias={offset_marketing={{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}}}, def_query0={query_dictionary={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, table_dictionary={{{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}, interface={audience=[{name=audience, table_ref=mail_contacts}], stream_key=[{name=stream_key, table_ref=mail_contacts}], eab_contact_id=[{name=eab_contact_id, table_ref=mail_contacts}], valid_from_dt=[{name=intake_dt, table_ref=mail_contacts}]}, table_alias={mail_contacts={{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}}}, interface={audience=query_column, stream_key=query_column, eab_contact_id=query_column, valid_from_dt=query_column}}, window_partition_by=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}], interface={audience=[{name=audience, table_ref=paper_data}], rno=[{name=eab_contact_id, table_ref=paper_data}, {name=stream_key, table_ref=paper_data}, {name=valid_from_dt, table_ref=paper_data}], stream_key=[{name=stream_key, table_ref=paper_data}], eab_contact_id=[{name=eab_contact_id, table_ref=paper_data}], valid_from_dt=[{name=valid_from_dt, table_ref=paper_data}]}, table_alias={paper_data=intersect2}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{{{ source('pdp_ams', 'pdp_ams_offset_marketing') }}={audience=[[@82,565:580='offset_marketing',<393>,13:5]], sent_dt=[[@92,634:649='offset_marketing',<393>,15:10]], stream_key=[[@86,596:611='offset_marketing',<393>,14:5]], eab_contact_id=[[@78,528:543='offset_marketing',<393>,12:12]]}, {{ source('pdp_ams', 'pdp_ams_mail_contacts') }}={audience=[[@47,309:321='mail_contacts',<393>,7:5]], intake_dt=[[@57,372:384='mail_contacts',<393>,9:10]], stream_key=[[@51,337:349='mail_contacts',<393>,8:5]], eab_contact_id=[[@43,275:287='mail_contacts',<393>,6:11]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{{{ source('PDP_AMS', 'pdp_ams_mail_contacts') }}=tuple, {{ source('PDP_AMS', 'pdp_ams_offset_marketing') }}=tuple}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect2={audience=[[@5,41:50='paper_data',<393>,2:8]], stream_key=[[@9,69:78='paper_data',<393>,3:8], [@28,190:199='paper_data',<393>,5:66]], eab_contact_id=[[@1,7:16='paper_data',<393>,1:7], [@24,164:173='paper_data',<393>,5:40]], valid_from_dt=[[@13,99:108='paper_data',<393>,4:8], [@33,221:230='paper_data',<393>,5:97]]}, query0={audience=[[@49,323:330='audience',<393>,7:19]], stream_key=[[@53,351:360='stream_key',<393>,8:19]], eab_contact_id=[[@45,289:302='eab_contact_id',<393>,6:25]], valid_from_dt=[[@64,413:425='valid_from_dt',<393>,9:51]]}, query1={audience=[[@84,582:589='audience',<393>,13:22]], stream_key=[[@88,613:622='stream_key',<393>,14:22]], eab_contact_id=[[@80,545:558='eab_contact_id',<393>,12:29]], valid_from_dt=[[@99,676:688='valid_from_dt',<393>,15:52]]}, query3={audience=[[@7,52:59='audience',<393>,2:19]], rno=[[@39,255:257='rno',<393>,5:131]], stream_key=[[@11,80:89='stream_key',<393>,3:19]], eab_contact_id=[[@3,18:31='eab_contact_id',<393>,1:18]], valid_from_dt=[[@15,110:122='valid_from_dt',<393>,4:19]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectSubqueryInterfaceValidationV1Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query6={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_intersect2={def_query1={query_dictionary={a=[[@26,76:76='a',<393>,3:17]], b=[[@20,70:70='b',<393>,3:11]], c=[[@22,72:72='c',<393>,3:13]], d=[[@24,74:74='d',<393>,3:15]]}, table_dictionary={t2={a=[[@26,76:76='a',<393>,3:17]], b=[[@20,70:70='b',<393>,3:11], [@46,150:150='b',<393>,6:11]], c=[[@22,72:72='c',<393>,3:13], [@48,152:152='c',<393>,6:13]], d=[[@24,74:74='d',<393>,3:15], [@50,154:154='d',<393>,6:15]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@11,32:32='a',<393>,2:11]], b=[[@13,34:34='b',<393>,2:13]], c=[[@15,36:36='c',<393>,2:15]]}, table_dictionary={t1={a=[[@11,32:32='a',<393>,2:11], [@35,110:110='a',<393>,5:11]], b=[[@13,34:34='b',<393>,2:13], [@37,112:112='b',<393>,5:13]], c=[[@15,36:36='c',<393>,2:15], [@39,114:114='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, def_intersect5={query_dictionary={d=[[@7,13:13='d',<393>,1:13]]}, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@46,150:150='b',<393>,6:11]], c=[[@48,152:152='c',<393>,6:13]], d=[[@50,154:154='d',<393>,6:15]]}, table_dictionary={t2={b=[[@46,150:150='b',<393>,6:11]], c=[[@48,152:152='c',<393>,6:13]], d=[[@50,154:154='d',<393>,6:15]]}}, setop=INTERSECTION, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query3={query_dictionary={a=[[@35,110:110='a',<393>,5:11]], b=[[@37,112:112='b',<393>,5:13]], c=[[@39,114:114='c',<393>,5:15]], d=[[@41,116:116='d',<393>,5:17]]}, table_dictionary={t1={a=[[@35,110:110='a',<393>,5:11]], b=[[@37,112:112='b',<393>,5:13]], c=[[@39,114:114='c',<393>,5:15]], d=[[@41,116:116='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}, interface={a=[{name=a, table_ref=null}], b=[{name=b, table_ref=null}], c=[{name=c, table_ref=null}], d=[{name=d, table_ref=intersect5}]}, table_alias={i1=intersect2, i2=intersect5}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@11,32:32='a',<393>,2:11], [@35,110:110='a',<393>,5:11]], b=[[@13,34:34='b',<393>,2:13], [@37,112:112='b',<393>,5:13]], c=[[@15,36:36='c',<393>,2:15], [@39,114:114='c',<393>,5:15]], d=[[@41,116:116='d',<393>,5:17]]}, t2={a=[[@26,76:76='a',<393>,3:17]], b=[[@20,70:70='b',<393>,3:11], [@46,150:150='b',<393>,6:11]], c=[[@22,72:72='c',<393>,3:13], [@48,152:152='c',<393>,6:13]], d=[[@24,74:74='d',<393>,3:15], [@50,154:154='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect5={d=[[@7,13:13='d',<393>,1:13]]}, query4={d=[[@50,154:154='d',<393>,6:15]], b=[[@46,150:150='b',<393>,6:11]], c=[[@48,152:152='c',<393>,6:13]]}, query6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@11,32:32='a',<393>,2:11]], b=[[@13,34:34='b',<393>,2:13]], c=[[@15,36:36='c',<393>,2:15]]}, query1={a=[[@26,76:76='a',<393>,3:17]], b=[[@20,70:70='b',<393>,3:11]], c=[[@22,72:72='c',<393>,3:13]], d=[[@24,74:74='d',<393>,3:15]]}, query3={a=[[@35,110:110='a',<393>,5:11]], b=[[@37,112:112='b',<393>,5:13]], c=[[@39,114:114='c',<393>,5:15]], d=[[@41,116:116='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleExceptSubqueryInterfaceValidationV1Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query6={def_union2={def_query1={query_dictionary={a=[[@26,73:73='a',<393>,3:17]], b=[[@20,67:67='b',<393>,3:11]], c=[[@22,69:69='c',<393>,3:13]], d=[[@24,71:71='d',<393>,3:15]]}, table_dictionary={t2={a=[[@26,73:73='a',<393>,3:17]], b=[[@20,67:67='b',<393>,3:11], [@46,144:144='b',<393>,6:11]], c=[[@22,69:69='c',<393>,3:13], [@48,146:146='c',<393>,6:13]], d=[[@24,71:71='d',<393>,3:15], [@50,148:148='d',<393>,6:15]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@11,32:32='a',<393>,2:11]], b=[[@13,34:34='b',<393>,2:13]], c=[[@15,36:36='c',<393>,2:15]]}, table_dictionary={t1={a=[[@11,32:32='a',<393>,2:11], [@35,107:107='a',<393>,5:11]], b=[[@13,34:34='b',<393>,2:13], [@37,109:109='b',<393>,5:13]], c=[[@15,36:36='c',<393>,2:15], [@39,111:111='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=null}], b=[{name=b, table_ref=null}], c=[{name=c, table_ref=null}], d=[{name=d, table_ref=union5}]}, def_union5={query_dictionary={d=[[@7,13:13='d',<393>,1:13]]}, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@46,144:144='b',<393>,6:11]], c=[[@48,146:146='c',<393>,6:13]], d=[[@50,148:148='d',<393>,6:15]]}, table_dictionary={t2={b=[[@46,144:144='b',<393>,6:11]], c=[[@48,146:146='c',<393>,6:13]], d=[[@50,148:148='d',<393>,6:15]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query3={query_dictionary={a=[[@35,107:107='a',<393>,5:11]], b=[[@37,109:109='b',<393>,5:13]], c=[[@39,111:111='c',<393>,5:15]], d=[[@41,113:113='d',<393>,5:17]]}, table_dictionary={t1={a=[[@35,107:107='a',<393>,5:11]], b=[[@37,109:109='b',<393>,5:13]], c=[[@39,111:111='c',<393>,5:15]], d=[[@41,113:113='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}, table_alias={i1=union2, i2=union5}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@11,32:32='a',<393>,2:11], [@35,107:107='a',<393>,5:11]], b=[[@13,34:34='b',<393>,2:13], [@37,109:109='b',<393>,5:13]], c=[[@15,36:36='c',<393>,2:15], [@39,111:111='c',<393>,5:15]], d=[[@41,113:113='d',<393>,5:17]]}, t2={a=[[@26,73:73='a',<393>,3:17]], b=[[@20,67:67='b',<393>,3:11], [@46,144:144='b',<393>,6:11]], c=[[@22,69:69='c',<393>,3:13], [@48,146:146='c',<393>,6:13]], d=[[@24,71:71='d',<393>,3:15], [@50,148:148='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union5={d=[[@7,13:13='d',<393>,1:13]]}, query4={d=[[@50,148:148='d',<393>,6:15]], b=[[@46,144:144='b',<393>,6:11]], c=[[@48,146:146='c',<393>,6:13]]}, query6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@11,32:32='a',<393>,2:11]], b=[[@13,34:34='b',<393>,2:13]], c=[[@15,36:36='c',<393>,2:15]]}, query1={a=[[@26,73:73='a',<393>,3:17]], b=[[@20,67:67='b',<393>,3:11]], c=[[@22,69:69='c',<393>,3:13]], d=[[@24,71:71='d',<393>,3:15]]}, query3={a=[[@35,107:107='a',<393>,5:11]], b=[[@37,109:109='b',<393>,5:13]], c=[[@39,111:111='c',<393>,5:15]], d=[[@41,113:113='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectSubqueryInterfaceValidationV2Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query8={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_query0={query_dictionary={i=[[@11,28:28='i',<393>,1:28]]}, table_dictionary={tab1={i=[[@11,28:28='i',<393>,1:28]]}}, interface={i=[{name=i, table_ref=tab1}]}}, filters=[{name=d, table_ref=null}], def_union7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, def_intersect3={def_query1={query_dictionary={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, table_dictionary={t1={a=[[@20,64:64='a',<393>,2:12], [@44,144:144='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,146:146='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,148:148='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}, def_query2={query_dictionary={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11]], c=[[@31,104:104='c',<393>,3:13]], d=[[@33,106:106='d',<393>,3:15]]}, table_dictionary={t2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11], [@55,184:184='b',<393>,6:11]], c=[[@31,104:104='c',<393>,3:13], [@57,186:186='c',<393>,6:13]], d=[[@33,106:106='d',<393>,3:15], [@59,188:188='d',<393>,6:15]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}}, def_intersect6={def_query5={query_dictionary={b=[[@55,184:184='b',<393>,6:11]], c=[[@57,186:186='c',<393>,6:13]], d=[[@59,188:188='d',<393>,6:15]]}, table_dictionary={t2={b=[[@55,184:184='b',<393>,6:11]], c=[[@57,186:186='c',<393>,6:13]], d=[[@59,188:188='d',<393>,6:15]]}}, setop=INTERSECTION, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={a=[[@44,144:144='a',<393>,5:11]], b=[[@46,146:146='b',<393>,5:13]], c=[[@48,148:148='c',<393>,5:15]], d=[[@50,150:150='d',<393>,5:17]]}, table_dictionary={t1={a=[[@44,144:144='a',<393>,5:11]], b=[[@46,146:146='b',<393>,5:13]], c=[[@48,148:148='c',<393>,5:15]], d=[[@50,150:150='d',<393>,5:17]]}}, setop=UNION, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}, interface={a=query_column, b=query_column, c=query_column}}, interface={a=[{name=a, table_ref=union7}], b=[{name=b, table_ref=union7}], c=[{name=c, table_ref=union7}], d=[{name=d, table_ref=null}]}, table_alias={tab1=query0, union7=union7}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={i=[[@11,28:28='i',<393>,1:28]]}, t1={a=[[@20,64:64='a',<393>,2:12], [@44,144:144='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,146:146='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,148:148='c',<393>,5:15]], d=[[@50,150:150='d',<393>,5:17]]}, t2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11], [@55,184:184='b',<393>,6:11]], c=[[@31,104:104='c',<393>,3:13], [@57,186:186='c',<393>,6:13]], d=[[@33,106:106='d',<393>,3:15], [@59,188:188='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query8={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query4={a=[[@44,144:144='a',<393>,5:11]], b=[[@46,146:146='b',<393>,5:13]], c=[[@48,148:148='c',<393>,5:15]], d=[[@50,150:150='d',<393>,5:17]]}, query5={d=[[@59,188:188='d',<393>,6:15]], b=[[@55,184:184='b',<393>,6:11]], c=[[@57,186:186='c',<393>,6:13]]}, query0={i=[[@11,28:28='i',<393>,1:28]]}, query1={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, query2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11]], c=[[@31,104:104='c',<393>,3:13]], d=[[@33,106:106='d',<393>,3:15]]}, union7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleExceptSubqueryInterfaceValidationV2Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query8={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_query0={query_dictionary={i=[[@11,28:28='i',<393>,1:28]]}, table_dictionary={tab1={i=[[@11,28:28='i',<393>,1:28]]}}, interface={i=[{name=i, table_ref=tab1}]}}, filters=[{name=d, table_ref=null}], def_union7={def_union3={def_query1={query_dictionary={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, table_dictionary={t1={a=[[@20,64:64='a',<393>,2:12], [@44,141:141='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,143:143='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,145:145='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}, def_query2={query_dictionary={a=[[@35,105:105='a',<393>,3:17]], b=[[@29,99:99='b',<393>,3:11]], c=[[@31,101:101='c',<393>,3:13]], d=[[@33,103:103='d',<393>,3:15]]}, table_dictionary={t2={a=[[@35,105:105='a',<393>,3:17]], b=[[@29,99:99='b',<393>,3:11], [@55,178:178='b',<393>,6:11]], c=[[@31,101:101='c',<393>,3:13], [@57,180:180='c',<393>,6:13]], d=[[@33,103:103='d',<393>,3:15], [@59,182:182='d',<393>,6:15]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union6={def_query5={query_dictionary={b=[[@55,178:178='b',<393>,6:11]], c=[[@57,180:180='c',<393>,6:13]], d=[[@59,182:182='d',<393>,6:15]]}, table_dictionary={t2={b=[[@55,178:178='b',<393>,6:11]], c=[[@57,180:180='c',<393>,6:13]], d=[[@59,182:182='d',<393>,6:15]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={a=[[@44,141:141='a',<393>,5:11]], b=[[@46,143:143='b',<393>,5:13]], c=[[@48,145:145='c',<393>,5:15]], d=[[@50,147:147='d',<393>,5:17]]}, table_dictionary={t1={a=[[@44,141:141='a',<393>,5:11]], b=[[@46,143:143='b',<393>,5:13]], c=[[@48,145:145='c',<393>,5:15]], d=[[@50,147:147='d',<393>,5:17]]}}, setop=UNION, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}}, interface={a=[{name=a, table_ref=union7}], b=[{name=b, table_ref=union7}], c=[{name=c, table_ref=union7}], d=[{name=d, table_ref=null}]}, table_alias={tab1=query0, union7=union7}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={i=[[@11,28:28='i',<393>,1:28]]}, t1={a=[[@20,64:64='a',<393>,2:12], [@44,141:141='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,143:143='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,145:145='c',<393>,5:15]], d=[[@50,147:147='d',<393>,5:17]]}, t2={a=[[@35,105:105='a',<393>,3:17]], b=[[@29,99:99='b',<393>,3:11], [@55,178:178='b',<393>,6:11]], c=[[@31,101:101='c',<393>,3:13], [@57,180:180='c',<393>,6:13]], d=[[@33,103:103='d',<393>,3:15], [@59,182:182='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query8={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query4={a=[[@44,141:141='a',<393>,5:11]], b=[[@46,143:143='b',<393>,5:13]], c=[[@48,145:145='c',<393>,5:15]], d=[[@50,147:147='d',<393>,5:17]]}, query5={d=[[@59,182:182='d',<393>,6:15]], b=[[@55,178:178='b',<393>,6:11]], c=[[@57,180:180='c',<393>,6:13]]}, query0={i=[[@11,28:28='i',<393>,1:28]]}, query1={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, query2={a=[[@35,105:105='a',<393>,3:17]], b=[[@29,99:99='b',<393>,3:11]], c=[[@31,101:101='c',<393>,3:13]], d=[[@33,103:103='d',<393>,3:15]]}, union7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectSubqueryInterfaceValidationV2ExceptTest(){
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query8={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_query0={query_dictionary={i=[[@11,28:28='i',<393>,1:28]]}, table_dictionary={tab1={i=[[@11,28:28='i',<393>,1:28]]}}, interface={i=[{name=i, table_ref=tab1}]}}, filters=[{name=d, table_ref=null}], def_union7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, def_intersect3={def_query1={query_dictionary={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, table_dictionary={t1={a=[[@20,64:64='a',<393>,2:12], [@44,145:145='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,147:147='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,149:149='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}, def_query2={query_dictionary={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11]], c=[[@31,104:104='c',<393>,3:13]], d=[[@33,106:106='d',<393>,3:15]]}, table_dictionary={t2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11], [@55,185:185='b',<393>,6:11]], c=[[@31,104:104='c',<393>,3:13], [@57,187:187='c',<393>,6:13]], d=[[@33,106:106='d',<393>,3:15], [@59,189:189='d',<393>,6:15]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}}, def_intersect6={def_query5={query_dictionary={b=[[@55,185:185='b',<393>,6:11]], c=[[@57,187:187='c',<393>,6:13]], d=[[@59,189:189='d',<393>,6:15]]}, table_dictionary={t2={b=[[@55,185:185='b',<393>,6:11]], c=[[@57,187:187='c',<393>,6:13]], d=[[@59,189:189='d',<393>,6:15]]}}, setop=INTERSECTION, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={a=[[@44,145:145='a',<393>,5:11]], b=[[@46,147:147='b',<393>,5:13]], c=[[@48,149:149='c',<393>,5:15]], d=[[@50,151:151='d',<393>,5:17]]}, table_dictionary={t1={a=[[@44,145:145='a',<393>,5:11]], b=[[@46,147:147='b',<393>,5:13]], c=[[@48,149:149='c',<393>,5:15]], d=[[@50,151:151='d',<393>,5:17]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}, interface={a=query_column, b=query_column, c=query_column}}, interface={a=[{name=a, table_ref=union7}], b=[{name=b, table_ref=union7}], c=[{name=c, table_ref=union7}], d=[{name=d, table_ref=null}]}, table_alias={tab1=query0, union7=union7}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={i=[[@11,28:28='i',<393>,1:28]]}, t1={a=[[@20,64:64='a',<393>,2:12], [@44,145:145='a',<393>,5:11]], b=[[@22,66:66='b',<393>,2:14], [@46,147:147='b',<393>,5:13]], c=[[@24,68:68='c',<393>,2:16], [@48,149:149='c',<393>,5:15]], d=[[@50,151:151='d',<393>,5:17]]}, t2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11], [@55,185:185='b',<393>,6:11]], c=[[@31,104:104='c',<393>,3:13], [@57,187:187='c',<393>,6:13]], d=[[@33,106:106='d',<393>,3:15], [@59,189:189='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query8={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query4={a=[[@44,145:145='a',<393>,5:11]], b=[[@46,147:147='b',<393>,5:13]], c=[[@48,149:149='c',<393>,5:15]], d=[[@50,151:151='d',<393>,5:17]]}, query5={d=[[@59,189:189='d',<393>,6:15]], b=[[@55,185:185='b',<393>,6:11]], c=[[@57,187:187='c',<393>,6:13]]}, query0={i=[[@11,28:28='i',<393>,1:28]]}, query1={a=[[@20,64:64='a',<393>,2:12]], b=[[@22,66:66='b',<393>,2:14]], c=[[@24,68:68='c',<393>,2:16]]}, query2={a=[[@35,108:108='a',<393>,3:17]], b=[[@29,102:102='b',<393>,3:11]], c=[[@31,104:104='c',<393>,3:13]], d=[[@33,106:106='d',<393>,3:15]]}, union7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleUnionedIntersectSubqueryInterfaceValidationWOAliasesV3Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=union6}], b=[{name=b, table_ref=union6}], c=[{name=c, table_ref=union6}], d=[{name=d, table_ref=null}]}, table_alias={union6=union6}, def_union6={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, def_intersect2={def_query1={query_dictionary={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, def_intersect5={interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}}, setop=INTERSECTION, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,106:106='a',<393>,5:11]], b=[[@36,108:108='b',<393>,5:13]], c=[[@38,110:110='c',<393>,5:15]], d=[[@40,112:112='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,106:106='a',<393>,5:11]], b=[[@36,108:108='b',<393>,5:13]], c=[[@38,110:110='c',<393>,5:15]], d=[[@40,112:112='d',<393>,5:17]]}}, setop=UNION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}, interface={a=query_column, b=query_column, c=query_column}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, t3={a=[[@34,106:106='a',<393>,5:11]], b=[[@36,108:108='b',<393>,5:13]], c=[[@38,110:110='c',<393>,5:15]], d=[[@40,112:112='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,150:150='d',<393>,6:15]], b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, query3={a=[[@34,106:106='a',<393>,5:11]], b=[[@36,108:108='b',<393>,5:13]], c=[[@38,110:110='c',<393>,5:15]], d=[[@40,112:112='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleUnionedExceptSubqueryInterfaceValidationWOAliasesV3Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=union6}], b=[{name=b, table_ref=union6}], c=[{name=c, table_ref=union6}], d=[{name=d, table_ref=null}]}, table_alias={union6=union6}, def_union6={def_union2={def_query1={query_dictionary={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,140:140='b',<393>,6:11]], c=[[@47,142:142='c',<393>,6:13]], d=[[@49,144:144='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,140:140='b',<393>,6:11]], c=[[@47,142:142='c',<393>,6:13]], d=[[@49,144:144='d',<393>,6:15]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,103:103='a',<393>,5:11]], b=[[@36,105:105='b',<393>,5:13]], c=[[@38,107:107='c',<393>,5:15]], d=[[@40,109:109='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,103:103='a',<393>,5:11]], b=[[@36,105:105='b',<393>,5:13]], c=[[@38,107:107='c',<393>,5:15]], d=[[@40,109:109='d',<393>,5:17]]}}, setop=UNION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,140:140='b',<393>,6:11]], c=[[@47,142:142='c',<393>,6:13]], d=[[@49,144:144='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, t3={a=[[@34,103:103='a',<393>,5:11]], b=[[@36,105:105='b',<393>,5:13]], c=[[@38,107:107='c',<393>,5:15]], d=[[@40,109:109='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,144:144='d',<393>,6:15]], b=[[@45,140:140='b',<393>,6:11]], c=[[@47,142:142='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, query3={a=[[@34,103:103='a',<393>,5:11]], b=[[@36,105:105='b',<393>,5:13]], c=[[@38,107:107='c',<393>,5:15]], d=[[@40,109:109='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleExceptedIntersectSubqueryInterfaceValidationWOAliasesV3Test(){
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=union6}], b=[{name=b, table_ref=union6}], c=[{name=c, table_ref=union6}], d=[{name=d, table_ref=null}]}, table_alias={union6=union6}, def_union6={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, def_intersect2={def_query1={query_dictionary={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, def_intersect5={interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,147:147='b',<393>,6:11]], c=[[@47,149:149='c',<393>,6:13]], d=[[@49,151:151='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,147:147='b',<393>,6:11]], c=[[@47,149:149='c',<393>,6:13]], d=[[@49,151:151='d',<393>,6:15]]}}, setop=INTERSECTION, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,107:107='a',<393>,5:11]], b=[[@36,109:109='b',<393>,5:13]], c=[[@38,111:111='c',<393>,5:15]], d=[[@40,113:113='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,107:107='a',<393>,5:11]], b=[[@36,109:109='b',<393>,5:13]], c=[[@38,111:111='c',<393>,5:15]], d=[[@40,113:113='d',<393>,5:17]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}, interface={a=query_column, b=query_column, c=query_column}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,147:147='b',<393>,6:11]], c=[[@47,149:149='c',<393>,6:13]], d=[[@49,151:151='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, t3={a=[[@34,107:107='a',<393>,5:11]], b=[[@36,109:109='b',<393>,5:13]], c=[[@38,111:111='c',<393>,5:15]], d=[[@40,113:113='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,151:151='d',<393>,6:15]], b=[[@45,147:147='b',<393>,6:11]], c=[[@47,149:149='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,77:77='a',<393>,3:17]], b=[[@21,71:71='b',<393>,3:11]], c=[[@23,73:73='c',<393>,3:13]], d=[[@25,75:75='d',<393>,3:15]]}, query3={a=[[@34,107:107='a',<393>,5:11]], b=[[@36,109:109='b',<393>,5:13]], c=[[@38,111:111='c',<393>,5:15]], d=[[@40,113:113='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectedUnionSubqueryInterfaceValidationV4Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_intersect6={def_union2={def_query1={query_dictionary={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11], [@47,149:149='b',<393>,6:11]], c=[[@23,69:69='c',<393>,3:13], [@49,151:151='c',<393>,6:13]], d=[[@25,71:71='d',<393>,3:15], [@51,153:153='d',<393>,6:15]]}}, setop=UNION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12], [@36,113:113='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,115:115='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,117:117='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={setop=INTERSECTION, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@47,149:149='b',<393>,6:11]], c=[[@49,151:151='c',<393>,6:13]], d=[[@51,153:153='d',<393>,6:15]]}, table_dictionary={t2={b=[[@47,149:149='b',<393>,6:11]], c=[[@49,151:151='c',<393>,6:13]], d=[[@51,153:153='d',<393>,6:15]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query3={query_dictionary={a=[[@36,113:113='a',<393>,5:11]], b=[[@38,115:115='b',<393>,5:13]], c=[[@40,117:117='c',<393>,5:15]], d=[[@42,119:119='d',<393>,5:17]]}, table_dictionary={t1={a=[[@36,113:113='a',<393>,5:11]], b=[[@38,115:115='b',<393>,5:13]], c=[[@40,117:117='c',<393>,5:15]], d=[[@42,119:119='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}}, interface={a=[{name=a, table_ref=intersect6}], b=[{name=b, table_ref=intersect6}], c=[{name=c, table_ref=intersect6}], d=[{name=d, table_ref=null}]}, table_alias={intersect6=intersect6}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@12,33:33='a',<393>,2:12], [@36,113:113='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,115:115='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,117:117='c',<393>,5:15]], d=[[@42,119:119='d',<393>,5:17]]}, t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11], [@47,149:149='b',<393>,6:11]], c=[[@23,69:69='c',<393>,3:13], [@49,151:151='c',<393>,6:13]], d=[[@25,71:71='d',<393>,3:15], [@51,153:153='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@51,153:153='d',<393>,6:15]], b=[[@47,149:149='b',<393>,6:11]], c=[[@49,151:151='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, query3={a=[[@36,113:113='a',<393>,5:11]], b=[[@38,115:115='b',<393>,5:13]], c=[[@40,117:117='c',<393>,5:15]], d=[[@42,119:119='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleExceptedUnionSubqueryInterfaceValidationV4Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=union6}], b=[{name=b, table_ref=union6}], c=[{name=c, table_ref=union6}], d=[{name=d, table_ref=null}]}, table_alias={union6=union6}, def_union6={def_union2={def_query1={query_dictionary={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11], [@47,146:146='b',<393>,6:11]], c=[[@23,69:69='c',<393>,3:13], [@49,148:148='c',<393>,6:13]], d=[[@25,71:71='d',<393>,3:15], [@51,150:150='d',<393>,6:15]]}}, setop=UNION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12], [@36,110:110='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,112:112='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,114:114='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@47,146:146='b',<393>,6:11]], c=[[@49,148:148='c',<393>,6:13]], d=[[@51,150:150='d',<393>,6:15]]}, table_dictionary={t2={b=[[@47,146:146='b',<393>,6:11]], c=[[@49,148:148='c',<393>,6:13]], d=[[@51,150:150='d',<393>,6:15]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query3={query_dictionary={a=[[@36,110:110='a',<393>,5:11]], b=[[@38,112:112='b',<393>,5:13]], c=[[@40,114:114='c',<393>,5:15]], d=[[@42,116:116='d',<393>,5:17]]}, table_dictionary={t1={a=[[@36,110:110='a',<393>,5:11]], b=[[@38,112:112='b',<393>,5:13]], c=[[@40,114:114='c',<393>,5:15]], d=[[@42,116:116='d',<393>,5:17]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@12,33:33='a',<393>,2:12], [@36,110:110='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,112:112='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,114:114='c',<393>,5:15]], d=[[@42,116:116='d',<393>,5:17]]}, t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11], [@47,146:146='b',<393>,6:11]], c=[[@23,69:69='c',<393>,3:13], [@49,148:148='c',<393>,6:13]], d=[[@25,71:71='d',<393>,3:15], [@51,150:150='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@51,150:150='d',<393>,6:15]], b=[[@47,146:146='b',<393>,6:11]], c=[[@49,148:148='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, query3={a=[[@36,110:110='a',<393>,5:11]], b=[[@38,112:112='b',<393>,5:13]], c=[[@40,114:114='c',<393>,5:15]], d=[[@42,116:116='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectedExceptSubqueryInterfaceValidationV4Test(){
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_intersect6={def_union2={def_query1={query_dictionary={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11], [@47,151:151='b',<393>,6:11]], c=[[@23,70:70='c',<393>,3:13], [@49,153:153='c',<393>,6:13]], d=[[@25,72:72='d',<393>,3:15], [@51,155:155='d',<393>,6:15]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12], [@36,114:114='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,116:116='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,118:118='c',<393>,5:15]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={setop=INTERSECTION, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@47,151:151='b',<393>,6:11]], c=[[@49,153:153='c',<393>,6:13]], d=[[@51,155:155='d',<393>,6:15]]}, table_dictionary={t2={b=[[@47,151:151='b',<393>,6:11]], c=[[@49,153:153='c',<393>,6:13]], d=[[@51,155:155='d',<393>,6:15]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query3={query_dictionary={a=[[@36,114:114='a',<393>,5:11]], b=[[@38,116:116='b',<393>,5:13]], c=[[@40,118:118='c',<393>,5:15]], d=[[@42,120:120='d',<393>,5:17]]}, table_dictionary={t1={a=[[@36,114:114='a',<393>,5:11]], b=[[@38,116:116='b',<393>,5:13]], c=[[@40,118:118='c',<393>,5:15]], d=[[@42,120:120='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}], d=[{name=d, table_ref=t1}]}}}}, interface={a=[{name=a, table_ref=intersect6}], b=[{name=b, table_ref=intersect6}], c=[{name=c, table_ref=intersect6}], d=[{name=d, table_ref=null}]}, table_alias={intersect6=intersect6}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@12,33:33='a',<393>,2:12], [@36,114:114='a',<393>,5:11]], b=[[@14,35:35='b',<393>,2:14], [@38,116:116='b',<393>,5:13]], c=[[@16,37:37='c',<393>,2:16], [@40,118:118='c',<393>,5:15]], d=[[@42,120:120='d',<393>,5:17]]}, t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11], [@47,151:151='b',<393>,6:11]], c=[[@23,70:70='c',<393>,3:13], [@49,153:153='c',<393>,6:13]], d=[[@25,72:72='d',<393>,3:15], [@51,155:155='d',<393>,6:15]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@51,155:155='d',<393>,6:15]], b=[[@47,151:151='b',<393>,6:11]], c=[[@49,153:153='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, query3={a=[[@36,114:114='a',<393>,5:11]], b=[[@38,116:116='b',<393>,5:13]], c=[[@40,118:118='c',<393>,5:15]], d=[[@42,120:120='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectedUnionSubqueryInterfaceValidationWOAliasesV5Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_intersect6={def_union2={def_query1={query_dictionary={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}}, setop=UNION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={setop=INTERSECTION, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,144:144='b',<393>,6:11]], c=[[@47,146:146='c',<393>,6:13]], d=[[@49,148:148='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,144:144='b',<393>,6:11]], c=[[@47,146:146='c',<393>,6:13]], d=[[@49,148:148='d',<393>,6:15]]}}, setop=UNION, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,108:108='a',<393>,5:11]], b=[[@36,110:110='b',<393>,5:13]], c=[[@38,112:112='c',<393>,5:15]], d=[[@40,114:114='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,108:108='a',<393>,5:11]], b=[[@36,110:110='b',<393>,5:13]], c=[[@38,112:112='c',<393>,5:15]], d=[[@40,114:114='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}}, interface={a=[{name=a, table_ref=intersect6}], b=[{name=b, table_ref=intersect6}], c=[{name=c, table_ref=intersect6}], d=[{name=d, table_ref=null}]}, table_alias={intersect6=intersect6}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,144:144='b',<393>,6:11]], c=[[@47,146:146='c',<393>,6:13]], d=[[@49,148:148='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, t3={a=[[@34,108:108='a',<393>,5:11]], b=[[@36,110:110='b',<393>,5:13]], c=[[@38,112:112='c',<393>,5:15]], d=[[@40,114:114='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,148:148='d',<393>,6:15]], b=[[@45,144:144='b',<393>,6:11]], c=[[@47,146:146='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, query3={a=[[@34,108:108='a',<393>,5:11]], b=[[@36,110:110='b',<393>,5:13]], c=[[@38,112:112='c',<393>,5:15]], d=[[@40,114:114='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleExceptedUnionSubqueryInterfaceValidationWOAliasesV5Test() {
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, interface={a=[{name=a, table_ref=union6}], b=[{name=b, table_ref=union6}], c=[{name=c, table_ref=union6}], d=[{name=d, table_ref=null}]}, table_alias={union6=union6}, def_union6={def_union2={def_query1={query_dictionary={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}}, setop=UNION, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,141:141='b',<393>,6:11]], c=[[@47,143:143='c',<393>,6:13]], d=[[@49,145:145='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,141:141='b',<393>,6:11]], c=[[@47,143:143='c',<393>,6:13]], d=[[@49,145:145='d',<393>,6:15]]}}, setop=UNION, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,105:105='a',<393>,5:11]], b=[[@36,107:107='b',<393>,5:13]], c=[[@38,109:109='c',<393>,5:15]], d=[[@40,111:111='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,105:105='a',<393>,5:11]], b=[[@36,107:107='b',<393>,5:13]], c=[[@38,109:109='c',<393>,5:15]], d=[[@40,111:111='d',<393>,5:17]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,141:141='b',<393>,6:11]], c=[[@47,143:143='c',<393>,6:13]], d=[[@49,145:145='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, t3={a=[[@34,105:105='a',<393>,5:11]], b=[[@36,107:107='b',<393>,5:13]], c=[[@38,109:109='c',<393>,5:15]], d=[[@40,111:111='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,145:145='d',<393>,6:15]], b=[[@45,141:141='b',<393>,6:11]], c=[[@47,143:143='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,73:73='a',<393>,3:17]], b=[[@21,67:67='b',<393>,3:11]], c=[[@23,69:69='c',<393>,3:13]], d=[[@25,71:71='d',<393>,3:15]]}, query3={a=[[@34,105:105='a',<393>,5:11]], b=[[@36,107:107='b',<393>,5:13]], c=[[@38,109:109='c',<393>,5:15]], d=[[@40,111:111='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void multipleIntersectedExceptSubqueryInterfaceValidationWOAliasesV5Test(){
		...
		Assert.assertEquals("Interface is wrong", "[a, b, c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query7={query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, def_intersect6={def_union2={def_query1={query_dictionary={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, table_dictionary={t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t2}], b=[{name=b, table_ref=t2}], c=[{name=c, table_ref=t2}], d=[{name=d, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, table_dictionary={t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}}, interface={a=[{name=a, table_ref=t1}], b=[{name=b, table_ref=t1}], c=[{name=c, table_ref=t1}]}}, interface={a=query_column, b=query_column, c=query_column}}, query_dictionary={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, interface={a=query_column, b=query_column, c=query_column}, def_union5={setop=INTERSECTION, interface={a=query_column, b=query_column, c=query_column, d=query_column}, def_query4={query_dictionary={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}, table_dictionary={t4={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t4}], c=[{name=c, table_ref=t4}], d=[{name=d, table_ref=t4}]}}, def_query3={query_dictionary={a=[[@34,109:109='a',<393>,5:11]], b=[[@36,111:111='b',<393>,5:13]], c=[[@38,113:113='c',<393>,5:15]], d=[[@40,115:115='d',<393>,5:17]]}, table_dictionary={t3={a=[[@34,109:109='a',<393>,5:11]], b=[[@36,111:111='b',<393>,5:13]], c=[[@38,113:113='c',<393>,5:15]], d=[[@40,115:115='d',<393>,5:17]]}}, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}], c=[{name=c, table_ref=t3}], d=[{name=d, table_ref=t3}]}}}}, interface={a=[{name=a, table_ref=intersect6}], b=[{name=b, table_ref=intersect6}], c=[{name=c, table_ref=intersect6}], d=[{name=d, table_ref=null}]}, table_alias={intersect6=intersect6}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t4={b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]], d=[[@49,150:150='d',<393>,6:15]]}, t1={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, t2={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, t3={a=[[@34,109:109='a',<393>,5:11]], b=[[@36,111:111='b',<393>,5:13]], c=[[@38,113:113='c',<393>,5:15]], d=[[@40,115:115='d',<393>,5:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{intersect6={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]]}, query4={d=[[@49,150:150='d',<393>,6:15]], b=[[@45,146:146='b',<393>,6:11]], c=[[@47,148:148='c',<393>,6:13]]}, query7={a=[[@1,7:7='a',<393>,1:7]], b=[[@3,9:9='b',<393>,1:9]], c=[[@5,11:11='c',<393>,1:11]], d=[[@7,13:13='d',<393>,1:13]]}, query0={a=[[@12,33:33='a',<393>,2:12]], b=[[@14,35:35='b',<393>,2:14]], c=[[@16,37:37='c',<393>,2:16]]}, query1={a=[[@27,74:74='a',<393>,3:17]], b=[[@21,68:68='b',<393>,3:11]], c=[[@23,70:70='c',<393>,3:13]], d=[[@25,72:72='d',<393>,3:15]]}, query3={a=[[@34,109:109='a',<393>,5:11]], b=[[@36,111:111='b',<393>,5:13]], c=[[@38,113:113='c',<393>,5:15]], d=[[@40,115:115='d',<393>,5:17]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void subqueryQualifyValidationV1Test() {
		...
		Assert.assertEquals("Interface is wrong", "[rno, min_activity_dt, outbound_ind, person_activity_key, activity_id, person_id]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query0={window_ordered_by=[{name=activity_dt, table_ref=null}, {name=person_activity_key, table_ref=personactivity}], query_dictionary={rno=[[@16,101:103='rno',<393>,1:101], [@52,354:356='rno',<393>,4:54]], min_activity_dt=[[@44,284:298='min_activity_dt',<393>,3:109]], outbound_ind=[[@24,161:172='outbound_ind',<393>,2:55]], person_activity_key=[[@18,113:131='person_activity_key',<393>,2:7]], activity_id=[[@20,135:145='activity_id',<393>,2:29]], person_id=[[@22,149:157='person_id',<393>,2:43]]}, table_dictionary={personactivity={activity_dt=[[@11,60:70='activity_dt',<393>,1:60], [@28,186:196='activity_dt',<393>,3:11], [@37,237:247='activity_dt',<393>,3:62]], outbound_ind=[[@24,161:172='outbound_ind',<393>,2:55], [@48,330:341='outbound_ind',<393>,4:30]], person_activity_key=[[@13,74:92='person_activity_key',<393>,1:74], [@18,113:131='person_activity_key',<393>,2:7], [@40,255:273='person_activity_key',<393>,3:80]], activity_id=[[@20,135:145='activity_id',<393>,2:29]], person_id=[[@8,41:49='person_id',<393>,1:41], [@22,149:157='person_id',<393>,2:43], [@34,218:226='person_id',<393>,3:43], [@57,371:379='person_id',<393>,4:71]]}}, window_partition_by=[{name=person_id, table_ref=personactivity}], ordered_by=[{name=person_id, table_ref=personactivity}], filters=[{name=outbound_ind, table_ref=personactivity}, {name=rno, table_ref=query0}], interface={rno=[{name=person_id, table_ref=personactivity}, {name=activity_dt, table_ref=personactivity}, {name=person_activity_key, table_ref=personactivity}], min_activity_dt=[{name=person_id, table_ref=personactivity}, {name=activity_dt, table_ref=personactivity}, {name=person_activity_key, table_ref=personactivity}], outbound_ind=[{name=outbound_ind, table_ref=personactivity}], person_activity_key=[{name=person_activity_key, table_ref=personactivity}], activity_id=[{name=activity_id, table_ref=personactivity}], person_id=[{name=person_id, table_ref=personactivity}]}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{personactivity={activity_dt=[[@11,60:70='activity_dt',<393>,1:60], [@28,186:196='activity_dt',<393>,3:11], [@37,237:247='activity_dt',<393>,3:62]], outbound_ind=[[@24,161:172='outbound_ind',<393>,2:55], [@48,330:341='outbound_ind',<393>,4:30]], person_activity_key=[[@13,74:92='person_activity_key',<393>,1:74], [@18,113:131='person_activity_key',<393>,2:7], [@40,255:273='person_activity_key',<393>,3:80]], activity_id=[[@20,135:145='activity_id',<393>,2:29]], person_id=[[@8,41:49='person_id',<393>,1:41], [@22,149:157='person_id',<393>,2:43], [@34,218:226='person_id',<393>,3:43], [@57,371:379='person_id',<393>,4:71]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={activity_id=[[@20,135:145='activity_id',<393>,2:29]], rno=[[@16,101:103='rno',<393>,1:101], [@52,354:356='rno',<393>,4:54]], min_activity_dt=[[@44,284:298='min_activity_dt',<393>,3:109]], outbound_ind=[[@24,161:172='outbound_ind',<393>,2:55]], person_activity_key=[[@18,113:131='person_activity_key',<393>,2:7]], person_id=[[@22,149:157='person_id',<393>,2:43]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void coverageDrivenUpdateSingleFromTableRehomesUnqualifiedUnknownsTest() {
		...
		Assert.assertEquals("Interface is wrong", "[a]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_update0={assignments={a=[{name=b, table_ref=t2}]}, table_dictionary={t={a=[[@3,13:13='a',<393>,1:13]]}, t2={b=[[@5,17:17='b',<393>,1:17]]}}, update_dictionary={a=[[@3,13:13='a',<393>,1:13]]}, filters=[{name=c, table_ref=null}]}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={a=[[@3,13:13='a',<393>,1:13]]}, t2={b=[[@5,17:17='b',<393>,1:17]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{update0={a=[[@3,13:13='a',<393>,1:13]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void coverageDrivenUpdateNoFromDefaultsUnqualifiedUnknownsToTargetTableTest() {
		...
		Assert.assertEquals("Interface is wrong", "[a]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_update0={assignments={a=[{name=b, table_ref=t}]}, table_dictionary={t={b=[[@5,17:17='b',<393>,1:17]], c=[[@7,25:25='c',<393>,1:25]]}}, update_dictionary={a=[[@3,13:13='a',<393>,1:13]]}, target_table={t={a=[[@3,13:13='a',<393>,1:13]]}}, filters=[{name=c, table_ref=t}], lhs_unresolved_columns={a={column={name=a, table_ref=null}, locations=[[@3,13:13='a',<393>,1:13]]}}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t={b=[[@5,17:17='b',<393>,1:17]], c=[[@7,25:25='c',<393>,1:25]]}}",
				snippet.getTableDictionary().toString());
	...
	public void coverageDrivenSelectAliasBackedByQueryMissingColumnFatalTest() {
		...
		Assert.assertEquals("Interface is wrong", "[missing]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query1={query_dictionary={missing=[[@3,9:15='missing',<393>,1:9]]}, def_query0={query_dictionary={a=[[@7,30:30='a',<393>,1:30]]}, table_dictionary={tab1={a=[[@7,30:30='a',<393>,1:30]]}}, interface={a=[{name=a, table_ref=tab1}]}}, interface={missing=[{name=missing, table_ref=q}]}, table_alias={q=query0}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@7,30:30='a',<393>,1:30]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,30:30='a',<393>,1:30]]}, query1={missing=[[@3,9:15='missing',<393>,1:9]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSelectAliasBackedByQueryWildcardAllowsQualifiedReferenceTest() {
		...
		Assert.assertEquals("Interface is wrong", "[anycol]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query1={query_dictionary={anycol=[[@3,9:14='anycol',<393>,1:9]]}, def_query0={query_dictionary={anycol=[[@1,7:7='q',<393>,1:7]], *=[[@7,29:29='*',<291>,1:29]]}, table_dictionary={tab1={*=[[@7,29:29='*',<291>,1:29]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={anycol=[{name=anycol, table_ref=q}]}, table_alias={q=query0}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={*=[[@7,29:29='*',<291>,1:29]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={anycol=[[@1,7:7='q',<393>,1:7]], *=[[@7,29:29='*',<291>,1:29]]}, query1={anycol=[[@3,9:14='anycol',<393>,1:9]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void coverageDrivenSelectAliasBackedByValuesMissingColumnFatalTest() {
		...
		Assert.assertEquals("Interface is wrong", "[missing]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query1={query_dictionary={missing=[[@3,9:15='missing',<393>,1:9]]}, def_values0={query_dictionary={a=[[@13,37:37='a',<393>,1:37]]}, interface={a=[]}}, interface={missing=[{name=missing, table_ref=v}]}, table_alias={v=values0}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{values0={a=[[@13,37:37='a',<393>,1:37]]}, query1={missing=[[@3,9:15='missing',<393>,1:9]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchTopLevelSiblingTest() {
		...
		Assert.assertEquals("Interface is wrong", "[a]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_intersect4={def_union2={def_query1={query_dictionary={b=[[@7,31:31='b',<393>,1:31]]}, table_dictionary={t2={b=[[@7,31:31='b',<393>,1:31]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@2,8:8='a',<393>,1:8]]}, table_dictionary={t1={a=[[@2,8:8='a',<393>,1:8]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@14,60:60='a',<393>,1:60]], b=[[@16,62:62='b',<393>,1:62]]}, table_dictionary={t3={a=[[@14,60:60='a',<393>,1:60]], b=[[@16,62:62='b',<393>,1:62]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@2,8:8='a',<393>,1:8]]}, t2={b=[[@7,31:31='b',<393>,1:31]]}, t3={a=[[@14,60:60='a',<393>,1:60]], b=[[@16,62:62='b',<393>,1:62]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@2,8:8='a',<393>,1:8]]}, query1={b=[[@7,31:31='b',<393>,1:31]]}, query3={a=[[@14,60:60='a',<393>,1:60]], b=[[@16,62:62='b',<393>,1:62]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchTopLevelSiblingTestIntersectAsExcept() {
		...
		Assert.assertEquals("Interface is wrong", "[a]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_union4={def_union2={def_query1={query_dictionary={b=[[@7,31:31='b',<393>,1:31]]}, table_dictionary={t2={b=[[@7,31:31='b',<393>,1:31]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@2,8:8='a',<393>,1:8]]}, table_dictionary={t1={a=[[@2,8:8='a',<393>,1:8]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@14,57:57='a',<393>,1:57]], b=[[@16,59:59='b',<393>,1:59]]}, table_dictionary={t3={a=[[@14,57:57='a',<393>,1:57]], b=[[@16,59:59='b',<393>,1:59]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@2,8:8='a',<393>,1:8]]}, t2={b=[[@7,31:31='b',<393>,1:31]]}, t3={a=[[@14,57:57='a',<393>,1:57]], b=[[@16,59:59='b',<393>,1:59]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@2,8:8='a',<393>,1:8]]}, query1={b=[[@7,31:31='b',<393>,1:31]]}, query3={a=[[@14,57:57='a',<393>,1:57]], b=[[@16,59:59='b',<393>,1:59]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchTopLevelSiblingExceptTest(){
		...
		Assert.assertEquals("Interface is wrong", "[a]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_intersect4={def_union2={def_query1={query_dictionary={b=[[@7,32:32='b',<393>,1:32]]}, table_dictionary={t2={b=[[@7,32:32='b',<393>,1:32]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@2,8:8='a',<393>,1:8]]}, table_dictionary={t1={a=[[@2,8:8='a',<393>,1:8]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@14,61:61='a',<393>,1:61]], b=[[@16,63:63='b',<393>,1:63]]}, table_dictionary={t3={a=[[@14,61:61='a',<393>,1:61]], b=[[@16,63:63='b',<393>,1:63]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@2,8:8='a',<393>,1:8]]}, t2={b=[[@7,32:32='b',<393>,1:32]]}, t3={a=[[@14,61:61='a',<393>,1:61]], b=[[@16,63:63='b',<393>,1:63]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@2,8:8='a',<393>,1:8]]}, query1={b=[[@7,32:32='b',<393>,1:32]]}, query3={a=[[@14,61:61='a',<393>,1:61]], b=[[@16,63:63='b',<393>,1:63]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchNestedSubqueryTest() {
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query5={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, def_intersect4={def_union2={def_query1={query_dictionary={b=[[@11,46:46='b',<393>,1:46]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t2={b=[[@11,46:46='b',<393>,1:46]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t1={a=[[@6,23:23='a',<393>,1:23]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@18,75:75='a',<393>,1:75]], b=[[@20,77:77='b',<393>,1:77]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t3={a=[[@18,75:75='a',<393>,1:75]], b=[[@20,77:77='b',<393>,1:77]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}, interface={*=[{name=*, table_ref=*}]}, table_alias={x=intersect4}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@6,23:23='a',<393>,1:23]]}, t2={b=[[@11,46:46='b',<393>,1:46]]}, t3={a=[[@18,75:75='a',<393>,1:75]], b=[[@20,77:77='b',<393>,1:77]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query5={*=[[@1,7:7='*',<291>,1:7]]}, query0={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, query1={b=[[@11,46:46='b',<393>,1:46]], *=[[@1,7:7='*',<291>,1:7]]}, query3={a=[[@18,75:75='a',<393>,1:75]], b=[[@20,77:77='b',<393>,1:77]], *=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchNestedSubqueryTestIntersectAsExcept() {
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query5={def_union4={def_union2={def_query1={query_dictionary={b=[[@11,46:46='b',<393>,1:46]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t2={b=[[@11,46:46='b',<393>,1:46]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t1={a=[[@6,23:23='a',<393>,1:23]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@18,72:72='a',<393>,1:72]], b=[[@20,74:74='b',<393>,1:74]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t3={a=[[@18,72:72='a',<393>,1:72]], b=[[@20,74:74='b',<393>,1:74]]}}, setop=EXCEPT, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}, query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, interface={*=[{name=*, table_ref=*}]}, table_alias={x=union4}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@6,23:23='a',<393>,1:23]]}, t2={b=[[@11,46:46='b',<393>,1:46]]}, t3={a=[[@18,72:72='a',<393>,1:72]], b=[[@20,74:74='b',<393>,1:74]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query5={*=[[@1,7:7='*',<291>,1:7]]}, query0={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, query1={b=[[@11,46:46='b',<393>,1:46]], *=[[@1,7:7='*',<291>,1:7]]}, query3={a=[[@18,72:72='a',<393>,1:72]], b=[[@20,74:74='b',<393>,1:74]], *=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSetOperationInterfaceMismatchNestedSubqueryExceptTest(){
		...
		Assert.assertEquals("Interface is wrong", "[*]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query5={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, def_intersect4={def_union2={def_query1={query_dictionary={b=[[@11,47:47='b',<393>,1:47]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t2={b=[[@11,47:47='b',<393>,1:47]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t1={a=[[@6,23:23='a',<393>,1:23]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}, interface={a=query_column}, def_query3={query_dictionary={a=[[@18,76:76='a',<393>,1:76]], b=[[@20,78:78='b',<393>,1:78]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t3={a=[[@18,76:76='a',<393>,1:76]], b=[[@20,78:78='b',<393>,1:78]]}}, setop=INTERSECTION, interface={a=[{name=a, table_ref=t3}], b=[{name=b, table_ref=t3}]}}}, interface={*=[{name=*, table_ref=*}]}, table_alias={x=intersect4}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@6,23:23='a',<393>,1:23]]}, t2={b=[[@11,47:47='b',<393>,1:47]]}, t3={a=[[@18,76:76='a',<393>,1:76]], b=[[@20,78:78='b',<393>,1:78]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query5={*=[[@1,7:7='*',<291>,1:7]]}, query0={a=[[@6,23:23='a',<393>,1:23]], *=[[@1,7:7='*',<291>,1:7]]}, query1={b=[[@11,47:47='b',<393>,1:47]], *=[[@1,7:7='*',<291>,1:7]]}, query3={a=[[@18,76:76='a',<393>,1:76]], b=[[@20,78:78='b',<393>,1:78]], *=[[@1,7:7='*',<291>,1:7]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenInsertDerivedSourceColumnSequenceFromUnionNoFallbackTest() {
		...
		Assert.assertEquals("Interface is wrong", "[c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert4={query_dictionary={d=[[@6,19:19='d',<393>,1:19]], c=[[@4,17:17='c',<393>,1:17]]}, table_dictionary={tab1={c=[[@4,17:17='c',<393>,1:17]], d=[[@6,19:19='d',<393>,1:19]]}}, interface={c=[{name=x, table_ref=query3}], d=[{name=y, table_ref=query3}]}, def_query3={def_union2={query_dictionary={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, def_query1={query_dictionary={x=[[@28,87:87='x',<393>,1:87]], y=[[@32,95:95='y',<393>,1:95]]}, table_dictionary={t3={c=[[@26,82:82='c',<393>,1:82]], d=[[@30,90:90='d',<393>,1:90]]}}, setop=UNION, interface={x=[{name=c, table_ref=t3}], y=[{name=d, table_ref=t3}]}}, def_query0={query_dictionary={x=[[@17,51:51='x',<393>,1:51]], y=[[@21,59:59='y',<393>,1:59]]}, table_dictionary={t2={a=[[@15,46:46='a',<393>,1:46]], b=[[@19,54:54='b',<393>,1:54]]}}, interface={x=[{name=a, table_ref=t2}], y=[{name=b, table_ref=t2}]}}, interface={x=query_column, y=query_column}}, query_dictionary={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, interface={x=[{name=x, table_ref=union2}], y=[{name=y, table_ref=union2}]}, table_alias={s=union2}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={c=[[@4,17:17='c',<393>,1:17]], d=[[@6,19:19='d',<393>,1:19]]}, t2={a=[[@15,46:46='a',<393>,1:46]], b=[[@19,54:54='b',<393>,1:54]]}, t3={c=[[@26,82:82='c',<393>,1:82]], d=[[@30,90:90='d',<393>,1:90]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, query0={x=[[@17,51:51='x',<393>,1:51]], y=[[@21,59:59='y',<393>,1:59]]}, insert4={d=[[@6,19:19='d',<393>,1:19]], c=[[@4,17:17='c',<393>,1:17]]}, query1={x=[[@28,87:87='x',<393>,1:87]], y=[[@32,95:95='y',<393>,1:95]]}, query3={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	public void coverageDrivenInsertDerivedSourceColumnSequenceFromExceptNoFallbackTest(){
		...
		Assert.assertEquals("Interface is wrong", "[c, d]",
			snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_insert4={query_dictionary={d=[[@6,19:19='d',<393>,1:19]], c=[[@4,17:17='c',<393>,1:17]]}, table_dictionary={tab1={c=[[@4,17:17='c',<393>,1:17]], d=[[@6,19:19='d',<393>,1:19]]}}, interface={c=[{name=x, table_ref=query3}], d=[{name=y, table_ref=query3}]}, def_query3={def_union2={query_dictionary={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, def_query1={query_dictionary={x=[[@28,88:88='x',<393>,1:88]], y=[[@32,96:96='y',<393>,1:96]]}, table_dictionary={t3={c=[[@26,83:83='c',<393>,1:83]], d=[[@30,91:91='d',<393>,1:91]]}}, setop=EXCEPT, interface={x=[{name=c, table_ref=t3}], y=[{name=d, table_ref=t3}]}}, def_query0={query_dictionary={x=[[@17,51:51='x',<393>,1:51]], y=[[@21,59:59='y',<393>,1:59]]}, table_dictionary={t2={a=[[@15,46:46='a',<393>,1:46]], b=[[@19,54:54='b',<393>,1:54]]}}, interface={x=[{name=a, table_ref=t2}], y=[{name=b, table_ref=t2}]}}, interface={x=query_column, y=query_column}}, query_dictionary={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, interface={x=[{name=x, table_ref=union2}], y=[{name=y, table_ref=union2}]}, table_alias={s=union2}}}}",
			snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={c=[[@4,17:17='c',<393>,1:17]], d=[[@6,19:19='d',<393>,1:19]]}, t2={a=[[@15,46:46='a',<393>,1:46]], b=[[@19,54:54='b',<393>,1:54]]}, t3={c=[[@26,83:83='c',<393>,1:83]], d=[[@30,91:91='d',<393>,1:91]]}}",
			snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
			snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}, query0={x=[[@17,51:51='x',<393>,1:51]], y=[[@21,59:59='y',<393>,1:59]]}, insert4={d=[[@6,19:19='d',<393>,1:19]], c=[[@4,17:17='c',<393>,1:17]]}, query1={x=[[@28,88:88='x',<393>,1:88]], y=[[@32,96:96='y',<393>,1:96]]}, query3={x=[[@9,29:29='x',<393>,1:29]], y=[[@11,31:31='y',<393>,1:31]]}}",
			snippet.getQueryColumnDictionaryMap().toString());
	}
	...
	*/
	...
	public void coverageDrivenQuerySpecificationAliasUnresolvedSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={missing=[[@3,9:15='missing',<393>,1:9]]}, def_query0={query_dictionary={a=[[@7,30:30='a',<393>,1:30]]}, table_dictionary={t1={a=[[@7,30:30='a',<393>,1:30]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={missing=[{name=missing, table_ref=q}]}, table_alias={q=query0}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t1={a=[[@7,30:30='a',<393>,1:30]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@7,30:30='a',<393>,1:30]]}, query1={missing=[[@3,9:15='missing',<393>,1:9]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenQuerySpecificationCorrelatedPassUpSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query2={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t1={a=[[@16,61:62='t1',<393>,1:61]], *=[[@1,7:7='*',<291>,1:7]]}}, dependent_queries={exists1={query=query0, type=filters}}, def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]], unnamed_0=[[@8,38:38='1',<300>,1:38]]}, table_dictionary={t2={a=[[@12,54:55='t2',<393>,1:54]]}}, filters=[{name=a, table_ref=t2}, {name=a, table_ref=t1}], interface={unnamed_0=[]}}, filters=[], interface={*=[{name=*, table_ref=*}]}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t1={a=[[@16,61:62='t1',<393>,1:61]], *=[[@1,7:7='*',<291>,1:7]]}, t2={a=[[@12,54:55='t2',<393>,1:54]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
	...
	public void coverageDrivenQuerySpecificationTopLevelSourceNotFoundSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={a=[[@3,9:9='a',<393>,1:9]]}, table_dictionary={t1={}}, interface={a=[{name=a, table_ref=z}]}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t1={}}",
				snippet.getTableDictionary().toString());
	...
	public void coverageDrivenQuerySpecificationEmitFromSubquerySnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={}, def_query0={query_dictionary={a=[[@7,32:32='a',<393>,1:32]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t2={}}, interface={a=[{name=a, table_ref=bad_alias}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={q=query0}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t2={}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				...
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@7,32:32='a',<393>,1:32]], *=[[@1,7:7='*',<291>,1:7]]}, query1={*=[[@1,7:7='*',<291>,1:7]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSelectIntoSimpleTargetProjectionSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={a=[[@3,19:19='a',<393>,1:19]]}, table_dictionary={outtab={a=[[@3,19:19='a',<393>,1:19]]}, t1={a=[[@3,19:19='a',<393>,1:19]]}}, target_table={outtab={a=[[@3,19:19='a',<393>,1:19]]}}, interface={a=[{name=a, table_ref=t1}]}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{outtab={a=[[@3,19:19='a',<393>,1:19]]}, t1={a=[[@3,19:19='a',<393>,1:19]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@3,19:19='a',<393>,1:19]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSelectIntoQualifiedAndAliasedProjectionSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={a=[[@7,27:27='a',<393>,1:27]], b1=[[@11,35:36='b1',<393>,1:35]]}, table_dictionary={t1={a=[[@7,27:27='a',<393>,1:27]], b=[[@9,30:30='b',<393>,1:30]]}, db1.sc1.outtab={a=[[@7,27:27='a',<393>,1:27]], b1=[[@11,35:36='b1',<393>,1:35]]}}, target_table={db1.sc1.outtab={a=[[@7,27:27='a',<393>,1:27]], b1=[[@11,35:36='b1',<393>,1:35]]}}, interface={a=[{name=a, table_ref=t1}], b1=[{name=b, table_ref=t1}]}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{t1={a=[[@7,27:27='a',<393>,1:27]], b=[[@9,30:30='b',<393>,1:30]]}, db1.sc1.outtab={a=[[@7,27:27='a',<393>,1:27]], b1=[[@11,35:36='b1',<393>,1:35]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@7,27:27='a',<393>,1:27]], b1=[[@11,35:36='b1',<393>,1:35]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSelectIntoUnionMixedSidesSnapshotTest() {
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_union2={def_query1={query_dictionary={b=[[@8,40:40='b',<393>,1:40]]}, table_dictionary={t2={b=[[@8,40:40='b',<393>,1:40]]}}, setop=UNION, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@3,17:17='a',<393>,1:17]]}, table_dictionary={out1={a=[[@3,17:17='a',<393>,1:17]]}, t1={a=[[@3,17:17='a',<393>,1:17]]}}, target_table={out1={a=[[@3,17:17='a',<393>,1:17]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{out1={a=[[@3,17:17='a',<393>,1:17]]}, t1={a=[[@3,17:17='a',<393>,1:17]]}, t2={b=[[@8,40:40='b',<393>,1:40]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@3,17:17='a',<393>,1:17]]}, query1={b=[[@8,40:40='b',<393>,1:40]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenSelectIntoExceptMixedSidesSnapshotTest(){
		...
		Assert.assertEquals("Interface is wrong",
				...
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_union2={def_query1={query_dictionary={b=[[@8,41:41='b',<393>,1:41]]}, table_dictionary={t2={b=[[@8,41:41='b',<393>,1:41]]}}, setop=EXCEPT, interface={b=[{name=b, table_ref=t2}]}}, def_query0={query_dictionary={a=[[@3,17:17='a',<393>,1:17]]}, table_dictionary={out1={a=[[@3,17:17='a',<393>,1:17]]}, t1={a=[[@3,17:17='a',<393>,1:17]]}}, target_table={out1={a=[[@3,17:17='a',<393>,1:17]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={a=query_column}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{out1={a=[[@3,17:17='a',<393>,1:17]]}, t1={a=[[@3,17:17='a',<393>,1:17]]}, t2={b=[[@8,41:41='b',<393>,1:41]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong",
				"{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@3,17:17='a',<393>,1:17]]}, query1={b=[[@8,41:41='b',<393>,1:41]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenUpdateAliasQualifiedTargetAndSourceRefsTest() {
		...
		Assert.assertEquals("Interface is wrong", "[a]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_update0={assignments={a=[{name=b, table_ref=src}]}, table_dictionary={s={b=[[@7,24:26='src',<393>,1:24]], id=[[@19,59:61='src',<393>,1:59]]}, t={a=[[@5,20:20='a',<393>,1:20]], id=[[@15,50:52='tgt',<393>,1:50]], flag=[[@23,70:72='tgt',<393>,1:70]]}}, update_dictionary={a=[[@5,20:20='a',<393>,1:20]]}, filters=[{name=id, table_ref=tgt}, {name=id, table_ref=src}, {name=flag, table_ref=tgt}], table_alias={tgt=t, src=s}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{s={b=[[@7,24:26='src',<393>,1:24]], id=[[@19,59:61='src',<393>,1:59]]}, t={a=[[@5,20:20='a',<393>,1:20]], flag=[[@23,70:72='tgt',<393>,1:70]], id=[[@15,50:52='tgt',<393>,1:50]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{update0={a=[[@5,20:20='a',<393>,1:20]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
		assertFatalDiagnosticCount(snippet, null, null, null, 0);
	}
	...
	public void coverageDrivenQualifiedSourceNotFoundPluralMissingColumnsTest() {
		...
		Assert.assertEquals("Interface is wrong", "[missing1, missing2]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={missing1=[[@3,9:16='missing1',<393>,1:9]], missing2=[[@7,21:28='missing2',<393>,1:21]]}, table_dictionary={t1={}}, interface={missing1=[{name=missing1, table_ref=z}], missing2=[{name=missing2, table_ref=z}]}}}",
				snippet.getSymbolTable().toString());
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={missing2=[[@7,21:28='missing2',<393>,1:21]], missing1=[[@3,9:16='missing1',<393>,1:9]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
	...
	public void coverageDrivenQueryAliasCaseInsensitiveResolutionTest() {
		...
		Assert.assertEquals("Interface is wrong", "[A]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={A=[[@3,9:9='A',<393>,1:9]]}, def_query0={query_dictionary={a=[[@7,24:24='a',<393>,1:24], [@1,7:7='q',<393>,1:7]]}, table_dictionary={t1={a=[[@7,24:24='a',<393>,1:24]]}}, interface={a=[{name=a, table_ref=t1}]}}, interface={A=[{name=A, table_ref=q}]}, table_alias={q=query0}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={a=[[@7,24:24='a',<393>,1:24]]}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@7,24:24='a',<393>,1:24], [@1,7:7='q',<393>,1:7]]}, query1={A=[[@3,9:9='A',<393>,1:9]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
		assertFatalDiagnosticCount(snippet, null, null, null, 0);
	}
	...
	public void coverageDrivenWildcardQueryAliasPermissiveMultipleRefsTest() {
		...
		Assert.assertEquals("Interface is wrong", "[any1, any2]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={any1=[[@3,9:12='any1',<393>,1:9]], any2=[[@7,17:20='any2',<393>,1:17]]}, def_query0={query_dictionary={any1=[[@1,7:7='q',<393>,1:7]], *=[[@11,35:35='*',<291>,1:35]], any3=[[@17,54:54='q',<393>,1:54]], any2=[[@5,15:15='q',<393>,1:15]]}, table_dictionary={t1={*=[[@11,35:35='*',<291>,1:35]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=any3, table_ref=q}], interface={any1=[{name=any1, table_ref=q}], any2=[{name=any2, table_ref=q}]}, table_alias={q=query0}}}",
				snippet.getSymbolTable().toString());
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={any1=[[@1,7:7='q',<393>,1:7]], *=[[@11,35:35='*',<291>,1:35]], any3=[[@17,54:54='q',<393>,1:54]], any2=[[@5,15:15='q',<393>,1:15]]}, query1={any1=[[@3,9:12='any1',<393>,1:9]], any2=[[@7,17:20='any2',<393>,1:17]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
		assertFatalDiagnosticCount(snippet, null, null, null, 0);
	}
	...
	public void coverageDrivenSubqueryUnresolvedQualifierPassUpToParentTest() {
		...
		Assert.assertEquals("Interface is wrong", "[*]",
				snippet.getQueryInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={}, def_query0={query_dictionary={a=[[@7,24:24='a',<393>,1:24]], *=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t1={}}, interface={a=[{name=a, table_ref=x}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={q=query0}}}",
				snippet.getSymbolTable().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t1={}}",
				snippet.getTableDictionary().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				snippet.getSubstitutionsMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={a=[[@7,24:24='a',<393>,1:24]], *=[[@1,7:7='*',<291>,1:7]]}, query1={*=[[@1,7:7='*',<291>,1:7]]}}",
				snippet.getQueryColumnDictionaryMap().toString());
