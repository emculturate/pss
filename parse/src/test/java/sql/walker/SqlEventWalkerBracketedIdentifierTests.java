...
public class SqlEventWalkerBracketedIdentifierTests extends AbstractSqlParseEventWalkerTest {
	...
	public void singleTermBracketedIdentifierTableColumnAndAliasV0Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong",
				"{[Entity]={score=[[@1,7:7='t',<393>,1:7], [@25,69:69='t',<393>,1:69]], *=[[@15,40:40='t',<393>,1:40]], [Metric]=[[@9,28:28='t',<393>,1:28]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={*=[[@17,42:42='*',<291>,1:42]], [Metric]=[[@13,37:37=']',<412>,1:37]], [Result]=[[@7,25:25=']',<412>,1:25]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@17,42:42='*',<291>,1:42]], [Result]=[[@7,25:25=']',<412>,1:25]], [Metric]=[[@13,37:37=']',<412>,1:37]]}, table_dictionary={[Entity]={score=[[@1,7:7='t',<393>,1:7], [@25,69:69='t',<393>,1:69]], *=[[@15,40:40='t',<393>,1:40]], [Metric]=[[@9,28:28='t',<393>,1:28]]}}, filters=[{name=score, table_ref=t}], interface={*=[{name=*, table_ref=t}], [Result]=[{name=score, table_ref=t}], [Metric]=[{name=[Metric], table_ref=t}]}, table_alias={t=[Entity]}}}",
