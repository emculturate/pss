...
public class SqlEventWalkerBracketedIdentifierTests extends AbstractSqlParseEventWalkerTest {
	...
	public void singleTermBracketedIdentifierTableColumnAndAliasV0Test() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@17,42:42='*',<291>,1:42]], [Result]=[[@7,25:25=']',<412>,1:25]], [Metric]=[[@13,37:37=']',<412>,1:37]]}, table_dictionary={[Entity]={score=[[@1,7:7='t',<392>,1:7], [@25,69:69='t',<392>,1:69]], *=[[@15,40:40='t',<392>,1:40]], [Metric]=[[@9,28:28='t',<392>,1:28]]}}, filters=[{name=score, table_ref=t}], interface={*=[{name=*, table_ref=t}], [Result]=[{name=score, table_ref=t}], [Metric]=[{name=[Metric], table_ref=t}]}, table_alias={t=[Entity]}}}",
