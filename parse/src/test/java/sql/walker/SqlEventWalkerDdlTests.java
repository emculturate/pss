...
public class SqlEventWalkerDdlTests extends AbstractSqlParseEventWalkerTest {
	...
	public void createTableAsSelectTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@7,34:35='id',<393>,1:34]]}, table_dictionary={demo.src={id=[[@7,34:35='id',<393>,1:34]]}}, interface={id=[{name=id, table_ref=demo.src}]}}}}");
	}
	...
	public void createIndexTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create0={unresolved_column={event_ts={column={name=event_ts, table_ref=null}, locations=[[@14,66:73='event_ts',<393>,1:66]]}}}}");
	}
	...
	public void createViewAsSelectTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@7,46:47='id',<393>,1:46]]}, table_dictionary={demo.stage={id=[[@7,46:47='id',<393>,1:46]]}}, interface={id=[{name=id, table_ref=demo.stage}]}}}}");
	}
	...
	public void createMaterializedViewAsSelectTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@8,54:55='id',<393>,1:54]]}, table_dictionary={demo.stage={id=[[@8,54:55='id',<393>,1:54]]}}, interface={id=[{name=id, table_ref=demo.stage}]}}}}");
	}
	...
	public void createMacroAsSelectTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@15,60:61='id',<393>,1:60]]}, interface={id=[]}}}}");
	}
	...
	public void createMacroEmptyArgsTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@13,51:52='id',<393>,1:51]]}, interface={id=[]}}}}");
	}
	...
	public void createMacroParametersPreserveCaseVerbatimTest() {
		assertDdlAstSymbolDiagnostics(
				...
				"{def_create1={def_query0={query_dictionary={id=[[@15,62:63='id',<393>,1:62]]}, interface={id=[]}}}}");
	}
