...
public class SqlEventWalkerCastingAndTypesTests extends AbstractSqlParseEventWalkerTest {
	...
	public void basicSelectListCasting1Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={d=[[@17,38:38='d',<373>,1:38]]}}",
			extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@5,17:17='a',<373>,1:17]], b=[[@14,34:34='b',<373>,1:34]], c=[[@22,53:53='c',<373>,1:53]]}}",
			extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@5,17:17='a',<373>,1:17]], b=[[@14,34:34='b',<373>,1:34]], c=[[@22,53:53='c',<373>,1:53]]}, table_dictionary={tab1={d=[[@17,38:38='d',<373>,1:38]]}}, interface={a=[], b=[], c=[{name=d, table_ref=tab1}]}}}",
	...
	public void inlineCastOnColumnPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:25='varchar',<248>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:25='varchar',<248>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToIntegerTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:25='integer',<234>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:25='integer',<234>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToBigintTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:24='bigint',<235>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:24='bigint',<235>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToBooleanTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:25='boolean',<209>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:25='boolean',<209>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToDateTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:22='date',<253>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:22='date',<253>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToTimestampTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:27='timestamp',<257>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:27='timestamp',<257>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToTextTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:22='text',<262>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:22='text',<262>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToCharNoLengthTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:22='char',<247>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:22='char',<247>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToVarcharWithLengthTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@6,29:29=')',<287>,1:29]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@6,29:29=')',<287>,1:29]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToCharWithLengthTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@6,26:26=')',<287>,1:26]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@6,26:26=')',<287>,1:26]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToNumericNoParamsTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:25='numeric',<245>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:25='numeric',<245>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToFloatNoParamsTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:23='float',<243>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:23='float',<243>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToNumericWithPrecisionAndScaleTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@8,31:31=')',<287>,1:31]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@8,31:31=')',<287>,1:31]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToVariantSnowflakeTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:25='variant',<269>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:25='variant',<269>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToTimestampNtzSnowflakeTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:31='timestamp_ntz',<259>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:31='timestamp_ntz',<259>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToTimestampTzSnowflakeTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:30='timestamp_tz',<260>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:30='timestamp_tz',<260>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastToTimestampLtzSnowflakeTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@3,19:31='timestamp_ltz',<258>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@3,19:31='timestamp_ltz',<258>,1:19]]}, table_dictionary={tab1={columnName=[[@1,7:16='columnName',<373>,1:7]]}}, interface={unnamed_0=[{name=columnName, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inlineCastOnFormulaInWherePredicateTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@6,26:26='a',<373>,1:26]], b=[[@8,30:30='b',<373>,1:30]], *=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={*=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={tab1={a=[[@6,26:26='a',<373>,1:26]], b=[[@8,30:30='b',<373>,1:30]], *=[[@1,7:7='*',<290>,1:7]]}}, filters=[{name=a, table_ref=tab1}, {name=b, table_ref=tab1}], interface={*=[{name=*, table_ref=*}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListCasting2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={col2=[[@11,37:40='col2',<373>,1:37]], col3=[[@22,65:68='col3',<373>,1:65]], col1=[[@3,13:16='col1',<373>,1:13]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,30:30='a',<373>,1:30]], b=[[@18,57:57='b',<373>,1:57]], c=[[@32,90:90='c',<373>,1:90]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,30:30='a',<373>,1:30]], b=[[@18,57:57='b',<373>,1:57]], c=[[@32,90:90='c',<373>,1:90]]}, table_dictionary={tab1={col2=[[@11,37:40='col2',<373>,1:37]], col3=[[@22,65:68='col3',<373>,1:65]], col1=[[@3,13:16='col1',<373>,1:13]]}}, interface={a=[{name=col1, table_ref=tab1}], b=[{name=col2, table_ref=tab1}], c=[{name=col3, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListTryCasting2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={col2=[[@11,41:44='col2',<373>,1:41]], col3=[[@22,69:72='col3',<373>,1:69]], col1=[[@3,17:20='col1',<373>,1:17]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,34:34='a',<373>,1:34]], b=[[@18,61:61='b',<373>,1:61]], c=[[@32,94:94='c',<373>,1:94]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,34:34='a',<373>,1:34]], b=[[@18,61:61='b',<373>,1:61]], c=[[@32,94:94='c',<373>,1:94]]}, table_dictionary={tab1={col2=[[@11,41:44='col2',<373>,1:41]], col3=[[@22,69:72='col3',<373>,1:69]], col1=[[@3,17:20='col1',<373>,1:17]]}}, interface={a=[{name=col1, table_ref=tab1}], b=[{name=col2, table_ref=tab1}], c=[{name=col3, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsWhereConditionTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[[@1,8:11='colu',<373>,1:8]], cola=[[@7,34:37='cola',<373>,1:34]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={colu=[[@1,8:11='colu',<373>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={colu=[[@1,8:11='colu',<373>,1:8]]}, table_dictionary={tab1={colu=[[@1,8:11='colu',<373>,1:8]], cola=[[@7,34:37='cola',<373>,1:34]]}}, filters=[{name=cola, table_ref=tab1}], interface={colu=[{name=colu, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsCalculationTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[[@1,8:11='colu',<373>,1:8]], cola=[[@5,20:23='cola',<373>,1:20]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@11,39:39=')',<287>,1:39]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={unnamed_0=[[@11,39:39=')',<287>,1:39]]}, table_dictionary={tab1={colu=[[@1,8:11='colu',<373>,1:8]], cola=[[@5,20:23='cola',<373>,1:20]]}}, interface={unnamed_0=[{name=colu, table_ref=tab1}, {name=cola, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsJoinConditionTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[[@1,8:11='tab1',<373>,1:8]], cola=[[@9,41:44='tab1',<373>,1:41]]}, tab2={cola=[[@15,58:61='tab2',<373>,1:58]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={colu=[[@3,13:16='colu',<373>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={colu=[[@3,13:16='colu',<373>,1:13]]}, table_dictionary={tab1={colu=[[@1,8:11='tab1',<373>,1:8]], cola=[[@9,41:44='tab1',<373>,1:41]]}, tab2={cola=[[@15,58:61='tab2',<373>,1:58]]}}, filters=[{name=cola, table_ref=tab1}, {name=cola, table_ref=tab2}], interface={colu=[{name=colu, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsGroupByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={cola=[[@3,13:16='cola',<373>,1:13], [@13,42:45='cola',<373>,1:42], [@25,86:89='cola',<373>,1:86]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,30:30='a',<373>,1:30]], b=[[@18,60:60='b',<373>,1:60]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,30:30='a',<373>,1:30]], b=[[@18,60:60='b',<373>,1:60]]}, table_dictionary={tab1={cola=[[@3,13:16='cola',<373>,1:13], [@13,42:45='cola',<373>,1:42], [@25,86:89='cola',<373>,1:86]]}}, grouped_by=[{name=cola, table_ref=tab1}], interface={a=[{name=cola, table_ref=tab1}], b=[{name=cola, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[[@1,8:8='a',<373>,1:8]], b=[[@3,11:11='b',<373>,1:11]], cola=[[@10,37:40='cola',<373>,1:37]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@1,8:8='a',<373>,1:8]], b=[[@3,11:11='b',<373>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@1,8:8='a',<373>,1:8]], b=[[@3,11:11='b',<373>,1:11]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8]], b=[[@3,11:11='b',<373>,1:11]], cola=[[@10,37:40='cola',<373>,1:37]]}}, ordered_by=[{name=cola, table_ref=tab1}], interface={a=[{name=a, table_ref=tab1}], b=[{name=b, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCastingVariableTypesWithLengthsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={valid_from_dt=[[@61,227:239='valid_from_dt',<373>,1:227]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@11,44:44='a',<373>,1:44]], b=[[@20,79:79='b',<373>,1:79]], c=[[@32,120:120='c',<373>,1:120]], d=[[@43,166:166='d',<373>,1:166]], e=[[@57,219:219='e',<373>,1:219]], f=[[@69,265:265='f',<373>,1:265]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@11,44:44='a',<373>,1:44]], b=[[@20,79:79='b',<373>,1:79]], c=[[@32,120:120='c',<373>,1:120]], d=[[@43,166:166='d',<373>,1:166]], e=[[@57,219:219='e',<373>,1:219]], f=[[@69,265:265='f',<373>,1:265]]}, table_dictionary={tab1={valid_from_dt=[[@61,227:239='valid_from_dt',<373>,1:227]]}}, interface={a=[], b=[], c=[], d=[], e=[], f=[{name=valid_from_dt, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCastingPrecisionTypesTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,29:29='a',<373>,1:29]], b=[[@16,62:62='b',<373>,1:62]], c=[[@29,93:93='c',<373>,1:93]], d=[[@44,138:138='d',<373>,1:138]], e=[[@56,166:166='e',<373>,1:166]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,29:29='a',<373>,1:29]], b=[[@16,62:62='b',<373>,1:62]], c=[[@29,93:93='c',<373>,1:93]], d=[[@44,138:138='d',<373>,1:138]], e=[[@56,166:166='e',<373>,1:166]]}, table_dictionary={tab1={}}, interface={a=[], b=[], c=[], d=[], e=[]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCastingCompundStaticTypesTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,26:26='a',<373>,1:26]], b=[[@15,49:49='b',<373>,1:49]], c=[[@26,86:86='c',<373>,1:86]], d=[[@38,132:132='d',<373>,1:132]], e=[[@47,157:157='e',<373>,1:157]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,26:26='a',<373>,1:26]], b=[[@15,49:49='b',<373>,1:49]], c=[[@26,86:86='c',<373>,1:86]], d=[[@38,132:132='d',<373>,1:132]], e=[[@47,157:157='e',<373>,1:157]]}, table_dictionary={tab1={}}, interface={a=[], b=[], c=[], d=[], e=[]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nullCastingTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,29:29='a',<373>,1:29]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,29:29='a',<373>,1:29]]}, table_dictionary={tab1={}}, interface={a=[]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castingWithPredicandVariableTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@7,31:31='a',<373>,1:31]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@7,31:31='a',<373>,1:31]]}, table_dictionary={tab1={}}, interface={a=[{name=<var1>, type=predicand}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castingWithColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<var1>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<var1>=[[@3,13:16='tab1',<373>,1:13]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={a=[[@9,36:36='a',<373>,1:36]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={a=[[@9,36:36='a',<373>,1:36]]}, table_dictionary={tab1={<var1>=[[@3,13:16='tab1',<373>,1:13]]}}, interface={a=[{substitution={name=<var1>, type=column}, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
