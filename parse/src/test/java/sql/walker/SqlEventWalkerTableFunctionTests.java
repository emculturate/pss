...
public class SqlEventWalkerTableFunctionTests extends AbstractSqlParseEventWalkerTest {
	...
	public void inferSchemaTableFunctionFromListDoesNotUseQueryWrapperTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{infer_schema0={*=[[@1,7:7='s',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@3,9:9='*',<291>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@3,9:9='*',<291>,1:9]]}, table_dictionary={infer_schema0={*=[[@1,7:7='s',<393>,1:7]]}}, interface={*=[{name=*, table_ref=s}]}, table_alias={s=infer_schema0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleTfCallFlattenIndexValueV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{flatten0={index=[[@1,7:7='f',<393>,1:7]], value=[[@5,16:16='f',<393>,1:16]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={index=[[@3,9:13='index',<96>,1:9]], value=[[@7,18:22='value',<393>,1:18]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={index=[[@3,9:13='index',<96>,1:9]], value=[[@7,18:22='value',<393>,1:18]]}, table_dictionary={flatten0={index=[[@1,7:7='f',<393>,1:7]], value=[[@5,16:16='f',<393>,1:16]]}}, interface={index=[{name=index, table_ref=f}], value=[{name=value, table_ref=f}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleTfCallFlattenKeyValueV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{flatten0={value=[[@5,14:14='f',<393>,1:14]], key=[[@1,7:7='f',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@7,16:20='value',<393>,1:16]], key=[[@3,9:11='key',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={value=[[@7,16:20='value',<393>,1:16]], key=[[@3,9:11='key',<393>,1:9]]}, table_dictionary={flatten0={value=[[@5,14:14='f',<393>,1:14]], key=[[@1,7:7='f',<393>,1:7]]}}, interface={value=[{name=value, table_ref=f}], key=[{name=key, table_ref=f}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleTfCallSplitToTableV4WithWhereReferenceTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{table_function0={index=[[@20,74:75='tf',<393>,1:74]], value=[[@5,15:16='tf',<393>,1:15]], seq=[[@1,7:8='tf',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@7,18:22='value',<393>,1:18]], seq=[[@3,10:12='seq',<393>,1:10]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={value=[[@7,18:22='value',<393>,1:18]], seq=[[@3,10:12='seq',<393>,1:10]]}, table_dictionary={table_function0={index=[[@20,74:75='tf',<393>,1:74]], value=[[@5,15:16='tf',<393>,1:15]], seq=[[@1,7:8='tf',<393>,1:7]]}}, filters=[{name=index, table_ref=tf}], interface={value=[{name=value, table_ref=tf}], seq=[{name=seq, table_ref=tf}]}, table_alias={tf=table_function0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleTfCallFlattenSplitV5Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{flatten0={value=[[@1,7:11='value',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@1,7:11='value',<393>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={value=[[@1,7:11='value',<393>,1:7]]}, table_dictionary={flatten0={value=[[@1,7:11='value',<393>,1:7]]}}, interface={value=[{name=value, table_ref=null}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfFromBaseTableLateralFlattenV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{my_table={id=[[@1,7:7='t',<393>,1:7]], items=[[@19,71:71='t',<393>,1:71]]}, flatten0={value=[[@5,13:13='f',<393>,1:13]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={item=[[@9,24:27='item',<393>,1:24]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={item=[[@9,24:27='item',<393>,1:24]], id=[[@3,9:10='id',<393>,1:9]]}, table_dictionary={my_table={id=[[@1,7:7='t',<393>,1:7]], items=[[@19,71:71='t',<393>,1:71]]}, flatten0={value=[[@5,13:13='f',<393>,1:13]]}}, interface={item=[{name=value, table_ref=f}], id=[{name=id, table_ref=t}]}, table_alias={t=my_table, f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfFromBaseTableFlattenNoLateralV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{my_table={id=[[@1,7:7='t',<393>,1:7]], items=[[@18,63:63='t',<393>,1:63]]}, flatten0={value=[[@5,13:13='f',<393>,1:13]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={item=[[@9,24:27='item',<393>,1:24]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={item=[[@9,24:27='item',<393>,1:24]], id=[[@3,9:10='id',<393>,1:9]]}, table_dictionary={my_table={id=[[@1,7:7='t',<393>,1:7]], items=[[@18,63:63='t',<393>,1:63]]}, flatten0={value=[[@5,13:13='f',<393>,1:13]]}}, interface={item=[{name=value, table_ref=f}], id=[{name=id, table_ref=t}]}, table_alias={t=my_table, f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfFromBaseTableLateralFlattenOuterV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={*=[[@1,7:7='*',<291>,1:7]], items=[[@10,42:42='t',<393>,1:42]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t={*=[[@1,7:7='*',<291>,1:7]], items=[[@10,42:42='t',<393>,1:42]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void fieldExtractionFlatJsonLateralFlattenV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{my_table={obj_col=[[@17,64:64='t',<393>,1:64]]}, flatten0={value=[[@5,14:14='f',<393>,1:14]], key=[[@1,7:7='f',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@7,16:20='value',<393>,1:16]], key=[[@3,9:11='key',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={value=[[@7,16:20='value',<393>,1:16]], key=[[@3,9:11='key',<393>,1:9]]}, table_dictionary={my_table={obj_col=[[@17,64:64='t',<393>,1:64]]}, flatten0={value=[[@5,14:14='f',<393>,1:14]], key=[[@1,7:7='f',<393>,1:7]]}}, interface={value=[{name=value, table_ref=f}], key=[{name=key, table_ref=f}]}, table_alias={t=my_table, f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void chainedLateralTfDoubleNestedV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{my_table={orders=[[@21,86:86='t',<393>,1:86]]}, flatten1={value=[[@7,25:25='p',<393>,1:25]]}, flatten0={id=[[@1,7:7='o',<393>,1:7]], value=[[@32,124:124='o',<393>,1:124]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={order_id=[[@5,15:22='order_id',<393>,1:15]], product=[[@11,36:42='product',<393>,1:36]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={product=[[@11,36:42='product',<393>,1:36]], order_id=[[@5,15:22='order_id',<393>,1:15]]}, table_dictionary={my_table={orders=[[@21,86:86='t',<393>,1:86]]}, flatten1={value=[[@7,25:25='p',<393>,1:25]]}, flatten0={id=[[@1,7:7='o',<393>,1:7]], value=[[@32,124:124='o',<393>,1:124]]}}, interface={product=[{name=value, table_ref=p}], order_id=[{name=id, table_ref=o}]}, table_alias={p=flatten1, t=my_table, o=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void chainedLateralTfOrderItemsV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={orders=[[@20,71:71='t',<393>,1:71]]}, flatten1={sku=[[@7,25:25='i',<393>,1:25]]}, flatten0={id=[[@1,7:7='o',<393>,1:7]], value=[[@31,109:109='o',<393>,1:109]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={sku=[[@11,34:36='sku',<393>,1:34]], order_id=[[@5,15:22='order_id',<393>,1:15]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={sku=[[@11,34:36='sku',<393>,1:34]], order_id=[[@5,15:22='order_id',<393>,1:15]]}, table_dictionary={t={orders=[[@20,71:71='t',<393>,1:71]]}, flatten1={sku=[[@7,25:25='i',<393>,1:25]]}, flatten0={id=[[@1,7:7='o',<393>,1:7]], value=[[@31,109:109='o',<393>,1:109]]}}, interface={sku=[{name=sku, table_ref=i}], order_id=[{name=id, table_ref=o}]}, table_alias={i=flatten1, o=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void chainedLateralTfWildcardBothV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={a=[[@16,49:49='t',<393>,1:49]]}, flatten1={*=[[@5,12:12='e',<393>,1:12]]}, flatten0={*=[[@1,7:7='f',<393>,1:7]], value=[[@27,82:82='f',<393>,1:82]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@3,9:9='*',<291>,1:9], [@7,14:14='*',<291>,1:14]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@3,9:9='*',<291>,1:9], [@7,14:14='*',<291>,1:14]]}, table_dictionary={t={a=[[@16,49:49='t',<393>,1:49]]}, flatten1={*=[[@5,12:12='e',<393>,1:12]]}, flatten0={*=[[@1,7:7='f',<393>,1:7]], value=[[@27,82:82='f',<393>,1:82]]}}, interface={*=[{name=*, table_ref=e}]}, table_alias={e=flatten1, f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void snowflakeColonNotationSelectPathV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={orders=[[@16,63:63='t',<393>,1:63]]}, flatten0={value=[[@1,7:7='o',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={order_id=[[@7,21:28='order_id',<393>,1:21]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={order_id=[[@7,21:28='order_id',<393>,1:21]]}, table_dictionary={t={orders=[[@16,63:63='t',<393>,1:63]]}, flatten0={value=[[@1,7:7='o',<393>,1:7]]}}, interface={order_id=[{name=value, json_path=id, table_ref=o}]}, table_alias={o=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void snowflakeColonNotationNestedFlattenInputV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={orders=[[@16,59:59='t',<393>,1:59]]}, flatten1={value=[[@1,7:7='i',<393>,1:7]]}, flatten0={value=[[@27,97:97='o',<393>,1:97]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={sku=[[@7,22:24='sku',<393>,1:22]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={sku=[[@7,22:24='sku',<393>,1:22]]}, table_dictionary={t={orders=[[@16,59:59='t',<393>,1:59]]}, flatten1={value=[[@1,7:7='i',<393>,1:7]]}, flatten0={value=[[@27,97:97='o',<393>,1:97]]}}, interface={sku=[{name=value, json_path=sku, table_ref=i}]}, table_alias={i=flatten1, o=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void snowflakeColonNotationJoinOnPathV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={json_col=[[@16,58:58='t',<393>,1:58]], id=[[@1,7:7='t',<393>,1:7], [@28,88:88='t',<393>,1:88]]}, flatten0={value=[[@5,13:13='f',<393>,1:13], [@22,75:75='f',<393>,1:75]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@7,15:19='value',<393>,1:15]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={id=[[@3,9:10='id',<393>,1:9]], value=[[@7,15:19='value',<393>,1:15]]}, table_dictionary={t={json_col=[[@16,58:58='t',<393>,1:58]], id=[[@1,7:7='t',<393>,1:7], [@28,88:88='t',<393>,1:88]]}, flatten0={value=[[@5,13:13='f',<393>,1:13], [@22,75:75='f',<393>,1:75]]}}, filters=[{name=value, json_path=id, table_ref=f}, {name=id, table_ref=t}], interface={id=[{name=id, table_ref=t}], value=[{name=value, table_ref=f}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfMixedJoinCrossLateralProductsV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{orders={id=[[@1,7:7='o',<393>,1:7]], items=[[@24,84:84='o',<393>,1:84]]}, flatten0={sku=[[@5,13:13='f',<393>,1:13], [@37,122:122='f',<393>,1:122]]}, products={name=[[@11,27:27='p',<393>,1:27]], sku=[[@33,114:114='p',<393>,1:114]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={name=[[@13,29:32='name',<225>,1:29]], sku=[[@9,22:24='sku',<393>,1:22]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={name=[[@13,29:32='name',<225>,1:29]], id=[[@3,9:10='id',<393>,1:9]], sku=[[@9,22:24='sku',<393>,1:22]]}, table_dictionary={orders={id=[[@1,7:7='o',<393>,1:7]], items=[[@24,84:84='o',<393>,1:84]]}, flatten0={sku=[[@5,13:13='f',<393>,1:13], [@37,122:122='f',<393>,1:122]]}, products={name=[[@11,27:27='p',<393>,1:27]], sku=[[@33,114:114='p',<393>,1:114]]}}, filters=[{name=sku, table_ref=p}, {name=sku, table_ref=f}], interface={name=[{name=name, table_ref=p}], id=[{name=id, table_ref=o}], sku=[{name=sku, table_ref=f}]}, table_alias={p=products, f=flatten0, o=orders}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfMixedJoinInnerLateralOnCondV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={json_col=[[@16,58:58='t',<393>,1:58]], id=[[@1,7:7='t',<393>,1:7], [@26,82:82='t',<393>,1:82]]}, flatten0={id=[[@22,75:75='f',<393>,1:75]], value=[[@5,13:13='f',<393>,1:13]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={value=[[@7,15:19='value',<393>,1:15]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={id=[[@3,9:10='id',<393>,1:9]], value=[[@7,15:19='value',<393>,1:15]]}, table_dictionary={t={json_col=[[@16,58:58='t',<393>,1:58]], id=[[@1,7:7='t',<393>,1:7], [@26,82:82='t',<393>,1:82]]}, flatten0={id=[[@22,75:75='f',<393>,1:75]], value=[[@5,13:13='f',<393>,1:13]]}}, filters=[{name=id, table_ref=f}, {name=id, table_ref=t}], interface={id=[{name=id, table_ref=t}], value=[{name=value, table_ref=f}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfMixedJoinBigTableDimV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{big_table={*=[[@1,7:7='*',<291>,1:7]], items=[[@12,62:62='t',<393>,1:62]]}, dim={*=[[@1,7:7='*',<291>,1:7]], id=[[@21,87:87='d',<393>,1:87]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]], id=[[@25,94:94='f',<393>,1:94]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={big_table={*=[[@1,7:7='*',<291>,1:7]], items=[[@12,62:62='t',<393>,1:62]]}, dim={*=[[@1,7:7='*',<291>,1:7]], id=[[@21,87:87='d',<393>,1:87]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]], id=[[@25,94:94='f',<393>,1:94]]}}, filters=[{name=id, table_ref=d}, {name=id, table_ref=f}], interface={*=[{name=*, table_ref=*}]}, table_alias={t=big_table, d=dim, f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tfInDmlCtasUpdateFlattenV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={col=[[@3,13:15='col',<393>,1:13]], json_col=[[@15,55:55='t',<393>,1:55]], id=[[@22,76:76='t',<393>,1:76]]}, flatten0={value=[[@5,19:19='f',<393>,1:19]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{update0={col=[[@3,13:15='col',<393>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_update0={assignments={col=[{name=value, table_ref=f}]}, table_dictionary={t={json_col=[[@15,55:55='t',<393>,1:55]], col=[[@3,13:15='col',<393>,1:13]], id=[[@22,76:76='t',<393>,1:76]]}, flatten0={value=[[@5,19:19='f',<393>,1:19]]}}, update_dictionary={col=[[@3,13:15='col',<393>,1:13]]}, filters=[{name=id, table_ref=t}], table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void otherTfExampleSplitToTableCommaV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
		 "{t={csv_col=[[@9,38:38='t',<393>,1:38]], *=[[@1,7:7='*',<291>,1:7]]}, table_function0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
		 "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
		"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t={csv_col=[[@9,38:38='t',<393>,1:38]], *=[[@1,7:7='*',<291>,1:7]]}, table_function0={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={s=table_function0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void otherTfExampleLateralUdtfV3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={col=[[@11,49:49='t',<393>,1:49]], *=[[@1,7:7='*',<291>,1:7]]}, table_function0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t={col=[[@11,49:49='t',<393>,1:49]], *=[[@1,7:7='*',<291>,1:7]]}, table_function0={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={u=table_function0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lateralCorrelatedSubquerySimpleV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}, query1={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}, table_dictionary={t={id=[[@1,7:7='t',<393>,1:7], [@14,43:43='t',<393>,1:43]]}}, def_query0={query_dictionary={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}, table_dictionary={t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}, interface={x=[{name=id, table_ref=t}]}}, interface={x=[{name=x, table_ref=sub}], id=[{name=id, table_ref=t}]}, table_alias={sub=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void explicitJoinFormCrossLateralFlattenV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={col=[[@11,52:52='t',<393>,1:52]], *=[[@1,7:7='*',<291>,1:7]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t={col=[[@11,52:52='t',<393>,1:52]], *=[[@1,7:7='*',<291>,1:7]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void explicitJoinFormLeftLateralFlattenV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{t={*=[[@1,7:7='*',<291>,1:7]], items=[[@11,51:51='t',<393>,1:51]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<291>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={t={*=[[@1,7:7='*',<291>,1:7]], items=[[@11,51:51='t',<393>,1:51]]}, flatten0={*=[[@1,7:7='*',<291>,1:7]]}}, filters=[], interface={*=[{name=*, table_ref=*}]}, table_alias={f=flatten0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lateralCorrelatedSubqueryNestedUnionV5Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={v=[[@18,50:50='v',<393>,1:50]]}, query4={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}, query0={v=[[@26,75:75='v',<393>,1:75]]}, query1={v=[[@32,99:99='v',<393>,1:99]]}, query3={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query4={query_dictionary={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}, table_dictionary={t={id=[[@1,7:7='t',<393>,1:7], [@14,43:43='t',<393>,1:43]]}}, interface={x=[{name=x, table_ref=sub}], id=[{name=id, table_ref=t}]}, def_query3={def_union2={query_dictionary={v=[[@18,50:50='v',<393>,1:50]]}, def_query1={query_dictionary={v=[[@32,99:99='v',<393>,1:99]]}, setop=UNION, interface={v=[]}}, def_query0={query_dictionary={v=[[@26,75:75='v',<393>,1:75]]}, interface={v=[]}}, interface={v=query_column}}, query_dictionary={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}, table_dictionary={t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}, interface={x=[{name=id, table_ref=t}, {name=v, table_ref=union2}]}, table_alias={union2=union2}}, table_alias={sub=query3}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lateralCorrelatedSubqueryNestedExceptV5Test(){
		...
		Assert.assertEquals("Table Dictionary is wrong", "{t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{union2={v=[[@18,50:50='v',<393>,1:50]]}, query4={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}, query0={v=[[@26,75:75='v',<393>,1:75]]}, query1={v=[[@31,96:96='v',<393>,1:96]]}, query3={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query4={query_dictionary={x=[[@7,17:17='x',<393>,1:17]], id=[[@3,9:10='id',<393>,1:9]]}, table_dictionary={t={id=[[@1,7:7='t',<393>,1:7], [@14,43:43='t',<393>,1:43]]}}, interface={x=[{name=x, table_ref=sub}], id=[{name=id, table_ref=t}]}, def_query3={def_union2={query_dictionary={v=[[@18,50:50='v',<393>,1:50]]}, def_query1={query_dictionary={v=[[@31,96:96='v',<393>,1:96]]}, setop=EXCEPT, interface={v=[]}}, def_query0={query_dictionary={v=[[@26,75:75='v',<393>,1:75]]}, interface={v=[]}}, interface={v=query_column}}, query_dictionary={x=[[@20,55:55='x',<393>,1:55], [@5,13:15='sub',<393>,1:13]]}, table_dictionary={t={id=[[@14,43:43='t',<393>,1:43], [@1,7:7='t',<393>,1:7]]}}, interface={x=[{name=id, table_ref=t}, {name=v, table_ref=union2}]}, table_alias={union2=union2}}, table_alias={sub=query3}}}",
				extractor.getSymbolTable().toString());
	}
