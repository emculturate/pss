...
public class SqlEventWalkerTableFunctionTests extends AbstractSqlParseEventWalkerTest {
	...
	public void lateralCorrelatedSubqueryNestedUnionV5Test() {
		...
		Assert.assertEquals("AST is wrong",
				...
				extractor.getAsTree().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query4={query_dictionary={x=[[@7,17:17='x',<381>,1:17]], id=[[@3,9:10='id',<381>,1:9]]}, table_dictionary={t={id=[[@1,7:7='t',<381>,1:7], [@14,43:43='t',<381>,1:43], [@14,43:43='t',<381>,1:43], [@14,43:43='t',<381>,1:43]]}}, interface={x=[{name=x, table_ref=sub}], id=[{name=id, table_ref=t}]}, def_query3={def_union2={def_query1={query_dictionary={v=[[@32,99:99='v',<381>,1:99]]}, interface={v=[]}}, def_query0={query_dictionary={v=[[@26,75:75='v',<381>,1:75]]}, interface={v=[]}}, interface={v=[]}}, query_dictionary={x=[[@20,55:55='x',<381>,1:55]]}, interface={x=[{name=id, table_ref=t}, {name=v, table_ref=union2}]}, table_alias={union2=union2}}, table_alias={sub=query3}}}",
				extractor.getSymbolTable().toString());
	}
