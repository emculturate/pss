...
public class SqlEventWalkerJoinsAndTableResolutionTests extends AbstractSqlParseEventWalkerTest {
	...
	public void joinUsingTwoColumnsRightSubquerySourceV5Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{third={a=[[@1,7:7='a',<391>,1:7]], b=[[@7,18:18='a',<391>,1:18]], value=[[@42,126:130='value',<391>,3:1]], seq=[[@40,119:121='seq',<391>,2:57]]}, table_function0={value=[[@19,42:42='b',<391>,1:42]], seq=[[@13,29:29='b',<391>,1:29]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={da=[[@17,38:39='da',<391>,1:38]], ca=[[@5,14:15='ca',<391>,1:14]], db=[[@23,53:54='db',<391>,1:53]], cb=[[@11,25:26='cb',<391>,1:25]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={query_dictionary={da=[[@17,38:39='da',<391>,1:38]], ca=[[@5,14:15='ca',<391>,1:14]], db=[[@23,53:54='db',<391>,1:53]], cb=[[@11,25:26='cb',<391>,1:25]]}, table_dictionary={third={a=[[@1,7:7='a',<391>,1:7]], b=[[@7,18:18='a',<391>,1:18]], value=[[@42,126:130='value',<391>,3:1]], seq=[[@40,119:121='seq',<391>,2:57]]}, table_function0={value=[[@19,42:42='b',<391>,1:42]], seq=[[@13,29:29='b',<391>,1:29]]}}, filters=[{name=seq, table_ref=a}, {name=value, table_ref=a}], interface={da=[{name=seq, table_ref=b}], ca=[{name=a, table_ref=a}], db=[{name=value, table_ref=b}], cb=[{name=b, table_ref=a}]}, table_alias={a=third, b=table_function0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void joinUsingSingleColumnSubqueryOperandsV5Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{third={a=[[@25,65:65='a',<391>,2:9]], d=[[@27,68:68='d',<391>,2:12]]}, table_function0={value=[[@17,36:36='y',<391>,1:36]], seq=[[@11,23:23='y',<391>,1:23]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={d=[[@9,20:20='d',<391>,1:20]], ya=[[@15,32:33='ya',<391>,1:32]], xa=[[@5,14:15='xa',<391>,1:14]], ye=[[@21,47:48='ye',<391>,1:47]]}, table_dictionary={table_function0={value=[[@17,36:36='y',<391>,1:36]], seq=[[@11,23:23='y',<391>,1:23]]}}, def_query0={query_dictionary={a=[[@25,65:65='a',<391>,2:9], [@1,7:7='x',<391>,1:7], [@45,136:136='a',<391>,3:46]], d=[[@27,68:68='d',<391>,2:12], [@7,18:18='x',<391>,1:18]]}, table_dictionary={third={a=[[@25,65:65='a',<391>,2:9]], d=[[@27,68:68='d',<391>,2:12]]}}, interface={a=[{name=a, table_ref=third}], d=[{name=d, table_ref=third}]}}, filters=[{name=a, table_ref=x}], interface={d=[{name=d, table_ref=x}], ya=[{name=seq, table_ref=y}], xa=[{name=a, table_ref=x}], ye=[{name=value, table_ref=y}]}, table_alias={x=query0, y=table_function0}}}",
				extractor.getSymbolTable().toString());
	}
