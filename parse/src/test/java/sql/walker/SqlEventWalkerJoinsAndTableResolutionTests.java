...
public class SqlEventWalkerJoinsAndTableResolutionTests extends AbstractSqlParseEventWalkerTest {
	...
	public void variation4_2ColumnVariableTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={banana=[[@11,57:62='banana',<381>,3:16]], apple=[[@9,50:54='apple',<381>,3:9], [@5,28:32='apple',<381>,2:9]]}, query1={apple=[[@5,28:32='apple',<381>,2:9], [@31,140:140='a',<381>,5:14]]}, query2={apple=[[@1,7:11='apple',<381>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query2={query_dictionary={apple=[[@1,7:11='apple',<381>,1:7]]}, table_dictionary={tab2={apple=[[@35,150:153='tab2',<381>,5:24], [@1,7:11='apple',<381>,1:7]], <middle>=[[@23,109:112='tab2',<381>,4:7]], <other>=[[@15,80:83='tab2',<381>,3:39]]}}, def_query1={query_dictionary={apple=[[@5,28:32='apple',<381>,2:9], [@31,140:140='a',<381>,5:14]]}, def_query0={query_dictionary={banana=[[@11,57:62='banana',<381>,3:16]], apple=[[@9,50:54='apple',<381>,3:9], [@5,28:32='apple',<381>,2:9]]}, table_dictionary={tab1={banana=[[@11,57:62='banana',<381>,3:16]], apple=[[@9,50:54='apple',<381>,3:9]]}}, filters=[{substitution={name=<other>, type=column}, table_ref=tab2}], interface={banana=[{name=banana, table_ref=tab1}], apple=[{name=apple, table_ref=tab1}]}}, filters=[{substitution={name=<middle>, type=column}, table_ref=tab2}], interface={apple=[{name=apple, table_ref=query0}]}, table_alias={b=query0}}, filters=[{name=apple, table_ref=a}, {name=apple, table_ref=tab2}], interface={apple=[{name=apple, table_ref=null}]}, table_alias={a=query1}}}",
				extractor.getSymbolTable().toString());
