...
public class SqlEventWalkerBareValueExpressionTests extends AbstractSqlParseEventWalkerTest {
	...
	public void bareValueExpressionSubqueryFromAllClausesV0Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={CURRENT_TIMESTAMP=[[@34,153:169='CURRENT_TIMESTAMP',<393>,1:153]], rn=[[@32,149:150='rn',<393>,1:149], [@7,36:38='sub',<393>,1:36]], outer_col=[[@17,67:75='outer_col',<393>,1:67], [@1,7:9='sub',<393>,1:7], [@74,357:359='sub',<393>,1:357]]}, query1={CURRENT_DATE=[[@5,22:33='CURRENT_DATE',<393>,1:22]], rn=[[@9,40:41='rn',<393>,1:40]], outer_col=[[@3,11:19='outer_col',<393>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
