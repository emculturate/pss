...
// COMPLEX DML SUBSTITUTION TESTS (generated — review before commit)
	...
	public void updateComplexSubstitutionU3WithCteIntersectOrderBySubstitution() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update3={context_list={b=intersect2, base=intersect2}, assignments={score=[{name=score_val, table_ref=b}]}, table_dictionary={employees={score=[[@48,320:324='score',<381>,11:4]], emp_id=[[@57,358:358='e',<381>,13:6]]}}, def_intersect2={query0={query_dictionary={score_val=[[@13,62:70='score_val',<381>,2:47]], emp_id=[[@7,26:31='emp_id',<381>,2:11]]}, table_dictionary={<[Ops Data].[Account Ledger U3]>={<update select col U3>=[[@9,34:34='a',<381>,2:19]], emp_id=[[@5,24:24='a',<381>,2:9]], <update where col U3>=[[@18,122:122='a',<381>,4:8]]}}, filters=[{substitution={name=<update where col U3>, type=column}, table_ref=a}], interface={score_val=[{substitution={name=<update select col U3>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Ops Data].[Account Ledger U3]>}}, interface={score_val=[{table_ref=a, substitution={name=<update select col U3>, type=column}}, {table_ref=b, substitution={name=<update select col U3>, type=column}}], emp_id=[{name=emp_id, table_ref=a}, {name=emp_id, table_ref=b}]}, query1={query_dictionary={score_val=[[@33,209:217='score_val',<381>,6:47]], emp_id=[[@27,173:178='emp_id',<381>,6:11]]}, table_dictionary={<[Ops Data].[Audit Ledger U3]>={<update select col U3>=[[@29,181:181='b',<381>,6:19]], emp_id=[[@25,171:171='b',<381>,6:9]], <update where col U3>=[[@38,267:267='b',<381>,8:8]]}}, filters=[{substitution={name=<update where col U3>, type=column}, table_ref=b}], interface={score_val=[{substitution={name=<update select col U3>, type=column}, table_ref=b}], emp_id=[{name=emp_id, table_ref=b}]}, table_alias={b=<[Ops Data].[Audit Ledger U3]>}}}, update_dictionary={score=[[@48,320:324='score',<381>,11:4]]}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=b}], table_alias={base=intersect2}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void updateComplexSubstitutionU4NestedWithInCteBody() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<update select col U4>=column, <update where col U4>=column, <[Finance].[Revenue Feed U4]>=tuple}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{employees={score=[[@44,261:265='score',<381>,11:4]], emp_id=[[@53,305:305='e',<381>,13:6]]}, <[Finance].[Revenue Feed U4]>={<update select col U4>=[[@13,63:63='a',<381>,3:21]], <update where col U4>=[[@22,153:153='a',<381>,5:10]], emp_id=[[@9,53:53='a',<381>,3:11], [@29,194:194='i',<381>,7:9]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update2={context_list={o=query1, outer_cte=query1}, assignments={score=[{name=metric_val, table_ref=o}]}, table_dictionary={employees={score=[[@44,261:265='score',<381>,11:4]], emp_id=[[@53,305:305='e',<381>,13:6]]}}, update_dictionary={score=[[@44,261:265='score',<381>,11:4]]}, def_query1={context_list={inner_cte=query0, i=query0}, query_dictionary={metric_val=[[@35,206:215='metric_val',<381>,7:21]], emp_id=[[@31,196:201='emp_id',<381>,7:11], [@57,316:316='o',<381>,13:17]]}, def_query0={query_dictionary={metric_val=[[@17,91:100='metric_val',<381>,3:49], [@33,204:204='i',<381>,7:19]], emp_id=[[@11,55:60='emp_id',<381>,3:13], [@29,194:194='i',<381>,7:9]]}, table_dictionary={<[Finance].[Revenue Feed U4]>={<update select col U4>=[[@13,63:63='a',<381>,3:21]], <update where col U4>=[[@22,153:153='a',<381>,5:10]], emp_id=[[@9,53:53='a',<381>,3:11], [@29,194:194='i',<381>,7:9]]}}, filters=[{substitution={name=<update where col U4>, type=column}, table_ref=a}], interface={metric_val=[{substitution={name=<update select col U4>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Finance].[Revenue Feed U4]>}}, interface={metric_val=[{name=metric_val, table_ref=i}], emp_id=[{name=emp_id, table_ref=i}]}, table_alias={inner_cte=query0}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=o}], table_alias={outer_cte=query1}}}",
				extractor.getSymbolTable().toString());
	}
