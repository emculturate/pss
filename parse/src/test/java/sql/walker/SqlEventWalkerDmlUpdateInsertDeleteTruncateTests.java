...
public class SqlEventWalkerDmlUpdateInsertDeleteTruncateTests extends AbstractSqlParseEventWalkerTest {
	...
	*/
	...
	@Test
	public void insertSelectUnionOverTwoIntersectsWithExplicitTargetColumnsV19() {
		final String query = " insert into employees (score, rank_bucket)"
	...
	public void insertDictionaryHandlingGroupByHavingSubqueryAndUnqualifiedRhsV5() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{insert2={query_dictionary={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}, table_dictionary={employees={stale_flag=[[@6,35:44='stale_flag',<381>,1:35]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}}, def_query1={query_dictionary={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, def_query0={query_dictionary={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, table_dictionary={accounts={score=[[@23,114:114='a',<381>,3:28], [@40,207:207='a',<381>,6:18]], emp_id=[[@17,100:100='a',<381>,3:14], [@34,180:180='a',<381>,5:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, interface={total_score=[{name=total_score, table_ref=src}], orphan_marker=[{name=orphan_marker, table_ref=null}]}, table_alias={src=query0}}, interface={agg_score=[{name=total_score, table_ref=query1}], stale_flag=[{name=orphan_marker, table_ref=query1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void insertDictionaryHandlingQualifySubqueryAndUnqualifiedRhsV7() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{accounts={score=[[@21,110:110='a',<381>,3:24]], last_update=[[@37,183:183='a',<381>,4:64]], rn=[[@48,248:249='rn',<381>,6:14]], emp_id=[[@17,100:100='a',<381>,3:14], [@32,165:165='a',<381>,4:46]]}, employees={fallback_note=[[@6,35:47='fallback_note',<381>,1:35]], top_score=[[@4,24:32='top_score',<381>,1:24]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void insertDictionaryHandlingWhereInSubqueryWithOrphanRhsV8() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{insert2={query_dictionary={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}, table_dictionary={employees={stale_flag=[[@6,35:44='stale_flag',<381>,1:35]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}}, def_query1={query_dictionary={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, def_query0={query_dictionary={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, table_dictionary={accounts={score=[[@23,114:114='a',<381>,3:28], [@33,177:177='a',<381>,5:14]], emp_id=[[@17,100:100='a',<381>,3:14], [@40,206:206='a',<381>,6:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, interface={total_score=[{name=total_score, table_ref=src}], orphan_marker=[{name=orphan_marker, table_ref=null}]}, table_alias={src=query0}}, interface={agg_score=[{name=total_score, table_ref=query1}], stale_flag=[{name=orphan_marker, table_ref=query1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void insertDictionaryHandlingQualifyInSubqueryWithOrphanRhsV10() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{accounts={score=[[@21,104:104='a',<381>,3:24], [@37,177:177='a',<381>,4:64]], rn=[[@48,238:239='rn',<381>,6:16]], emp_id=[[@17,94:94='a',<381>,3:14], [@32,159:159='a',<381>,4:46]]}, employees={stale_flag=[[@6,35:44='stale_flag',<381>,1:35]], top_score=[[@4,24:32='top_score',<381>,1:24]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void simpleBasicUpdateTestV1() {
		...
		assertDiagnosticAtPosition(
				...
				"AMBIGUOUS_COLUMN_REFERENCE",
				ParseDiagnostic.Severity.SEVERE_WARNING,
				"Ambiguous column reference 'greener' at (l:1 c:78)",
				"greener",
				1,
				78);
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{update0={emp_sales_count=[[@6,25:39='emp_sales_count',<381>,1:25]], redder=[[@16,69:74='redder',<381>,1:69]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_update0={assignments={emp_sales_count=[{name=acct_sales_count, table_ref=a}], redder=[{name=greener, table_ref=null}]}, table_dictionary={accounts={acct_sales_count=[[@8,43:43='a',<381>,1:43]]}, employees={emp_sales_count=[[@4,23:23='e',<381>,1:23]], redder=[[@14,67:67='e',<381>,1:67]]}}, update_dictionary={emp_sales_count=[[@6,25:39='emp_sales_count',<381>,1:25]], redder=[[@16,69:74='redder',<381>,1:69]]}, table_alias={a=accounts, e=employees}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleBasicUpdateTestV2() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{that_table={key=[[@21,116:125='that_table',<381>,1:116]]}, this_table={outputC=[[@11,60:66='outputC',<381>,1:60]], outputA=[[@3,22:28='outputA',<381>,1:22]], outputB=[[@7,41:47='outputB',<381>,1:41]], key=[[@17,101:110='this_table',<381>,1:101]]}}",
				extractor.getTableColumnDictionaryMap().toString());
...
// DELETE TESTS
	...
	public void deleteUsingSiblingAliasReferenceInFirstUsingSubqueryMustFatalV0a() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{delete1={query_dictionary={}, table_dictionary={tab1={a1=[[@35,110:110='t',<381>,3:7]]}, tab2={a1=[[@39,117:117='b',<381>,3:14]]}}, def_query0={query_dictionary={a1=[[@9,37:38='a1',<381>,2:17]]}, table_dictionary={taba={a1=[[@7,35:35='a',<381>,2:15]], a2=[[@14,58:58='a',<381>,2:38]], extra=[[@22,74:74='a',<381>,2:54]]}}, unresolved_column={b.a2={column={name=a2, table_ref=b}, locations=[[@18,65:65='b',<381>,2:45]]}, t.extra={column={name=extra, table_ref=t}, locations=[[@26,84:84='t',<381>,2:64]]}}, filters=[{name=a2, table_ref=a}, {name=a2, table_ref=b}, {name=extra, table_ref=a}, {name=extra, table_ref=t}], interface={a1=[{name=a1, table_ref=a}]}, table_alias={a=tabA}}, filters=[{name=a1, table_ref=t}, {name=a1, table_ref=b}], interface=null, table_alias={b=tab2, t=tab1, u=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteUsingSiblingAliasReferenceInSecondUsingSubqueryMustFatalV0b() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{delete1={query_dictionary={}, table_dictionary={tab1={a1=[[@35,110:110='t',<381>,3:7]]}, tab2={a1=[[@39,117:117='b',<381>,3:14]]}}, def_query0={query_dictionary={a1=[[@12,45:46='a1',<381>,2:25]]}, table_dictionary={taba={a1=[[@10,43:43='a',<381>,2:23]], a2=[[@17,66:66='a',<381>,2:46]], extra=[[@25,82:82='a',<381>,2:62]]}}, unresolved_column={b.a2={column={name=a2, table_ref=b}, locations=[[@21,73:73='b',<381>,2:53]]}, t.extra={column={name=extra, table_ref=t}, locations=[[@29,92:92='t',<381>,2:72]]}}, filters=[{name=a2, table_ref=a}, {name=a2, table_ref=b}, {name=extra, table_ref=a}, {name=extra, table_ref=t}], interface={a1=[{name=a1, table_ref=a}]}, table_alias={a=tabA}}, filters=[{name=a1, table_ref=t}, {name=a1, table_ref=b}], interface=null, table_alias={b=tab2, t=tab1, u=query0}}}",
				extractor.getSymbolTable().toString());
	}
...
// COMPLEX DML SUBSTITUTION TESTS (generated — review before commit)
	...
	public void insertComplexSubstitutionI3WithCteIntersectOrderBySubstitution() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{insert6={context_list={branch_a=query0, branch_b=query1, base=intersect4}, query_dictionary={top_score=[[@76,474:482='top_score',<381>,16:23]], rank_bucket=[[@78,485:495='rank_bucket',<381>,16:34]]}, table_dictionary={employees={top_score=[[@76,474:482='top_score',<381>,16:23]], rank_bucket=[[@78,485:495='rank_bucket',<381>,16:34]]}}, def_intersect4={context_list={branch_a=query0, branch_b=query1}, interface={*=[{name=*, table_ref=*}, {name=*, table_ref=*}]}, table_alias={branch_a=query0, branch_b=query1}, query2={context_list={branch_a=query0, branch_b=query1}, query_dictionary={*=[[@63,396:396='*',<291>,12:9]]}, interface={*=[{name=*, table_ref=*}]}, table_alias={branch_a=query0, branch_b=query1}}, query3={context_list={branch_a=query0, branch_b=query1}, query_dictionary={*=[[@68,433:433='*',<291>,14:9]]}, interface={*=[{name=*, table_ref=*}]}, table_alias={branch_a=query0, branch_b=query1}}}, def_query1={context_list={branch_a=query0}, query_dictionary={*=[[@63,396:396='*',<291>,12:9]], score_val=[[@42,253:261='score_val',<381>,7:47]], emp_id=[[@36,217:222='emp_id',<381>,7:11]]}, table_dictionary={<[Ops Data].[Audit Ledger I3]>={<insert order col I3>=[[@54,350:350='b',<381>,10:11]], <insert where col I3>=[[@47,311:311='b',<381>,9:8]], <insert select col I3>=[[@38,225:225='b',<381>,7:19]], emp_id=[[@34,215:215='b',<381>,7:9]]}}, ordered_by=[{substitution={name=<insert order col I3>, type=column}, table_ref=b}], filters=[{substitution={name=<insert where col I3>, type=column}, table_ref=b}], interface={score_val=[{substitution={name=<insert select col I3>, type=column}, table_ref=b}], emp_id=[{name=emp_id, table_ref=b}]}, table_alias={b=<[Ops Data].[Audit Ledger I3]>, branch_a=query0}}, def_query0={query_dictionary={*=[[@63,396:396='*',<291>,12:9]], score_val=[[@13,66:74='score_val',<381>,2:47]], emp_id=[[@7,30:35='emp_id',<381>,2:11]]}, table_dictionary={<[Ops Data].[Account Ledger I3]>={<insert order col I3>=[[@25,165:165='a',<381>,5:11]], <insert where col I3>=[[@18,126:126='a',<381>,4:8]], <insert select col I3>=[[@9,38:38='a',<381>,2:19]], emp_id=[[@5,28:28='a',<381>,2:9]]}}, ordered_by=[{substitution={name=<insert order col I3>, type=column}, table_ref=a}], filters=[{substitution={name=<insert where col I3>, type=column}, table_ref=a}], interface={score_val=[{substitution={name=<insert select col I3>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Ops Data].[Account Ledger I3]>}}, def_query5={context_list={branch_a=query0, branch_b=query1, base=intersect4, b=intersect4}, query_dictionary={score_val=[[@83,507:515='score_val',<381>,17:9]], emp_id=[[@87,520:525='emp_id',<381>,17:22]]}, interface={score_val=[{name=score_val, table_ref=b}], emp_id=[{name=emp_id, table_ref=b}]}, table_alias={b=intersect4, branch_a=query0, branch_b=query1, base=intersect4}}, interface={top_score=[{name=score_val, table_ref=query5}], rank_bucket=[{name=emp_id, table_ref=query5}]}, table_alias={branch_a=query0, branch_b=query1, base=intersect4}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void insertComplexSubstitutionI6SubqueryJoinOnColumnSubstitution() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[Join Data].[Left Feed I6]>=tuple, <insert join col I6b>=column, <[Join Data].[Right Feed I6]>=tuple, <insert select col I6>=column, <insert where col I6>=column, <insert join col I6>=column}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{<[Join Data].[Left Feed I6]>={<insert select col I6>=[[@23,99:99='a',<381>,4:19]], <insert where col I6>=[[@43,279:279='a',<381>,8:8]], emp_id=[[@19,89:89='a',<381>,4:9]], <insert join col I6>=[[@35,222:222='a',<381>,7:7]]}, <insert join col I6b>={}, <[Join Data].[Right Feed I6]>={<insert join col I6b>=[[@39,247:247='b',<381>,7:32]]}, employees={score=[[@4,23:27='score',<381>,1:23]], rank_bucket=[[@6,30:40='rank_bucket',<381>,1:30]]}, <insert join col I6>={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
	...
	public void updateComplexSubstitutionU1WithCteGroupByHaving() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[HR Data].[Employee Accounts U1]>=tuple, <update group col U1>=column, <update where col U1>=column, <update select col U1>=column}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{<[HR Data].[Employee Accounts U1]>={<update group col U1>=[[@32,182:182='a',<381>,5:21]], <update where col U1>=[[@21,133:133='a',<381>,4:8]], <update select col U1>=[[@11,40:40='a',<381>,2:23], [@38,219:219='a',<381>,6:13]], emp_id=[[@5,26:26='a',<381>,2:9], [@28,172:172='a',<381>,5:11], [@62,326:326='s',<381>,10:17]]}, employees={score=[[@49,273:277='score',<381>,8:4]], emp_id=[[@58,315:315='e',<381>,10:6]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
	...
	public void updateComplexSubstitutionU5WithCteQualifyWindowSubstitution() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<update select col U5>=column, <update order col U5>=column, <update where col U5>=column, <[Metrics].[Score Feed U5]>=tuple}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{<[Metrics].[Score Feed U5]>={<update select col U5>=[[@9,36:36='a',<381>,2:19]], <update order col U5>=[[@27,134:134='a',<381>,3:59]], <update where col U5>=[[@38,215:215='a',<381>,5:8]], rn=[[@44,253:254='rn',<381>,6:10]], emp_id=[[@5,26:26='a',<381>,2:9], [@22,116:116='a',<381>,3:41], [@65,336:336='r',<381>,11:17]]}, employees={score=[[@52,285:289='score',<381>,9:4]], emp_id=[[@61,325:325='e',<381>,11:6]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update1={context_list={r=query0, ranked=query0}, assignments={score=[{name=score_val, table_ref=r}]}, table_dictionary={employees={score=[[@52,285:289='score',<381>,9:4]], emp_id=[[@61,325:325='e',<381>,11:6]]}}, update_dictionary={score=[[@52,285:289='score',<381>,9:4]]}, def_query0={query_dictionary={rn=[[@33,167:168='rn',<381>,3:92]], score_val=[[@13,64:72='score_val',<381>,2:47]], emp_id=[[@7,28:33='emp_id',<381>,2:11], [@65,336:336='r',<381>,11:17]]}, table_dictionary={<[Metrics].[Score Feed U5]>={<update select col U5>=[[@9,36:36='a',<381>,2:19]], <update order col U5>=[[@27,134:134='a',<381>,3:59]], <update where col U5>=[[@38,215:215='a',<381>,5:8]], rn=[[@44,253:254='rn',<381>,6:10]], emp_id=[[@5,26:26='a',<381>,2:9], [@22,116:116='a',<381>,3:41], [@65,336:336='r',<381>,11:17]]}}, filters=[{substitution={name=<update where col U5>, type=column}, table_ref=a}, {name=rn, table_ref=<[Metrics].[Score Feed U5]>}], interface={rn=[{name=emp_id, table_ref=a}, {substitution={name=<update order col U5>, type=column}, table_ref=a}], score_val=[{substitution={name=<update select col U5>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Metrics].[Score Feed U5]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=r}], table_alias={ranked=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void updateComplexSubstitutionU6SubqueryJoinOnColumnSubstitution() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update1={assignments={score=[{name=metric_val, table_ref=j}]}, table_dictionary={employees={score=[[@4,23:27='score',<381>,2:4]], emp_id=[[@44,288:288='e',<381>,10:6]]}}, update_dictionary={score=[[@4,23:27='score',<381>,2:4]]}, def_query0={query_dictionary={metric_val=[[@20,98:107='metric_val',<381>,4:47], [@6,31:31='j',<381>,2:12]], emp_id=[[@14,62:67='emp_id',<381>,4:11], [@48,299:299='j',<381>,10:17]]}, table_dictionary={<[Join Data].[Left Feed U6]>={<update select col U6>=[[@16,70:70='a',<381>,4:19]], <update join col U6>=[[@28,193:193='a',<381>,7:7]], <update where col U6>=[[@36,250:250='a',<381>,8:8]], emp_id=[[@12,60:60='a',<381>,4:9]]}, <[Join Data].[Right Feed U6]>={<update join col U6b>=[[@32,218:218='b',<381>,7:32]]}}, filters=[{substitution={name=<update join col U6>, type=column}, table_ref=a}, {substitution={name=<update join col U6b>, type=column}, table_ref=b}, {substitution={name=<update where col U6>, type=column}, table_ref=a}], interface={metric_val=[{substitution={name=<update select col U6>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Join Data].[Left Feed U6]>, b=<[Join Data].[Right Feed U6]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=j}], table_alias={e=employees, j=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void updateComplexSubstitutionU7ChainedCteReferences() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[Pipeline].[Stage One U7]>=tuple, <update select col U7>=column, <update where col U7>=column}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{<[Pipeline].[Stage One U7]>={<update select col U7>=[[@9,35:35='a',<381>,2:19]], <update where col U7>=[[@18,116:116='a',<381>,4:8]], emp_id=[[@5,25:25='a',<381>,2:9], [@29,167:167='s',<381>,6:9]]}, employees={score=[[@44,227:231='score',<381>,10:4]], emp_id=[[@53,264:264='e',<381>,12:6]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update2={context_list={t=query1, step1=query0, step2=query1}, assignments={score=[{name=raw_val, table_ref=t}]}, table_dictionary={employees={score=[[@44,227:231='score',<381>,10:4]], emp_id=[[@53,264:264='e',<381>,12:6]]}}, update_dictionary={score=[[@44,227:231='score',<381>,10:4]]}, def_query1={context_list={step1=query0, s=query0}, query_dictionary={raw_val=[[@35,179:185='raw_val',<381>,6:21]], emp_id=[[@31,169:174='emp_id',<381>,6:11], [@57,275:275='t',<381>,12:17]]}, interface={raw_val=[{name=raw_val, table_ref=s}], emp_id=[{name=emp_id, table_ref=s}]}, table_alias={s=query0, step1=query0}}, def_query0={query_dictionary={raw_val=[[@13,63:69='raw_val',<381>,2:47], [@33,177:177='s',<381>,6:19]], emp_id=[[@7,27:32='emp_id',<381>,2:11], [@29,167:167='s',<381>,6:9]]}, table_dictionary={<[Pipeline].[Stage One U7]>={<update select col U7>=[[@9,35:35='a',<381>,2:19]], <update where col U7>=[[@18,116:116='a',<381>,4:8]], emp_id=[[@5,25:25='a',<381>,2:9], [@29,167:167='s',<381>,6:9]]}}, filters=[{substitution={name=<update where col U7>, type=column}, table_ref=a}], interface={raw_val=[{substitution={name=<update select col U7>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Pipeline].[Stage One U7]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=t}], table_alias={step2=query1, step1=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteComplexSubstitutionD4NestedWithInCteBody() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{delete2={context_list={outer_cte=query1}, query_dictionary={}, table_dictionary={employees={emp_id=[[@48,286:286='e',<381>,12:6]]}}, def_query1={context_list={inner_cte=query0, i=query0}, query_dictionary={metric_val=[[@35,206:215='metric_val',<381>,7:21]], emp_id=[[@31,196:201='emp_id',<381>,7:11], [@52,297:297='o',<381>,12:17]]}, def_query0={query_dictionary={metric_val=[[@17,91:100='metric_val',<381>,3:49], [@33,204:204='i',<381>,7:19]], emp_id=[[@11,55:60='emp_id',<381>,3:13], [@29,194:194='i',<381>,7:9]]}, table_dictionary={<[Finance].[Revenue Feed D4]>={<delete where col D4>=[[@22,153:153='a',<381>,5:10]], <delete select col D4>=[[@13,63:63='a',<381>,3:21]], emp_id=[[@9,53:53='a',<381>,3:11], [@29,194:194='i',<381>,7:9]]}}, filters=[{substitution={name=<delete where col D4>, type=column}, table_ref=a}], interface={metric_val=[{substitution={name=<delete select col D4>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Finance].[Revenue Feed D4]>}}, interface={metric_val=[{name=metric_val, table_ref=i}], emp_id=[{name=emp_id, table_ref=i}]}, table_alias={inner_cte=query0}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=o}], interface=null, table_alias={outer_cte=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteComplexSubstitutionD5WithCteQualifyWindowSubstitution() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{delete1={context_list={ranked=query0}, query_dictionary={}, table_dictionary={employees={emp_id=[[@56,307:307='e',<381>,10:6]]}}, def_query0={query_dictionary={rn=[[@33,167:168='rn',<381>,3:92]], score_val=[[@13,64:72='score_val',<381>,2:47]], emp_id=[[@7,28:33='emp_id',<381>,2:11], [@60,318:318='r',<381>,10:17]]}, table_dictionary={<[Metrics].[Score Feed D5]>={<delete where col D5>=[[@38,215:215='a',<381>,5:8]], <delete select col D5>=[[@9,36:36='a',<381>,2:19]], <delete order col D5>=[[@27,134:134='a',<381>,3:59]], rn=[[@44,253:254='rn',<381>,6:10]], emp_id=[[@5,26:26='a',<381>,2:9], [@22,116:116='a',<381>,3:41], [@60,318:318='r',<381>,10:17]]}}, filters=[{substitution={name=<delete where col D5>, type=column}, table_ref=a}, {name=rn, table_ref=<[Metrics].[Score Feed D5]>}], interface={rn=[{name=emp_id, table_ref=a}, {substitution={name=<delete order col D5>, type=column}, table_ref=a}], score_val=[{substitution={name=<delete select col D5>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Metrics].[Score Feed D5]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=r}], interface=null, table_alias={ranked=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteComplexSubstitutionD6SubqueryJoinOnColumnSubstitution() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[Join Data].[Right Feed D6]>=tuple, <delete where col D6>=column, <delete select col D6>=column, <delete join col D6>=column, <delete join col D6b>=column, <[Join Data].[Left Feed D6]>=tuple}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong",
				"{<[Join Data].[Right Feed D6]>={<delete join col D6b>=[[@27,199:199='b',<381>,6:32]]}, <delete join col D6>={}, <delete join col D6b>={}, <[Join Data].[Left Feed D6]>={<delete where col D6>=[[@31,231:231='a',<381>,7:8]], <delete select col D6>=[[@11,51:51='a',<381>,3:19]], <delete join col D6>=[[@23,174:174='a',<381>,6:7]], emp_id=[[@7,41:41='a',<381>,3:9]]}, employees={emp_id=[[@39,269:269='e',<381>,9:6]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={metric_val=[[@15,79:88='metric_val',<381>,3:47]], emp_id=[[@9,43:48='emp_id',<381>,3:11], [@43,280:280='j',<381>,9:17]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{delete1={query_dictionary={}, table_dictionary={employees={emp_id=[[@39,269:269='e',<381>,9:6]]}}, def_query0={query_dictionary={metric_val=[[@15,79:88='metric_val',<381>,3:47]], emp_id=[[@9,43:48='emp_id',<381>,3:11], [@43,280:280='j',<381>,9:17]]}, table_dictionary={<[Join Data].[Right Feed D6]>={<delete join col D6b>=[[@27,199:199='b',<381>,6:32]]}, <delete join col D6>={}, <delete join col D6b>={}, <[Join Data].[Left Feed D6]>={<delete where col D6>=[[@31,231:231='a',<381>,7:8]], <delete select col D6>=[[@11,51:51='a',<381>,3:19]], <delete join col D6>=[[@23,174:174='a',<381>,6:7]], emp_id=[[@7,41:41='a',<381>,3:9]]}}, filters=[{substitution={name=<delete join col D6>, type=column}, table_ref=a}, {substitution={name=<delete join col D6b>, type=column}, table_ref=b}, {substitution={name=<delete where col D6>, type=column}, table_ref=a}], interface={metric_val=[{substitution={name=<delete select col D6>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Join Data].[Left Feed D6]>, b=<[Join Data].[Right Feed D6]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=j}], interface=null, table_alias={e=employees, j=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteComplexSubstitutionD7ChainedCteReferences() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{delete2={context_list={step1=query0, step2=query1}, query_dictionary={}, table_dictionary={employees={emp_id=[[@48,248:248='e',<381>,11:6]]}}, def_query1={context_list={step1=query0, s=query0}, query_dictionary={raw_val=[[@35,179:185='raw_val',<381>,6:21]], emp_id=[[@31,169:174='emp_id',<381>,6:11], [@52,259:259='t',<381>,11:17]]}, interface={raw_val=[{name=raw_val, table_ref=s}], emp_id=[{name=emp_id, table_ref=s}]}, table_alias={s=query0, step1=query0}}, def_query0={query_dictionary={raw_val=[[@13,63:69='raw_val',<381>,2:47], [@33,177:177='s',<381>,6:19]], emp_id=[[@7,27:32='emp_id',<381>,2:11], [@29,167:167='s',<381>,6:9]]}, table_dictionary={<[Pipeline].[Stage One D7]>={<delete where col D7>=[[@18,116:116='a',<381>,4:8]], <delete select col D7>=[[@9,35:35='a',<381>,2:19]], emp_id=[[@5,25:25='a',<381>,2:9], [@29,167:167='s',<381>,6:9]]}}, filters=[{substitution={name=<delete where col D7>, type=column}, table_ref=a}], interface={raw_val=[{substitution={name=<delete select col D7>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Pipeline].[Stage One D7]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=t}], interface=null, table_alias={step2=query1, step1=query0}}}",
				extractor.getSymbolTable().toString());
	}
