...
public class SqlEventWalkerDmlUpdateInsertDeleteTruncateTests extends AbstractSqlParseEventWalkerTest {
	...
	public void updateDictionaryHandlingGroupByHavingSubqueryAndUnqualifiedRhsV5() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={total_score=[[@27,120:130='total_score',<381>,2:40]], emp_id=[[@18,96:101='emp_id',<381>,2:16], [@54,243:245='src',<381>,6:18]]}, update1={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@10,53:62='stale_flag',<381>,1:53]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{update1={assignments={stale_flag=[{name=orphan_marker, table_ref=null}], agg_score=[{name=total_score, table_ref=src}]}, table_dictionary={employees={score=[[@44,212:212='e',<381>,5:29]], agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@10,53:62='stale_flag',<381>,1:53]], emp_id=[[@50,232:232='e',<381>,6:7]]}}, update_dictionary={stale_flag=[[@10,53:62='stale_flag',<381>,1:53]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}, def_query0={query_dictionary={total_score=[[@27,120:130='total_score',<381>,2:40]], emp_id=[[@18,96:101='emp_id',<381>,2:16], [@54,243:245='src',<381>,6:18]]}, table_dictionary={accounts={emp_id=[[@16,94:94='a',<381>,2:14], [@33,174:174='a',<381>,4:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}, {name=score, table_ref=e}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=src}], table_alias={e=employees, src=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void updateDictionaryHandlingWhereInSubqueryWithTargetTableRefAndOrphanRhsV8() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={total_score=[[@27,120:130='total_score',<381>,2:40]], emp_id=[[@18,96:101='emp_id',<381>,2:16], [@51,242:244='src',<381>,6:18]]}, update1={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@10,53:62='stale_flag',<381>,1:53]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{update1={assignments={stale_flag=[{name=orphan_marker, table_ref=null}], agg_score=[{name=total_score, table_ref=src}]}, table_dictionary={employees={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@10,53:62='stale_flag',<381>,1:53]], min_score=[[@36,181:181='e',<381>,4:24]], emp_id=[[@47,231:231='e',<381>,6:7]]}}, update_dictionary={stale_flag=[[@10,53:62='stale_flag',<381>,1:53]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}, def_query0={query_dictionary={total_score=[[@27,120:130='total_score',<381>,2:40]], emp_id=[[@18,96:101='emp_id',<381>,2:16], [@51,242:244='src',<381>,6:18]]}, table_dictionary={accounts={emp_id=[[@16,94:94='a',<381>,2:14], [@41,210:210='a',<381>,5:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}, {name=min_score, table_ref=e}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=src}], table_alias={e=employees, src=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	*/
	...
	public void insertDictionaryHandlingGroupByHavingSubqueryAndUnqualifiedRhsV5() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, query1={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, insert2={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{insert2={query_dictionary={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}, table_dictionary={employees={stale_flag=[[@6,35:44='stale_flag',<381>,1:35]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}}, def_query1={query_dictionary={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, table_dictionary={}, def_query0={query_dictionary={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, table_dictionary={accounts={emp_id=[[@17,100:100='a',<381>,3:14], [@34,180:180='a',<381>,5:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, interface={total_score=[{name=total_score, table_ref=src}], orphan_marker=[{name=orphan_marker, table_ref=null}]}, table_alias={src=query0}}, interface={agg_score=[{name=total_score, table_ref=query1}], stale_flag=[{name=orphan_marker, table_ref=query1}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void insertDictionaryHandlingWhereInSubqueryWithOrphanRhsV8() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, query1={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, insert2={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{insert2={query_dictionary={agg_score=[[@4,24:32='agg_score',<381>,1:24]], stale_flag=[[@6,35:44='stale_flag',<381>,1:35]]}, table_dictionary={employees={stale_flag=[[@6,35:44='stale_flag',<381>,1:35]], agg_score=[[@4,24:32='agg_score',<381>,1:24]]}}, def_query1={query_dictionary={total_score=[[@11,59:69='total_score',<381>,2:12]], orphan_marker=[[@13,72:84='orphan_marker',<381>,2:25]]}, table_dictionary={}, def_query0={query_dictionary={total_score=[[@28,126:136='total_score',<381>,3:40], [@9,55:57='src',<381>,2:8]], emp_id=[[@19,102:107='emp_id',<381>,3:16]]}, table_dictionary={accounts={emp_id=[[@17,100:100='a',<381>,3:14], [@40,206:206='a',<381>,6:17]]}}, grouped_by=[{name=emp_id, table_ref=a}], filters=[{name=score, table_ref=a}], interface={total_score=[{name=score, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=accounts}}, interface={total_score=[{name=total_score, table_ref=src}], orphan_marker=[{name=orphan_marker, table_ref=null}]}, table_alias={src=query0}}, interface={agg_score=[{name=total_score, table_ref=query1}], stale_flag=[{name=orphan_marker, table_ref=query1}]}}}",
				extractor.getSymbolTable().toString());
	}
...
// COMPLEX DML SUBSTITUTION TESTS (generated — review before commit)
	...
	public void updateComplexSubstitutionU4NestedWithInCteBody() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{update2={context_list={o=query1, outer_cte=query1}, assignments={score=[{name=metric_val, table_ref=o}]}, table_dictionary={employees={score=[[@44,261:265='score',<381>,11:4]], emp_id=[[@53,305:305='e',<381>,13:6]]}}, update_dictionary={score=[[@44,261:265='score',<381>,11:4]]}, def_query1={context_list={inner_cte=query0, i=query0}, query_dictionary={metric_val=[[@35,206:215='metric_val',<381>,7:21], [@46,269:269='o',<381>,11:12]], emp_id=[[@31,196:201='emp_id',<381>,7:11], [@57,316:316='o',<381>,13:17]]}, table_dictionary={}, def_query0={query_dictionary={metric_val=[[@17,91:100='metric_val',<381>,3:49], [@33,204:204='i',<381>,7:19]], emp_id=[[@11,55:60='emp_id',<381>,3:13], [@29,194:194='i',<381>,7:9]]}, table_dictionary={<[Finance].[Revenue Feed U4]>={<update select col U4>=[[@13,63:63='a',<381>,3:21]], <update where col U4>=[[@22,153:153='a',<381>,5:10]], emp_id=[[@9,53:53='a',<381>,3:11]]}}, filters=[{substitution={name=<update where col U4>, type=column}, table_ref=a}], interface={metric_val=[{substitution={name=<update select col U4>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Finance].[Revenue Feed U4]>}}, interface={metric_val=[{name=metric_val, table_ref=i}], emp_id=[{name=emp_id, table_ref=i}]}, table_alias={inner_cte=query0}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=o}], table_alias={outer_cte=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void deleteComplexSubstitutionD7ChainedCteReferences() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{delete2={context_list={step1=query0, step2=query1}, query_dictionary={}, table_dictionary={employees={emp_id=[[@48,248:248='e',<381>,11:6]]}}, def_query1={context_list={step1=query0, s=query0}, query_dictionary={raw_val=[[@35,179:185='raw_val',<381>,6:21]], emp_id=[[@31,169:174='emp_id',<381>,6:11], [@52,259:259='t',<381>,11:17]]}, table_dictionary={}, interface={raw_val=[{name=raw_val, table_ref=s}], emp_id=[{name=emp_id, table_ref=s}]}, table_alias={step1=query0, s=query0}}, def_query0={query_dictionary={raw_val=[[@13,63:69='raw_val',<381>,2:47], [@33,177:177='s',<381>,6:19]], emp_id=[[@7,27:32='emp_id',<381>,2:11], [@29,167:167='s',<381>,6:9]]}, table_dictionary={<[Pipeline].[Stage One D7]>={<delete where col D7>=[[@18,116:116='a',<381>,4:8]], <delete select col D7>=[[@9,35:35='a',<381>,2:19]], emp_id=[[@5,25:25='a',<381>,2:9]]}}, filters=[{substitution={name=<delete where col D7>, type=column}, table_ref=a}], interface={raw_val=[{substitution={name=<delete select col D7>, type=column}, table_ref=a}], emp_id=[{name=emp_id, table_ref=a}]}, table_alias={a=<[Pipeline].[Stage One D7]>}}, filters=[{name=emp_id, table_ref=e}, {name=emp_id, table_ref=t}], interface=null, table_alias={step2=query1, step1=query0}}}",
				extractor.getSymbolTable().toString());
	}
