...
public class SqlParseEventWalkerTest {
	...
	public void concatenationInTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{orange={fld=[@11,58:60='fld',<327>,1:58]}, tab1={subj_cd=[@5,29:35='subj_cd',<327>,1:29], apple=[@1,7:11='apple',<327>,1:7], crs_nm=[@7,40:45='crs_nm',<327>,1:40]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={tab1={subj_cd=[@5,29:35='subj_cd',<327>,1:29], apple=[@1,7:11='apple',<327>,1:7], crs_nm=[@7,40:45='crs_nm',<327>,1:40]}, interface={apple={column={name=apple, table_ref=null}}}, query0={orange={fld=[@11,58:60='fld',<327>,1:58]}, interface={fld={column={name=fld, table_ref=null}}}}}}",
...
// Aliasing in select lists
	...
	public void basicSelectListQuotedNumericPrefixColumnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{\"99tab1\"={\"22_b\"=[@5,24:29='\"22_b\"',<330>,1:24], \"36_c\"=[@9,39:44='\"36_c\"',<330>,1:39], \"09_a\"=[@1,8:13='\"09_a\"',<330>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={\"99tab1\"={\"22_b\"=[@5,24:29='\"22_b\"',<330>,1:24], \"36_c\"=[@9,39:44='\"36_c\"',<330>,1:39], \"09_a\"=[@1,8:13='\"09_a\"',<330>,1:8]}, interface={\"999_z\"={column={name=\"36_c\", table_ref=null}}, 02_y={column={name=\"22_b\", table_ref=null}}, 01_x={column={name=\"09_a\", table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
...
//	}
	...
	public void realisticRankAndDescColumnNameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={rank=[@11,54:57='rank',<126>,1:54], is_active=[@7,39:47='is_active',<327>,1:39], category=[@5,29:36='category',<327>,1:29], student=[@15,66:72='student',<327>,1:66], nk=[@9,50:51='nk',<327>,1:50], desc=[@13,60:63='desc',<76>,1:60]}, <NAV>={rank=[@33,178:181='rank',<126>,1:178], is_active=[@29,163:171='is_active',<327>,1:163], category=[@27,153:160='category',<327>,1:153], student=[@37,190:196='student',<327>,1:190], nk=[@31,174:175='nk',<327>,1:174], desc=[@35,184:187='desc',<76>,1:184]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union2={query0={<Guide>={rank=[@11,54:57='rank',<126>,1:54], is_active=[@7,39:47='is_active',<327>,1:39], category=[@5,29:36='category',<327>,1:29], student=[@15,66:72='student',<327>,1:66], nk=[@9,50:51='nk',<327>,1:50], desc=[@13,60:63='desc',<76>,1:60]}, Guide_Student_Conditions=<Guide>, interface={app_name={literal='Guide'}, is_active={column={name=is_active, table_ref=null}}, student={column={name=student, table_ref=null}}, rank={column={name=rank, table_ref=null}}, category={column={name=category, table_ref=null}}, nk={column={name=nk, table_ref=null}}, desc={column={name=desc, table_ref=null}}}}, interface={app_name=query_column, is_active=query_column, student=query_column, rank=query_column, category=query_column, nk=query_column, desc=query_column}, query1={Nav_Student_Conditions=<NAV>, <NAV>={rank=[@33,178:181='rank',<126>,1:178], is_active=[@29,163:171='is_active',<327>,1:163], category=[@27,153:160='category',<327>,1:153], student=[@37,190:196='student',<327>,1:190], nk=[@31,174:175='nk',<327>,1:174], desc=[@35,184:187='desc',<76>,1:184]}, interface={app_name={literal='Nav'}, is_active={column={name=is_active, table_ref=null}}, student={column={name=student, table_ref=null}}, rank={column={name=rank, table_ref=null}}, category={column={name=category, table_ref=null}}, nk={column={name=nk, table_ref=null}}, desc={column={name=desc, table_ref=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void multipleColumnsWithNullsDecoratorsOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={col2=[@11,49:52='col2',<327>,1:49], *=[@1,7:7='*',<288>,1:7], col1=[@6,28:31='col1',<327>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={col2=[@11,49:52='col2',<327>,1:49], *=[@1,7:7='*',<288>,1:7], col1=[@6,28:31='col1',<327>,1:28]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
...
public void selectOrderByVariableNullsLastStatementTest() {
	...
	public void predicandAndColumnVariableNotBetweenTestWithSymmetry() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<c>=column, <a>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={d=[@13,68:68='d',<327>,1:68], apple=[@1,7:11='apple',<327>,1:7], <c>={substitution={name=<c>, type=column}}}}",
				extractor.getTableColumnMap().toString());
...
//				extractor.getSymbolTable().toString());
	...
	public void columnVariableHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<condition>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<condition>={substitution={name=<condition>, type=column}}, TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<327>,1:21], spriden_id=[@1,8:17='spriden_id',<327>,1:8]}}",
				extractor.getTableColumnMap().toString());
	...
	public void basicAggregateQueryWithCountOverCalcTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={subj=[@5,20:23='subj',<327>,1:20], apple=[@13,54:58='apple',<327>,1:54], object=[@7,27:32='object',<266>,1:27]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={subj=[@5,20:23='subj',<327>,1:20], apple=[@13,54:58='apple',<327>,1:54], object=[@7,27:32='object',<266>,1:27]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=count, qualifier=null, parameters={calc={left={column={name=subj, table_ref=null}}, right={column={name=object, table_ref=null}}, operator=+}}}}}}}",
				extractor.getSymbolTable().toString());
	}
  ...
  // Snowflake Aggregate Function APPROX_PERCENTILE_COMBINE
	...
	public void windowFunctionPredicandVariableP1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<columnParam>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={k_stfd=[@8,39:44='k_stfd',<327>,1:39], kppi=[@10,47:50='kppi',<327>,1:47], row_num=[@13,61:67='row_num',<327>,1:61]}}",
				extractor.getTableColumnMap().toString());
	...
	public void windowFunctionPredicandVariableP2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<k_stfd>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column=[@2,5:10='column',<68>,1:5], kppi=[@10,42:45='kppi',<327>,1:42], row_num=[@13,56:62='row_num',<327>,1:56]}}",
				extractor.getTableColumnMap().toString());
	...
	public void windowFunctionPredicandVariableP3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<row_num>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={k_stfd=[@8,32:37='k_stfd',<327>,1:32], column=[@2,5:10='column',<68>,1:5], kppi=[@10,40:43='kppi',<327>,1:40]}}",
				extractor.getTableColumnMap().toString());
