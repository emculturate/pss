...
public class SqlParseEventWalkerTest {
	...
	public void basicSelectDistinctQualifierListTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@2,17:17='a',<299>,1:17], b=[@4,19:19='b',<299>,1:19], c=[@6,21:21='c',<299>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@2,17:17='a',<299>,1:17], b=[@4,19:19='b',<299>,1:19], c=[@6,21:21='c',<299>,1:21]}, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectDistinctListWithEmbeddedAllListQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab2={b=[@11,40:40='b',<299>,1:40], c=[@13,42:42='c',<299>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={def_query0={tab2={b=[@11,40:40='b',<299>,1:40], c=[@13,42:42='c',<299>,1:42]}, interface={b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}}, tab1=query0, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}, query0={a=[@2,17:17='a',<299>,1:17], b=[@4,19:19='b',<299>,1:19], c=[@6,21:21='c',<299>,1:21]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void aggregateFunctionWithDistinctQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@4,21:21='a',<299>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@4,21:21='a',<299>,1:21]}, interface={unnamed_0={function={function_name=max, qualifier=distinct, parameters={column={name=a, table_ref=null}}}}}}}",
				extractor.getSymbolTable().toString());
	}
...
// Aliasing in select lists
	...
	public void extendedVariableNamePopulationSubnamerTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}>={col=[@1,9:9='a',<299>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[schema].[entity].{pop1}>, <[schema].[entity].{pop1}>={col=[@1,9:9='a',<299>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void extendedVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<299>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[schema].[entity].{pop1}.[Current Batch]>, <[schema].[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<299>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationSubnameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}>={col=[@1,9:9='a',<299>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[entity].{pop1}>, <[entity].{pop1}>={col=[@1,9:9='a',<299>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<299>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[entity].{pop1}.[Current Batch]>, <[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<299>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void joinQualifiedWithTupleVariableT1() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{<tuple1>={}, fourth={}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={<tuple1>={}, fourth={}, interface={*={column={name=*, table_ref=*}}}, F4=fourth, T3=<tuple1>, unknown={*=[@1,8:8='*',<286>,1:8]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void joinSubqueryTableV2() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[@5,23:23='*',<286>,1:23]}, fourth={}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={def_query0={third={*=[@5,23:23='*',<286>,1:23]}, interface={*={column={name=*, table_ref=*}}}}, fourth={}, interface={*={column={name=*, table_ref=*}}}, query0={*=[@1,8:8='*',<286>,1:8]}, F4=fourth, T3=query0}}",
				extractor.getSymbolTable().toString());
	}
...
//	}
	...
	public void simpleOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={*=[@1,7:7='*',<286>,1:7], col1=[@6,28:31='col1',<299>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={*=[@1,7:7='*',<286>,1:7], col1=[@6,28:31='col1',<299>,1:28]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void multipleColumnsWithNullsDecoratorsOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={*=[@1,7:7='*',<286>,1:7], col2=[@11,49:52='col2',<299>,1:49], col1=[@6,28:31='col1',<299>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={*=[@1,7:7='*',<286>,1:7], col2=[@11,49:52='col2',<299>,1:49], col1=[@6,28:31='col1',<299>,1:28]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{other={*=[@18,79:79='*',<286>,1:79]}, scbcrse={item=[@14,63:66='item',<299>,1:63], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,32:40='subj_code',<299>,1:32]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={aa=scbcrse, scbcrse={item=[@14,63:66='item',<299>,1:63], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,32:40='subj_code',<299>,1:32]}, interface={*={column={name=*, table_ref=*}}}, query0={other={*=[@18,79:79='*',<286>,1:79]}, interface={*={column={name=*, table_ref=*}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateInListSubqueryVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist subquery>=query}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@14,62:65='item',<299>,1:62], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,31:39='subj_code',<299>,1:31]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={item=[@14,62:65='item',<299>,1:62], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,31:39='subj_code',<299>,1:31]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateInListVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist substitution>=in_list}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@6,33:36='item',<299>,1:33], *=[@1,7:7='*',<286>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={item=[@6,33:36='item',<299>,1:33], *=[@1,7:7='*',<286>,1:7]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void notInPredicateSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{other={*=[@20,87:87='*',<286>,1:87]}, scbcrse={item=[@15,67:70='item',<299>,1:67], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,32:40='subj_code',<299>,1:32]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={aa=scbcrse, scbcrse={item=[@15,67:70='item',<299>,1:67], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,32:40='subj_code',<299>,1:32]}, interface={*={column={name=*, table_ref=*}}}, query0={other={*=[@20,87:87='*',<286>,1:87]}, interface={*={column={name=*, table_ref=*}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void notInPredicateInListSubqueryVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist subquery>=query}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@15,66:69='item',<299>,1:66], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,31:39='subj_code',<299>,1:31]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={item=[@15,66:69='item',<299>,1:66], *=[@1,7:7='*',<286>,1:7], subj_code=[@6,31:39='subj_code',<299>,1:31]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionVariableHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<condition>=condition, <condition2>=condition}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<299>,1:21], spriden_id=[@1,8:17='spriden_id',<299>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<299>,1:21], spriden_id=[@1,8:17='spriden_id',<299>,1:8]}, interface={TERM_CODE_ADMIT={column={name=TERM_CODE_ADMIT, table_ref=null}}, spriden_id={column={name=spriden_id, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void columnVariableHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<condition>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<condition>={substitution={name=<condition>, type=column}}, spriden_id=[@1,8:17='spriden_id',<299>,1:8], TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<299>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={<condition>={substitution={name=<condition>, type=column}}, TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<299>,1:21], spriden_id=[@1,8:17='spriden_id',<299>,1:8]}, interface={TERM_CODE_ADMIT={column={name=TERM_CODE_ADMIT, table_ref=null}}, spriden_id={column={name=spriden_id, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithCountOverCalcTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@13,54:58='apple',<299>,1:54], subj=[@5,20:23='subj',<299>,1:20], object=[@7,27:32='object',<264>,1:27]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@13,54:58='apple',<299>,1:54], subj=[@5,20:23='subj',<299>,1:20], object=[@7,27:32='object',<264>,1:27]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=count, qualifier=null, parameters={calc={left={column={name=subj, table_ref=null}}, right={column={name=object, table_ref=null}}, operator=+}}}}}}}",
				extractor.getSymbolTable().toString());
	}
...
//	}
	...
	public void basicColumnValueTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={emp_sales_count=[@0,0:14='emp_sales_count',<299>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={emp_sales_count=[@0,0:14='emp_sales_count',<299>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicTableColumnValueTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{table1={emp_sales_count=[@0,0:5='table1',<299>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table1={emp_sales_count=[@0,0:5='table1',<299>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void concatenationParenthesisPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@1,1:1='a',<299>,1:1], b=[@3,6:6='b',<299>,1:6]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@1,1:1='a',<299>,1:1], b=[@3,6:6='b',<299>,1:6]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void functionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{crs={course_number=[@8,33:35='crs',<299>,1:33], subject_code=[@4,15:17='crs',<299>,1:15]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{crs={subject_code=[@4,15:17='crs',<299>,1:15], course_number=[@8,33:35='crs',<299>,1:33]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void aggregateFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={scbcrse_eff_term=[@2,4:19='scbcrse_eff_term',<299>,1:4]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={scbcrse_eff_term=[@2,4:19='scbcrse_eff_term',<299>,1:4]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void caseFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={Y=[@4,21:21='Y',<299>,1:21], N=[@10,50:50='N',<299>,1:50]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={Y=[@4,21:21='Y',<299>,1:21], N=[@10,50:50='N',<299>,1:50]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void trimFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={field1=[@5,22:27='field1',<299>,1:22]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={field1=[@5,22:27='field1',<299>,1:22]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectLookupSubqueryPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={scbcrse_coll_code=[@2,8:9='aa',<299>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={scbcrse_coll_code=[@2,8:9='aa',<299>,1:8]}, interface={scbcrse_coll_code={column={name=scbcrse_coll_code, table_ref=aa}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void arithmeticParenExpressionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{aa={scbcrse_coll_code=[@3,3:4='aa',<299>,1:3]}, unknown={other=[@9,30:34='other',<299>,1:30]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{aa={scbcrse_coll_code=[@3,3:4='aa',<299>,1:3]}, unknown={other=[@9,30:34='other',<299>,1:30]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionListOfAndsV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={x=[@8,16:16='x',<299>,1:16], a=[@0,0:0='a',<299>,1:0], y=[@10,19:19='y',<299>,1:19], b=[@4,8:8='b',<299>,1:8], c=[@6,10:10='c',<299>,1:10]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@0,0:0='a',<299>,1:0], b=[@4,8:8='b',<299>,1:8], c=[@6,10:10='c',<299>,1:10], x=[@8,16:16='x',<299>,1:16], y=[@10,19:19='y',<299>,1:19]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionListOfAndsV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={x=[@16,24:24='a',<299>,1:24], a=[@0,0:0='a',<299>,1:0], b=[@8,12:12='a',<299>,1:12]}, b={y=[@20,30:30='b',<299>,1:30], b=[@4,4:4='b',<299>,1:4], c=[@12,16:16='b',<299>,1:16]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={a=[@0,0:0='a',<299>,1:0], b=[@8,12:12='a',<299>,1:12], x=[@16,24:24='a',<299>,1:24]}, b={b=[@4,4:4='b',<299>,1:4], c=[@12,16:16='b',<299>,1:16], y=[@20,30:30='b',<299>,1:30]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionListOfOrsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={x=[@8,14:14='x',<299>,1:14], a=[@0,0:0='a',<299>,1:0], y=[@10,17:17='y',<299>,1:17], b=[@4,7:7='b',<299>,1:7], c=[@6,9:9='c',<299>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@0,0:0='a',<299>,1:0], b=[@4,7:7='b',<299>,1:7], c=[@6,9:9='c',<299>,1:9], x=[@8,14:14='x',<299>,1:14], y=[@10,17:17='y',<299>,1:17]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionParentheticalTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@2,2:2='a',<299>,1:2], b=[@8,11:11='b',<299>,1:11], c=[@10,13:13='c',<299>,1:13]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@2,2:2='a',<299>,1:2], b=[@8,11:11='b',<299>,1:11], c=[@10,13:13='c',<299>,1:13]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionNotTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@1,4:4='a',<299>,1:4], b=[@3,8:8='b',<299>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@1,4:4='a',<299>,1:4], b=[@3,8:8='b',<299>,1:8]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionInTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={columnName=[@0,0:9='columnName',<299>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={columnName=[@0,0:9='columnName',<299>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicJoinExtensionValueWithOnClauseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{bb={col1=[@12,41:42='bb',<299>,1:41]}, emp_sales={col1=[@8,33:34='dd',<299>,1:33]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{dd=emp_sales, bb={col1=[@12,41:42='bb',<299>,1:41]}, emp_sales={col1=[@8,33:34='dd',<299>,1:33]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void joinExtensionLeftJoinWithOnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={a=[@5,23:23='a',<299>,1:23]}, fourth={b=[@9,29:29='b',<299>,1:29]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={a=[@5,23:23='a',<299>,1:23]}, b=fourth, fourth={b=[@9,29:29='b',<299>,1:29]}}",
				extractor.getSymbolTable().toString());
	}
