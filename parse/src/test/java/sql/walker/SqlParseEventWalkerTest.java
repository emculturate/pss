...
public class SqlParseEventWalkerTest {
	...
	public void concatenationInTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{orange={fld=[@11,58:60='fld',<321>,1:58]}, tab1={apple=[@1,7:11='apple',<321>,1:7], crs_nm=[@7,40:45='crs_nm',<321>,1:40], subj_cd=[@5,29:35='subj_cd',<321>,1:29]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={tab1={apple=[@1,7:11='apple',<321>,1:7], crs_nm=[@7,40:45='crs_nm',<321>,1:40], subj_cd=[@5,29:35='subj_cd',<321>,1:29]}, interface={apple={column={name=apple, table_ref=null}}}, query0={orange={fld=[@11,58:60='fld',<321>,1:58]}, interface={fld={column={name=fld, table_ref=null}}}}}}",
	...
	public void basicSelectList2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@1,8:8='a',<321>,1:8], b=[@3,10:10='b',<321>,1:10], c=[@5,12:12='c',<321>,1:12]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@1,8:8='a',<321>,1:8], b=[@3,10:10='b',<321>,1:10], c=[@5,12:12='c',<321>,1:12]}, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectList3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={d=[@15,29:29='d',<321>,1:29]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={d=[@15,29:29='d',<321>,1:29]}, interface={a={calc={left={literal=1}, right={literal=2}, operator=+}}, b={parentheses={calc={left={literal=1}, right={literal=2}, operator=+}}}, c={parentheses={column={name=d, table_ref=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectDistinctQualifierListTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@2,17:17='a',<321>,1:17], b=[@4,19:19='b',<321>,1:19], c=[@6,21:21='c',<321>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@2,17:17='a',<321>,1:17], b=[@4,19:19='b',<321>,1:19], c=[@6,21:21='c',<321>,1:21]}, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectDistinctListWithEmbeddedAllListQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab2={b=[@11,40:40='b',<321>,1:40], c=[@13,42:42='c',<321>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={def_query0={tab2={b=[@11,40:40='b',<321>,1:40], c=[@13,42:42='c',<321>,1:42]}, interface={b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}}, tab1=query0, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}, c={column={name=c, table_ref=null}}}, query0={a=[@2,17:17='a',<321>,1:17], b=[@4,19:19='b',<321>,1:19], c=[@6,21:21='c',<321>,1:21]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void aggregateFunctionWithDistinctQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@4,21:21='a',<321>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@4,21:21='a',<321>,1:21]}, interface={unnamed_0={function={function_name=max, qualifier=distinct, parameters={column={name=a, table_ref=null}}}}}}}",
				extractor.getSymbolTable().toString());
	}
...
// Aliasing in select lists
	...
	public void basicSelectListAliasing1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@1,8:8='a',<321>,1:8], b=[@5,15:15='b',<321>,1:15], c=[@9,22:22='c',<321>,1:22]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@1,8:8='a',<321>,1:8], b=[@5,15:15='b',<321>,1:15], c=[@9,22:22='c',<321>,1:22]}, interface={x={column={name=a, table_ref=null}}, y={column={name=b, table_ref=null}}, z={column={name=c, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@1,8:8='a',<321>,1:8], b=[@5,18:18='b',<321>,1:18], c=[@9,28:28='c',<321>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@1,8:8='a',<321>,1:8], b=[@5,18:18='b',<321>,1:18], c=[@9,28:28='c',<321>,1:28]}, interface={02_y={column={name=b, table_ref=null}}, 999_z={column={name=c, table_ref=null}}, 01_x={column={name=a, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListQuotedNumericPrefixColumnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{\"99tab1\"={\"22_b\"=[@5,24:29='\"22_b\"',<324>,1:24], \"09_a\"=[@1,8:13='\"09_a\"',<324>,1:8], \"36_c\"=[@9,39:44='\"36_c\"',<324>,1:39]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={\"99tab1\"={\"22_b\"=[@5,24:29='\"22_b\"',<324>,1:24], \"09_a\"=[@1,8:13='\"09_a\"',<324>,1:8], \"36_c\"=[@9,39:44='\"36_c\"',<324>,1:39]}, interface={\"999_z\"={column={name=\"36_c\", table_ref=null}}, 02_y={column={name=\"22_b\", table_ref=null}}, 01_x={column={name=\"09_a\", table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real1SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{hive_result_pit_5223_164728_46090704={*=[@15,87:87='t',<321>,1:87]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={sub=query0, def_query0={hive_result_pit_5223_164728_46090704={*=[@15,87:87='t',<321>,1:87]}, t=hive_result_pit_5223_164728_46090704, interface={*={column={name=*, table_ref=t}}}}, interface={02_DEGREE_NAME={column={name=Degree_Name, table_ref=sub}}, 01_DEGREE_CD={column={name=Degree_Code, table_ref=sub}}}, query0={Degree_Code=[@1,7:9='sub',<321>,1:7], Degree_Name=[@7,40:42='sub',<321>,1:40]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real2SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{hive_result_pit_6875_220752_46090864={*=[@15,91:91='t',<321>,1:91]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={sub=query0, def_query0={t=hive_result_pit_6875_220752_46090864, interface={*={column={name=*, table_ref=t}}}, hive_result_pit_6875_220752_46090864={*=[@15,91:91='t',<321>,1:91]}}, interface={02_College_Name={column={name=College_Name, table_ref=sub}}, 01_College_Cd={column={name=College_Code, table_ref=sub}}}, query0={College_Name=[@7,42:44='sub',<321>,1:42], College_Code=[@1,7:9='sub',<321>,1:7]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void real3SelectListNumericPrefixAliasingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{hive_result_pit_5223_164727_46090703={*=[@15,146:146='t',<321>,1:146]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={sub=query0, def_query0={t=hive_result_pit_5223_164727_46090703, hive_result_pit_5223_164727_46090703={*=[@15,146:146='t',<321>,1:146]}, interface={*={column={name=*, table_ref=t}}}}, interface={02_COURSE_REGISTRATION_DESC={column={name=Course_Registration_Description, table_ref=sub}}, 01_COURSE_REGISTRATION_CD={column={name=Course_Registration_Code, table_ref=sub}}}, query0={Course_Registration_Description=[@7,66:68='sub',<321>,1:66], Course_Registration_Code=[@1,7:9='sub',<321>,1:7]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void extendedVariableNamePopulationSubnamerTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}>={col=[@1,9:9='a',<321>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[schema].[entity].{pop1}>, <[schema].[entity].{pop1}>={col=[@1,9:9='a',<321>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void extendedVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[schema].[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<321>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[schema].[entity].{pop1}.[Current Batch]>, <[schema].[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<321>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationSubnameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}>={col=[@1,9:9='a',<321>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[entity].{pop1}>, <[entity].{pop1}>={col=[@1,9:9='a',<321>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void entityVariableNamePopulationQualifierTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<[entity].{pop1}.[Current Batch]>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<321>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=<[entity].{pop1}.[Current Batch]>, <[entity].{pop1}.[Current Batch]>={col=[@1,9:9='a',<321>,1:9]}, interface={col={column={name=col, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicSelectListTryCasting2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={col2=[@11,41:44='col2',<321>,1:41], col3=[@22,69:72='col3',<321>,1:69], col1=[@3,17:20='col1',<321>,1:17]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={col2=[@11,41:44='col2',<321>,1:41], col3=[@22,69:72='col3',<321>,1:69], col1=[@3,17:20='col1',<321>,1:17]}, interface={a={function={function_name=TRY_cast, data_type={type=BOOLEAN}, type=TRY_CAST, value={column={name=col1, table_ref=null}}}}, b={function={function_name=cast, data_type={length=2, type=VARCHAR}, type=CAST, value={column={name=col2, table_ref=null}}}}, c={function={function_name=cast, data_type={precision=9, scale=3, type=NUMERIC}, type=CAST, value={column={name=col3, table_ref=null}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsWhereConditionTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[@1,8:11='colu',<321>,1:8], cola=[@7,34:37='cola',<321>,1:34]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={colu=[@1,8:11='colu',<321>,1:8], cola=[@7,34:37='cola',<321>,1:34]}, interface={colu={column={name=colu, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsCalculationTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[@1,8:11='colu',<321>,1:8], cola=[@5,20:23='cola',<321>,1:20]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={colu=[@1,8:11='colu',<321>,1:8], cola=[@5,20:23='cola',<321>,1:20]}, interface={unnamed_0={calc={left={column={name=colu, table_ref=null}}, right={function={function_name=cast, data_type={precision=9, type=NUMERIC}, type=CAST, value={column={name=cola, table_ref=null}}}}, operator=+}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsJoinConditionTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={colu=[@1,8:11='tab1',<321>,1:8], cola=[@9,41:44='tab1',<321>,1:41]}, tab2={cola=[@15,58:61='tab2',<321>,1:58]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={colu=[@1,8:11='tab1',<321>,1:8], cola=[@9,41:44='tab1',<321>,1:41]}, tab2={cola=[@15,58:61='tab2',<321>,1:58]}, interface={colu={column={name=colu, table_ref=tab1}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void castInDifferentContextsOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={a=[@1,8:8='a',<321>,1:8], b=[@3,11:11='b',<321>,1:11], cola=[@10,37:40='cola',<321>,1:37]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={a=[@1,8:8='a',<321>,1:8], b=[@3,11:11='b',<321>,1:11], cola=[@10,37:40='cola',<321>,1:37]}, interface={a={column={name=a, table_ref=null}}, b={column={name=b, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicJoinWithOnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[@11,43:43='a',<321>,1:43], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@15,49:49='b',<321>,1:49]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=third, b=fourth, third={a=[@11,43:43='a',<321>,1:43], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@15,49:49='b',<321>,1:49]}, interface={*={column={name=*, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicLeftJoinWithOnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[@12,48:48='a',<321>,1:48], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@16,54:54='b',<321>,1:54]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=third, b=fourth, third={a=[@12,48:48='a',<321>,1:48], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@16,54:54='b',<321>,1:54]}, interface={*={column={name=*, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicJoinWithOnParenthesisTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[@12,43:43='a',<321>,1:43], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@16,49:49='b',<321>,1:49]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=third, b=fourth, third={a=[@12,43:43='a',<321>,1:43], *=[@1,8:8='a',<321>,1:8]}, fourth={b=[@16,49:49='b',<321>,1:49]}, interface={*={column={name=*, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicJoinWithOnOnConditionVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<OnJoinCondition>=condition}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[@1,8:8='a',<321>,1:8]}, fourth={}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=third, b=fourth, third={*=[@1,8:8='a',<321>,1:8]}, fourth={}, interface={*={column={name=*, table_ref=a}}}}}",
				extractor.getSymbolTable().toString());
	}
...
//	}
	...
	public void descReservedWordTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@6,32:36='apple',<321>,1:32]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@6,32:36='apple',<321>,1:32]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void rankReservedWordTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={row_num=[@16,76:82='row_num',<321>,1:76], k_stfd=[@8,33:38='k_stfd',<321>,1:33], kppi=[@10,41:44='kppi',<321>,1:41], OBSERVATION_TM=[@13,55:68='OBSERVATION_TM',<321>,1:55]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={row_num=[@16,76:82='row_num',<321>,1:76], k_stfd=[@8,33:38='k_stfd',<321>,1:33], kppi=[@10,41:44='kppi',<321>,1:41], OBSERVATION_TM=[@13,55:68='OBSERVATION_TM',<321>,1:55]}, interface={key_rank={window_function={over={partition_by={1={column={name=k_stfd, table_ref=null}}, 2={column={name=kppi, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=OBSERVATION_TM, table_ref=null}}, sort_order=desc}, 2={null_order=null, predicand={column={name=row_num, table_ref=null}}, sort_order=desc}}}, function={function_name=rank, parameters=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void queryHasRankAsBothColumnAndReservedWordTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={row_num=[@16,76:82='row_num',<321>,1:76], k_stfd=[@8,33:38='k_stfd',<321>,1:33], kppi=[@10,41:44='kppi',<321>,1:41], OBSERVATION_TM=[@13,55:68='OBSERVATION_TM',<321>,1:55]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={row_num=[@16,76:82='row_num',<321>,1:76], k_stfd=[@8,33:38='k_stfd',<321>,1:33], kppi=[@10,41:44='kppi',<321>,1:41], OBSERVATION_TM=[@13,55:68='OBSERVATION_TM',<321>,1:55]}, interface={rank={window_function={over={partition_by={1={column={name=k_stfd, table_ref=null}}, 2={column={name=kppi, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=OBSERVATION_TM, table_ref=null}}, sort_order=desc}, 2={null_order=null, predicand={column={name=row_num, table_ref=null}}, sort_order=desc}}}, function={function_name=rank, parameters=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void realisticRankAndDescColumnNameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={is_active=[@7,39:47='is_active',<321>,1:39], student=[@15,66:72='student',<321>,1:66], rank=[@11,54:57='rank',<125>,1:54], category=[@5,29:36='category',<321>,1:29], nk=[@9,50:51='nk',<321>,1:50], desc=[@13,60:63='desc',<75>,1:60]}, <NAV>={is_active=[@29,163:171='is_active',<321>,1:163], student=[@37,190:196='student',<321>,1:190], rank=[@33,178:181='rank',<125>,1:178], category=[@27,153:160='category',<321>,1:153], nk=[@31,174:175='nk',<321>,1:174], desc=[@35,184:187='desc',<75>,1:184]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union2={query0={<Guide>={is_active=[@7,39:47='is_active',<321>,1:39], student=[@15,66:72='student',<321>,1:66], rank=[@11,54:57='rank',<125>,1:54], category=[@5,29:36='category',<321>,1:29], nk=[@9,50:51='nk',<321>,1:50], desc=[@13,60:63='desc',<75>,1:60]}, Guide_Student_Conditions=<Guide>, interface={app_name={literal='Guide'}, is_active={column={name=is_active, table_ref=null}}, student={column={name=student, table_ref=null}}, rank={column={name=rank, table_ref=null}}, category={column={name=category, table_ref=null}}, nk={column={name=nk, table_ref=null}}, desc={column={name=desc, table_ref=null}}}}, interface={app_name=query_column, is_active=query_column, student=query_column, rank=query_column, category=query_column, nk=query_column, desc=query_column}, query1={Nav_Student_Conditions=<NAV>, <NAV>={is_active=[@29,163:171='is_active',<321>,1:163], student=[@37,190:196='student',<321>,1:190], rank=[@33,178:181='rank',<125>,1:178], category=[@27,153:160='category',<321>,1:153], nk=[@31,174:175='nk',<321>,1:174], desc=[@35,184:187='desc',<75>,1:184]}, interface={app_name={literal='Nav'}, is_active={column={name=is_active, table_ref=null}}, student={column={name=student, table_ref=null}}, rank={column={name=rank, table_ref=null}}, category={column={name=category, table_ref=null}}, nk={column={name=nk, table_ref=null}}, desc={column={name=desc, table_ref=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void whereConditionWithNegationTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void whereConditionWithSingleColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<subject code>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], <subject code>={substitution={name=<subject code>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], <subject code>={substitution={name=<subject code>, type=column}}}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void whereIsTrueTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={subj=[@5,29:32='subj',<321>,1:29], apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={subj=[@5,29:32='subj',<321>,1:29], apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void whereConditionWithMixedConditionAndPredicandVariablesTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<subject code_condition>=condition, <subject_code_predicand>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={banana=[@9,85:90='banana',<321>,1:85], apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={banana=[@9,85:90='banana',<321>,1:85], apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={*=[@1,7:7='*',<287>,1:7], col1=[@6,28:31='col1',<321>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={*=[@1,7:7='*',<287>,1:7], col1=[@6,28:31='col1',<321>,1:28]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void multipleColumnsWithNullsDecoratorsOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={*=[@1,7:7='*',<287>,1:7], col2=[@11,49:52='col2',<321>,1:49], col1=[@6,28:31='col1',<321>,1:28]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={*=[@1,7:7='*',<287>,1:7], col2=[@11,49:52='col2',<321>,1:49], col1=[@6,28:31='col1',<321>,1:28]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicBetweenTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@7,39:39='c',<321>,1:39], d=[@9,45:45='d',<321>,1:45]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@7,39:39='c',<321>,1:39], d=[@9,45:45='d',<321>,1:45]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicBetweenTestWithSymmetry() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@8,49:49='c',<321>,1:49], d=[@10,55:55='d',<321>,1:55]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@8,49:49='c',<321>,1:49], d=[@10,55:55='d',<321>,1:55]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicNotBetweenTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@8,43:43='c',<321>,1:43], d=[@10,49:49='d',<321>,1:49]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@8,43:43='c',<321>,1:43], d=[@10,49:49='d',<321>,1:49]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicNotBetweenTestWithSymmetry() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@9,53:53='c',<321>,1:53], d=[@11,59:59='d',<321>,1:59]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@5,29:29='a',<321>,1:29], c=[@9,53:53='c',<321>,1:53], d=[@11,59:59='d',<321>,1:59]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void predicandAndColumnVariableNotBetweenTestWithSymmetry() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<c>=column, <a>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], d=[@13,68:68='d',<321>,1:68], <c>={substitution={name=<c>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], d=[@13,68:68='d',<321>,1:68], <c>={substitution={name=<c>, type=column}}}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void stringFunctionWithInStatementParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={a=[@9,38:38='a',<321>,1:38], field1=[@6,29:34='field1',<321>,1:29], b=[@11,43:43='b',<321>,1:43], field2=[@17,59:64='field2',<321>,1:59], subj_code=[@25,95:103='subj_code',<321>,1:95]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={a=[@9,38:38='a',<321>,1:38], field1=[@6,29:34='field1',<321>,1:29], b=[@11,43:43='b',<321>,1:43], field2=[@17,59:64='field2',<321>,1:59], subj_code=[@25,95:103='subj_code',<321>,1:95]}, interface={unnamed_1={concatenate={1={column={name=a, table_ref=null}}, 2={column={name=b, table_ref=null}}}}, unnamed_2={function={parameters={1={concatenate={1={literal='0'}, 2={column={name=field2, table_ref=null}}}}, 2={literal='0'}}, function_name=trim}}, unnamed_0={function={function_name=trim, parameters={qualifier=leading, trim_character={literal='0'}, value={column={name=field1, table_ref=null}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{other={*=[@18,79:79='*',<287>,1:79]}, scbcrse={item=[@14,63:66='item',<321>,1:63], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,32:40='subj_code',<321>,1:32]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={aa=scbcrse, scbcrse={item=[@14,63:66='item',<321>,1:63], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,32:40='subj_code',<321>,1:32]}, interface={*={column={name=*, table_ref=*}}}, query0={other={*=[@18,79:79='*',<287>,1:79]}, interface={*={column={name=*, table_ref=*}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateInListSubqueryVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist subquery>=query}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@14,62:65='item',<321>,1:62], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,31:39='subj_code',<321>,1:31]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={item=[@14,62:65='item',<321>,1:62], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,31:39='subj_code',<321>,1:31]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void inPredicateInListVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist substitution>=in_list}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@6,33:36='item',<321>,1:33], *=[@1,7:7='*',<287>,1:7]}}",
				extractor.getTableColumnMap().toString());
	...
	public void notInPredicateSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{other={*=[@20,87:87='*',<287>,1:87]}, scbcrse={item=[@15,67:70='item',<321>,1:67], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,32:40='subj_code',<321>,1:32]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={aa=scbcrse, scbcrse={item=[@15,67:70='item',<321>,1:67], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,32:40='subj_code',<321>,1:32]}, interface={*={column={name=*, table_ref=*}}}, query0={other={*=[@20,87:87='*',<287>,1:87]}, interface={*={column={name=*, table_ref=*}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void notInPredicateInListSubqueryVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<inlist subquery>=query}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={item=[@15,66:69='item',<321>,1:66], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,31:39='subj_code',<321>,1:31]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={item=[@15,66:69='item',<321>,1:66], *=[@1,7:7='*',<287>,1:7], subj_code=[@6,31:39='subj_code',<321>,1:31]}, interface={*={column={name=*, table_ref=*}}}}}",
				extractor.getSymbolTable().toString());
	}
...
//				extractor.getSymbolTable().toString());
	...
	public void likeCondition1V1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={subj_cd=[@5,29:35='subj_cd',<321>,1:29], apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={subj_cd=[@5,29:35='subj_cd',<321>,1:29], apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void likeCondition1WithColumnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={subj_cd=[@7,42:48='subj_cd',<321>,1:42], apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={subj_cd=[@7,42:48='subj_cd',<321>,1:42], apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void notLikeCondition1WithColumnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={subj_cd=[@8,47:53='subj_cd',<321>,1:47], apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={subj_cd=[@8,47:53='subj_cd',<321>,1:47], apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCaseExplicitConditionExpressionTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column1=[@2,10:16='column1',<321>,1:10], column2=[@8,39:45='column2',<321>,1:39]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column1=[@2,10:16='column1',<321>,1:10], column2=[@8,39:45='column2',<321>,1:39]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCaseImpliedConditionExpressionV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicCaseImpliedColumnExpressionV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5], column3=[@7,40:46='column3',<321>,1:40], column2=[@3,18:24='column2',<321>,1:18]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5], column3=[@7,40:46='column3',<321>,1:40], column2=[@3,18:24='column2',<321>,1:18]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseImpliedConditionExpressionWithPredicandSubstitutionPos1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<item>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{s949={t_student_last_name=[@23,161:164='S949',<321>,1:161]}, s948={OBSERVATION_TM=[@3,27:30='s948',<321>,1:27], t_student_last_name=[@19,135:138='S948',<321>,1:135]}, unknown={observation_time=[@1,5:20='observation_time',<321>,1:5]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{S948={t_student_last_name=[@19,135:138='S948',<321>,1:135]}, S949={t_student_last_name=[@23,161:164='S949',<321>,1:161]}, unknown={observation_time=[@1,5:20='observation_time',<321>,1:5]}, s948={OBSERVATION_TM=[@3,27:30='s948',<321>,1:27]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseImpliedConditionExpressionWithPredicandSubstitutionPos2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column1>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column3=[@7,42:48='column3',<321>,1:42], column2=[@3,20:26='column2',<321>,1:20]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column3=[@7,42:48='column3',<321>,1:42], column2=[@3,20:26='column2',<321>,1:20]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseImpliedConditionExpressionWithPredicandSubstitutionPos4Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column5>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5], column4=[@9,53:59='column4',<321>,1:53], column3=[@7,40:46='column3',<321>,1:40], column2=[@3,18:24='column2',<321>,1:18]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column1=[@1,5:11='column1',<321>,1:5], column4=[@9,53:59='column4',<321>,1:53], column3=[@7,40:46='column3',<321>,1:40], column2=[@3,18:24='column2',<321>,1:18]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseExplicitConditionExpressionWithPredicandSubstitutionPos1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column1>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column2=[@8,41:47='column2',<321>,1:41]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column2=[@8,41:47='column2',<321>,1:41]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseExplicitConditionExpressionWithPredicandSubstitutionPos2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column1>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={<column1>={substitution={name=<column1>, type=column}}, column2=[@10,42:42='a',<321>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={column2=[@10,42:42='a',<321>,1:42], <column1>={substitution={name=<column1>, type=column}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseExplicitConditionExpressionWithPredicandSubstitutionPos3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column1>=condition}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column2=[@6,34:40='column2',<321>,1:34]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column2=[@6,34:40='column2',<321>,1:34]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseExplicitConditionExpressionWithPredicandSubstitutionPos4Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<predicand>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={column1=[@2,10:10='a',<321>,1:10], column2=[@10,40:40='a',<321>,1:40]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={column1=[@2,10:10='a',<321>,1:10], column2=[@10,40:40='a',<321>,1:40]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void complexCaseExplicitConditionExpressionWithPredicandSubstitutionPos6Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column4>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={column1=[@2,10:10='a',<321>,1:10], <column4>={substitution={name=<column4>, type=column}}, column2=[@10,40:40='a',<321>,1:40]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={column1=[@2,10:10='a',<321>,1:10], column2=[@10,40:40='a',<321>,1:40], <column4>={substitution={name=<column4>, type=column}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void caseExpressionStatementParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sgbstdn={a=[@9,38:38='a',<321>,1:38], b=[@11,42:42='b',<321>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={sgbstdn={a=[@9,38:38='a',<321>,1:38], b=[@11,42:42='b',<321>,1:42]}, interface={case_one={case={clauses={1={then={literal='Y'}, when={condition={left={column={name=a, table_ref=null}}, right={column={name=b, table_ref=null}}, operator=<}}}, 2={then={literal='N'}, when={condition={left={column={name=a, table_ref=null}}, right={column={name=b, table_ref=null}}, operator==}}}}, else={literal='N'}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void trimFunctionVariationsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={field2=[@13,50:55='field2',<321>,1:50], field1=[@6,29:34='field1',<321>,1:29]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={scbcrse={field2=[@13,50:55='field2',<321>,1:50], field1=[@6,29:34='field1',<321>,1:29]}, interface={unnamed_1={function={parameters={1={concatenate={1={literal='0'}, 2={column={name=field2, table_ref=null}}}}, 2={literal='0'}}, function_name=trim}}, unnamed_0={function={function_name=trim, parameters={qualifier=leading, trim_character={literal='0'}, value={column={name=field1, table_ref=null}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={TERM_CODE_ADMIT=[@9,59:73='TERM_CODE_ADMIT',<321>,1:59], spriden_id=[@1,8:17='spriden_id',<321>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={TERM_CODE_ADMIT=[@9,59:73='TERM_CODE_ADMIT',<321>,1:59], spriden_id=[@1,8:17='spriden_id',<321>,1:8]}, interface={TERM_CODE_ADMIT={column={name=TERM_CODE_ADMIT, table_ref=null}}, spriden_id={column={name=spriden_id, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionVariableHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<condition>=condition, <condition2>=condition}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<321>,1:21], spriden_id=[@1,8:17='spriden_id',<321>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<321>,1:21], spriden_id=[@1,8:17='spriden_id',<321>,1:8]}, interface={TERM_CODE_ADMIT={column={name=TERM_CODE_ADMIT, table_ref=null}}, spriden_id={column={name=spriden_id, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void columnVariableHavingTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<condition>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={<condition>={substitution={name=<condition>, type=column}}, spriden_id=[@1,8:17='spriden_id',<321>,1:8], TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<321>,1:21]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={<condition>={substitution={name=<condition>, type=column}}, TERM_CODE_ADMIT=[@3,21:35='TERM_CODE_ADMIT',<321>,1:21], spriden_id=[@1,8:17='spriden_id',<321>,1:8]}, interface={TERM_CODE_ADMIT={column={name=TERM_CODE_ADMIT, table_ref=null}}, spriden_id={column={name=spriden_id, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicOrderByTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@8,42:46='apple',<321>,1:42], fruit_cd=[@12,52:59='fruit_cd',<321>,1:52]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@8,42:46='apple',<321>,1:42], fruit_cd=[@12,52:59='fruit_cd',<321>,1:52]}, interface={apple={column={name=apple, table_ref=null}}, fruit_cd={column={name=fruit_cd, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicOrderByWithPredicandVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<predicand variable>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], fruit_cd=[@11,69:76='fruit_cd',<321>,1:69]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], fruit_cd=[@11,69:76='fruit_cd',<321>,1:69]}, interface={apple={column={name=apple, table_ref=null}}, fruit_cd={column={name=fruit_cd, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicOrderByWithColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<column variable>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], <column variable>={substitution={name=<column variable>, type=column}}, fruit_cd=[@13,71:78='fruit_cd',<321>,1:71]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], <column variable>={substitution={name=<column variable>, type=column}}, fruit_cd=[@13,71:78='fruit_cd',<321>,1:71]}, interface={apple={column={name=apple, table_ref=null}}, fruit_cd={column={name=fruit_cd, table_ref=null}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@11,42:46='apple',<321>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@11,42:46='apple',<321>,1:42]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=COUNT, qualifier=null, parameters=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<other>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], <other>={substitution={name=<other>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], <other>={substitution={name=<other>, type=column}}}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=COUNT, qualifier=null, parameters=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithMultiplePredicandsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<predicand>=predicand, <other>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@18,70:70='a',<321>,1:70], <other>={substitution={name=<other>, type=column}}, b=[@20,72:72='b',<321>,1:72], c=[@22,74:74='c',<321>,1:74]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7], a=[@18,70:70='a',<321>,1:70], b=[@20,72:72='b',<321>,1:72], c=[@22,74:74='c',<321>,1:74], <other>={substitution={name=<other>, type=column}}}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=COUNT, qualifier=null, parameters=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithPredicandVariableTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@1,7:11='apple',<321>,1:7]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@1,7:11='apple',<321>,1:7]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=COUNT, qualifier=null, parameters=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithCountOverCalcTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@13,54:58='apple',<321>,1:54], subj=[@5,20:23='subj',<321>,1:20], object=[@7,27:32='object',<265>,1:27]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@13,54:58='apple',<321>,1:54], subj=[@5,20:23='subj',<321>,1:20], object=[@7,27:32='object',<265>,1:27]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=count, qualifier=null, parameters={calc={left={column={name=subj, table_ref=null}}, right={column={name=object, table_ref=null}}, operator=+}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithCountOverColumnVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<other>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@13,53:57='apple',<321>,1:53], <other>={substitution={name=<other>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@13,53:57='apple',<321>,1:53], <other>={substitution={name=<other>, type=column}}}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=count, qualifier=null, parameters={column={substitution={name=<other>, type=column}, table_ref=tab1}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicAggregateQueryWithCountOverPredicandVariableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<other>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={apple=[@11,48:52='apple',<321>,1:48]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={tab1={apple=[@11,48:52='apple',<321>,1:48]}, interface={apple={column={name=apple, table_ref=null}}, unnamed_0={function={function_name=count, qualifier=null, parameters={substitution={name=<other>, type=predicand}}}}}}}",
				extractor.getSymbolTable().toString());
	}
  ...
  // Snowflake Aggregate Function APPROX_PERCENTILE_COMBINE
	...
	public void rankPartitionSyntaxTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={row_num=[@16,78:84='row_num',<321>,1:78], k_stfd=[@8,35:40='k_stfd',<321>,1:35], kppi=[@10,43:46='kppi',<321>,1:43], OBSERVATION_TM=[@13,57:70='OBSERVATION_TM',<321>,1:57]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=tab1, tab1={row_num=[@16,78:84='row_num',<321>,1:78], k_stfd=[@8,35:40='k_stfd',<321>,1:35], kppi=[@10,43:46='kppi',<321>,1:43], OBSERVATION_TM=[@13,57:70='OBSERVATION_TM',<321>,1:57]}, interface={key_rank={window_function={over={partition_by={1={column={name=k_stfd, table_ref=null}}, 2={column={name=kppi, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=OBSERVATION_TM, table_ref=null}}, sort_order=desc}, 2={null_order=null, predicand={column={name=row_num, table_ref=null}}, sort_order=desc}}}, function={function_name=rank, parameters=null}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void rankWithParameterPartitionSyntaxTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={parm=[@3,14:17='parm',<321>,1:14], row_num=[@17,82:88='row_num',<321>,1:82], k_stfd=[@9,39:44='k_stfd',<321>,1:39], kppi=[@11,47:50='kppi',<321>,1:47], OBSERVATION_TM=[@14,61:74='OBSERVATION_TM',<321>,1:61]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={a=tab1, tab1={parm=[@3,14:17='parm',<321>,1:14], row_num=[@17,82:88='row_num',<321>,1:82], k_stfd=[@9,39:44='k_stfd',<321>,1:39], kppi=[@11,47:50='kppi',<321>,1:47], OBSERVATION_TM=[@14,61:74='OBSERVATION_TM',<321>,1:61]}, interface={key_rank={window_function={over={partition_by={1={column={name=k_stfd, table_ref=null}}, 2={column={name=kppi, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=OBSERVATION_TM, table_ref=null}}, sort_order=desc}, 2={null_order=null, predicand={column={name=row_num, table_ref=null}}, sort_order=desc}}}, function={function_name=rank, parameters={1={column={name=parm, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lagWindowIgnoreNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@23,153:160='major_cd',<321>,1:153], student_id=[@11,58:67='student_id',<321>,1:58], value_partition=[@13,70:84='value_partition',<321>,1:70], term_row=[@16,95:102='term_row',<321>,1:95]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@23,153:160='major_cd',<321>,1:153], student_id=[@11,58:67='student_id',<321>,1:58], value_partition=[@13,70:84='value_partition',<321>,1:70], term_row=[@16,95:102='term_row',<321>,1:95]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=lag, parameters={1={column={name=major_cd, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void leadWindowIgnoreNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@23,154:161='major_cd',<321>,1:154], student_id=[@11,59:68='student_id',<321>,1:59], value_partition=[@13,71:85='value_partition',<321>,1:71], term_row=[@16,96:103='term_row',<321>,1:96]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@23,154:161='major_cd',<321>,1:154], student_id=[@11,59:68='student_id',<321>,1:59], value_partition=[@13,71:85='value_partition',<321>,1:71], term_row=[@16,96:103='term_row',<321>,1:96]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=lead, parameters={1={column={name=major_cd, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lastValueWindowIgnoreNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@23,160:167='major_cd',<321>,1:160], student_id=[@11,65:74='student_id',<321>,1:65], value_partition=[@13,77:91='value_partition',<321>,1:77], term_row=[@16,102:109='term_row',<321>,1:102]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@23,160:167='major_cd',<321>,1:160], student_id=[@11,65:74='student_id',<321>,1:65], value_partition=[@13,77:91='value_partition',<321>,1:77], term_row=[@16,102:109='term_row',<321>,1:102]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=last_value, parameters={1={column={name=major_cd, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void lastValueWindowRespectNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@23,161:168='major_cd',<321>,1:161], student_id=[@11,66:75='student_id',<321>,1:66], value_partition=[@13,78:92='value_partition',<321>,1:78], term_row=[@16,103:110='term_row',<321>,1:103]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@23,161:168='major_cd',<321>,1:161], student_id=[@11,66:75='student_id',<321>,1:66], value_partition=[@13,78:92='value_partition',<321>,1:78], term_row=[@16,103:110='term_row',<321>,1:103]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=respect, function_name=last_value, parameters={1={column={name=major_cd, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void firstValueWindowRespectNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@23,162:169='major_cd',<321>,1:162], student_id=[@11,67:76='student_id',<321>,1:67], value_partition=[@13,79:93='value_partition',<321>,1:79], term_row=[@16,104:111='term_row',<321>,1:104]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@23,162:169='major_cd',<321>,1:162], student_id=[@11,67:76='student_id',<321>,1:67], value_partition=[@13,79:93='value_partition',<321>,1:79], term_row=[@16,104:111='term_row',<321>,1:104]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=respect, function_name=first_value, parameters={1={column={name=major_cd, table_ref=null}}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nthValueWindowIgnoreNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@25,162:169='major_cd',<321>,1:162], student_id=[@13,67:76='student_id',<321>,1:67], value_partition=[@15,79:93='value_partition',<321>,1:79], term_row=[@18,104:111='term_row',<321>,1:104]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@25,162:169='major_cd',<321>,1:162], student_id=[@13,67:76='student_id',<321>,1:67], value_partition=[@15,79:93='value_partition',<321>,1:79], term_row=[@18,104:111='term_row',<321>,1:104]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=nth_value, parameters={1={column={name=major_cd, table_ref=null}}, 2={literal=2}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nthValueWindowRespectNullsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@25,163:170='major_cd',<321>,1:163], student_id=[@13,68:77='student_id',<321>,1:68], value_partition=[@15,80:94='value_partition',<321>,1:80], term_row=[@18,105:112='term_row',<321>,1:105]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@25,163:170='major_cd',<321>,1:163], student_id=[@13,68:77='student_id',<321>,1:68], value_partition=[@15,80:94='value_partition',<321>,1:80], term_row=[@18,105:112='term_row',<321>,1:105]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=respect, function_name=nth_value, parameters={1={column={name=major_cd, table_ref=null}}, 2={literal=2}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nthValueWindowIgnoreNullsFromFirstTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@27,173:180='major_cd',<321>,1:173], student_id=[@15,78:87='student_id',<321>,1:78], value_partition=[@17,90:104='value_partition',<321>,1:90], term_row=[@20,115:122='term_row',<321>,1:115]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@27,173:180='major_cd',<321>,1:173], student_id=[@15,78:87='student_id',<321>,1:78], value_partition=[@17,90:104='value_partition',<321>,1:90], term_row=[@20,115:122='term_row',<321>,1:115]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=nth_value, select_from=first, parameters={1={column={name=major_cd, table_ref=null}}, 2={literal=2}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nthValueWindowIgnoreNullsFromLastTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student_term_major={major_cd=[@27,172:179='major_cd',<321>,1:172], student_id=[@15,77:86='student_id',<321>,1:77], value_partition=[@17,89:103='value_partition',<321>,1:89], term_row=[@20,114:121='term_row',<321>,1:114]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student_term_major={major_cd=[@27,172:179='major_cd',<321>,1:172], student_id=[@15,77:86='student_id',<321>,1:77], value_partition=[@17,89:103='value_partition',<321>,1:89], term_row=[@20,114:121='term_row',<321>,1:114]}, interface={major_cd_fill={window_function={over={partition_by={1={column={name=student_id, table_ref=null}}, 2={column={name=value_partition, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=term_row, table_ref=null}}, sort_order=ASC}}}, function={null_handle=ignore, function_name=nth_value, select_from=last, parameters={1={column={name=major_cd, table_ref=null}}, 2={literal=2}}}}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={row_num=[@15,69:75='row_num',<321>,1:69], k_stfd=[@7,26:31='k_stfd',<321>,1:26], kppi=[@9,34:37='kppi',<321>,1:34], OBSERVATION_TM=[@12,48:61='OBSERVATION_TM',<321>,1:48]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={k_stfd=[@7,26:31='k_stfd',<321>,1:26], row_num=[@15,69:75='row_num',<321>,1:69], kppi=[@9,34:37='kppi',<321>,1:34], OBSERVATION_TM=[@12,48:61='OBSERVATION_TM',<321>,1:48]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionColumnVariableP1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<columnParam>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={<columnParam>={substitution={name=<columnParam>, type=column}}, row_num=[@19,67:67='a',<321>,1:67], k_stfd=[@10,41:41='a',<321>,1:41], kppi=[@14,51:51='a',<321>,1:51]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={<columnParam>={substitution={name=<columnParam>, type=column}}, k_stfd=[@10,41:41='a',<321>,1:41], row_num=[@19,67:67='a',<321>,1:67], kppi=[@14,51:51='a',<321>,1:51]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionColumnVariableP2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<k_stfd>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={column=[@2,5:5='a',<321>,1:5], row_num=[@19,62:62='a',<321>,1:62], kppi=[@14,46:46='a',<321>,1:46], <k_stfd>={substitution={name=<k_stfd>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={<k_stfd>={substitution={name=<k_stfd>, type=column}}, column=[@2,5:5='a',<321>,1:5], row_num=[@19,62:62='a',<321>,1:62], kppi=[@14,46:46='a',<321>,1:46]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionColumnVariableP3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<row_num>=column}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={column=[@2,5:5='a',<321>,1:5], <row_num>={substitution={name=<row_num>, type=column}}, k_stfd=[@10,34:34='a',<321>,1:34], kppi=[@14,44:44='a',<321>,1:44]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={k_stfd=[@10,34:34='a',<321>,1:34], column=[@2,5:5='a',<321>,1:5], <row_num>={substitution={name=<row_num>, type=column}}, kppi=[@14,44:44='a',<321>,1:44]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionPredicandVariableP1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<columnParam>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={row_num=[@13,61:67='row_num',<321>,1:61], k_stfd=[@8,39:44='k_stfd',<321>,1:39], kppi=[@10,47:50='kppi',<321>,1:47]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={k_stfd=[@8,39:44='k_stfd',<321>,1:39], row_num=[@13,61:67='row_num',<321>,1:61], kppi=[@10,47:50='kppi',<321>,1:47]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionPredicandVariableP2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<k_stfd>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column=[@2,5:10='column',<68>,1:5], row_num=[@13,56:62='row_num',<321>,1:56], kppi=[@10,42:45='kppi',<321>,1:42]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={column=[@2,5:10='column',<68>,1:5], row_num=[@13,56:62='row_num',<321>,1:56], kppi=[@10,42:45='kppi',<321>,1:42]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void windowFunctionPredicandVariableP3Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<row_num>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={column=[@2,5:10='column',<68>,1:5], k_stfd=[@8,32:37='k_stfd',<321>,1:32], kppi=[@10,40:43='kppi',<321>,1:40]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={k_stfd=[@8,32:37='k_stfd',<321>,1:32], column=[@2,5:10='column',<68>,1:5], kppi=[@10,40:43='kppi',<321>,1:40]}}",
				extractor.getSymbolTable().toString());
	}
...
//	}
	...
	public void formulaWithSubstitution() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{old_table={otherColumn=[@7,33:43='otherColumn',<321>,1:33], newColumn=[@3,12:20='old_table',<321>,1:12], <today>={substitution={name=<today>, type=column}}}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={old_table={newColumn=[@3,12:20='old_table',<321>,1:12], otherColumn=[@7,33:43='otherColumn',<321>,1:33], <today>={substitution={name=<today>, type=column}}}, interface={ex={function={parameters={1={column={name=newColumn, table_ref=old_table}}, 2={column={name=otherColumn, table_ref=null}}, 3={substitution={name=<substitute_me>, type=predicand}}, 4={column={substitution={name=<today>, type=column}, table_ref=old_table}}, 5={literal=128.9}, 6={literal='A'}}, function_name=func}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void interfaceHandlingOfSubstitution() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<notmissing>=predicand, <missing>=predicand}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{student={normalColumn=[@1,8:19='normalColumn',<321>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={student={normalColumn=[@1,8:19='normalColumn',<321>,1:8]}, interface={normalColumn={column={name=normalColumn, table_ref=null}}, notMissing={substitution={name=<notmissing>, type=predicand}}, <missing>={substitution={name=<missing>, type=predicand}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void aggregateParseTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={scbcrse_subj_code=[@23,127:143=\'scbcrse_subj_code\',<321>,1:127], scbcrse_eff_term=[@12,54:69=\'scbcrse_eff_term\',<321>,1:54]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={scbcrse={scbcrse_subj_code=[@23,127:143='scbcrse_subj_code',<321>,1:127], scbcrse_eff_term=[@12,54:69='scbcrse_eff_term',<321>,1:54]}, interface={subj_code={column={name=scbcrse_subj_code, table_ref=null}}, unnamed_1={function={function_name=MAX, qualifier=null, parameters={column={name=scbcrse_eff_term, table_ref=null}}}}, unnamed_0={function={function_name=COUNT, qualifier=null, parameters=*}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicColumnValueTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={emp_sales_count=[@0,0:14='emp_sales_count',<321>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={emp_sales_count=[@0,0:14='emp_sales_count',<321>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicTableColumnValueTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{table1={emp_sales_count=[@0,0:5='table1',<321>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{table1={emp_sales_count=[@0,0:5='table1',<321>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void concatenationParenthesisPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@1,1:1='a',<321>,1:1], b=[@3,6:6='b',<321>,1:6]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@1,1:1='a',<321>,1:1], b=[@3,6:6='b',<321>,1:6]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void functionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{crs={course_number=[@8,33:35='crs',<321>,1:33], subject_code=[@4,15:17='crs',<321>,1:15]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{crs={subject_code=[@4,15:17='crs',<321>,1:15], course_number=[@8,33:35='crs',<321>,1:33]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void aggregateFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={scbcrse_eff_term=[@2,4:19='scbcrse_eff_term',<321>,1:4]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={scbcrse_eff_term=[@2,4:19='scbcrse_eff_term',<321>,1:4]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void caseFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={Y=[@4,21:21='Y',<321>,1:21], N=[@10,50:50='N',<321>,1:50]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={Y=[@4,21:21='Y',<321>,1:21], N=[@10,50:50='N',<321>,1:50]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void trimFunctionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={field1=[@5,22:27='field1',<321>,1:22]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={field1=[@5,22:27='field1',<321>,1:22]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectLookupSubqueryPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={scbcrse_coll_code=[@2,8:9='aa',<321>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={aa=scbcrse, scbcrse={scbcrse_coll_code=[@2,8:9='aa',<321>,1:8]}, interface={scbcrse_coll_code={column={name=scbcrse_coll_code, table_ref=aa}}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void arithmeticParenExpressionPredicandTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{aa={scbcrse_coll_code=[@3,3:4='aa',<321>,1:3]}, unknown={other=[@9,30:34='other',<321>,1:30]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{aa={scbcrse_coll_code=[@3,3:4='aa',<321>,1:3]}, unknown={other=[@9,30:34='other',<321>,1:30]}}",
				extractor.getSymbolTable().toString());
	}
...
//	PUML_CONSTANT_TARGET_MODEL_NAME : '#' T A R G E T '_' M O D E L '_' N A M E;
	...
	public void conditionListOfAndsV1Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={x=[@8,16:16='x',<321>,1:16], a=[@0,0:0='a',<321>,1:0], y=[@10,19:19='y',<321>,1:19], b=[@4,8:8='b',<321>,1:8], c=[@6,10:10='c',<321>,1:10]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@0,0:0='a',<321>,1:0], b=[@4,8:8='b',<321>,1:8], c=[@6,10:10='c',<321>,1:10], x=[@8,16:16='x',<321>,1:16], y=[@10,19:19='y',<321>,1:19]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionListOfAndsV2Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={x=[@16,24:24='a',<321>,1:24], a=[@0,0:0='a',<321>,1:0], b=[@8,12:12='a',<321>,1:12]}, b={y=[@20,30:30='b',<321>,1:30], b=[@4,4:4='b',<321>,1:4], c=[@12,16:16='b',<321>,1:16]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={a=[@0,0:0='a',<321>,1:0], b=[@8,12:12='a',<321>,1:12], x=[@16,24:24='a',<321>,1:24]}, b={b=[@4,4:4='b',<321>,1:4], c=[@12,16:16='b',<321>,1:16], y=[@20,30:30='b',<321>,1:30]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionListOfOrsTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={x=[@8,14:14='x',<321>,1:14], a=[@0,0:0='a',<321>,1:0], y=[@10,17:17='y',<321>,1:17], b=[@4,7:7='b',<321>,1:7], c=[@6,9:9='c',<321>,1:9]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@0,0:0='a',<321>,1:0], b=[@4,7:7='b',<321>,1:7], c=[@6,9:9='c',<321>,1:9], x=[@8,14:14='x',<321>,1:14], y=[@10,17:17='y',<321>,1:17]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionParentheticalTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@2,2:2='a',<321>,1:2], b=[@8,11:11='b',<321>,1:11], c=[@10,13:13='c',<321>,1:13]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@2,2:2='a',<321>,1:2], b=[@8,11:11='b',<321>,1:11], c=[@10,13:13='c',<321>,1:13]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionNotTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={a=[@1,4:4='a',<321>,1:4], b=[@3,8:8='b',<321>,1:8]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={a=[@1,4:4='a',<321>,1:4], b=[@3,8:8='b',<321>,1:8]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void conditionInTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{unknown={columnName=[@0,0:9='columnName',<321>,1:0]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{unknown={columnName=[@0,0:9='columnName',<321>,1:0]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void basicJoinExtensionValueWithOnClauseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{bb={col1=[@12,41:42='bb',<321>,1:41]}, emp_sales={col1=[@8,33:34='dd',<321>,1:33]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{dd=emp_sales, bb={col1=[@12,41:42='bb',<321>,1:41]}, emp_sales={col1=[@8,33:34='dd',<321>,1:33]}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void joinExtensionLeftJoinWithOnTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{a={a=[@5,23:23='a',<321>,1:23]}, fourth={b=[@9,29:29='b',<321>,1:29]}}",
				extractor.getTableColumnMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{a={a=[@5,23:23='a',<321>,1:23]}, b=fourth, fourth={b=[@9,29:29='b',<321>,1:29]}}",
				extractor.getSymbolTable().toString());
	}
