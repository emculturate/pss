...
public class SqlEventWalkerPivotUnpivotTests extends AbstractSqlParseEventWalkerTest {
	...
	public void triplePivotUnpivotPivotJoinDerivedColumnsV1Test() {
		final String query =
			...
			"  AND feb_sales_SUM > 0 \n" +
			"ORDER BY p.jan_sales_SUM, q.feb_sales_SUM;";
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query2={jan_sales_SUM=[[@1,7:19='jan_sales_SUM',<381>,1:7], [@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], month_name=[[@5,36:45='month_name',<381>,1:36], [@34,216:225='month_name',<381>,5:26]], sales_amount=[[@3,22:33='sales_amount',<381>,1:22], [@32,199:210='sales_amount',<381>,5:9]], feb_sales_SUM=[[@7,48:60='feb_sales_SUM',<381>,1:48]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query2={query_dictionary={jan_sales_SUM=[[@1,7:19='jan_sales_SUM',<381>,1:7], [@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], month_name=[[@5,36:45='month_name',<381>,1:36], [@34,216:225='month_name',<381>,5:26]], sales_amount=[[@3,22:33='sales_amount',<381>,1:22], [@32,199:210='sales_amount',<381>,5:9]], feb_sales_SUM=[[@7,48:60='feb_sales_SUM',<381>,1:48]]}, table_dictionary={monthly_sales={jan_sales=[[@37,231:239='jan_sales',<381>,5:41]], feb_sales=[[@39,242:250='feb_sales',<381>,5:52]]}, monthly_sales_long={month_name=[[@18,121:130='month_name',<381>,3:29], [@67,384:393='month_name',<381>,8:29]], sales_amount=[[@15,103:114='sales_amount',<381>,3:11], [@64,366:377='sales_amount',<381>,8:11]]}}, derivation={source_columns={p=[{name=month_name, table_ref=p_src}, {name=sales_amount, table_ref=p_src}], q=[{name=month_name, table_ref=q_src}, {name=sales_amount, table_ref=q_src}], u=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}]}, derived_columns={p={jan_sales_SUM=[[@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], feb_sales_SUM=[[@13,99:101='SUM',<141>,3:7], [@23,149:159=''feb_sales'',<389>,3:57]]}, q={feb_sales_SUM=[[@62,362:364='SUM',<141>,8:7], [@70,399:409=''feb_sales'',<389>,8:44]]}, u={sales_amount=[[@32,199:210='sales_amount',<381>,5:9]], month_name=[[@34,216:225='month_name',<381>,5:26]]}}}, filters=[{name=jan_sales_SUM, table_ref=p}, {name=sales_amount, table_ref=u}, {name=month_name, table_ref=u}, {name=feb_sales_SUM, table_ref=q}, {name=feb_sales_SUM, table_ref=null}], interface={jan_sales_SUM=[{name=sales_amount, table_ref=p_src}], month_name=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}], sales_amount=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}], feb_sales_SUM=[{name=feb_sales_SUM, table_ref=null}]}, table_alias={p=p_src, q=q_src, p_src=monthly_sales_long, q_src=monthly_sales_long, u=u_src, u_src=monthly_sales}}}",
				extractor.getSymbolTable().toString());
	}
