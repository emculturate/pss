...
public class SqlEventWalkerPivotUnpivotTests extends AbstractSqlParseEventWalkerTest {
	...
	public void unpivotV0Test() {
		...
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query0={source_columns={tuple_0=[{name=jan_sales, table_ref=my_table}, {name=feb_sales, table_ref=my_table}, {name=mar_sales, table_ref=my_table}]}, query_dictionary={metric_name=[[@3,11:21='metric_name',<381>,1:11]], metric_value=[[@5,24:35='metric_value',<381>,1:24]], id=[[@1,7:8='id',<381>,1:7]]}, table_dictionary={my_table={jan_sales=[[@15,99:107='jan_sales',<381>,4:34]], mar_sales=[[@19,121:129='mar_sales',<381>,4:56]], id=[[@1,7:8='id',<381>,1:7]], feb_sales=[[@17,110:118='feb_sales',<381>,4:45]]}}, interface={metric_name=[{name=jan_sales, table_ref=my_table}, {name=feb_sales, table_ref=my_table}, {name=mar_sales, table_ref=my_table}], metric_value=[{name=jan_sales, table_ref=my_table}, {name=feb_sales, table_ref=my_table}, {name=mar_sales, table_ref=my_table}], id=[{name=id, table_ref=my_table}]}, derived_columns={tuple_0={metric_value=[[@10,66:77='metric_value',<381>,4:1]], metric_name=[[@12,83:93='metric_name',<381>,4:18]]}}}}",
