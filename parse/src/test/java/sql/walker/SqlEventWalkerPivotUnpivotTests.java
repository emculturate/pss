...
public class SqlEventWalkerPivotUnpivotTests extends AbstractSqlParseEventWalkerTest {
	...
	public void pivotV1Tab1Test() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={*=[[@1,7:7='*',<291>,1:7]], A_sum=[[@3,10:14='A_sum',<381>,1:10]]}, table_dictionary={tab1={*=[[@1,7:7='*',<291>,1:7]], col4=[[@25,74:77='col4',<381>,2:47]], col5=[[@30,85:88='col5',<381>,2:58]], col2=[[@15,50:53='col2',<381>,2:23], [@33,97:100='col2',<381>,3:5]], col3=[[@20,63:66='col3',<381>,2:36]], col1=[[@10,39:42='col1',<381>,2:12]]}}, interface={*=[{name=*, table_ref=*}], A_sum=[{name=A_sum, table_ref=tab1}, {name=A_sum, table_ref=null}]}, derived_columns={B_sum=[{name=col1, table_ref=tab1}], A_avg=[{name=col2, table_ref=tab1}], A_min=[{name=col5, table_ref=tab1}], A_max=[{name=col4, table_ref=tab1}], A_count=[{name=col3, table_ref=tab1}], B_max=[{name=col4, table_ref=tab1}], B_avg=[{name=col2, table_ref=tab1}], B_min=[{name=col5, table_ref=tab1}], B_count=[{name=col3, table_ref=tab1}], A_sum=[{name=col1, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	...
	public void pivotV1Tab1WithAliasQuotedSelectorsSuccessTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong",
				...
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={asum2=[[@9,33:37='asum2',<381>,1:33]], asum3=[[@14,51:55='asum3',<381>,1:51]], *=[[@1,7:7='*',<291>,1:7]], asum1=[[@6,20:24='asum1',<381>,1:20]]}, table_dictionary={tab1={*=[[@1,7:7='*',<291>,1:7]], col4=[[@36,115:118='col4',<381>,2:47]], col5=[[@41,126:129='col5',<381>,2:58]], col2=[[@26,91:94='col2',<381>,2:23], [@44,138:141='col2',<381>,3:5]], col3=[[@31,104:107='col3',<381>,2:36]], A_sum=[[@11,40:43='tab1',<381>,1:40]], col1=[[@21,80:83='col1',<381>,2:12]]}}, interface={asum2=[{name=A_sum, table_ref=tab1}], asum3=[{name=A_sum, table_ref=tab1}], *=[{name=*, table_ref=*}], asum1=[{name=A_sum, table_ref=pvt}]}, derived_columns={B_sum=[{name=col1, table_ref=pvt}], A_avg=[{name=col2, table_ref=pvt}], A_min=[{name=col5, table_ref=pvt}], A_max=[{name=col4, table_ref=pvt}], A_count=[{name=col3, table_ref=pvt}], B_max=[{name=col4, table_ref=pvt}], B_avg=[{name=col2, table_ref=pvt}], B_min=[{name=col5, table_ref=pvt}], B_count=[{name=col3, table_ref=pvt}], A_sum=[{name=col1, table_ref=pvt}]}, table_alias={pvt=tab1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void pivotBasicMonthSalesV7Test() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{monthly_sales_long={empid=[[@1,7:11='empid',<381>,1:7]], month_name=[[@17,111:120='month_name',<381>,3:29]], sales_amount=[[@14,93:104='sales_amount',<381>,3:11]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query1={empid=[[@1,7:11='empid',<381>,1:7]], jan_sales_SUM=[[@3,14:26='jan_sales_SUM',<381>,1:14]], mar_sales_SUM=[[@7,44:56='mar_sales_SUM',<381>,1:44]], feb_sales_SUM=[[@5,29:41='feb_sales_SUM',<381>,1:29]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={empid=[[@1,7:11='empid',<381>,1:7]], jan_sales_SUM=[[@3,14:26='jan_sales_SUM',<381>,1:14]], mar_sales_SUM=[[@7,44:56='mar_sales_SUM',<381>,1:44]], feb_sales_SUM=[[@5,29:41='feb_sales_SUM',<381>,1:29]]}, table_dictionary={monthly_sales_long={empid=[[@1,7:11='empid',<381>,1:7]], month_name=[[@17,111:120='month_name',<381>,3:29]], sales_amount=[[@14,93:104='sales_amount',<381>,3:11]]}}, interface={empid=[{name=empid, table_ref=monthly_sales_long}], jan_sales_SUM=[{name=jan_sales_SUM, table_ref=monthly_sales_long}, {name=jan_sales_SUM, table_ref=null}], mar_sales_SUM=[{name=mar_sales_SUM, table_ref=monthly_sales_long}, {name=mar_sales_SUM, table_ref=null}], feb_sales_SUM=[{name=feb_sales_SUM, table_ref=monthly_sales_long}, {name=feb_sales_SUM, table_ref=null}]}, derived_columns={jan_sales_SUM=[{name=sales_amount, table_ref=monthly_sales_long}], mar_sales_SUM=[{name=sales_amount, table_ref=monthly_sales_long}], feb_sales_SUM=[{name=sales_amount, table_ref=monthly_sales_long}]}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void pivotSameQuerySelectDerivedColumnFromTableTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query1={src=[[@1,7:9='src',<381>,1:7]], A_sum=[[@3,12:16='A_sum',<381>,1:12]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={src=[[@1,7:9='src',<381>,1:7]], A_sum=[[@3,12:16='A_sum',<381>,1:12]]}, table_dictionary={tab1={src=[[@1,7:9='src',<381>,1:7]], col2=[[@14,53:56='col2',<381>,3:25]], col1=[[@10,39:42='col1',<381>,3:11]]}}, interface={src=[{name=src, table_ref=tab1}], A_sum=[{name=A_sum, table_ref=tab1}, {name=A_sum, table_ref=null}]}, derived_columns={A_sum=[{name=col1, table_ref=tab1}]}}}",
				extractor.getSymbolTable().toString());
	}
