...
public class SqlEventWalkerPivotUnpivotTests extends AbstractSqlParseEventWalkerTest {
	...
	public void triplePivotUnpivotPivotJoinDerivedColumnsV1Test() {
		...
		assertFatalDiagnosticCount(
				...
				2);
		Assert.assertEquals("AST is wrong",
				"{SQL={select={1={column={name=jan_sales_SUM, table_ref=null}}, 2={column={name=sales_amount, table_ref=null}}, 3={column={name=month_name, table_ref=null}}, 4={column={name=feb_sales_SUM, table_ref=null}}}, orderby={1={null_order=null, predicand={column={name=jan_sales_SUM, table_ref=p}}, sort_order=ASC}, 2={null_order=null, predicand={column={name=feb_sales_SUM, table_ref=q}}, sort_order=ASC}}, from={join={1={pivot={value={function={function_name=SUM, parameters={column={name=sales_amount, table_ref=null}}}}, for={column={name=month_name, table_ref=null}}, in={1={pivot_literal='jan_sales'}, 2={pivot_literal='feb_sales'}}}, alias=p, table={alias=p_src, table=monthly_sales_long}}, 2={join=JOIN, on={and={1={condition={left={column={name=jan_sales_SUM, table_ref=p}}, right={column={name=sales_amount, table_ref=u}}, operator==}}, 2={condition={left={column={name=month_name, table_ref=u}}, right={literal='jan_sales'}, operator==}}}}}, 3={unpivot={value={column={name=sales_amount, table_ref=null}}, for={column={name=month_name, table_ref=null}}, in={1={name=jan_sales, table_ref=null}, 2={name=feb_sales, table_ref=null}}}, alias=u, table={alias=u_src, table=monthly_sales}}, 4={join=JOIN, on={condition={left={column={name=sales_amount, table_ref=u}}, right={column={name=feb_sales_SUM, table_ref=q}}, operator==}}}, 5={pivot={value={function={function_name=SUM, parameters={column={name=sales_amount, table_ref=null}}}}, for={column={name=month_name, table_ref=null}}, in={1={pivot_literal='feb_sales'}}}, alias=q, table={alias=q_src, table=monthly_sales_long}}}}, where={and={1={condition={left={column={name=jan_sales_SUM, table_ref=p}}, right={literal=0}, operator=>}}, 2={condition={left={column={name=sales_amount, table_ref=u}}, right={literal=0}, operator=>}}, 3={condition={left={column={name=feb_sales_SUM, table_ref=null}}, right={literal=0}, operator=>}}}}}}",
				extractor.getAsTree().toString());
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query2={jan_sales_SUM=[[@1,7:19='jan_sales_SUM',<381>,1:7], [@46,263:275='jan_sales_SUM',<381>,6:7], [@85,461:473='jan_sales_SUM',<381>,10:8], [@102,540:552='jan_sales_SUM',<381>,13:11], [@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], month_name=[[@5,36:45='month_name',<381>,1:36], [@54,300:309='month_name',<381>,6:44], [@34,216:225='month_name',<381>,5:26]], sales_amount=[[@3,22:33='sales_amount',<381>,1:22], [@50,281:292='sales_amount',<381>,6:25], [@77,422:433='sales_amount',<381>,9:7], [@91,487:498='sales_amount',<381>,11:8], [@32,199:210='sales_amount',<381>,5:9]], feb_sales_SUM=[[@7,48:60='feb_sales_SUM',<381>,1:48], [@81,439:451='feb_sales_SUM',<381>,9:24], [@95,510:522='feb_sales_SUM',<381>,12:6], [@106,557:569='feb_sales_SUM',<381>,13:28]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query2={query_dictionary={jan_sales_SUM=[[@1,7:19='jan_sales_SUM',<381>,1:7], [@46,263:275='jan_sales_SUM',<381>,6:7], [@85,461:473='jan_sales_SUM',<381>,10:8], [@102,540:552='jan_sales_SUM',<381>,13:11], [@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], month_name=[[@5,36:45='month_name',<381>,1:36], [@54,300:309='month_name',<381>,6:44], [@34,216:225='month_name',<381>,5:26]], sales_amount=[[@3,22:33='sales_amount',<381>,1:22], [@50,281:292='sales_amount',<381>,6:25], [@77,422:433='sales_amount',<381>,9:7], [@91,487:498='sales_amount',<381>,11:8], [@32,199:210='sales_amount',<381>,5:9]], feb_sales_SUM=[[@7,48:60='feb_sales_SUM',<381>,1:48], [@81,439:451='feb_sales_SUM',<381>,9:24], [@95,510:522='feb_sales_SUM',<381>,12:6], [@106,557:569='feb_sales_SUM',<381>,13:28]]}, table_dictionary={monthly_sales={jan_sales=[[@37,231:239='jan_sales',<381>,5:41]], feb_sales=[[@39,242:250='feb_sales',<381>,5:52]]}, monthly_sales_long={month_name=[[@18,121:130='month_name',<381>,3:29], [@67,384:393='month_name',<381>,8:29]], sales_amount=[[@15,103:114='sales_amount',<381>,3:11], [@64,366:377='sales_amount',<381>,8:11]]}}, derivation={source_columns={p=[{name=month_name, table_ref=p_src}, {name=sales_amount, table_ref=p_src}], q=[{name=month_name, table_ref=q_src}, {name=sales_amount, table_ref=q_src}], u=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}]}, derived_columns={p={jan_sales_SUM=[[@13,99:101='SUM',<141>,3:7], [@21,136:146=''jan_sales'',<389>,3:44]], feb_sales_SUM=[[@13,99:101='SUM',<141>,3:7], [@23,149:159=''feb_sales'',<389>,3:57]]}, q={feb_sales_SUM=[[@62,362:364='SUM',<141>,8:7], [@70,399:409=''feb_sales'',<389>,8:44]]}, u={sales_amount=[[@32,199:210='sales_amount',<381>,5:9]], month_name=[[@34,216:225='month_name',<381>,5:26]]}}}, ordered_by=[{name=jan_sales_SUM, table_ref=p}, {name=feb_sales_SUM, table_ref=q}], filters=[{name=jan_sales_SUM, table_ref=p}, {name=sales_amount, table_ref=u}, {name=month_name, table_ref=u}, {name=feb_sales_SUM, table_ref=q}, {name=feb_sales_SUM, table_ref=null}], interface={jan_sales_SUM=[{name=sales_amount, table_ref=p_src}], month_name=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}], sales_amount=[{name=jan_sales, table_ref=u_src}, {name=feb_sales, table_ref=u_src}], feb_sales_SUM=[{name=feb_sales_SUM, table_ref=null}]}, table_alias={p=p_src, q=q_src, p_src=monthly_sales_long, q_src=monthly_sales_long, u=u_src, u_src=monthly_sales}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void tripleUnpivotPivotUnpivotJoinDerivedColumnsV1Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query1={jan_sales_SUM=[[@7,27:39='jan_sales_SUM',<381>,1:27], [@39,217:219='SUM',<141>,5:7], [@47,254:264=''jan_sales'',<389>,5:44]], month_name=[[@17,76:85='month_name',<381>,1:76]], sales_amount=[[@15,62:73='sales_amount',<381>,1:62]], e1=[[@5,23:24='e1',<381>,1:23]], e2=[[@13,58:59='e2',<381>,1:58]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong",
				"{def_query1={query_dictionary={jan_sales_SUM=[[@7,27:39='jan_sales_SUM',<381>,1:27], [@39,217:219='SUM',<141>,5:7], [@47,254:264=''jan_sales'',<389>,5:44]], month_name=[[@17,76:85='month_name',<381>,1:76]], sales_amount=[[@15,62:73='sales_amount',<381>,1:62]], e1=[[@5,23:24='e1',<381>,1:23]], e2=[[@13,58:59='e2',<381>,1:58]]}, table_dictionary={monthly_sales={jan_sales=[[@28,154:162='jan_sales',<381>,3:41]], mar_sales=[[@71,387:395='mar_sales',<381>,8:52]], empid=[[@1,7:12='u1_src',<381>,1:7], [@9,42:47='u2_src',<381>,1:42]], feb_sales=[[@69,376:384='feb_sales',<381>,8:41], [@30,165:173='feb_sales',<381>,3:52]]}, monthly_sales_long={month_name=[[@44,239:248='month_name',<381>,5:29]], sales_amount=[[@41,221:232='sales_amount',<381>,5:11]]}}, derivation={source_columns={p=[{name=month_name, table_ref=p_src}, {name=sales_amount, table_ref=p_src}], u1=[{name=jan_sales, table_ref=u1_src}, {name=feb_sales, table_ref=u1_src}], u2=[{name=feb_sales, table_ref=u2_src}, {name=mar_sales, table_ref=u2_src}]}, derived_columns={p={jan_sales_SUM=[[@39,217:219='SUM',<141>,5:7], [@47,254:264=''jan_sales'',<389>,5:44]]}, u1={sales_amount=[[@23,122:133='sales_amount',<381>,3:9]], month_name=[[@25,139:148='month_name',<381>,3:26]]}, u2={sales_amount=[[@64,344:355='sales_amount',<381>,8:9]], month_name=[[@66,361:370='month_name',<381>,8:26]]}}}, filters=[{name=jan_sales, table_ref=u1_src}, {name=feb_sales, table_ref=u1_src}, {name=sales_amount, table_ref=p_src}, {name=feb_sales, table_ref=u2_src}, {name=mar_sales, table_ref=u2_src}], interface={jan_sales_SUM=[{name=sales_amount, table_ref=p_src}], month_name=[{name=month_name, table_ref=null}], sales_amount=[{name=sales_amount, table_ref=null}], e1=[{name=empid, table_ref=u1_src}], e2=[{name=empid, table_ref=u2_src}]}, table_alias={p_src=monthly_sales_long, u2_src=monthly_sales, u1_src=monthly_sales}}}",
				extractor.getSymbolTable().toString());
	}
