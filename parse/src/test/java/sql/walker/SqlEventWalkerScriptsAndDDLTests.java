...
public class SqlEventWalkerScriptsAndDDLTests extends AbstractSqlParseEventWalkerTest {
	...
	public void simpleScriptTest() {
		...
		Assert.assertEquals("Statement 1 query dictionary snapshot is wrong",
				"{query0={*=[[@5,15:15='*',<291>,1:15]], col1=[[@3,9:12='col1',<381>,1:9]]}}",
	...
	public void simpleDdlCreateTableExpressionV1Test() {
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={col2=[[@15,56:59='col2',<381>,1:56]], col3=[[@19,66:69='col3',<381>,1:66]], col1=[[@11,46:49='col1',<381>,1:46]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertNull("Snippet should omit optional array-output collector for non-script parses",
	...
	public void simpleDdlCreateViewExpressionV1Test() {
		...
		Assert.assertEquals("AST is wrong",
				"{DDL={create={type=view, name={schema=myschema, dbname=mydb, table=vw1}, query={select={1={column={name=col1, table_ref=src}}, 2={column={name=col2, table_ref=src}}, 3={column={name=col3, table_ref=src}}}, from={table={schema=myschema, alias=src, dbname=mydb, table=source_tab}}}}}}",
				extractor.getAsTree().toString());
		Assert.assertEquals("Interface is wrong", "[]",
				extractor.getInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={col2=[[@15,54:57='col2',<381>,1:54]], col3=[[@19,64:67='col3',<381>,1:64]], col1=[[@11,44:47='col1',<381>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertNull("Snippet should omit optional array-output collector for non-script parses",
	...
	public void simpleDdlCreateMaterializedViewExpressionV1Test() {
		...
		Assert.assertEquals("AST is wrong",
				"{DDL={create={type=materialized view, name={schema=myschema, dbname=mydb, table=mv1}, query={select={1={column={name=col1, table_ref=src}}, 2={column={name=col2, table_ref=src}}, 3={column={name=col3, table_ref=src}}}, from={table={schema=myschema, alias=src, dbname=mydb, table=source_tab}}}}}}",
				extractor.getAsTree().toString());
		Assert.assertEquals("Interface is wrong", "[]",
				extractor.getInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={col2=[[@16,67:70='col2',<381>,1:67]], col3=[[@20,77:80='col3',<381>,1:77]], col1=[[@12,57:60='col1',<381>,1:57]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertNull("Snippet should omit optional array-output collector for non-script parses",
	...
	public void simpleDdlCreateMacroExpressionV1Test() {
		...
		Assert.assertEquals("AST is wrong",
				"{DDL={create={type=macro, name={schema=myschema, dbname=mydb, table=mac1}, parameters=arg1 int, query={select={1={column={name=col1, table_ref=src}}, 2={column={name=col2, table_ref=src}}, 3={column={name=col3, table_ref=src}}}, from={table={schema=myschema, alias=src, dbname=mydb, table=source_tab}}}}}}",
				extractor.getAsTree().toString());
		Assert.assertEquals("Interface is wrong", "[]",
				extractor.getInterface().toString());
		Assert.assertEquals("Symbol Table is wrong",
		...
		Assert.assertEquals("Table Dictionary is wrong",
				...
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong",
				"{query0={col2=[[@19,66:69='col2',<381>,1:66]], col3=[[@23,76:79='col3',<381>,1:76]], col1=[[@15,56:59='col1',<381>,1:56]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertNull("Snippet should omit optional array-output collector for non-script parses",
