...
public class SqlEventWalkerLiveSampleQueriesTests extends AbstractSqlParseEventWalkerTest {
	...
	public void getTagSqlTest() {
		...
		Assert.assertEquals("Symbol Table is wrong", "{def_query0={query_dictionary={PRIMARY_USER_ID=[[@19,102:116='PRIMARY_USER_ID',<381>,1:102]], ACTION=[[@7,46:51='ACTION',<381>,1:46]], RECORD_TYPE=[[@3,20:30='RECORD_TYPE',<381>,1:20]], TAG=[[@11,66:68='TAG',<381>,1:66]], GROUP_ID=[[@15,81:88='GROUP_ID',<381>,1:81]]}, table_dictionary={tagtbl={rec_type=[[@1,8:15='rec_type',<381>,1:8]], user_id=[[@17,91:97='user_id',<381>,1:91], [@53,245:251='user_id',<381>,1:245], [@62,281:287='user_id',<381>,1:281]], tag_name=[[@9,54:61='tag_name',<381>,1:54], [@23,137:144='tag_name',<381>,1:137], [@32,174:181='tag_name',<381>,1:174]], grp_id=[[@13,71:76='grp_id',<381>,1:71], [@38,193:198='grp_id',<381>,1:193], [@47,228:233='grp_id',<381>,1:228]], action_cd=[[@5,33:41='action_cd',<381>,1:33]]}}, filters=[{name=tag_name, table_ref=tagtbl}, {name=grp_id, table_ref=tagtbl}, {name=user_id, table_ref=tagtbl}], interface={PRIMARY_USER_ID=[{name=user_id, table_ref=tagtbl}], ACTION=[{name=action_cd, table_ref=tagtbl}], RECORD_TYPE=[{name=rec_type, table_ref=tagtbl}], TAG=[{name=tag_name, table_ref=tagtbl}], GROUP_ID=[{name=grp_id, table_ref=tagtbl}]}}}", extractor.getSymbolTable().toString());
	}
	...
	public void selectEmbeddedSubqueryTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={term_row=[[@28,142:149='term_row',<381>,2:65]], term_id=[[@30,152:158='term_id',<381>,2:75], [@5,22:26='terms',<381>,1:22], [@36,192:196='terms',<381>,3:31]]}, query1={term_row=[[@9,37:44='term_row',<381>,1:37]], term_id=[[@3,13:19='term_id',<381>,1:13], [@7,28:34='term_id',<381>,1:28]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{def_query1={query_dictionary={term_row=[[@9,37:44='term_row',<381>,1:37]], term_id=[[@3,13:19='term_id',<381>,1:13], [@7,28:34='term_id',<381>,1:28]]}, table_dictionary={student_major_term={term_row=[[@9,37:44='term_row',<381>,1:37]], term_id=[[@1,9:11='smt',<381>,1:9], [@40,208:210='smt',<381>,3:47]]}}, def_query0={query_dictionary={term_row=[[@28,142:149='term_row',<381>,2:65]], term_id=[[@30,152:158='term_id',<381>,2:75], [@5,22:26='terms',<381>,1:22], [@36,192:196='terms',<381>,3:31]]}, table_dictionary={standard_term={term_id=[[@30,152:158='term_id',<381>,2:75]], start_date=[[@24,123:132='start_date',<381>,2:46]]}}, interface={term_row=[{name=start_date, table_ref=standard_term}], term_id=[{name=term_id, table_ref=standard_term}]}}, ordered_by=[], filters=[{name=term_id, table_ref=terms}, {name=term_id, table_ref=smt}], interface={term_row=[{name=term_row, table_ref=null}], term_id=[{name=term_id, table_ref=terms}]}, table_alias={terms=query0, smt=student_major_term}}}",
				extractor.getSymbolTable().toString());
	}
