...
public class SqlEventWalkerLiveSampleQueriesTests extends AbstractSqlParseEventWalkerTest {
	...
	public void getInstructionSqlTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{instructorassgnmttbl={subject_code=[[@23,98:99='ia',<381>,1:98]], course_number=[[@27,114:115='ia',<381>,1:114]], section_name=[[@34,154:155='ia',<381>,1:154]], instructor_id=[[@40,187:188='ia',<381>,1:187]], term_code=[[@13,59:60='ia',<381>,1:59], [@53,285:286='ia',<381>,1:285]], action=[[@7,38:39='ia',<381>,1:38]], record_type=[[@1,7:8='ia',<381>,1:7]]}, termfiltertbl={term_id=[[@57,300:301='tf',<381>,1:300]]}}", extractor.getTableColumnDictionaryMap().toString());
	...
	public void createTermFilterTableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{termstgtablename={term_rank=[[@29,185:186='t1',<381>,4:12], [@41,267:268='t1',<381>,4:94], [@53,314:314='a',<381>,4:141]], external_id=[[@1,7:17='external_id',<381>,1:7]]}, currenttermtablename={curr_term_rank=[[@19,108:121='curr_term_rank',<381>,3:8], [@45,282:283='t2',<381>,4:109]]}}", extractor.getTableColumnDictionaryMap().toString());
	...
	public void complexJINJAQueryWithWoldcardTest() {
		...
		Assert.assertEquals("Global table dictionary entry is wrong for prc_contact_donor_xwalk",
				"{fund_desc=[[@96,655:663='fund_desc',<381>,13:28]], source_partnercontact_id=[[@291,2187:2190='pcdx',<381>,32:63]], contact_key=[[@65,425:428='pcdx',<381>,9:32], [@134,982:985='pcdx',<381>,18:42]]}",
		...
		Assert.assertEquals("def_query5 local table_dictionary is wrong",
				"{{{ ref ( 'prc_contact_donor_xwalk') }}={fund_desc=[[@96,655:663='fund_desc',<381>,13:28]], source_partnercontact_id=[[@291,2187:2190='pcdx',<381>,32:63]], contact_key=[[@65,425:428='pcdx',<381>,9:32], [@134,982:985='pcdx',<381>,18:42]]}}",
