...
public class SqlEventWalkerSubqueriesAndClauseSemanticsTests extends AbstractSqlParseEventWalkerTest {
	...
	public void nestedSubqueryWithColumnsV0() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={x=[[@9,40:40='x',<373>,2:10]], y=[[@13,51:51='y',<373>,2:21]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col2=[[@15,56:59='col2',<373>,2:26]], col1=[[@11,45:48='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8]]}, query1={last=[[@5,19:22='last',<101>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]]}, table_dictionary={}, def_query0={query_dictionary={col2=[[@15,56:59='col2',<373>,2:26]], col1=[[@11,45:48='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8]]}, table_dictionary={third={x=[[@9,40:40='x',<373>,2:10]], y=[[@13,51:51='y',<373>,2:21]]}}, interface={col2=[{name=y, table_ref=third}], col1=[{name=x, table_ref=third}]}}, interface={last=[{name=col1, table_ref=F4}]}, table_alias={F4=query0}}}",
	...
	public void nestedSubqueryWithWildcardV0() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@9,40:40='*',<290>,2:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@9,40:40='*',<290>,2:10]], col1=[[@1,8:9='F4',<373>,1:8]]}, query1={last=[[@5,19:22='last',<101>,1:19]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@9,40:40='*',<290>,2:10]], col1=[[@1,8:9='F4',<373>,1:8]]}, table_dictionary={third={*=[[@9,40:40='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={last=[{name=col1, table_ref=F4}]}, table_alias={F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedSelectStarV1() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@11,49:49='*',<290>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@11,49:49='*',<290>,3:10]]}, query1={*=[[@7,31:31='*',<290>,2:9]], col1=[[@1,8:9='F4',<373>,1:8]]}, query2={col1=[[@3,11:14='col1',<373>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col1=[[@3,11:14='col1',<373>,1:11]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@7,31:31='*',<290>,2:9]], col1=[[@1,8:9='F4',<373>,1:8]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@11,49:49='*',<290>,3:10]]}, table_dictionary={third={*=[[@11,49:49='*',<290>,3:10]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={T3=query0}}, interface={col1=[{name=col1, table_ref=F4}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedSelectStarV2() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@9,46:46='*',<290>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@9,46:46='*',<290>,3:10]]}, query1={*=[[@5,28:28='*',<290>,2:9]]}, query2={col1=[[@1,8:11='col1',<373>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col1=[[@1,8:11='col1',<373>,1:8]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@5,28:28='*',<290>,2:9]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@9,46:46='*',<290>,3:10]]}, table_dictionary={third={*=[[@9,46:46='*',<290>,3:10]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={T3=query0}}, interface={col1=[{name=col1, table_ref=query1}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedSelectStarV3() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={col2=[[@11,52:55='col2',<373>,3:16]], col1=[[@9,46:49='col1',<373>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@5,28:28='*',<290>,2:9]], col2=[[@11,52:55='col2',<373>,3:16]], col1=[[@9,46:49='col1',<373>,3:10]]}, query1={*=[[@5,28:28='*',<290>,2:9]]}, query2={col1=[[@1,8:11='col1',<373>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
	...
	public void nestedSelectStarV4() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@7,31:31='*',<290>,2:9]], col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}, query1={*=[[@7,31:31='*',<290>,2:9]], col1=[[@1,8:9='F4',<373>,1:8]]}, query2={col1=[[@3,11:14='col1',<373>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col1=[[@3,11:14='col1',<373>,1:11]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@7,31:31='*',<290>,2:9]], col1=[[@1,8:9='F4',<373>,1:8]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@7,31:31='*',<290>,2:9]], col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}, table_dictionary={third={col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}}, interface={col2=[{name=col2, table_ref=third}], col1=[{name=col1, table_ref=third}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={T3=query0}}, interface={col1=[{name=col1, table_ref=F4}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedSelectStarV5() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@11,49:49='*',<290>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@11,49:49='*',<290>,3:10]]}, query1={*=[[@7,31:31='*',<290>,2:9]]}, query2={col1=[[@3,11:14='col1',<373>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col1=[[@3,11:14='col1',<373>,1:11]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@7,31:31='*',<290>,2:9]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@11,49:49='*',<290>,3:10]]}, table_dictionary={third={*=[[@11,49:49='*',<290>,3:10]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={T3=query0}}, interface={col1=[{name=col1, table_ref=T3}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	...
	public void nestedSelectStarV6() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@7,31:31='*',<290>,2:9]], col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}, query1={*=[[@7,31:31='*',<290>,2:9]]}, query2={col1=[[@3,11:14='col1',<373>,1:11]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col1=[[@3,11:14='col1',<373>,1:11]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@7,31:31='*',<290>,2:9]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@7,31:31='*',<290>,2:9]], col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}, table_dictionary={third={col2=[[@13,55:58='col2',<373>,3:16]], col1=[[@11,49:52='col1',<373>,3:10]]}}, interface={col2=[{name=col2, table_ref=third}], col1=[{name=col1, table_ref=third}]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={T3=query0}}, interface={col1=[{name=col1, table_ref=T3}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	...
	public void nestedSelectStarV7() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@11,49:49='*',<290>,3:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@11,49:49='*',<290>,3:10]], col1=[[@5,25:26='T3',<373>,2:9]]}, query1={*=[[@1,8:8='*',<290>,1:8]], col1=[[@7,28:31='col1',<373>,2:12]]}, query2={*=[[@1,8:8='*',<290>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={*=[[@1,8:8='*',<290>,1:8]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@1,8:8='*',<290>,1:8]], col1=[[@7,28:31='col1',<373>,2:12]]}, table_dictionary={}, def_query0={query_dictionary={*=[[@11,49:49='*',<290>,3:10]], col1=[[@5,25:26='T3',<373>,2:9]]}, table_dictionary={third={*=[[@11,49:49='*',<290>,3:10]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={col1=[{name=col1, table_ref=T3}]}, table_alias={T3=query0}}, interface={*=[{name=*, table_ref=*}]}, table_alias={F4=query1}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionJoinClauseV1() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@19,65:65='*',<290>,2:10]]}, fourth={col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={*=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19]]}, table_dictionary={third={*=[[@19,65:65='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionWhereClauseV2() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@19,65:65='*',<290>,2:10]]}, fourth={col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@60,188:189='F4',<373>,4:49]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@60,188:189='F4',<373>,4:49]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28]]}, table_dictionary={third={*=[[@19,65:65='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionHavingClauseV3() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@19,65:65='*',<290>,2:10]]}, fourth={col7=[[@48,157:157='t',<373>,4:18]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,178:178='t',<373>,4:39]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@60,189:190='F4',<373>,4:50]], col6=[[@44,147:148='F4',<373>,4:8]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,168:169='F4',<373>,4:29]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@48,157:157='t',<373>,4:18]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,178:178='t',<373>,4:39]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@60,189:190='F4',<373>,4:50]], col6=[[@44,147:148='F4',<373>,4:8]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,168:169='F4',<373>,4:29]]}, table_dictionary={third={*=[[@19,65:65='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionQualifyClauseV4() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@19,65:65='*',<290>,2:10]]}, fourth={col10=[[@70,219:219='t',<373>,5:19]], col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@60,188:189='F4',<373>,4:49], [@74,231:232='F4',<373>,5:31]], col9=[[@66,209:210='F4',<373>,5:9]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col10=[[@70,219:219='t',<373>,5:19]], col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@60,188:189='F4',<373>,4:49], [@74,231:232='F4',<373>,5:31]], col9=[[@66,209:210='F4',<373>,5:9]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28]]}, table_dictionary={third={*=[[@19,65:65='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}, {name=col9, table_ref=F4}, {name=col10, table_ref=t}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionAggregateGroupByV5() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@28,95:95='*',<290>,2:10]]}, fourth={col7=[[@57,186:186='t',<373>,4:17]], col5=[[@49,162:162='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@41,141:141='t',<373>,3:29], [@65,207:207='t',<373>,4:38], [@80,249:249='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@84,257:257='t',<373>,5:27]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@69,218:219='F4',<373>,4:49]], col11=[[@19,54:55='F4',<373>,1:54]], col6=[[@53,176:177='F4',<373>,4:7]], *=[[@28,95:95='*',<290>,2:10]], col4=[[@45,152:153='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@37,131:132='F4',<373>,3:19], [@61,197:198='F4',<373>,4:28], [@76,240:241='F4',<373>,5:10]]}, query1={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@57,186:186='t',<373>,4:17]], col5=[[@49,162:162='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@41,141:141='t',<373>,3:29], [@65,207:207='t',<373>,4:38], [@80,249:249='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@84,257:257='t',<373>,5:27]]}}, grouped_by=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col3, table_ref=t}], def_query0={query_dictionary={col8=[[@69,218:219='F4',<373>,4:49]], col11=[[@19,54:55='F4',<373>,1:54]], col6=[[@53,176:177='F4',<373>,4:7]], *=[[@28,95:95='*',<290>,2:10]], col4=[[@45,152:153='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@37,131:132='F4',<373>,3:19], [@61,197:198='F4',<373>,4:28], [@76,240:241='F4',<373>,5:10]]}, table_dictionary={third={*=[[@28,95:95='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], total_col11=[{name=col11, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionOrderByV6() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={*=[[@19,65:65='*',<290>,2:10]]}, fourth={col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@67,210:210='t',<373>,5:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col12=[[@77,236:237='F4',<373>,5:36]], col8=[[@60,188:189='F4',<373>,4:49]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28], [@72,223:224='F4',<373>,5:23]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@48,156:156='t',<373>,4:17]], col5=[[@40,132:132='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@32,111:111='t',<373>,3:29], [@56,177:177='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@67,210:210='t',<373>,5:10]]}}, def_query0={query_dictionary={col12=[[@77,236:237='F4',<373>,5:36]], col8=[[@60,188:189='F4',<373>,4:49]], col6=[[@44,146:147='F4',<373>,4:7]], *=[[@19,65:65='*',<290>,2:10]], col4=[[@36,122:123='F4',<373>,3:40]], col1=[[@1,8:9='F4',<373>,1:8], [@28,101:102='F4',<373>,3:19], [@52,167:168='F4',<373>,4:28], [@72,223:224='F4',<373>,5:23]]}, table_dictionary={third={*=[[@19,65:65='*',<290>,2:10]]}}, interface={*=[{name=*, table_ref=*}]}}, ordered_by=[{name=col3, table_ref=t}, {name=col1, table_ref=F4}, {name=col12, table_ref=F4}], filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionJoinClauseV11() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], col4=[[@23,76:79='col4',<373>,2:21]]}, fourth={col5=[[@44,146:146='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@36,125:125='t',<373>,3:29]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col4=[[@23,76:79='col4',<373>,2:21], [@40,136:137='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@32,115:116='F4',<373>,3:19]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col5=[[@44,146:146='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@36,125:125='t',<373>,3:29]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col4=[[@23,76:79='col4',<373>,2:21], [@40,136:137='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@32,115:116='F4',<373>,3:19]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], col4=[[@23,76:79='col4',<373>,2:21]]}}, interface={col4=[{name=col4, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionWhereClauseV12() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={col7=[[@58,187:187='t',<373>,4:17]], col5=[[@50,163:163='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@42,142:142='t',<373>,3:29], [@66,208:208='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@70,219:220='F4',<373>,4:49]], col6=[[@27,87:90='col6',<373>,2:32], [@54,177:178='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@46,153:154='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,132:133='F4',<373>,3:19], [@62,198:199='F4',<373>,4:28]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@58,187:187='t',<373>,4:17]], col5=[[@50,163:163='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@42,142:142='t',<373>,3:29], [@66,208:208='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@70,219:220='F4',<373>,4:49]], col6=[[@27,87:90='col6',<373>,2:32], [@54,177:178='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@46,153:154='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,132:133='F4',<373>,3:19], [@62,198:199='F4',<373>,4:28]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionHavingClauseV13() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={col7=[[@58,188:188='t',<373>,4:18]], col5=[[@50,163:163='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@42,142:142='t',<373>,3:29], [@66,209:209='t',<373>,4:39]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@70,220:221='F4',<373>,4:50]], col6=[[@27,87:90='col6',<373>,2:32], [@54,178:179='F4',<373>,4:8]], col4=[[@25,81:84='col4',<373>,2:26], [@46,153:154='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,132:133='F4',<373>,3:19], [@62,199:200='F4',<373>,4:29]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@58,188:188='t',<373>,4:18]], col5=[[@50,163:163='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@42,142:142='t',<373>,3:29], [@66,209:209='t',<373>,4:39]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@70,220:221='F4',<373>,4:50]], col6=[[@27,87:90='col6',<373>,2:32], [@54,178:179='F4',<373>,4:8]], col4=[[@25,81:84='col4',<373>,2:26], [@46,153:154='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,132:133='F4',<373>,3:19], [@62,199:200='F4',<373>,4:29]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionQualifyClauseV14() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col9=[[@31,99:102='col9',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={col10=[[@82,256:256='t',<373>,5:19]], col7=[[@60,193:193='t',<373>,4:17]], col5=[[@52,169:169='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,148:148='t',<373>,3:29], [@68,214:214='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@72,225:226='F4',<373>,4:49], [@86,268:269='F4',<373>,5:31]], col9=[[@31,99:102='col9',<373>,2:44], [@78,246:247='F4',<373>,5:9]], col6=[[@27,87:90='col6',<373>,2:32], [@56,183:184='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,159:160='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,138:139='F4',<373>,3:19], [@64,204:205='F4',<373>,4:28]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col10=[[@82,256:256='t',<373>,5:19]], col7=[[@60,193:193='t',<373>,4:17]], col5=[[@52,169:169='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,148:148='t',<373>,3:29], [@68,214:214='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@72,225:226='F4',<373>,4:49], [@86,268:269='F4',<373>,5:31]], col9=[[@31,99:102='col9',<373>,2:44], [@78,246:247='F4',<373>,5:9]], col6=[[@27,87:90='col6',<373>,2:32], [@56,183:184='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,159:160='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,138:139='F4',<373>,3:19], [@64,204:205='F4',<373>,4:28]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col9=[[@31,99:102='col9',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col9=[{name=col9, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}, {name=col9, table_ref=F4}, {name=col10, table_ref=t}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionAggregateGroupByV15() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@28,95:95='a',<373>,2:10]], b=[[@32,106:106='b',<373>,2:21]], col8=[[@38,123:126='col8',<373>,2:38]], col11=[[@40,129:133='col11',<373>,2:44]], col6=[[@36,117:120='col6',<373>,2:32]]}, fourth={col7=[[@69,224:224='t',<373>,4:17]], col5=[[@61,200:200='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@53,179:179='t',<373>,3:29], [@77,245:245='t',<373>,4:38], [@92,287:287='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@96,295:295='t',<373>,5:27]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, query1={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@69,224:224='t',<373>,4:17]], col5=[[@61,200:200='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@53,179:179='t',<373>,3:29], [@77,245:245='t',<373>,4:38], [@92,287:287='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@96,295:295='t',<373>,5:27]]}}, grouped_by=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col3, table_ref=t}], def_query0={query_dictionary={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, table_dictionary={third={a=[[@28,95:95='a',<373>,2:10]], b=[[@32,106:106='b',<373>,2:21]], col8=[[@38,123:126='col8',<373>,2:38]], col11=[[@40,129:133='col11',<373>,2:44]], col6=[[@36,117:120='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col11=[{name=col11, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], total_col11=[{name=col11, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionOrderByV16() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col12=[[@31,99:103='col12',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={col7=[[@60,194:194='t',<373>,4:17]], col5=[[@52,170:170='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,149:149='t',<373>,3:29], [@68,215:215='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@79,248:248='t',<373>,5:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@72,226:227='F4',<373>,4:49]], col12=[[@31,99:103='col12',<373>,2:44], [@89,274:275='F4',<373>,5:36]], col6=[[@27,87:90='col6',<373>,2:32], [@56,184:185='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,160:161='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,139:140='F4',<373>,3:19], [@64,205:206='F4',<373>,4:28], [@84,261:262='F4',<373>,5:23]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@60,194:194='t',<373>,4:17]], col5=[[@52,170:170='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,149:149='t',<373>,3:29], [@68,215:215='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@79,248:248='t',<373>,5:10]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@72,226:227='F4',<373>,4:49]], col12=[[@31,99:103='col12',<373>,2:44], [@89,274:275='F4',<373>,5:36]], col6=[[@27,87:90='col6',<373>,2:32], [@56,184:185='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,160:161='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,139:140='F4',<373>,3:19], [@64,205:206='F4',<373>,4:28], [@84,261:262='F4',<373>,5:23]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col12=[[@31,99:103='col12',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col12=[{name=col12, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, ordered_by=[{name=col3, table_ref=t}, {name=col1, table_ref=F4}, {name=col12, table_ref=F4}], filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionJoinClauseMissingQualifiedV21() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col4=[[@23,76:79='col4',<373>,2:21], [@40,136:137='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@32,115:116='F4',<373>,3:19]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col5=[[@44,146:146='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@36,125:125='t',<373>,3:29], [@52,168:168='t',<373>,3:72]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col4=[[@23,76:79='col4',<373>,2:21], [@40,136:137='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@32,115:116='F4',<373>,3:19]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], col4=[[@23,76:79='col4',<373>,2:21]]}}, interface={col4=[{name=col4, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col99, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	...
	public void subqueryDictionaryExtensionAggregateGroupByMissingQualifiedV25() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, query1={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col7=[[@69,224:224='t',<373>,4:17]], col5=[[@61,200:200='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@53,179:179='t',<373>,3:29], [@77,245:245='t',<373>,4:38], [@92,287:287='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@96,295:295='t',<373>,5:27]]}}, grouped_by=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col3, table_ref=t}, {name=col99, table_ref=F4}], def_query0={query_dictionary={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, table_dictionary={third={a=[[@28,95:95='a',<373>,2:10]], b=[[@32,106:106='b',<373>,2:21]], col8=[[@38,123:126='col8',<373>,2:38]], col11=[[@40,129:133='col11',<373>,2:44]], col6=[[@36,117:120='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col11=[{name=col11, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], total_col11=[{name=col11, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	...
	public void subqueryDictionaryExtensionJoinClauseSubqueryJoinV31() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], col4=[[@23,76:79='col4',<373>,2:21]]}, fourth={*=[[@31,111:111='*',<290>,3:15]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col4=[[@23,76:79='col4',<373>,2:21], [@46,155:156='F4',<373>,3:59]], *=[[@31,111:111='*',<290>,3:15]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,134:135='F4',<373>,3:38]]}, query1={*=[[@31,111:111='*',<290>,3:15]], col5=[[@50,165:165='t',<373>,3:69]], col2=[[@7,25:25='t',<373>,1:25], [@42,144:144='t',<373>,3:48]], col3=[[@13,42:42='t',<373>,1:42]]}, query2={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={}, def_query1={query_dictionary={*=[[@31,111:111='*',<290>,3:15]], col5=[[@50,165:165='t',<373>,3:69]], col2=[[@7,25:25='t',<373>,1:25], [@42,144:144='t',<373>,3:48]], col3=[[@13,42:42='t',<373>,1:42]]}, table_dictionary={fourth={*=[[@31,111:111='*',<290>,3:15]]}}, interface={*=[{name=*, table_ref=*}]}}, def_query0={query_dictionary={col4=[[@23,76:79='col4',<373>,2:21], [@46,155:156='F4',<373>,3:59]], *=[[@31,111:111='*',<290>,3:15]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@38,134:135='F4',<373>,3:38]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], col4=[[@23,76:79='col4',<373>,2:21]]}}, interface={col4=[{name=col4, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=query1, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionWhereClauseSubqueryJoinV32() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={*=[[@37,128:128='*',<290>,3:15]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@76,238:239='F4',<373>,4:49]], col6=[[@27,87:90='col6',<373>,2:32], [@60,196:197='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@52,172:173='F4',<373>,3:59]], *=[[@37,128:128='*',<290>,3:15]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@44,151:152='F4',<373>,3:38], [@68,217:218='F4',<373>,4:28]]}, query1={col7=[[@64,206:206='t',<373>,4:17]], *=[[@37,128:128='*',<290>,3:15]], col5=[[@56,182:182='t',<373>,3:69]], col2=[[@7,25:25='t',<373>,1:25], [@48,161:161='t',<373>,3:48], [@72,227:227='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}, query2={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={}, def_query1={query_dictionary={col7=[[@64,206:206='t',<373>,4:17]], *=[[@37,128:128='*',<290>,3:15]], col5=[[@56,182:182='t',<373>,3:69]], col2=[[@7,25:25='t',<373>,1:25], [@48,161:161='t',<373>,3:48], [@72,227:227='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}, table_dictionary={fourth={*=[[@37,128:128='*',<290>,3:15]]}}, interface={*=[{name=*, table_ref=*}]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@76,238:239='F4',<373>,4:49]], col6=[[@27,87:90='col6',<373>,2:32], [@60,196:197='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@52,172:173='F4',<373>,3:59]], *=[[@37,128:128='*',<290>,3:15]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@44,151:152='F4',<373>,3:38], [@68,217:218='F4',<373>,4:28]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=query1, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionQualifyClauseMissingUnqualifiedV33() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col9=[[@31,99:102='col9',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={col10=[[@82,256:256='t',<373>,5:19]], missing=[[@92,284:290='missing',<373>,5:47]], col7=[[@60,193:193='t',<373>,4:17]], col5=[[@52,169:169='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,148:148='t',<373>,3:29], [@68,214:214='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@72,225:226='F4',<373>,4:49], [@86,268:269='F4',<373>,5:31]], col9=[[@31,99:102='col9',<373>,2:44], [@78,246:247='F4',<373>,5:9]], col6=[[@27,87:90='col6',<373>,2:32], [@56,183:184='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,159:160='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,138:139='F4',<373>,3:19], [@64,204:205='F4',<373>,4:28]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={col10=[[@82,256:256='t',<373>,5:19]], missing=[[@92,284:290='missing',<373>,5:47]], col7=[[@60,193:193='t',<373>,4:17]], col5=[[@52,169:169='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,148:148='t',<373>,3:29], [@68,214:214='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@72,225:226='F4',<373>,4:49], [@86,268:269='F4',<373>,5:31]], col9=[[@31,99:102='col9',<373>,2:44], [@78,246:247='F4',<373>,5:9]], col6=[[@27,87:90='col6',<373>,2:32], [@56,183:184='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,159:160='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,138:139='F4',<373>,3:19], [@64,204:205='F4',<373>,4:28]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col9=[[@31,99:102='col9',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col9=[{name=col9, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}, {name=col9, table_ref=F4}, {name=col10, table_ref=t}, {name=missing, table_ref=fourth}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionAggregateGroupByMissingUnqualifiedV34() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@28,95:95='a',<373>,2:10]], b=[[@32,106:106='b',<373>,2:21]], col8=[[@38,123:126='col8',<373>,2:38]], col11=[[@40,129:133='col11',<373>,2:44]], col6=[[@36,117:120='col6',<373>,2:32]]}, fourth={missing=[[@100,303:309='missing',<373>,5:35]], col7=[[@69,224:224='t',<373>,4:17]], col5=[[@61,200:200='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@53,179:179='t',<373>,3:29], [@77,245:245='t',<373>,4:38], [@92,287:287='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@96,295:295='t',<373>,5:27]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, query1={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], total_col11=[[@24,67:77='total_col11',<373>,1:67]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={missing=[[@100,303:309='missing',<373>,5:35]], col7=[[@69,224:224='t',<373>,4:17]], col5=[[@61,200:200='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@53,179:179='t',<373>,3:29], [@77,245:245='t',<373>,4:38], [@92,287:287='t',<373>,5:19]], col3=[[@13,42:42='t',<373>,1:42], [@96,295:295='t',<373>,5:27]]}}, grouped_by=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col3, table_ref=t}, {name=missing, table_ref=fourth}], def_query0={query_dictionary={col8=[[@38,123:126='col8',<373>,2:38], [@81,256:257='F4',<373>,4:49]], col11=[[@40,129:133='col11',<373>,2:44], [@19,54:55='F4',<373>,1:54]], col6=[[@36,117:120='col6',<373>,2:32], [@65,214:215='F4',<373>,4:7]], col4=[[@34,111:114='col4',<373>,2:26], [@57,190:191='F4',<373>,3:40]], col1=[[@30,100:103='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@49,169:170='F4',<373>,3:19], [@73,235:236='F4',<373>,4:28], [@88,278:279='F4',<373>,5:10]]}, table_dictionary={third={a=[[@28,95:95='a',<373>,2:10]], b=[[@32,106:106='b',<373>,2:21]], col8=[[@38,123:126='col8',<373>,2:38]], col11=[[@40,129:133='col11',<373>,2:44]], col6=[[@36,117:120='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col11=[{name=col11, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], total_col11=[{name=col11, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void subqueryDictionaryExtensionOrderByMissingUnqualifiedV35() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col12=[[@31,99:103='col12',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}, fourth={missing=[[@94,289:295='missing',<373>,5:51]], col7=[[@60,194:194='t',<373>,4:17]], col5=[[@52,170:170='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,149:149='t',<373>,3:29], [@68,215:215='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@79,248:248='t',<373>,5:10]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col8=[[@29,93:96='col8',<373>,2:38], [@72,226:227='F4',<373>,4:49]], col12=[[@31,99:103='col12',<373>,2:44], [@89,274:275='F4',<373>,5:36]], col6=[[@27,87:90='col6',<373>,2:32], [@56,184:185='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,160:161='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,139:140='F4',<373>,3:19], [@64,205:206='F4',<373>,4:28], [@84,261:262='F4',<373>,5:23]]}, query1={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={last=[[@5,19:22='last',<101>,1:19]], tcol2=[[@11,35:39='tcol2',<373>,1:35]], col3=[[@15,44:47='col3',<373>,1:44]]}, table_dictionary={fourth={missing=[[@94,289:295='missing',<373>,5:51]], col7=[[@60,194:194='t',<373>,4:17]], col5=[[@52,170:170='t',<373>,3:50]], col2=[[@7,25:25='t',<373>,1:25], [@44,149:149='t',<373>,3:29], [@68,215:215='t',<373>,4:38]], col3=[[@13,42:42='t',<373>,1:42], [@79,248:248='t',<373>,5:10]]}}, def_query0={query_dictionary={col8=[[@29,93:96='col8',<373>,2:38], [@72,226:227='F4',<373>,4:49]], col12=[[@31,99:103='col12',<373>,2:44], [@89,274:275='F4',<373>,5:36]], col6=[[@27,87:90='col6',<373>,2:32], [@56,184:185='F4',<373>,4:7]], col4=[[@25,81:84='col4',<373>,2:26], [@48,160:161='F4',<373>,3:40]], col1=[[@21,70:73='col1',<373>,2:15], [@1,8:9='F4',<373>,1:8], [@40,139:140='F4',<373>,3:19], [@64,205:206='F4',<373>,4:28], [@84,261:262='F4',<373>,5:23]]}, table_dictionary={third={a=[[@19,65:65='a',<373>,2:10]], b=[[@23,76:76='b',<373>,2:21]], col8=[[@29,93:96='col8',<373>,2:38]], col12=[[@31,99:103='col12',<373>,2:44]], col6=[[@27,87:90='col6',<373>,2:32]]}}, interface={col8=[{name=col8, table_ref=third}], col12=[{name=col12, table_ref=third}], col6=[{name=col6, table_ref=third}], col4=[{name=b, table_ref=third}], col1=[{name=a, table_ref=third}]}}, ordered_by=[{name=col3, table_ref=t}, {name=col1, table_ref=F4}, {name=col12, table_ref=F4}, {name=missing, table_ref=fourth}], filters=[{name=col1, table_ref=F4}, {name=col2, table_ref=t}, {name=col4, table_ref=F4}, {name=col5, table_ref=t}, {name=col6, table_ref=F4}, {name=col7, table_ref=t}, {name=col8, table_ref=F4}], interface={last=[{name=col1, table_ref=F4}], tcol2=[{name=col2, table_ref=t}], col3=[{name=col3, table_ref=t}]}, table_alias={t=fourth, F4=query0}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void unionWithDuplicateColumnNameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, <NAV>={is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, query1={app_name=[[@25,146:153='app_name',<373>,3:17]], is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union2={query0={query_dictionary={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, table_dictionary={<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<Guide>}], student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], category=[{name=category, table_ref=<Guide>}], nk=[{name=nk, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={app_name=query_column, is_active=query_column, student=query_column, rank=query_column, category=query_column, nk=query_column, desc=query_column}, query1={query_dictionary={app_name=[[@25,146:153='app_name',<373>,3:17]], is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}, table_dictionary={<NAV>={is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], student=[{name=student, table_ref=<NAV>}], rank=[{name=rank, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}], desc=[{name=desc, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void multipleUnionWithDuplicateColumnNameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple, <IMPL>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, <NAV>={is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}, <IMPL>={is_active=[[@51,290:298='is_active',<373>,5:38]], student=[[@59,317:323='student',<373>,5:65]], rank=[[@55,305:308='rank',<127>,5:53]], category=[[@49,280:287='category',<373>,5:28]], nk=[[@53,301:302='nk',<373>,5:49]], desc=[[@57,311:314='desc',<76>,5:59]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, query1={app_name=[[@25,146:153='app_name',<373>,3:17]], is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}, query2={app_name=[[@47,270:277='app_name',<373>,5:18]], is_active=[[@51,290:298='is_active',<373>,5:38]], student=[[@59,317:323='student',<373>,5:65]], rank=[[@55,305:308='rank',<127>,5:53]], category=[[@49,280:287='category',<373>,5:28]], nk=[[@53,301:302='nk',<373>,5:49]], desc=[[@57,311:314='desc',<76>,5:59]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union3={query0={query_dictionary={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, table_dictionary={<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<Guide>}], student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], category=[{name=category, table_ref=<Guide>}], nk=[{name=nk, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={app_name=query_column, is_active=query_column, student=query_column, rank=query_column, category=query_column, nk=query_column, desc=query_column}, query1={query_dictionary={app_name=[[@25,146:153='app_name',<373>,3:17]], is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}, table_dictionary={<NAV>={is_active=[[@29,166:174='is_active',<373>,3:37]], student=[[@37,193:199='student',<373>,3:64]], rank=[[@33,181:184='rank',<127>,3:52]], category=[[@27,156:163='category',<373>,3:27]], nk=[[@31,177:178='nk',<373>,3:48]], desc=[[@35,187:190='desc',<76>,3:58]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], student=[{name=student, table_ref=<NAV>}], rank=[{name=rank, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}], desc=[{name=desc, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}, query2={query_dictionary={app_name=[[@47,270:277='app_name',<373>,5:18]], is_active=[[@51,290:298='is_active',<373>,5:38]], student=[[@59,317:323='student',<373>,5:65]], rank=[[@55,305:308='rank',<127>,5:53]], category=[[@49,280:287='category',<373>,5:28]], nk=[[@53,301:302='nk',<373>,5:49]], desc=[[@57,311:314='desc',<76>,5:59]]}, table_dictionary={<IMPL>={is_active=[[@51,290:298='is_active',<373>,5:38]], student=[[@59,317:323='student',<373>,5:65]], rank=[[@55,305:308='rank',<127>,5:53]], category=[[@49,280:287='category',<373>,5:28]], nk=[[@53,301:302='nk',<373>,5:49]], desc=[[@57,311:314='desc',<76>,5:59]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<IMPL>}], student=[{name=student, table_ref=<IMPL>}], rank=[{name=rank, table_ref=<IMPL>}], category=[{name=category, table_ref=<IMPL>}], nk=[{name=nk, table_ref=<IMPL>}], desc=[{name=desc, table_ref=<IMPL>}]}, table_alias={IMPL_Student_Conditions=<IMPL>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectWithDuplicateColumnNameTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, <NAV>={is_active=[[@28,166:174='is_active',<373>,3:37]], student=[[@36,193:199='student',<373>,3:64]], rank=[[@32,181:184='rank',<127>,3:52]], category=[[@26,156:163='category',<373>,3:27]], nk=[[@30,177:178='nk',<373>,3:48]], desc=[[@34,187:190='desc',<76>,3:58]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, query1={app_name=[[@24,146:153='app_name',<373>,3:17]], is_active=[[@28,166:174='is_active',<373>,3:37]], student=[[@36,193:199='student',<373>,3:64]], rank=[[@32,181:184='rank',<127>,3:52]], category=[[@26,156:163='category',<373>,3:27]], nk=[[@30,177:178='nk',<373>,3:48]], desc=[[@34,187:190='desc',<76>,3:58]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect2={query0={query_dictionary={app_name=[[@3,18:25='app_name',<373>,1:18]], is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}, table_dictionary={<Guide>={is_active=[[@7,39:47='is_active',<373>,1:39]], student=[[@15,66:72='student',<373>,1:66]], rank=[[@11,54:57='rank',<127>,1:54]], category=[[@5,29:36='category',<373>,1:29]], nk=[[@9,50:51='nk',<373>,1:50]], desc=[[@13,60:63='desc',<76>,1:60]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<Guide>}], student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], category=[{name=category, table_ref=<Guide>}], nk=[{name=nk, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={app_name=query_column, is_active=query_column, student=query_column, rank=query_column, category=query_column, nk=query_column, desc=query_column}, query1={query_dictionary={app_name=[[@24,146:153='app_name',<373>,3:17]], is_active=[[@28,166:174='is_active',<373>,3:37]], student=[[@36,193:199='student',<373>,3:64]], rank=[[@32,181:184='rank',<127>,3:52]], category=[[@26,156:163='category',<373>,3:27]], nk=[[@30,177:178='nk',<373>,3:48]], desc=[[@34,187:190='desc',<76>,3:58]]}, table_dictionary={<NAV>={is_active=[[@28,166:174='is_active',<373>,3:37]], student=[[@36,193:199='student',<373>,3:64]], rank=[[@32,181:184='rank',<127>,3:52]], category=[[@26,156:163='category',<373>,3:27]], nk=[[@30,177:178='nk',<373>,3:48]], desc=[[@34,187:190='desc',<76>,3:58]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], student=[{name=student, table_ref=<NAV>}], rank=[{name=rank, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}], desc=[{name=desc, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void unionWithMismatchColumnCountsAndNamesTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, <NAV>={is_active=[[@18,115:123='is_active',<373>,3:37]], category=[[@16,105:112='category',<373>,3:27]], nk=[[@20,126:127='nk',<373>,3:48]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, query1={app_name=[[@14,95:102='app_name',<373>,3:17]], is_active=[[@18,115:123='is_active',<373>,3:37]], category=[[@16,105:112='category',<373>,3:27]], nk=[[@20,126:127='nk',<373>,3:48]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union2={query0={query_dictionary={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, table_dictionary={<Guide>={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={student=query_column, rank=query_column, desc=query_column}, query1={query_dictionary={app_name=[[@14,95:102='app_name',<373>,3:17]], is_active=[[@18,115:123='is_active',<373>,3:37]], category=[[@16,105:112='category',<373>,3:27]], nk=[[@20,126:127='nk',<373>,3:48]]}, table_dictionary={<NAV>={is_active=[[@18,115:123='is_active',<373>,3:37]], category=[[@16,105:112='category',<373>,3:27]], nk=[[@20,126:127='nk',<373>,3:48]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectionWithMismatchColumnCountsAndNamesTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<Guide>=tuple, <NAV>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{<Guide>={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, <NAV>={is_active=[[@18,119:127='is_active',<373>,3:37]], category=[[@16,109:116='category',<373>,3:27]], nk=[[@20,130:131='nk',<373>,3:48]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, query1={app_name=[[@14,99:106='app_name',<373>,3:17]], is_active=[[@18,119:127='is_active',<373>,3:37]], category=[[@16,109:116='category',<373>,3:27]], nk=[[@20,130:131='nk',<373>,3:48]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect2={query0={query_dictionary={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}, table_dictionary={<Guide>={student=[[@5,19:25='student',<373>,1:19]], rank=[[@1,7:10='rank',<127>,1:7]], desc=[[@3,13:16='desc',<76>,1:13]]}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={student=query_column, rank=query_column, desc=query_column}, query1={query_dictionary={app_name=[[@14,99:106='app_name',<373>,3:17]], is_active=[[@18,119:127='is_active',<373>,3:37]], category=[[@16,109:116='category',<373>,3:27]], nk=[[@20,130:131='nk',<373>,3:48]]}, table_dictionary={<NAV>={is_active=[[@18,119:127='is_active',<373>,3:37]], category=[[@16,109:116='category',<373>,3:27]], nk=[[@20,130:131='nk',<373>,3:48]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleMultipleUnionParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@11,70:75='fourth',<373>,1:70]]}, third={first=[[@1,8:12='first',<87>,1:8]]}, eighth={seventh=[[@16,102:108='seventh',<373>,1:102]]}, fifth={third=[[@6,39:43='third',<373>,1:39]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={first=[[@1,8:12='first',<87>,1:8]]}, query1={third=[[@6,39:43='third',<373>,1:39]]}, query2={fourth=[[@11,70:75='fourth',<373>,1:70]]}, query3={seventh=[[@16,102:108='seventh',<373>,1:102]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union4={query0={query_dictionary={first=[[@1,8:12='first',<87>,1:8]]}, table_dictionary={third={first=[[@1,8:12='first',<87>,1:8]]}}, interface={first=[{name=first, table_ref=third}]}}, interface={first=query_column}, query1={query_dictionary={third=[[@6,39:43='third',<373>,1:39]]}, table_dictionary={fifth={third=[[@6,39:43='third',<373>,1:39]]}}, interface={third=[{name=third, table_ref=fifth}]}}, query2={query_dictionary={fourth=[[@11,70:75='fourth',<373>,1:70]]}, table_dictionary={sixth={fourth=[[@11,70:75='fourth',<373>,1:70]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}, query3={query_dictionary={seventh=[[@16,102:108='seventh',<373>,1:102]]}, table_dictionary={eighth={seventh=[[@16,102:108='seventh',<373>,1:102]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleMultipleIntersectParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@11,78:83='fourth',<373>,1:78]]}, third={first=[[@1,8:12='first',<87>,1:8]]}, eighth={seventh=[[@16,114:120='seventh',<373>,1:114]]}, fifth={third=[[@6,43:47='third',<373>,1:43]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={first=[[@1,8:12='first',<87>,1:8]]}, query1={third=[[@6,43:47='third',<373>,1:43]]}, query2={fourth=[[@11,78:83='fourth',<373>,1:78]]}, query3={seventh=[[@16,114:120='seventh',<373>,1:114]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect4={query0={query_dictionary={first=[[@1,8:12='first',<87>,1:8]]}, table_dictionary={third={first=[[@1,8:12='first',<87>,1:8]]}}, interface={first=[{name=first, table_ref=third}]}}, interface={first=query_column}, query1={query_dictionary={third=[[@6,43:47='third',<373>,1:43]]}, table_dictionary={fifth={third=[[@6,43:47='third',<373>,1:43]]}}, interface={third=[{name=third, table_ref=fifth}]}}, query2={query_dictionary={fourth=[[@11,78:83='fourth',<373>,1:78]]}, table_dictionary={sixth={fourth=[[@11,78:83='fourth',<373>,1:78]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}, query3={query_dictionary={seventh=[[@16,114:120='seventh',<373>,1:114]]}, table_dictionary={eighth={seventh=[[@16,114:120='seventh',<373>,1:114]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleMultipleUnion1ParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@20,107:112='fourth',<373>,4:14]]}, third={item=[[@1,8:11='item',<373>,1:8]]}, ninth={x=[[@13,72:72='x',<373>,3:9]]}, eighth={seventh=[[@25,140:146='seventh',<373>,5:14]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={seventh=[[@25,140:146='seventh',<373>,5:14]]}, query0={first=[[@3,16:20='first',<87>,1:16]]}, query1={x=[[@13,72:72='x',<373>,3:9]]}, query2={second=[[@9,50:55='second',<134>,2:16]]}, query3={fourth=[[@20,107:112='fourth',<373>,4:14]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union5={query4={query_dictionary={seventh=[[@25,140:146='seventh',<373>,5:14]]}, table_dictionary={eighth={seventh=[[@25,140:146='seventh',<373>,5:14]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}, query0={query_dictionary={first=[[@3,16:20='first',<87>,1:16]]}, table_dictionary={third={item=[[@1,8:11='item',<373>,1:8]]}}, interface={first=[{name=item, table_ref=third}]}}, interface={first=query_column}, query2={query_dictionary={second=[[@9,50:55='second',<134>,2:16]]}, table_dictionary={}, def_query1={query_dictionary={x=[[@13,72:72='x',<373>,3:9]]}, table_dictionary={ninth={x=[[@13,72:72='x',<373>,3:9]]}}, interface={x=[{name=x, table_ref=ninth}]}}, interface={second=[{name=x, table_ref=query1}]}, table_alias={fifth=query1}}, query3={query_dictionary={fourth=[[@20,107:112='fourth',<373>,4:14]]}, table_dictionary={sixth={fourth=[[@20,107:112='fourth',<373>,4:14]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleMultipleIntersect1ParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={z=[[@13,83:83='z',<373>,1:83]]}, third={x=[[@1,8:8='x',<373>,1:8]]}, eighth={omega=[[@19,121:125='omega',<373>,1:121]]}, fifth={y=[[@7,45:45='y',<373>,1:45]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={first=[[@2,10:14='first',<87>,1:10]]}, query1={second=[[@8,47:52='second',<134>,1:47]]}, query2={fourth=[[@14,85:90='fourth',<373>,1:85]]}, query3={seventh=[[@20,127:133='seventh',<373>,1:127]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect4={query0={query_dictionary={first=[[@2,10:14='first',<87>,1:10]]}, table_dictionary={third={x=[[@1,8:8='x',<373>,1:8]]}}, interface={first=[{name=x, table_ref=third}]}}, interface={first=query_column}, query1={query_dictionary={second=[[@8,47:52='second',<134>,1:47]]}, table_dictionary={fifth={y=[[@7,45:45='y',<373>,1:45]]}}, interface={second=[{name=y, table_ref=fifth}]}}, query2={query_dictionary={fourth=[[@14,85:90='fourth',<373>,1:85]]}, table_dictionary={sixth={z=[[@13,83:83='z',<373>,1:83]]}}, interface={fourth=[{name=z, table_ref=sixth}]}}, query3={query_dictionary={seventh=[[@20,127:133='seventh',<373>,1:127]]}, table_dictionary={eighth={omega=[[@19,121:125='omega',<373>,1:121]]}}, interface={seventh=[{name=omega, table_ref=eighth}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void simpleUnionIntersectParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@11,74:79='fourth',<373>,1:74]]}, third={first=[[@1,8:12='first',<87>,1:8]]}, eighth={seventh=[[@16,106:112='seventh',<373>,1:106]]}, fifth={third=[[@6,39:43='third',<373>,1:39]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={seventh=[[@16,106:112='seventh',<373>,1:106]]}, query0={first=[[@1,8:12='first',<87>,1:8]]}, query1={third=[[@6,39:43='third',<373>,1:39]]}, query3={fourth=[[@11,74:79='fourth',<373>,1:74]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect6={union5={query4={query_dictionary={seventh=[[@16,106:112='seventh',<373>,1:106]]}, table_dictionary={eighth={seventh=[[@16,106:112='seventh',<373>,1:106]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}, interface={fourth=query_column}, query3={query_dictionary={fourth=[[@11,74:79='fourth',<373>,1:74]]}, table_dictionary={sixth={fourth=[[@11,74:79='fourth',<373>,1:74]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}}, union2={query0={query_dictionary={first=[[@1,8:12='first',<87>,1:8]]}, table_dictionary={third={first=[[@1,8:12='first',<87>,1:8]]}}, interface={first=[{name=first, table_ref=third}]}}, interface={first=query_column}, query1={query_dictionary={third=[[@6,39:43='third',<373>,1:39]]}, table_dictionary={fifth={third=[[@6,39:43='third',<373>,1:39]]}}, interface={third=[{name=third, table_ref=fifth}]}}}, interface={first=union_column}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedUnionIntersectAAParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@10,65:70='fourth',<373>,1:65]]}, eighth={seventh=[[@17,102:108='seventh',<373>,1:102]]}, fifth={third=[[@5,30:34='third',<373>,1:30]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={seventh=[[@17,102:108='seventh',<373>,1:102]]}, query0={third=[[@5,30:34='third',<373>,1:30]]}, query1={fourth=[[@10,65:70='fourth',<373>,1:65]]}, query3={first=[[@1,8:12='first',<87>,1:8]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union5={query4={query_dictionary={seventh=[[@17,102:108='seventh',<373>,1:102]]}, table_dictionary={eighth={seventh=[[@17,102:108='seventh',<373>,1:102]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}, interface={first=query_column}, query3={query_dictionary={first=[[@1,8:12='first',<87>,1:8]]}, table_dictionary={}, def_intersect2={query0={query_dictionary={third=[[@5,30:34='third',<373>,1:30]]}, table_dictionary={fifth={third=[[@5,30:34='third',<373>,1:30]]}}, interface={third=[{name=third, table_ref=fifth}]}}, interface={third=query_column}, query1={query_dictionary={fourth=[[@10,65:70='fourth',<373>,1:65]]}, table_dictionary={sixth={fourth=[[@10,65:70='fourth',<373>,1:65]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}}, interface={first=[{name=first, table_ref=null}]}, table_alias={aa=intersect2}}}}",
				extractor.getSymbolTable().toString());
	...
	public void nestedUnionIntersectParseTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{sixth={fourth=[[@10,65:70='fourth',<373>,1:65]]}, eighth={seventh=[[@16,99:105='seventh',<373>,1:99]]}, fifth={third=[[@5,30:34='third',<373>,1:30]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={seventh=[[@16,99:105='seventh',<373>,1:99]]}, query0={third=[[@5,30:34='third',<373>,1:30]]}, query1={fourth=[[@10,65:70='fourth',<373>,1:65]]}, query3={first=[[@1,8:12='first',<87>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union5={query4={query_dictionary={seventh=[[@16,99:105='seventh',<373>,1:99]]}, table_dictionary={eighth={seventh=[[@16,99:105='seventh',<373>,1:99]]}}, interface={seventh=[{name=seventh, table_ref=eighth}]}}, interface={first=query_column}, query3={intersect2={query0={query_dictionary={third=[[@5,30:34='third',<373>,1:30]]}, table_dictionary={fifth={third=[[@5,30:34='third',<373>,1:30]]}}, interface={third=[{name=third, table_ref=fifth}]}}, interface={third=query_column}, query1={query_dictionary={fourth=[[@10,65:70='fourth',<373>,1:65]]}, table_dictionary={sixth={fourth=[[@10,65:70='fourth',<373>,1:65]]}}, interface={fourth=[{name=fourth, table_ref=sixth}]}}}, query_dictionary={first=[[@1,8:12='first',<87>,1:8]]}, table_dictionary={}, interface={first=[{name=first, table_ref=null}]}}}}",
				extractor.getSymbolTable().toString());
	...
	public void ilikeAnyWithEscapePredicateSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{scbcrse={subj_code=[[@6,32:40='subj_code',<373>,1:32]], *=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={*=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={*=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={scbcrse={subj_code=[[@6,32:40='subj_code',<373>,1:32]], *=[[@1,7:7='*',<290>,1:7]]}}, filters=[{name=subj_code, table_ref=scbcrse}], interface={*=[{name=*, table_ref=*}]}, table_alias={aa=scbcrse}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV1() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]]}, ff={c=[[@25,80:80='c',<373>,1:80]]}, tab1={a=[[@1,8:8='a',<373>,1:8], [@21,67:67='a',<373>,1:67]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, query0={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, query2={c=[[@25,80:80='c',<373>,1:80]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8], [@21,67:67='a',<373>,1:67]]}}, def_query0={query_dictionary={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, table_dictionary={ee={D=[[@8,26:26='D',<373>,1:26]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query2}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, def_query2={query_dictionary={c=[[@25,80:80='c',<373>,1:80]]}, table_dictionary={ff={c=[[@25,80:80='c',<373>,1:80]]}}, filters=[], interface={c=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV2() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@10,31:31='D',<373>,1:31]]}, ff={c=[[@34,103:103='c',<373>,1:103]]}, tab1={a=[[@1,8:11='tab1',<373>,1:8], [@26,82:85='tab1',<373>,1:82]]}, tab2={}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@4,15:16='aa',<373>,1:15]], dd=[[@19,53:54='dd',<373>,1:53]]}, query0={unnamed_0=[[@11,32:32=')',<287>,1:32]]}, query2={unnamed_1=[[@35,104:104=')',<287>,1:104]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@4,15:16='aa',<373>,1:15]], dd=[[@19,53:54='dd',<373>,1:53]]}, table_dictionary={tab1={a=[[@1,8:11='tab1',<373>,1:8], [@26,82:85='tab1',<373>,1:82]]}, tab2={}}, def_query0={query_dictionary={unnamed_0=[[@11,32:32=')',<287>,1:32]]}, table_dictionary={ee={D=[[@10,31:31='D',<373>,1:31]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query2}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, table_alias={bb=tab2}, def_query2={query_dictionary={unnamed_1=[[@35,104:104=')',<287>,1:104]]}, table_dictionary={ff={c=[[@34,103:103='c',<373>,1:103]]}}, filters=[], interface={unnamed_1=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV3() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]]}, ff={c=[[@30,95:95='c',<373>,1:95]]}, tab1={a=[[@1,8:8='a',<373>,1:8], [@22,70:70='a',<373>,1:70], [@24,79:79='a',<373>,1:79]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, query0={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, query2={unnamed_1=[[@31,96:96=')',<287>,1:96]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8], [@22,70:70='a',<373>,1:70], [@24,79:79='a',<373>,1:79]]}}, grouped_by=[{name=a, table_ref=tab1}], def_query0={query_dictionary={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, table_dictionary={ee={D=[[@8,26:26='D',<373>,1:26]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query2}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, def_query2={query_dictionary={unnamed_1=[[@31,96:96=')',<287>,1:96]]}, table_dictionary={ff={c=[[@30,95:95='c',<373>,1:95]]}}, filters=[], interface={unnamed_1=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV4() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]]}, ff={c=[[@28,85:85='c',<373>,1:85]]}, tab1={a=[[@1,8:8='a',<373>,1:8], [@22,70:70='a',<373>,1:70]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, query0={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, query2={unnamed_1=[[@29,86:86=')',<287>,1:86]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8], [@22,70:70='a',<373>,1:70]]}}, grouped_by=[{name=a, table_ref=tab1}, {query=query2}], def_query0={query_dictionary={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, table_dictionary={ee={D=[[@8,26:26='D',<373>,1:26]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, def_query2={query_dictionary={unnamed_1=[[@29,86:86=')',<287>,1:86]]}, table_dictionary={ff={c=[[@28,85:85='c',<373>,1:85]]}}, filters=[], interface={unnamed_1=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV5() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]]}, ff={c=[[@26,82:82='c',<373>,1:82]]}, tab1={a=[[@1,8:8='a',<373>,1:8]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, query0={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, query2={unnamed_1=[[@27,83:83=')',<287>,1:83]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8]]}}, def_query0={query_dictionary={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, table_dictionary={ee={D=[[@8,26:26='D',<373>,1:26]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, ordered_by=[{query=query2}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, def_query2={query_dictionary={unnamed_1=[[@27,83:83=')',<287>,1:83]]}, table_dictionary={ff={c=[[@26,82:82='c',<373>,1:82]]}}, filters=[], interface={unnamed_1=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesSymbolTableTestV6() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]]}, ff={c=[[@27,85:85='c',<373>,1:85]]}, tab1={a=[[@1,8:8='a',<373>,1:8], [@21,69:69='a',<373>,1:69]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, query0={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, query2={unnamed_1=[[@28,86:86=')',<287>,1:86]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@17,48:49='dd',<373>,1:48]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8], [@21,69:69='a',<373>,1:69]]}}, def_query0={query_dictionary={unnamed_0=[[@9,27:27=')',<287>,1:27]]}, table_dictionary={ee={D=[[@8,26:26='D',<373>,1:26]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query2}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}]}, def_query2={query_dictionary={unnamed_1=[[@28,86:86=')',<287>,1:86]]}, table_dictionary={ff={c=[[@27,85:85='c',<373>,1:85]]}}, filters=[], interface={unnamed_1=[{name=c, table_ref=ff}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void scalarSubqueriesCorrelatedSubquerySymbolTableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@8,26:26='D',<373>,1:26]], x=[[@13,43:44='ee',<373>,1:43]]}, ff={c=[[@29,90:90='c',<373>,1:90]], y=[[@33,106:107='ff',<373>,1:106]]}, tab1={y=[[@37,113:116='tab1',<373>,1:113]]}}",
				extractor.getTableColumnDictionaryMap().toString());
	...
	public void multipleScalarAndOtherSubqueriesSymbolTableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@10,31:31='D',<373>,1:31], [@21,62:62='D',<373>,1:62]]}, jj={w=[[@36,110:110='w',<373>,1:110]]}, ff={c=[[@46,143:143='c',<373>,1:143]]}, tab1={a=[[@1,8:11='tab1',<373>,1:8], [@42,130:130='a',<373>,1:130]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={w=[[@36,110:110='w',<373>,1:110], [@28,82:83='kk',<373>,1:82]]}, query5={c=[[@46,143:143='c',<373>,1:143]]}, query7={aa=[[@4,15:16='aa',<373>,1:15]], max_D=[[@15,43:47='max_D',<373>,1:43]], min_D=[[@26,74:78='min_D',<373>,1:74]], w=[[@30,85:85='w',<373>,1:85]]}, query0={unnamed_0=[[@11,32:32=')',<287>,1:32]]}, query2={unnamed_1=[[@22,63:63=')',<287>,1:63]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query7={query_dictionary={aa=[[@4,15:16='aa',<373>,1:15]], max_D=[[@15,43:47='max_D',<373>,1:43]], min_D=[[@26,74:78='min_D',<373>,1:74]], w=[[@30,85:85='w',<373>,1:85]]}, table_dictionary={tab1={a=[[@1,8:11='tab1',<373>,1:8], [@42,130:130='a',<373>,1:130]]}}, def_query0={query_dictionary={unnamed_0=[[@11,32:32=')',<287>,1:32]]}, table_dictionary={ee={D=[[@10,31:31='D',<373>,1:31], [@21,62:62='D',<373>,1:62]]}}, interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{name=a, table_ref=tab1}, {query=query5}], def_query5={query_dictionary={c=[[@46,143:143='c',<373>,1:143]]}, table_dictionary={ff={c=[[@46,143:143='c',<373>,1:143]]}}, interface={c=[{name=c, table_ref=ff}]}}, interface={aa=[{name=a, table_ref=tab1}], max_D=[{query=query0}], min_D=[{query=query2}], w=[{name=w, table_ref=kk}]}, def_query4={query_dictionary={w=[[@36,110:110='w',<373>,1:110], [@28,82:83='kk',<373>,1:82]]}, table_dictionary={jj={w=[[@36,110:110='w',<373>,1:110]]}}, interface={w=[{name=w, table_ref=jj}]}}, table_alias={kk=query4}, def_query2={query_dictionary={unnamed_1=[[@22,63:63=')',<287>,1:63]]}, table_dictionary={ee={D=[[@21,62:62='D',<373>,1:62]]}}, interface={unnamed_1=[{name=D, table_ref=ee}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void nestedFormulaSubqueriesUseQueryRefsInInterfaceAndFiltersTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}",
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{ee={D=[[@12,44:44='D',<373>,1:44]]}, gg={D=[[@26,78:78='D',<373>,1:78]]}, ff={c=[[@50,153:153='c',<373>,1:153]]}, tab3={b=[[@40,122:122='b',<373>,1:122]]}, tab1={a=[[@1,8:8='a',<373>,1:8]], emptyCol=[[@6,23:30='emptyCol',<373>,1:23]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query8={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@32,91:92='dd',<373>,1:91]]}, query4={bb=[[@43,128:129='bb',<373>,1:128]]}, query6={c=[[@50,153:153='c',<373>,1:153]]}, query0={unnamed_0=[[@13,45:45=')',<287>,1:45]]}, query2={unnamed_1=[[@27,79:79=')',<287>,1:79]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query8={def_query6={query_dictionary={c=[[@50,153:153='c',<373>,1:153]]}, table_dictionary={ff={c=[[@50,153:153='c',<373>,1:153]]}}, filters=[], interface={c=[{name=c, table_ref=ff}]}}, query_dictionary={aa=[[@2,10:11='aa',<373>,1:10]], dd=[[@32,91:92='dd',<373>,1:91]]}, table_dictionary={tab1={a=[[@1,8:8='a',<373>,1:8]], emptyCol=[[@6,23:30='emptyCol',<373>,1:23]]}}, def_query0={query_dictionary={unnamed_0=[[@13,45:45=')',<287>,1:45]]}, table_dictionary={ee={D=[[@12,44:44='D',<373>,1:44]]}}, filters=[], interface={unnamed_0=[{name=D, table_ref=ee}]}}, filters=[{query=query4}, {query=query6}], interface={aa=[{name=a, table_ref=tab1}], dd=[{query=query0}, {query=query2}]}, def_query4={query_dictionary={bb=[[@43,128:129='bb',<373>,1:128]]}, table_dictionary={tab3={b=[[@40,122:122='b',<373>,1:122]]}}, interface={bb=[{name=b, table_ref=tab3}]}}, def_query2={query_dictionary={unnamed_1=[[@27,79:79=')',<287>,1:79]]}, table_dictionary={gg={D=[[@26,78:78='D',<373>,1:78]]}}, interface={unnamed_1=[{name=D, table_ref=gg}]}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectWhereExistsCorrelatedSubquery() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{cat_concentration={concentration_code=[[@35,221:221='c',<373>,1:221]]}, bnr_stvmajr={stvmajr_code=[[@39,244:244='s',<373>,1:244]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@30,188:188='1',<299>,1:188]]}, query2={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}, table_dictionary={bnr_stvmajr={stvmajr_code=[[@39,244:244='s',<373>,1:244]]}}, def_query0={query_dictionary={unnamed_0=[[@30,188:188='1',<299>,1:188]]}, table_dictionary={cat_concentration={concentration_code=[[@35,221:221='c',<373>,1:221]]}}, filters=[{name=concentration_code, table_ref=c}, {name=stvmajr_code, table_ref=s}], interface={unnamed_0=[]}, table_alias={c=cat_concentration}}, filters=[{name=stvmajr_valid_concentratn_ind, table_ref=s}], interface={concentration_desc=[{name=stvmajr_desc, table_ref=s}], concentration_code=[{name=stvmajr_code, table_ref=s}], active_ind=[]}, exists1=query0, table_alias={s=bnr_stvmajr}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectWhereVariableExists() {
		...
		Assert.assertEquals("Substitution List is wrong", "{<table_variable>=tuple}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{bnr_stvmajr={stvmajr_desc=[[@7,45:45='s',<373>,1:45]], stvmajr_valid_concentratn_ind=[[@20,126:126='s',<373>,1:126]], stvmajr_code=[[@1,7:7='s',<373>,1:7]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query0={query_dictionary={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}, table_dictionary={bnr_stvmajr={stvmajr_desc=[[@7,45:45='s',<373>,1:45]], stvmajr_valid_concentratn_ind=[[@20,126:126='s',<373>,1:126]], stvmajr_code=[[@1,7:7='s',<373>,1:7]]}}, filters=[{name=stvmajr_valid_concentratn_ind, table_ref=s}], interface={concentration_desc=[{name=stvmajr_desc, table_ref=s}], concentration_code=[{name=stvmajr_code, table_ref=s}], active_ind=[]}, table_alias={s=bnr_stvmajr}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void havingScalarSubqueryComparisonTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{employees={dept=[[@1,7:7='e',<373>,1:7], [@18,71:71='e',<373>,1:71]], salary=[[@33,113:118='salary',<373>,1:113], [@7,19:19='e',<373>,1:19], [@24,89:89='e',<373>,1:89]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@34,119:119=')',<287>,1:119]]}, query2={total_salary=[[@12,32:43='total_salary',<373>,1:32]], dept=[[@3,9:12='dept',<373>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={total_salary=[[@12,32:43='total_salary',<373>,1:32]], dept=[[@3,9:12='dept',<373>,1:9]]}, table_dictionary={employees={dept=[[@1,7:7='e',<373>,1:7], [@18,71:71='e',<373>,1:71]], salary=[[@7,19:19='e',<373>,1:19], [@24,89:89='e',<373>,1:89]]}}, grouped_by=[{name=dept, table_ref=e}], def_query0={query_dictionary={unnamed_0=[[@34,119:119=')',<287>,1:119]]}, table_dictionary={employees={salary=[[@33,113:118='salary',<373>,1:113], [@7,19:19='e',<373>,1:19], [@24,89:89='e',<373>,1:89]]}}, interface={unnamed_0=[{name=salary, table_ref=employees}]}}, filters=[{name=salary, table_ref=e}, {query=query0}], interface={total_salary=[{name=salary, table_ref=e}], dept=[{name=dept, table_ref=e}]}, table_alias={e=employees}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void havingExistsCorrelatedSubqueryTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{orders={customer_id=[[@28,133:133='o',<373>,4:44]]}, customers={customer_id=[[@32,149:149='e',<373>,4:60]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@23,111:111='1',<299>,4:22]]}, query2={order_count=[[@10,34:44='order_count',<373>,1:34]], customer_id=[[@3,9:19='customer_id',<373>,1:9]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={order_count=[[@10,34:44='order_count',<373>,1:34]], customer_id=[[@3,9:19='customer_id',<373>,1:9]]}, table_dictionary={customers={customer_id=[[@32,149:149='e',<373>,4:60]]}}, grouped_by=[{name=customer_id, table_ref=e}], def_query0={query_dictionary={unnamed_0=[[@23,111:111='1',<299>,4:22]]}, table_dictionary={orders={customer_id=[[@28,133:133='o',<373>,4:44]]}}, filters=[{name=customer_id, table_ref=o}, {name=customer_id, table_ref=e}], interface={unnamed_0=[]}, table_alias={o=orders}}, filters=[], interface={order_count=[], customer_id=[{name=customer_id, table_ref=e}]}, exists1=query0, table_alias={e=customers}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectWhereScalarConditionCorrelatedSubquery() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
				//{ee={D=[@8,26:26='D',<373>,1:26]}, ff={c=[@21,70:70='c',<373>,1:70]}, tab1={a=[@1,8:8='a',<373>,1:8]}}
		Assert.assertEquals("Table Dictionary is wrong", "{cat_concentration={concentration_code=[[@28,157:157='c',<373>,1:157], [@36,210:210='c',<373>,1:210]]}, bnr_stvmajr={stvmajr_code=[[@40,234:234='s',<373>,1:234]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@31,177:177=')',<287>,1:177]]}, query2={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}, table_dictionary={bnr_stvmajr={stvmajr_code=[[@40,234:234='s',<373>,1:234]]}}, def_query0={query_dictionary={unnamed_0=[[@31,177:177=')',<287>,1:177]]}, table_dictionary={cat_concentration={concentration_code=[[@28,157:157='c',<373>,1:157], [@36,210:210='c',<373>,1:210]]}}, filters=[{name=concentration_code, table_ref=c}, {name=stvmajr_code, table_ref=s}], interface={unnamed_0=[{name=concentration_code, table_ref=c}]}, table_alias={c=cat_concentration}}, filters=[{name=stvmajr_code, table_ref=s}, {query=query0}], interface={concentration_desc=[{name=stvmajr_desc, table_ref=s}], concentration_code=[{name=stvmajr_code, table_ref=s}], active_ind=[]}, table_alias={s=bnr_stvmajr}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectOrderByScalarCorrelatedSubquery() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
				//{ee={D=[@8,26:26='D',<373>,1:26]}, ff={c=[@21,70:70='c',<373>,1:70]}, tab1={a=[@1,8:8='a',<373>,1:8]}}
		Assert.assertEquals("Table Dictionary is wrong", "{cat_concentration={code=[[@25,142:142='c',<373>,1:142]], concentration_code=[[@33,181:181='c',<373>,1:181]]}, bnr_stvmajr={stvmajr_code=[[@37,204:204='s',<373>,1:204]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={unnamed_0=[[@28,148:148=')',<287>,1:148]]}, query2={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={concentration_desc=[[@11,63:80='concentration_desc',<373>,1:63]], concentration_code=[[@5,25:42='concentration_code',<373>,1:25]], active_ind=[[@15,90:99='active_ind',<373>,1:90]]}, table_dictionary={bnr_stvmajr={stvmajr_code=[[@37,204:204='s',<373>,1:204]]}}, def_query0={query_dictionary={unnamed_0=[[@28,148:148=')',<287>,1:148]]}, table_dictionary={cat_concentration={code=[[@25,142:142='c',<373>,1:142]], concentration_code=[[@33,181:181='c',<373>,1:181]]}}, filters=[{name=concentration_code, table_ref=c}, {name=stvmajr_code, table_ref=s}], interface={unnamed_0=[{name=code, table_ref=c}]}, table_alias={c=cat_concentration}}, ordered_by=[{query=query0}], interface={concentration_desc=[{name=stvmajr_desc, table_ref=s}], concentration_code=[{name=stvmajr_code, table_ref=s}], active_ind=[]}, table_alias={s=bnr_stvmajr}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void selectWithSameSubqueriesTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
				extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{lawn={b=[[@18,76:76='b',<373>,1:76]]}, mulch={a=[[@5,22:22='a',<373>,1:22]]}, clay={b=[[@10,48:48='b',<373>,1:48]]}}",
				extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={*=[[@1,7:7='*',<290>,1:7]]}, query0={a=[[@5,22:22='a',<373>,1:22]], *=[[@1,7:7='*',<290>,1:7]]}, query1={b=[[@10,48:48='b',<373>,1:48]], *=[[@1,7:7='*',<290>,1:7]]}, query3={b=[[@18,76:76='b',<373>,1:76], [@28,112:117='second',<134>,1:112]], *=[[@1,7:7='*',<290>,1:7]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={def_union2={query0={query_dictionary={a=[[@5,22:22='a',<373>,1:22]], *=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={mulch={a=[[@5,22:22='a',<373>,1:22]]}}, interface={a=[{name=a, table_ref=mulch}]}}, interface={a=query_column}, query1={query_dictionary={b=[[@10,48:48='b',<373>,1:48]], *=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={clay={b=[[@10,48:48='b',<373>,1:48]]}}, interface={b=[{name=b, table_ref=clay}]}}}, query_dictionary={*=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={}, filters=[{name=a, table_ref=first}, {name=b, table_ref=second}], interface={*=[{name=*, table_ref=*}]}, def_query3={query_dictionary={b=[[@18,76:76='b',<373>,1:76], [@28,112:117='second',<134>,1:112]], *=[[@1,7:7='*',<290>,1:7]]}, table_dictionary={lawn={b=[[@18,76:76='b',<373>,1:76]]}}, interface={b=[{name=b, table_ref=lawn}]}}, table_alias={first=union2, second=query3}}}",
				extractor.getSymbolTable().toString());
}
	...
	public void normalMultiTableTest() {
		...
		Assert.assertEquals("Substitution List is wrong", "{}", 
					extractor.getSubstitutionsMap().toString());
		Assert.assertEquals("Table Dictionary is wrong", "{tab1={col1=[[@11,46:49='col1',<373>,1:46]]}, tab2={col2=[[@20,85:88='col2',<373>,1:85]]}}",
					extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={col1=[[@11,46:49='col1',<373>,1:46], [@1,8:13='source',<373>,1:8]]}, query1={col2=[[@20,85:88='col2',<373>,1:85], [@5,21:26='target',<373>,1:21]]}, query2={col2=[[@7,28:31='col2',<373>,1:28]], col1=[[@3,15:18='col1',<373>,1:15]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col2=[[@7,28:31='col2',<373>,1:28]], col1=[[@3,15:18='col1',<373>,1:15]]}, table_dictionary={}, def_query1={query_dictionary={col2=[[@20,85:88='col2',<373>,1:85], [@5,21:26='target',<373>,1:21]]}, table_dictionary={tab2={col2=[[@20,85:88='col2',<373>,1:85]]}}, interface={col2=[{name=col2, table_ref=tab2}]}}, def_query0={query_dictionary={col1=[[@11,46:49='col1',<373>,1:46], [@1,8:13='source',<373>,1:8]]}, table_dictionary={tab1={col1=[[@11,46:49='col1',<373>,1:46]]}}, interface={col1=[{name=col1, table_ref=tab1}]}}, interface={col2=[{name=col2, table_ref=target}], col1=[{name=col1, table_ref=source}]}, table_alias={source=query0, target=query1}}}",
					extractor.getSymbolTable().toString());
	}
	...
	public void multipleValuesStatementWithColumnAliasesClauseInSelectTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{}",
					extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{values0={col2=[[@24,78:81='col2',<373>,1:78]], col3=[[@26,84:87='col3',<373>,1:84]], col1=[[@22,72:75='col1',<373>,1:72], [@1,8:13='source',<373>,1:8]]}, values1={c3=[[@44,134:135='c3',<373>,1:134]], c1=[[@42,130:131='c1',<373>,1:130]], c2=[[@46,138:139='c2',<373>,1:138]]}, query2={col2=[[@7,28:31='col2',<373>,1:28]], col1=[[@3,15:18='col1',<373>,1:15]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query2={query_dictionary={col2=[[@7,28:31='col2',<373>,1:28]], col1=[[@3,15:18='col1',<373>,1:15]]}, def_values1={query_dictionary={c3=[[@44,134:135='c3',<373>,1:134]], c1=[[@42,130:131='c1',<373>,1:130]], c2=[[@46,138:139='c2',<373>,1:138]]}, table_dictionary={}, interface={c3=[], c1=[], c2=[]}}, table_dictionary={}, def_values0={query_dictionary={col2=[[@24,78:81='col2',<373>,1:78]], col3=[[@26,84:87='col3',<373>,1:84]], col1=[[@22,72:75='col1',<373>,1:72], [@1,8:13='source',<373>,1:8]]}, table_dictionary={}, interface={col2=[], col3=[], col1=[]}}, interface={col2=[{name=col2, table_ref=target}], col1=[{name=col1, table_ref=source}]}, table_alias={source=values0, target=values1}}}",
					extractor.getSymbolTable().toString());
	}
	...
	public void valuesStatementWithAsClauseAndColumnsInSelectTest() {
		...
		Assert.assertEquals("Table Dictionary is wrong", "{}",
					extractor.getTableColumnDictionaryMap().toString());
		Assert.assertEquals("Query Column Dictionary is wrong", "{values0={*=[[@1,8:8='*',<290>,1:8]], col2=[[@26,68:71='col2',<373>,1:68]], col3=[[@28,74:77='col3',<373>,1:74]], col1=[[@24,62:65='col1',<373>,1:62]]}, query1={*=[[@1,8:8='*',<290>,1:8]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query1={query_dictionary={*=[[@1,8:8='*',<290>,1:8]]}, table_dictionary={}, def_values0={query_dictionary={*=[[@1,8:8='*',<290>,1:8]], col2=[[@26,68:71='col2',<373>,1:68]], col3=[[@28,74:77='col3',<373>,1:74]], col1=[[@24,62:65='col1',<373>,1:62]]}, table_dictionary={}, interface={col2=[], col3=[], col1=[]}}, interface={*=[{name=*, table_ref=*}]}, table_alias={src=values0}}}",
					extractor.getSymbolTable().toString());
