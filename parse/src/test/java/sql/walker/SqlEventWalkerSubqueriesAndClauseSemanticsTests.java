...
public class SqlEventWalkerSubqueriesAndClauseSemanticsTests extends AbstractSqlParseEventWalkerTest {
	...
	public void unionWithMismatchColumnCountsAndNamesTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}, query1={app_name=[[@14,95:102='app_name',<381>,3:17]], is_active=[[@18,115:123='is_active',<381>,3:37]], category=[[@16,105:112='category',<381>,3:27]], nk=[[@20,126:127='nk',<381>,3:48]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{union2={query0={query_dictionary={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}, table_dictionary={<Guide>={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}, {name=is_active, table_ref=<NAV>}], desc=[{name=desc, table_ref=<Guide>}, {name=category, table_ref=<NAV>}]}, query1={query_dictionary={app_name=[[@14,95:102='app_name',<381>,3:17]], is_active=[[@18,115:123='is_active',<381>,3:37]], category=[[@16,105:112='category',<381>,3:27]], nk=[[@20,126:127='nk',<381>,3:48]]}, table_dictionary={<NAV>={is_active=[[@18,115:123='is_active',<381>,3:37]], category=[[@16,105:112='category',<381>,3:27]], nk=[[@20,126:127='nk',<381>,3:48]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectionWithMismatchColumnCountsAndNamesTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query0={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}, query1={app_name=[[@14,99:106='app_name',<381>,3:17]], is_active=[[@18,119:127='is_active',<381>,3:37]], category=[[@16,109:116='category',<381>,3:27]], nk=[[@20,130:131='nk',<381>,3:48]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect2={query0={query_dictionary={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}, table_dictionary={<Guide>={student=[[@5,19:25='student',<381>,1:19]], rank=[[@1,7:10='rank',<128>,1:7]], desc=[[@3,13:16='desc',<77>,1:13]]}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}], desc=[{name=desc, table_ref=<Guide>}]}, table_alias={Guide_Student_Conditions=<Guide>}}, interface={student=[{name=student, table_ref=<Guide>}], rank=[{name=rank, table_ref=<Guide>}, {name=is_active, table_ref=<NAV>}], desc=[{name=desc, table_ref=<Guide>}, {name=category, table_ref=<NAV>}]}, query1={query_dictionary={app_name=[[@14,99:106='app_name',<381>,3:17]], is_active=[[@18,119:127='is_active',<381>,3:37]], category=[[@16,109:116='category',<381>,3:27]], nk=[[@20,130:131='nk',<381>,3:48]]}, table_dictionary={<NAV>={is_active=[[@18,119:127='is_active',<381>,3:37]], category=[[@16,109:116='category',<381>,3:27]], nk=[[@20,130:131='nk',<381>,3:48]]}}, interface={app_name=[], is_active=[{name=is_active, table_ref=<NAV>}], category=[{name=category, table_ref=<NAV>}], nk=[{name=nk, table_ref=<NAV>}]}, table_alias={Nav_Student_Conditions=<NAV>}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectWithSubqueryWithIntersectSubqueryTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={*=[[@6,37:37='*',<291>,1:37]]}, query0={*=[[@1,7:7='*',<291>,1:7]]}, query1={*=[[@10,52:52='*',<291>,1:52]]}, query2={*=[[@15,84:84='*',<291>,1:84]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect5={query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={tab1={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={*=[{name=*, table_ref=*}, {name=*, table_ref=*}]}, query4={query_dictionary={*=[[@6,37:37='*',<291>,1:37]]}, table_dictionary={}, def_intersect3={interface={*=[{name=*, table_ref=*}, {name=*, table_ref=*}]}, query1={query_dictionary={*=[[@10,52:52='*',<291>,1:52]]}, table_dictionary={answer={*=[[@10,52:52='*',<291>,1:52]]}}, interface={*=[{name=*, table_ref=*}]}}, query2={query_dictionary={*=[[@15,84:84='*',<291>,1:84]]}, table_dictionary={problem={*=[[@15,84:84='*',<291>,1:84]]}}, interface={*=[{name=*, table_ref=*}]}}}, interface={*=[{name=*, table_ref=*}]}, table_alias={tab2=intersect3}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectWithSubqueryWithUnionSubqueryTest() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={*=[[@6,37:37='*',<291>,1:37]]}, query0={*=[[@1,7:7='*',<291>,1:7]]}, query1={*=[[@10,52:52='*',<291>,1:52]]}, query2={*=[[@15,80:80='*',<291>,1:80]]}}",
						extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{intersect5={query0={query_dictionary={*=[[@1,7:7='*',<291>,1:7]]}, table_dictionary={tab1={*=[[@1,7:7='*',<291>,1:7]]}}, interface={*=[{name=*, table_ref=*}]}}, interface={*=[{name=*, table_ref=*}, {name=*, table_ref=*}]}, query4={def_union3={interface={*=[{name=*, table_ref=*}, {name=*, table_ref=*}]}, query1={query_dictionary={*=[[@10,52:52='*',<291>,1:52]]}, table_dictionary={answer={*=[[@10,52:52='*',<291>,1:52]]}}, interface={*=[{name=*, table_ref=*}]}}, query2={query_dictionary={*=[[@15,80:80='*',<291>,1:80]]}, table_dictionary={problem={*=[[@15,80:80='*',<291>,1:80]]}}, interface={*=[{name=*, table_ref=*}]}}}, query_dictionary={*=[[@6,37:37='*',<291>,1:37]]}, table_dictionary={}, interface={*=[{name=*, table_ref=*}]}, table_alias={tab2=union3}}}}",
				extractor.getSymbolTable().toString());
	}
	...
	public void intersectAndQueryUnqualifiedReferencesCTEV6() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={col2=[[@26,126:129='col2',<381>,4:15]], col1=[[@24,120:123='col1',<381>,4:9]]}, query0={col1=[[@5,23:26='col1',<381>,2:17]]}, query1={col2=[[@10,58:61='col2',<381>,2:52]]}, query3={col2=[[@19,95:98='col2',<381>,3:16], [@36,163:165='bbb',<381>,4:52]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={col2=[[@26,126:129='col2',<381>,4:15]], col1=[[@24,120:123='col1',<381>,4:9]]}, table_dictionary={}, def_intersect2={query0={query_dictionary={col1=[[@5,23:26='col1',<381>,2:17]]}, table_dictionary={answer={col1=[[@5,23:26='col1',<381>,2:17]]}}, interface={col1=[{name=col1, table_ref=answer}]}}, interface={col1=[{name=col1, table_ref=answer}, {name=col2, table_ref=problem}]}, query1={query_dictionary={col2=[[@10,58:61='col2',<381>,2:52]]}, table_dictionary={problem={col2=[[@10,58:61='col2',<381>,2:52]]}}, interface={col2=[{name=col2, table_ref=problem}]}}}, cte_list={aaa=intersect2, bbb=query3}, filters=[{name=col1, table_ref=aaa}, {name=col2, table_ref=bbb}], interface={col2=[{name=col2, table_ref=query3}], col1=[{name=col1, table_ref=intersect2}]}, table_alias={aaa=intersect2, bbb=query3}, def_query3={query_dictionary={col2=[[@19,95:98='col2',<381>,3:16], [@36,163:165='bbb',<381>,4:52]]}, table_dictionary={tab2={col2=[[@19,95:98='col2',<381>,3:16]]}}, cte_list={aaa=intersect2}, interface={col2=[{name=col2, table_ref=tab2}]}}}}",
				extractor.getSymbolTable().toString());
	...
	public void unionAndValuesUnqualifiedReferencesCTEV9() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={col2=[[@49,174:177='col2',<381>,4:15]], col1=[[@47,168:171='col1',<381>,4:9]]}, query0={col1=[[@5,23:26='col1',<381>,2:17]]}, query1={col2=[[@10,54:57='col2',<381>,2:48]]}, values3={col2=[[@41,146:149='col2',<381>,3:71], [@59,211:213='bbb',<381>,4:52]], col3=[[@43,152:155='col3',<381>,3:77]], col1=[[@39,140:143='col1',<381>,3:65]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={col2=[[@49,174:177='col2',<381>,4:15]], col1=[[@47,168:171='col1',<381>,4:9]]}, def_union2={query0={query_dictionary={col1=[[@5,23:26='col1',<381>,2:17]]}, table_dictionary={answer={col1=[[@5,23:26='col1',<381>,2:17]]}}, interface={col1=[{name=col1, table_ref=answer}]}}, interface={col1=[{name=col1, table_ref=answer}, {name=col2, table_ref=problem}]}, query1={query_dictionary={col2=[[@10,54:57='col2',<381>,2:48]]}, table_dictionary={problem={col2=[[@10,54:57='col2',<381>,2:48]]}}, interface={col2=[{name=col2, table_ref=problem}]}}}, table_dictionary={}, def_values3={query_dictionary={col2=[[@41,146:149='col2',<381>,3:71], [@59,211:213='bbb',<381>,4:52]], col3=[[@43,152:155='col3',<381>,3:77]], col1=[[@39,140:143='col1',<381>,3:65]]}, table_dictionary={}, interface={col2=[], col3=[], col1=[]}}, cte_list={aaa=union2, bbb=values3}, filters=[{name=col1, table_ref=aaa}, {name=col2, table_ref=bbb}], interface={col2=[{name=col2, table_ref=values3}], col1=[{name=col1, table_ref=null}]}, table_alias={aaa=union2, bbb=values3}}}",
				extractor.getSymbolTable().toString());
	...
	public void intersectAndQueryQualifiedReferencesOutOfSequenceWithAliasesCTEV1() {
		...
		Assert.assertEquals("Query Column Dictionary is wrong", "{query4={col2=[[@40,158:161='col2',<381>,4:23]], col1=[[@36,148:151='col1',<381>,4:13]]}, query0={col2=[[@7,27:30='col2',<381>,2:21], [@25,108:110='eee',<381>,3:63], [@38,154:156='bbb',<381>,4:19], [@50,195:197='bbb',<381>,4:60]]}, query1={col1=[[@18,66:69='col1',<381>,3:21]]}, query2={col2=[[@27,112:115='col2',<381>,3:67]]}}",
				extractor.getQueryColumnDictionaryMap().toString());
		Assert.assertEquals("Symbol Table is wrong", "{query4={query_dictionary={col2=[[@40,158:161='col2',<381>,4:23]], col1=[[@36,148:151='col1',<381>,4:13]]}, table_dictionary={}, def_intersect3={cte_list={bbb=query0}, interface={col1=[{name=col1, table_ref=fff}, {name=col2, table_ref=eee}]}, query1={query_dictionary={col1=[[@18,66:69='col1',<381>,3:21]]}, table_dictionary={answer={col1=[[@16,62:64='fff',<381>,3:17]]}}, cte_list={bbb=query0}, interface={col1=[{name=col1, table_ref=fff}]}, table_alias={fff=answer}}, query2={query_dictionary={col2=[[@27,112:115='col2',<381>,3:67]]}, table_dictionary={}, cte_list={bbb=query0, eee=query0}, interface={col2=[{name=col2, table_ref=eee}]}, table_alias={eee=query0, bbb=query0}}}, cte_list={bbb=query0, aaa=intersect3}, def_query0={query_dictionary={col2=[[@7,27:30='col2',<381>,2:21], [@25,108:110='eee',<381>,3:63], [@38,154:156='bbb',<381>,4:19], [@50,195:197='bbb',<381>,4:60]]}, table_dictionary={tab2={col2=[[@5,22:25='tab2',<381>,2:16]]}}, interface={col2=[{name=col2, table_ref=tab2}]}}, filters=[{name=col1, table_ref=aaa}, {name=col2, table_ref=bbb}], interface={col2=[{name=col2, table_ref=bbb}], col1=[{name=col1, table_ref=aaa}]}, table_alias={aaa=intersect3, bbb=query0}}}",
				extractor.getSymbolTable().toString());
	}
