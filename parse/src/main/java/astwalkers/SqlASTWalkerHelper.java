...
public final class SqlASTWalkerHelper extends AbstractASTWalkerHelper {
	...
	public void notifyStatementDialectGrammarHit(
		...
		public static final String DIAG_SQL_AMBIGUOUS_DERIVED_AND_REGULAR_COLUMN_REFERENCE =
				"SQL_AMBIGUOUS_DERIVED_AND_REGULAR_COLUMN_REFERENCE";
		...
		public static final String DIAG_SQL_CROSS_NATURAL_JOIN_INVALID_CONDITION =
				"SQL_CROSS_NATURAL_JOIN_INVALID_CONDITION";
		public static final String DIAG_SQL_NATURAL_FULL_OUTER_JOIN_UNSUPPORTED =
				"SQL_NATURAL_FULL_OUTER_JOIN_UNSUPPORTED";
 ...
 protected void initializeAstKeyCrosswalkMap() {
    ...
    private String getASTWALKER_UPDATE_KEY() {
	 ...
	 private void initializeSqlDiagnosticCatalog() {
		 ...
		 registerDiagnostic(
				 DIAG_SQL_AMBIGUOUS_DERIVED_AND_REGULAR_COLUMN_REFERENCE,
		 ...
		 registerDiagnostic(
				 DIAG_SQL_CROSS_NATURAL_JOIN_INVALID_CONDITION,
				 "CROSS_NATURAL_JOIN_INVALID_CONDITION",
				 "%s JOIN at (l:%s c:%s) has invalid %s condition (l:%s c:%s).");
		 registerDiagnostic(
				 DIAG_SQL_NATURAL_FULL_OUTER_JOIN_UNSUPPORTED,
