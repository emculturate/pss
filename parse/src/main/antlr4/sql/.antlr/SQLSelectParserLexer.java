...
public class SQLSelectParserLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"AND", "ANY", "ASYMMETRIC", "BOTH", "CASE", "CAST", "CREATE", "CROSS", 
			"DISTINCT", "END", "ELSE", "EXCEPT", "FALSE", "FULL", "FROM", "GROUP", 
			"HAVING", "IGNORE", "ILIKE", "IN", "INNER", "INTERSECT", "INTO", "IS", 
			"JOIN", "LEADING", "LEFT", "LIKE", "LIMIT", "NATURAL", "NOT", "NULL", 
			"NULLS", "NUMBER_TYPE", "OFFSET", "ON", "OUTER", "OR", "ORDER", "RESPECT", 
			"RIGHT", "RETURNING", "SELECT", "SOME", "SYMMETRIC", "TABLE", "THEN", 
			"TRAILING", "TRUE", "TRYCAST", "UNION", "UNIQUE", "USING", "WHEN", "WHERE", 
			"WITH", "WITHOUT", "ASC", "AVG", "BETWEEN", "BY", "CENTURY", "CHARACTER", 
			"COLLECT", "COALESCE", "COLUMN", "COUNT", "COUNT_IF", "CUBE", "CURRENT", 
			"DAY", "DEC", "DECADE", "DESC", "DOW", "DOY", "DROP", "EPOCH", "ESCAPE", 
			...
			"NOT_EQUAL", "LTH", "LEQ", "GTH", "GEQ", "IMPLIES", "LEFT_PAREN", "RIGHT_PAREN", 
			...
			"Population_Identifier", "QUALIFY", "POSITION", "CHARINDEX", "INSTR", 
			"DELETE", "TRUNCATE", "IFF", "MD5", "REVERSE", "FLATTEN", "SPLIT_TO_TABLE", 
			"STRTOK_SPLIT_TO_TABLE", "GENERATOR", "INFER_SCHEMA", "VALIDATE", "RESULT_SCAN", 
			"QUERY_HISTORY", "QUERY_HSTORY", "INPUT", "PATH", "RECURSIVE", "MODE", 
			"LATERAL", "ROWCOUNT", "TIMELIMIT", "FILES", "FILE_FORMAT", "IGNORE_CASE", 
			"MAX_FILE_COUNT", "MAX_RECORDS_PER_FILE", "KIND", "JOB_ID", "ALTER", 
			"DATABASE", "FILE", "FUNCTION", "MACRO", "MATERIALIZED", "PROCEDURE", 
			"RETURNS", "ROLE", "SCHEMA", "SEQUENCE", "STAGE", "USER", "VIEW", "Identifier", 
			"EXPONEN", "Scientific_Numeric_Literal", "Numeric_Identifier", "Double_Quoted_Numeric_Identifier", 
			"Dollar_Sign_Identifier", "BlockComment", "LineComment", "Digit", "Period", 
			"Control_Characters", "Extended_Control_Characters", "Character_String_Literal", 
			"DOUBLE_QUOTE_ESCAPE", "HEX_DIGIT", "ESC_SEQ", "OCTAL_ESC", "UNICODE_ESC", 
	...
	public SQLSelectParserLexer(CharStream input) {
		super(input);
	...
	private static final String _serializedATNSegment0 =
		...
		"T\u00ddU\u00dfV\u00e1W\u00e3X\u00e5Y\u00e7Z\u00e9[\u00eb\\\u00ed]\u00ef"+
		"^\u00f1_\u00f3`\u00f5a\u00f7b\u00f9c\u00fbd\u00fde\u00fff\u0101g\u0103"+
		"h\u0105i\u0107j\u0109k\u010bl\u010dm\u010fn\u0111o\u0113p\u0115q\u0117"+
