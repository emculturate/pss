#!/usr/bin/env python3
"""Refresh goldens for nestedWith* exemplar tests in SqlEventWalkerSubqueriesAndClauseSemanticsTests."""
...
def main() -> int:
    ...
    if not failing:
        print("No nestedWith failures in surefire reports. Run mvn test first.")
        return 1
